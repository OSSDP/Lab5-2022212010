...
import { EmployCardRoutingModule } from './routing';
...
import { JobinfoComponent } from './components/jobinfo-component/jobinfocomponent';
import { EduinfoComponent } from './components/eduinfo-component/eduinfocomponent';
...
var EmployCardModule = /** @class */ (function () {
    ...
    EmployCardModule = tslib_1.__decorate([
        NgModule({
            exports: [
                RootComponent
            ],

    ...
    return {
        ...
        execute: function () {
            ...
            var PhoneNumber46c7Entity = /** @class */ (function (_super) {
                __extends(PhoneNumber46c7Entity, _super);
                ...
                PhoneNumber46c7Entity = __decorate([
                    NgEntity({
                        originalCode: "phone",
                        nodeCode: "phone"
                    })
            ...
            var Email503cEntity = /** @class */ (function (_super) {
                __extends(Email503cEntity, _super);
            ...
            var StudentEntity = /** @class */ (function (_super) {
                ...
                __decorate([
                    ...
                    __metadata("design:type", PhoneNumber46c7Entity)
                ...
                __decorate([
                    ...
                    __metadata("design:type", Email503cEntity)
            ...
            var StudentProxy = /** @class */ (function (_super) {
                ...
                function StudentProxy(httpClient, uriService) {
                    ...
                    _this.apiUrl = 'api/apporder/df/v1.0/student_frm';
            ...
            var StudentRepository = /** @class */ (function (_super) {
                ...
                StudentRepository = __decorate([
                    Injectable(),
                    NgRepository({
                        apiUrl: 'api/apporder/df/v1.0/student_frm',
            ...
            var ɵ0$1 = function (context) { return context.state === 'init'; }, ɵ1$1 = function (context) { return context.state === 'init'; }, ɵ2$1 = function (context) { return context.state === 'init'; }, ɵ3$1 = function (context) { return context.state === 'init'; };
            ...
            var rootAdd1Handler = /** @class */ (function (_super) {
                __extends(rootAdd1Handler, _super);
            ...
            var rootEdit1Handler = /** @class */ (function (_super) {
                __extends(rootEdit1Handler, _super);
                function rootEdit1Handler(_NavigationMiddlewareService1, _DataCheckService1, _NavigationService1) {
                    var _this = _super.call(this) || this;
                    _this._NavigationMiddlewareService1 = _NavigationMiddlewareService1;
                    _this._DataCheckService1 = _DataCheckService1;
                    _this._NavigationService1 = _NavigationService1;
                ...
                rootEdit1Handler.prototype.schedule = function () {
                    var _this = this;
                    this.addTask('checkBeforeEdit', function (context) {
                        var args = [
                            '{COMMAND~/params/idToEdit}'
                ...
                rootEdit1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'rootEdit1'
                    }),
                    __metadata("design:paramtypes", [NavigationMiddlewareService,
                        DataCheckService,
                        NavigationService])
                ], rootEdit1Handler);
                return rootEdit1Handler;
            }(CommandHandler));

            var rootView1Handler = /** @class */ (function (_super) {
                __extends(rootView1Handler, _super);
            ...
            var rootRemoveRows1Handler = /** @class */ (function (_super) {
                __extends(rootRemoveRows1Handler, _super);
                function rootRemoveRows1Handler(_DataGridService1, _ListDataService1) {
                    var _this = _super.call(this) || this;
                    _this._DataGridService1 = _DataGridService1;
                    _this._ListDataService1 = _ListDataService1;
                    return _this;
                }
                rootRemoveRows1Handler.prototype.schedule = function () {
                    var _this = this;
                    this.addTask('removeRows', function (context) {
                        var args = [
                            '{COMMAND~/params/ids}',
                ...
                rootRemoveRows1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'rootRemoveRows1'
                    }),
                    __metadata("design:paramtypes", [DataGridService,
                        ListDataService])
                ], rootRemoveRows1Handler);
                return rootRemoveRows1Handler;
            }(CommandHandler));

            var rootRemove1Handler = /** @class */ (function (_super) {
                __extends(rootRemove1Handler, _super);
                function rootRemove1Handler(_DataGridService1, _ListDataService1) {
                    var _this = _super.call(this) || this;
                    _this._DataGridService1 = _DataGridService1;
                    _this._ListDataService1 = _ListDataService1;
                    return _this;
                }
                rootRemove1Handler.prototype.schedule = function () {
                    var _this = this;
                    this.addTask('remove', function (context) {
                        var args = [
                            '{COMMAND~/params/id}',
                ...
                rootRemove1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'rootRemove1'
                    }),
                    __metadata("design:paramtypes", [DataGridService,
                        ListDataService])
                ], rootRemove1Handler);
                return rootRemove1Handler;
            }(CommandHandler));

            var rootRemove2Handler = /** @class */ (function (_super) {
                __extends(rootRemove2Handler, _super);
                function rootRemove2Handler(_DataGridService1, _ListDataService1) {
                    var _this = _super.call(this) || this;
                    _this._DataGridService1 = _DataGridService1;
                    _this._ListDataService1 = _ListDataService1;
                    return _this;
                }
                rootRemove2Handler.prototype.schedule = function () {
                    var _this = this;
                    this.addTask('remove', function (context) {
                        var args = [
                            '{COMMAND~/params/id}',
                ...
                rootRemove2Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'rootRemove2'
                    }),
                    __metadata("design:paramtypes", [DataGridService,
                        ListDataService])
                ], rootRemove2Handler);
                return rootRemove2Handler;
            }(CommandHandler));

            var rootRemoveRows2Handler = /** @class */ (function (_super) {
                __extends(rootRemoveRows2Handler, _super);
                function rootRemoveRows2Handler(_DataGridService1, _ListDataService1) {
                    var _this = _super.call(this) || this;
                    _this._DataGridService1 = _DataGridService1;
                    _this._ListDataService1 = _ListDataService1;
                    return _this;
                }
                rootRemoveRows2Handler.prototype.schedule = function () {
                    var _this = this;
                    this.addTask('removeRows', function (context) {
                        var args = [
                            '{COMMAND~/params/ids}',
                ...
                rootRemoveRows2Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'rootRemoveRows2'
                    }),
                    __metadata("design:paramtypes", [DataGridService,
                        ListDataService])
                ], rootRemoveRows2Handler);
                return rootRemoveRows2Handler;
            }(CommandHandler));

            var rootRemove3Handler = /** @class */ (function (_super) {
                __extends(rootRemove3Handler, _super);
            ...
            var ɵ0$3 = { type: 'string' }, ɵ1$2 = { type: 'string' };
            var DataGridComponentViewmodel = /** @class */ (function (_super) {
                ...
                DataGridComponentViewmodel.prototype.datagridRemove2 = function (commandParam) { return; };
                DataGridComponentViewmodel.prototype.datagridEdit2 = function (commandParam) { return; };
                DataGridComponentViewmodel.prototype.datagridChangePage1 = function (commandParam) { return; };
                DataGridComponentViewmodel.prototype.datagridChangePage2 = function (commandParam) { return; };
                __decorate([
                    NgCommand({
                        name: 'ChangePage1',
                        params: {
                ...
                __decorate([
                    ...
                    __metadata("design:paramtypes", [Object]),
                    __metadata("design:returntype", Observable)
                ], DataGridComponentViewmodel.prototype, "datagridRemove2", null);
                __decorate([
                    NgCommand({
                        name: 'datagridEdit2',
                        params: {
                    ...
                    __metadata("design:paramtypes", [Object]),
                    __metadata("design:returntype", Observable)
                ], DataGridComponentViewmodel.prototype, "datagridEdit2", null);
                __decorate([
                    NgCommand({
                    ...
                    __metadata("design:paramtypes", [Object]),
                    __metadata("design:returntype", Observable)
                ], DataGridComponentViewmodel.prototype, "datagridChangePage1", null);
                __decorate([
                    NgCommand({
                    ...
                    __metadata("design:paramtypes", [Object]),
                    __metadata("design:returntype", Observable)
                ], DataGridComponentViewmodel.prototype, "datagridChangePage2", null);
            ...
            var datagridRemove1Handler = /** @class */ (function (_super) {
                __extends(datagridRemove1Handler, _super);
                ...
                datagridRemove1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
            ...
            var datagridEdit1Handler = /** @class */ (function (_super) {
                __extends(datagridEdit1Handler, _super);
                function datagridEdit1Handler(_NavigationMiddlewareService1, _DataCheckService1, _NavigationService1) {
                    var _this = _super.call(this) || this;
                    _this._NavigationMiddlewareService1 = _NavigationMiddlewareService1;
                    _this._DataCheckService1 = _DataCheckService1;
                    _this._NavigationService1 = _NavigationService1;
                ...
                datagridEdit1Handler.prototype.schedule = function () {
                    var _this = this;
                    this.addTask('checkBeforeEdit', function (context) {
                        var args = [
                            '{COMMAND~/params/idToEdit}'
                ...
                datagridEdit1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'datagridEdit1'
                    }),
                    __metadata("design:paramtypes", [NavigationMiddlewareService,
                        DataCheckService,
                        NavigationService])
                ], datagridEdit1Handler);
                return datagridEdit1Handler;
            }(CommandHandler));

            var datagridRemove2Handler = /** @class */ (function (_super) {
                __extends(datagridRemove2Handler, _super);
                ...
                datagridRemove2Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
            ...
            var datagridEdit2Handler = /** @class */ (function (_super) {
                __extends(datagridEdit2Handler, _super);
                function datagridEdit2Handler(_NavigationMiddlewareService1, _DataCheckService1, _NavigationService1) {
                    var _this = _super.call(this) || this;
                    _this._NavigationMiddlewareService1 = _NavigationMiddlewareService1;
                    _this._DataCheckService1 = _DataCheckService1;
                    _this._NavigationService1 = _NavigationService1;
                ...
                datagridEdit2Handler.prototype.schedule = function () {
                    var _this = this;
                    this.addTask('checkBeforeEdit', function (context) {
                        var args = [
                            '{COMMAND~/params/idToEdit}'
                ...
                datagridEdit2Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
                        commandName: 'datagridEdit2'
                    }),
                    __metadata("design:paramtypes", [NavigationMiddlewareService,
                        DataCheckService,
                        NavigationService])
                ], datagridEdit2Handler);
                return datagridEdit2Handler;
            }(CommandHandler));

            var datagridChangePage1Handler = /** @class */ (function (_super) {
                __extends(datagridChangePage1Handler, _super);
                ...
                datagridChangePage1Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
            ...
            var datagridChangePage2Handler = /** @class */ (function (_super) {
                __extends(datagridChangePage2Handler, _super);
                ...
                datagridChangePage2Handler = __decorate([
                    Injectable(),
                    NgCommandHandler({
            ...
            var ɵ0$4 = (createTranslateLoader$1), ɵ1$3 = localStorage.getItem('languageCode') || 'zh-CHS', ɵ2$2 = function () { return window.location.protocol + "//" + window.location.hostname + ":" + window.location.port; };
            var StudentModule = /** @class */ (function () {
                function StudentModule(trans) {
                    this.trans = trans;
                }
                StudentModule = __decorate([
                    NgModule({
                        ...
                        providers: [
                            { provide: LOCALE_ID, useValue: ɵ1$3 },
                            TranslateResolveService,
                            FARRIS_DEVKIT_APP_PROVIDERS,
                            FrameworkVariableService,
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/apporder/df/web/bo-organization-front/student/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/apporder/df/web/bo-organization-front/student/i18n/', '.json');
            }

/*! UPDATE TIME: 2024/11/9 23:16:21 */
    ...
    return {
        ...
        execute: function () {
            ...
            var StudentCourseEntity = /** @class */ (function (_super) {
                __extends(StudentCourseEntity, _super);
                ...
                StudentCourseEntity = __decorate([
                    NgEntity({
            ...
            var StudentCourseRepository = /** @class */ (function (_super) {
                __extends(StudentCourseRepository, _super);
                ...
                StudentCourseRepository = __decorate([
                    Injectable(),
                    NgRepository({
            ...
            var ɵ0$1 = function (context) { return context.state === 'init'; }, ɵ1 = function (context) { return context.state === 'init'; }, ɵ2 = function (context) { return context.state === 'init'; }, ɵ3 = function (context) { return context.state === 'init'; };
                    ...
                    _this.fieldConfigsqueryscheme1 = [
                        {
                            ...
                            "labelCode": "ID",
                            "code": "ID",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/a4ae23b7-fa4e-425d-8349-07ec86fd8942", _this.lang, "主键"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/a4ae23b7-fa4e-425d-8349-07ec86fd8942/placeHolder", _this.lang, ""),
                            "control": { "id": "a4ae23b7-fa4e-425d-8349-07ec86fd8942", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "77153117-51b3-4cd0-bb7b-0c3a5a43bd32",
                            "labelCode": "Version",
                            "code": "Version",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/77153117-51b3-4cd0-bb7b-0c3a5a43bd32", _this.lang, "版本"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/77153117-51b3-4cd0-bb7b-0c3a5a43bd32/placeHolder", _this.lang, ""),
                            "control": { "id": "77153117-51b3-4cd0-bb7b-0c3a5a43bd32", "controltype": "date", "require": false, "format": "yyyy-MM-dd", "weekSelect": false, "startFieldCode": "Version", "endFieldCode": "Version" }
                        },
                        {
                            "id": "c8a96a10-136b-4552-bd9b-939e9ddc2d91",
                            "labelCode": "student_id",
                            "code": "student_id",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/c8a96a10-136b-4552-bd9b-939e9ddc2d91", _this.lang, "学生ID"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/c8a96a10-136b-4552-bd9b-939e9ddc2d91/placeHolder", _this.lang, ""),
                            "control": { "id": "c8a96a10-136b-4552-bd9b-939e9ddc2d91", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "4d647003-08b8-4450-bc45-f45ffcb18b70",
                            "labelCode": "course_id",
                            "code": "course_id",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/4d647003-08b8-4450-bc45-f45ffcb18b70", _this.lang, "课程ID"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/4d647003-08b8-4450-bc45-f45ffcb18b70/placeHolder", _this.lang, ""),
                            "control": { "id": "4d647003-08b8-4450-bc45-f45ffcb18b70", "controltype": "text", "require": false, "className": "" }
                        },
                        {
                            "id": "d3117fe5-7abd-4b35-bafc-6d8aafa40ae8",
                            "labelCode": "State",
                            "code": "State",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/d3117fe5-7abd-4b35-bafc-6d8aafa40ae8", _this.lang, "选课状态"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/d3117fe5-7abd-4b35-bafc-6d8aafa40ae8/placeHolder", _this.lang, ""),
                            "control": {
                                ...
                                "enumValues": [
                                    {
                                        "value": "xz",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/d3117fe5-7abd-4b35-bafc-6d8aafa40ae8/control/enumValues/xz", _this.lang, "已选中")
                                    },
                                    {
                                        "value": "yc",
                                        "name": _this.langService.transform("QueryScheme/query-scheme-1/d3117fe5-7abd-4b35-bafc-6d8aafa40ae8/control/enumValues/yc", _this.lang, "异常")
                                    }
                                ]
                            }
                        },
                        {
                            ...
                            "labelCode": "grade",
                            "code": "grade",
                            "name": _this.langService.transform("QueryScheme/query-scheme-1/c87e9cd9-e2bd-48fb-bbca-f8a346785534", _this.lang, "学生成绩"),
                            "placeHolder": _this.langService.transform("QueryScheme/query-scheme-1/c87e9cd9-e2bd-48fb-bbca-f8a346785534/placeHolder", _this.lang, ""),
                            "control": { "id": "c87e9cd9-e2bd-48fb-bbca-f8a346785534", "controltype": "number", "require": false, "className": "", "textAlign": "left", "precision": 2, "isBigNumber": false }
                        }
                    ];
                ...
                RootComponent = __decorate([
                    Component({
                        ...
                        providers: [
                            ...
                            { provide: FORM_ID, useValue: "cdc9192d-7129-41e7-b4a0-699cb1ea48f1" },
            ...
            var StudentCourseRoutingModule = /** @class */ (function () {
                function StudentCourseRoutingModule() {
                }
                StudentCourseRoutingModule = __decorate([
                    NgModule({
                        imports: [
                        ...
                        [
                            {
                                ...
                                field: 'student_id',
                                width: 120,
                                title: this.langService.transform("student_id_c8a96a10_ug84", this.lang, "学生ID"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                            ...
                            },
                            {
                                ...
                                field: 'course_id',
                                width: 120,
                                title: this.langService.transform("course_id_4d647003_prh6", this.lang, "课程ID"),
                                dataType: 'string',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                            ...
                            },
                            {
                                ...
                                field: 'state',
                                width: 120,
                                title: this.langService.transform("state_d3117fe5_13d1", this.lang, "选课状态"),
                                dataType: 'enum',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
                                ...
                                formatter: {
                                    ...
                                    "options": {
                                        ...
                                        "data": [
                                            {
                                                "value": "xz",
                                                "name": this.langService.transform("GridField/state_d3117fe5_13d1/enumData/xz", this.lang, "已选中")
                                            },
                                            {
                                                "value": "yc",
                                                "name": this.langService.transform("GridField/state_d3117fe5_13d1/enumData/yc", this.lang, "异常")
                                            }
                                        ]
                                    }
                                }
                            },
                            {
                                ...
                                field: 'grade',
                                width: 120,
                                title: this.langService.transform("grade_c87e9cd9_v6jm", this.lang, "学生成绩"),
                                dataType: 'number',
                                align: 'left',
                                halign: 'left',
                                valign: 'middle',
            ...
            var ɵ0$4 = (createTranslateLoader$1), ɵ1$1 = localStorage.getItem('languageCode') || 'zh-CHS', ɵ2$1 = function () { return window.location.protocol + "//" + window.location.hostname + ":" + window.location.port; };
            var StudentCourseModule = /** @class */ (function () {
                function StudentCourseModule(trans) {
                    this.trans = trans;
                }
                StudentCourseModule = __decorate([
                    NgModule({
                        ...
                        providers: [
                            ...
                            FrmI18nSettingService,
                            FileViewerService,
                            { provide: FORM_PATH_TOKEN, useValue: '/apps/apporder/df/web/bo-organization-front/studentcourse/' },
            ...
            function createTranslateLoader$1(http) {
                return new TranslateHttpLoader(http, '/apps/apporder/df/web/bo-organization-front/studentcourse/i18n/', '.json');
            }
            ...
            function View_DataGridComponent_3(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 7, "div", [["class", "f-btn-group "]], null, null, null, null, null)), (_l()(), ɵeld(1, 0, null, null, 6, "div", [["class", "btn-group-sm btn-group f-btn-group-links"]], null, null, null, null, null)), (_l()(), ɵeld(2, 0, null, null, 2, "button", [["class", "btn-link btn ng-star-inserted"]], null, [[null, "click"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("click" === en)) {
                    var pd_0 = (_co.viewModel.datagridEdit1($event, _v.context.$implicit) !== false);
                    ad = (pd_0 && ad);
                    ...
                    var pd_0 = (_co.viewModel.datagridRemove1($event, _v.context.$implicit) !== false);
                    ad = (pd_0 && ad);
            ...
            function View_RootComponent_3(_l) { return ɵvid(0, [(_l()(), ɵeld(0, 0, null, null, 5, "farris-querysolution", [["farris-querysolution-event-bind", ""], ["id", "query-scheme-1"]], [[8, "className", 0]], [[null, "queryEmitter"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("queryEmitter" === en)) {
                    ...
                    ad = (pd_1 && ad);
                } return ad; }, View_QuerySolutionComponent_0, RenderType_QuerySolutionComponent)), ɵprd(512, null, ConvertorService, ConvertorService, []), ɵprd(512, null, ɵa$1, ɵa$1, [HttpClient]), ɵprd(512, null, ɵb$2, ɵb$2, []), ɵdid(4, 770048, null, 0, QuerySolutionComponent, [NotifyService, ComponentFactoryResolver, Injector, BsModalService, ConvertorService, SolutionService, ɵa$1, ɵb$2, LocaleService], { fieldConfigs: [0, "fieldConfigs"], presetQuerySolutionName: [1, "presetQuerySolutionName"], presetFieldConfigs: [2, "presetFieldConfigs"], isDisabled: [3, "isDisabled"], formId: [4, "formId"], isFold: [5, "isFold"], isControlInline: [6, "isControlInline"], showCompleteLabel: [7, "showCompleteLabel"], enableInitQuery: [8, "enableInitQuery"], enableHistory: [9, "enableHistory"], filterText: [10, "filterText"] }, { queryEmitter: "queryEmitter" }), ɵdid(5, 16384, null, 0, FarrisQuerySolutionEventBindDirective, [Injector, QuerySolutionComponent, FrameContext], null, null)], function (_ck, _v) { var _co = _v.component; var currVal_1 = _co.fieldConfigsqueryscheme1; var currVal_2 = _co.QuerySolutionqueryscheme1; var currVal_3 = _co.presetFieldConfigsqueryscheme1; var currVal_4 = false; var currVal_5 = "StudentCourse"; var currVal_6 = !true; var currVal_7 = true; var currVal_8 = false; var currVal_9 = false; var currVal_10 = false; var currVal_11 = _co.filterTextqueryscheme1; _ck(_v, 4, 1, [currVal_1, currVal_2, currVal_3, currVal_4, currVal_5, currVal_6, currVal_7, currVal_8, currVal_9, currVal_10, currVal_11]); }, function (_ck, _v) { var currVal_0 = ɵnov(_v, 4).cls; _ck(_v, 0, 0, currVal_0); }); }

...
export declare class SuCreatorModalComponent implements OnInit {
    private boCreatorUtils;
    private boDtService;
    private notifyService;
    parentId: string;
    suConfirmEmitter: EventEmitter<any>;
    appSelector: ComboListComponent;
    /**
     * 当前BO节点
     */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('rxjs/Observable'), require('@angular/forms'), require('@progress/kendo-angular-treeview'), require('@progress/kendo-angular-grid'), require('@farris/ui-dialog'), require('@progress/kendo-angular-layout'), require('@progress/kendo-data-query'), require('@progress/kendo-angular-dropdowns'), require('@farris/ui-loading'), require('rxjs/operators'), require('rxjs'), require('@angular/core'), require('@angular/common/http'), require('@farris/ide-devkit')) :
    typeof define === 'function' && define.amd ? define('@gsp-lcm/metadata-selector', ['exports', '@angular/common', 'rxjs/Observable', '@angular/forms', '@progress/kendo-angular-treeview', '@progress/kendo-angular-grid', '@farris/ui-dialog', '@progress/kendo-angular-layout', '@progress/kendo-data-query', '@progress/kendo-angular-dropdowns', '@farris/ui-loading', 'rxjs/operators', 'rxjs', '@angular/core', '@angular/common/http', '@farris/ide-devkit'], factory) :
    (factory((global['gsp-lcm'] = global['gsp-lcm'] || {}, global['gsp-lcm']['metadata-selector'] = {}),global.ng.common,global.rxjs.Observable,global.ng.forms,global.kendoAngularTreeview,global.kendoAngularGrid,global.uiDialog,global.kendoAngularLayout,global.kendoDataQuery,global.kendoAngularDropdowns,global.uiLoading,global.rxjs.operators,global.rxjs,global.ng.core,global.ng.common.http,global.ideDevkit));
}(this, (function (exports,common,Observable,forms,kendoAngularTreeview,kendoAngularGrid,uiDialog,kendoAngularLayout,kendoDataQuery,kendoAngularDropdowns,uiLoading,operators,rxjs,core,http,ideDevkit) { 'use strict';
    ...
    var GSPMetadataService = /** @class */ (function () {
        function GSPMetadataService(http$$1, url) {
            this.http = http$$1;
            this.url = url;
        ...
        GSPMetadataService.prototype.PackageBuild =
            ...
            function (path) {
                ...
                /** @type {?} */
                var headers = new http.HttpHeaders({ 'Content-Type': 'application/json' }).append('SessionId', sessionId);
                /** @type {?} */
        ...
        GSPMetadataService.prototype.InitializeMetadataEntity =
            ...
            function (metadataDto) {
                /** @type {?} */
                var headers = new http.HttpHeaders().set('SessionId', this.sessionId);
         ...
         */
            function (scope, metadataType, searchText, page, selectedPackageSource, currentProjPath) {
                ...
                if (selectedPackageSource === void 0) {
                    selectedPackageSource = null;
                }
                if (currentProjPath === void 0) {
                    currentProjPath = '';
                }
                /** @type {?} */
                var headers = new http.HttpHeaders().set('SessionId', this.sessionId);
        ...
        /** @nocollapse */
        GSPMetadataService.ctorParameters = function () {
            return [
    ...
    var TreeclassifierComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        TreeclassifierComponent.ctorParameters = function () {
            return [
        ...
        TreeclassifierComponent.propDecorators = {
            metadataPath: [{ type: core.Input }],
            onlyDisplayCurrentProject: [{ type: core.Input }]
        };
    ...
    var MetadatapackageselectComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MetadatapackageselectComponent.ctorParameters = function () {
            return [
                { type: MetadataService },
                { type: GSPMetadataService }
            ];
        ...
        MetadatapackageselectComponent.propDecorators = {
            ...
            treeclassifierComponent: [{ type: core.ViewChild, args: [TreeclassifierComponent,] }]
        };
    ...
    var SelectMetadataComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        SelectMetadataComponent.ctorParameters = function () {
            return [
                { type: MetadataService },
        ...
        SelectMetadataComponent.propDecorators = {
            metadatapackageselectComponent: [{ type: core.ViewChild, args: [MetadatapackageselectComponent,] }],
            metadataPath: [{ type: core.Input }],
    ...
    ***************************************************************************** */
    ...
    var TemplatemetadataComponent = /** @class */ (function () {
        function TemplatemetadataComponent(metadataService, gspMetaService) {
            ...
            this.dotnet = 'dotnet';
            this.java = 'java';
            this.technologyStack = new core.EventEmitter();
            this.loading = false;
            this.selectedMetadataChanged = new core.EventEmitter();
            ...
            this.searchTextSub = new rxjs.Subject();
            this.postfix = '';
            ...
            this.classifier = { id: '' };
            this.searchTextSub.pipe(operators.debounceTime(2048), operators.distinctUntilChanged()).subscribe(( /**
             * @param {?} text
             * @return {?}
             */function (text) {
        ...
        /** @nocollapse */
        TemplatemetadataComponent.ctorParameters = function () {
            return [
                { type: MetadataService },
                { type: GSPMetadataService }
            ];
        ...
        TemplatemetadataComponent.propDecorators = {
            isMavenEnable: [{ type: core.Input }],
            technologyStack: [{ type: core.Output }],
            typeName: [{ type: core.Input }],
            filter: [{ type: core.Input }],
            selectedMetadataChanged: [{ type: core.Output }]
        };
    ...
    var MetadatapackagelistComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MetadatapackagelistComponent.ctorParameters = function () {
            return [
                { type: MetadataService }
            ];
        };
    ...
    var MetadatalistdetailsComponent = /** @class */ (function () {
        function MetadatalistdetailsComponent() {
            ...
            this.detailSkip = 0;
            this.pageSize = 5;
            this.selectedPkgChanged = new core.EventEmitter();
            this.dataItem = [];
        }
        /**
         * @return {?}
        ...
        MetadatalistdetailsComponent.propDecorators = {
            isMavenEnable: [{ type: core.Input }],
            mdItem: [{ type: core.Input }],
            selectedPkgChanged: [{ type: core.Output }],
            codelanguage: [{ type: core.Input }]
        };
    ...
    var OnceClickDirective = /** @class */ (function () {
        ...
        element) {
            ...
            this.clickCall = new core.EventEmitter();
         ...
         */
            function () {
                ...
                //   }
                // );
                this.subscription = this.$sub.pipe(operators.throttleTime(this.duration)).subscribe(( /**
                 * @param {?} e
                 * @return {?}
                 */function (e) {
        ...
        /** @nocollapse */
        OnceClickDirective.ctorParameters = function () {
            return [
                { type: core.Renderer2 },
        ...
        OnceClickDirective.propDecorators = {
            clickCall: [{ type: core.Output, args: ['click.once',] }],
    ...
    function factory(http$$1, url) {
        return new GSPMetadataService(http$$1, url);
    }
            ...
            function (url) {
                return {
                    ...
                    providers: [
                        ...
                        { provide: GSPMetadataService, useFactory: factory, deps: [http.HttpClient, 'url'] }
                    ]
                };
            };
    ...
    if (!(( /** @type {?} */(window))).gsp) {
        (( /** @type {?} */(window))).gsp = /*(globalGsp && globalGsp.createChild()) ||*/ new ideDevkit.GSP(globalGsp);
    }
    ...
    exports.MetadataSelectModule = MetadataSelectModule;
    exports.SelectMetadataComponent = SelectMetadataComponent;
    exports.GSPMetadataService = GSPMetadataService;
    exports.GSPMetadataServiceModule = GSPMetadataServiceModule;
    ...
    exports.ɵe = TemplatemetadataComponent;
    exports.ɵg = MetadatalistdetailsComponent;
    exports.ɵf = MetadatapackagelistComponent;
    exports.ɵb = MetadatapackageselectComponent;
    exports.ɵh = OnceClickDirective;
    exports.ɵc = TreeclassifierComponent;
    exports.ɵd = MetadataService;
    exports.ɵa = factory;
...
//# sourceMappingURL=gsp-lcm-metadata-selector.umd.js.map
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@gsp-bef/gsp-cm-metadata'), require('@gsp-bef/gsp-udt-metadata')) :
    typeof define === 'function' && define.amd ? define('@gsp-bef/gsp-be-metadata', ['exports', '@gsp-bef/gsp-cm-metadata', '@gsp-bef/gsp-udt-metadata'], factory) :
    (factory((global['gsp-bef'] = global['gsp-bef'] || {}, global['gsp-bef']['gsp-be-metadata'] = {}),global.gspCmMetadata,global.gspUdtMetadata));
}(this, (function (exports,gspCmMetadata,gspUdtMetadata) { 'use strict';
    ...
    * @author wangjiegj<wangjiegj@inspur.com>
    ...
    var BizReturnValue = /** @class */ (function (_super) {
        ...
        function BizReturnValue() {
            ...
            _this.Mode = BizParameterMode.OUT;
            return _this;
        }
    ...
    var BizAction = /** @class */ (function (_super) {
        ...
        function BizAction() {
            ...
            _this.ReturnValue = new BizVoidReturnType();
            return _this;
        }
        return BizAction;
    }(BizActionBase));
    ...
    * @author wangjiegj<wangjiegj@inspur.com>
     ...
     */
    /** @enum {number} */
    var BizCollectionParameterType = {
        /**
         * 未使用集合形式
         */
        None: 0,
    ...
    /** @type {?} */
    var BizCollectionParameterTypes = [
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ValidationTriggerPoint = /** @class */ (function () {
        function ValidationTriggerPoint() {
        }
        return ValidationTriggerPoint;
    }());
    ...
    * @author wangjiegj<wangjiegj@inspur.com>
    ...
    var BeOperationUtil = /** @class */ (function () {
         ...
         */
            function (bizObject) {
                ...
                if (bizObject.BizActions && bizObject.BizActions.length > 0) {
                    result.push.apply(result, __spread(bizObject.BizActions));
                }
                if (bizObject.ContainChildObjects && bizObject.ContainChildObjects.length > 0) {
                    for (var i = 0; i < bizObject.ContainChildObjects.length; i++) {
                        result.push.apply(result, __spread(this.getChidrenObjectsActions(( /** @type {?} */(bizObject.ContainChildObjects[i])))));
                    }
                }
                return result;
            };
         ...
         */
            function (bizObject) {
                ...
                if (bizObject.Determinations && bizObject.Determinations.length > 0) {
                    result.push.apply(result, __spread(bizObject.Determinations));
                }
                if (bizObject.ContainChildObjects && bizObject.ContainChildObjects.length > 0) {
                    for (var i = 0; i < bizObject.ContainChildObjects.length; i++) {
                        result.push.apply(result, __spread(this.getChidrenObjectsDeterminations(( /** @type {?} */(bizObject.ContainChildObjects[i])))));
                    }
                }
                return result;
            };
         ...
         */
            function (bizObject) {
                ...
                if (bizObject.Validations && bizObject.Validations.length > 0) {
                    result.push.apply(result, __spread(bizObject.Validations));
                }
                if (bizObject.ContainChildObjects && bizObject.ContainChildObjects.length > 0) {
                    for (var i = 0; i < bizObject.ContainChildObjects.length; i++) {
                        result.push.apply(result, __spread(this.getChidrenObjectsValidations(( /** @type {?} */(bizObject.ContainChildObjects[i])))));
                    }
                }
                return result;
            };
         ...
         */
            function (be) {
                /** @type {?} */
                var result = new Array();
                result.push.apply(result, __spread(this.getAllBizEntityActions(be)));
                result.push.apply(result, __spread(this.getAllMgrActions(be)));
                result.push.apply(result, __spread(this.getAllDeterminations(be)));
                result.push.apply(result, __spread(this.getAllValidations(be)));
                return result;
            };
        /**
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var LogicDeleteControlInfo = /** @class */ (function () {
        function LogicDeleteControlInfo() {
        }
    ...
    exports.BECategories = BECategories;
    ...
    exports.BETriggerTimePointTypes = BETriggerTimePointTypes;
    ...
    exports.BizParameterMode = BizParameterMode;
    exports.BizParameterModes = BizParameterModes;
    exports.BizParameterType = BizParameterType;
    exports.BizParameterTypes = BizParameterTypes;
    exports.BizReturnValue = BizReturnValue;
    exports.BizVoidReturnType = BizVoidReturnType;
    exports.BizCollectionParameterType = BizCollectionParameterType;
    exports.BizCollectionParameterTypes = BizCollectionParameterTypes;
    exports.ValidationTriggerPoint = ValidationTriggerPoint;
    ...
    exports.BeOperationUtil = BeOperationUtil;
    exports.LogicDeleteControlInfo = LogicDeleteControlInfo;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gsp-bef-gsp-be-metadata.umd.js.map
...
import { ValidationTriggerPoint } from './ValidationTriggerPoints/ValidationTriggerPoint';
/**
* 验证操作
...
* 验证操作
*/
export declare class Validation extends BizOperation {
    constructor();
    /**
     * 操作类型
     */
     ...
     */
    ValidationType: BEValidationType;
    /**
     * 触发时机的类型
     */
     ...
     * 前置校验列表，列表不分先后次序
     */
    Precedings: Validation[];
    /**
     * 后置校验列表，列表不分先后次序
     */
    Succeedings: Validation[];
    /**
     * 前置校验列表，列表不分先后次序
     */
    PrecedingIds: string[];
     ...
     * 触发时机
     */
    ValidationTriggerPoints: ValidationTriggerPoint[];
}

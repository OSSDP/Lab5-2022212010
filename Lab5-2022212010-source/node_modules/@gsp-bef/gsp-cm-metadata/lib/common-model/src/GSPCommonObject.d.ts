...
import { GspCommonDataType, GSPAssociationKey, MdRefInfo } from '../ref';
 ...
 * 节点元数据
 */
export declare class GSPCommonObject extends GspCommonDataType implements IGSPCommonObject {
    /**
     * 持久化构件
     */
     ...
     * 当前节点主键字段
     */
    readonly IDElement: IGSPCommonElement;
    /**
     * 当前节点字段集合
     */
    ContainElements: GSPCommonElement[];
    /**
     * 当前节点的子节点集合
     */

 ...
 * 关联关系
 */
export declare class CefGSPAssociation {
    /**
     * 标识
     */
    ID: string;
     ...
     * KeyCollection
     */
    KeyCollection: GSPAssociationKey[];
    /**
     * 引用的元素集合
     */
    RefElementCollection: GspCommonField[];
    /**
     * 过滤条件
     */
    Where: string;
     ...
     * 删除规则类型
     */
    DeleteRuleType: GSPDeleteRuleType;
    /**
     * 联接方式
     */
    JoinMode: JoinMode;

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@progress/kendo-angular-grid'), require('@progress/kendo-angular-dialog'), require('@progress/kendo-angular-treeview'), require('@progress/kendo-data-query'), require('rxjs'), require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('@progress/kendo-angular-buttons'), require('@progress/kendo-angular-dropdowns'), require('@progress/kendo-angular-layout'), require('@angular/forms'), require('@ecp-caf/caf-common'), require('@farris/ui-modal'), require('@farris/ui-dialog')) :
    typeof define === 'function' && define.amd ? define('@gsp-aif/runtime-api', ['exports', '@progress/kendo-angular-grid', '@progress/kendo-angular-dialog', '@progress/kendo-angular-treeview', '@progress/kendo-data-query', 'rxjs', '@angular/core', '@angular/common', '@angular/common/http', '@progress/kendo-angular-buttons', '@progress/kendo-angular-dropdowns', '@progress/kendo-angular-layout', '@angular/forms', '@ecp-caf/caf-common', '@farris/ui-modal', '@farris/ui-dialog'], factory) :
    (factory((global['gsp-aif'] = global['gsp-aif'] || {}, global['gsp-aif']['runtime-api'] = {}),global.kendoAngularGrid,global.kendoAngularDialog,global.kendoAngularTreeview,global.kendoDataQuery,global.rxjs,global.ng.core,global.ng.common,global.ng.common.http,global.kendoAngularButtons,global.kendoAngularDropdowns,global.kendoAngularLayout,global.ng.forms,global.cafCommon,global.uiModal,global.uiDialog));
}(this, (function (exports,kendoAngularGrid,kendoAngularDialog,kendoAngularTreeview,kendoDataQuery,rxjs,core,common,http,kendoAngularButtons,kendoAngularDropdowns,kendoAngularLayout,forms,cafCommon,uiModal,uiDialog) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AifDocumentsTrackService = /** @class */ (function () {
        function AifDocumentsTrackService(http$$1, modalService, injector, cfr, config) {
            this.http = http$$1;
        ...
        /** @nocollapse */
        AifDocumentsTrackService.ctorParameters = function () {
            return [
    ...
    var AifDocumentsTrackManagerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AifDocumentsTrackManagerComponent.ctorParameters = function () {
            return [
        ...
        AifDocumentsTrackManagerComponent.propDecorators = {
            ...
            beTypeCode: [{ type: core.Input }],
            selectedTrackType: [{ type: core.Input }],
            trackTypes: [{ type: core.Output }]
        };
    ...
    var AifDocumentsTreeComponent = /** @class */ (function () {
        function AifDocumentsTreeComponent(trackService) {
             ...
             * 父子组件通信传值
             */
            this.trackClick = new core.EventEmitter();
            this._documents = {};
            this._beTypeCodes = [];
            this.beTypeNames = {};
        }
        ...
        Object.defineProperty(AifDocumentsTreeComponent.prototype, "beTypeCodes", {
             ...
             */ function (beTypeCodes) {
                ...
                this.gridDataOfDocuments = kendoDataQuery.process([], this.stateOfDocuments);
                ...
                try {
                    ...
                    try {
                        if (beTypeCodes_1_1 && !beTypeCodes_1_1.done && (_a = beTypeCodes_1.return))
                            _a.call(beTypeCodes_1);
                    }
                    finally {
                        if (e_1)
                            throw e_1.error;
         ...
         */
            function () {
                ...
                this.gridDataOfDocuments = kendoDataQuery.process(this.documents[this.selectBeType], this.stateOfDocuments);
                // this.fitColumns();
        ...
        /** @nocollapse */
        AifDocumentsTreeComponent.ctorParameters = function () {
            return [
                { type: AifDocumentsTrackService }
            ];
        };
        AifDocumentsTreeComponent.propDecorators = {
            trackClick: [{ type: core.Output }],
            documents: [{ type: core.Input }],
            beTypeCodes: [{ type: core.Input }],
            beTypeNames: [{ type: core.Input }],
            trackType: [{ type: core.Input }],
            gridOfDocuments: [{ type: core.ViewChild, args: ["gridOfDocuments",] }]
        };
        ...
        AifDocumentsTrackManagerModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            ...
                            kendoAngularDialog.WindowModule,
                            kendoAngularDropdowns.DropDownsModule,
                            kendoAngularDialog.DialogModule,
                            kendoAngularTreeview.TreeViewModule,
                            kendoAngularLayout.SplitterModule,
                            kendoAngularGrid.GridModule,
    ...
    var AifPullSelectCreationRuleInternalService = /** @class */ (function () {
        function AifPullSelectCreationRuleInternalService(http$$1, config) {
            this.http = http$$1;
            this.serverIP = null;
        ...
        /** @nocollapse */
        AifPullSelectCreationRuleInternalService.ctorParameters = function () {
            return [
                { type: cafCommon.HttpService },
    ...
    var AifPullSelectCreationRuleComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AifPullSelectCreationRuleComponent.ctorParameters = function () {
            return [
    ...
    var AifPullSelectCreationRuleService = /** @class */ (function () {
        ...
        /** @nocollapse */
        AifPullSelectCreationRuleService.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.ComponentFactoryResolver },
                { type: uiModal.BsModalService }
    ...
    var AifPushSelectCreationRuleInternalService = /** @class */ (function () {
        function AifPushSelectCreationRuleInternalService(http$$1, config) {
            this.http = http$$1;
            this.serverIP = "";
            this.getCreationRuleUrl = "/api/runtime/aif/v1.0/creationrulecontroller/getcreationrule";
            this.serverIP = config == null || config.serverIP == null ? "" : config.serverIP;
        ...
        /** @nocollapse */
        AifPushSelectCreationRuleInternalService.ctorParameters = function () {
            return [
                { type: cafCommon.HttpService },
    ...
    var AifPushSelectCreationRuleComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        AifPushSelectCreationRuleComponent.ctorParameters = function () {
            return [
    ...
    var AifPushSelectCreationRuleService = /** @class */ (function () {
        ...
        /** @nocollapse */
        AifPushSelectCreationRuleService.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.ComponentFactoryResolver },
                { type: uiModal.BsModalService }
    ...
    exports.AifAssociationEntity = AifAssociationEntity;
    exports.GetCreationRuleArgs = GetCreationRuleArgs;
    exports.AifDocumentsTrackManagerModuleConfig = AifDocumentsTrackManagerModuleConfig;
    exports.AifPullSelectCreationRuleModuleConfig = AifPullSelectCreationRuleModuleConfig;
    exports.AifPushSelectCreationRuleModuleConfig = AifPushSelectCreationRuleModuleConfig;
    exports.AifDocumentsTrackManagerComponent = AifDocumentsTrackManagerComponent;
    exports.AifDocumentsTrackService = AifDocumentsTrackService;
    exports.AifDocumentsTrackManagerModule = AifDocumentsTrackManagerModule;
    exports.AifDocumentsPropertyTextMap = AifDocumentsPropertyTextMap;
    exports.TrackDirectionTypeMap = TrackDirectionTypeMap;
    exports.TrackTypeTextMap = TrackTypeTextMap;
    exports.TrackType = TrackType;
    exports.AifPullSelectCreationRuleComponent = AifPullSelectCreationRuleComponent;
    exports.AifPullSelectCreationRuleInternalService = AifPullSelectCreationRuleInternalService;
    exports.AifPullSelectCreationRuleService = AifPullSelectCreationRuleService;
    exports.AifPullSelectCreationRuleModule = AifPullSelectCreationRuleModule;
    exports.AifPushSelectCreationRuleComponent = AifPushSelectCreationRuleComponent;
    exports.AifPushSelectCreationRuleInternalService = AifPushSelectCreationRuleInternalService;
    exports.AifPushSelectCreationRuleService = AifPushSelectCreationRuleService;
    exports.AifPushSelectCreationRuleModule = AifPushSelectCreationRuleModule;
    exports.ɵa = AifDocumentsTreeComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gsp-aif-runtime-api.umd.js.map
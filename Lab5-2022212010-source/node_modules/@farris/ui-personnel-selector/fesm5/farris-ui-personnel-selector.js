...
import { CommonUtils, RuntimeStateService, FarrisCommonModule } from '@farris/ui-common';
...
import { of, Subject, fromEvent, BehaviorSubject } from 'rxjs';
import { trim, cloneDeep, omitBy, isUndefined, isNull } from 'lodash-es';
import { Component, ElementRef, EventEmitter, Injector, Renderer2, ViewChild, Injectable, InjectionToken, Input, Output, ChangeDetectorRef, Optional, Inject, forwardRef, HostBinding, NgZone, ViewContainerRef, ApplicationRef, Pipe, NgModule, defineInjectable } from '@angular/core';
...
/** @type {?} */
var PersonnelSelectorDataGridEditorProvider = { provide: GRID_EDITORS, useValue: { name: 'PersonnelSelector', value: DatagridPersonnelSelectorComponent }, multi: true };
 ...
 */
/** @type {?} */
var GROUP_SERVICE = new InjectionToken('groupService');
...
var CandidateComponent = /** @class */ (function () {
     ...
     */
    function () {
        this.selections = cloneDeep(this.cloneSelections);
        // this.emitSelections();
        this.toggleChecked();
        if (this.isAllChecked()) {
            this.allChecked = true;
    ...
    function () {
        ...
        /** @type {?} */
        var tempSelections = cloneDeep(this.selections);
        this.toggleChecked();
        this.selections = cloneDeep(tempSelections);
        this.cdRef.detectChanges();
    };
    /**
     * 全选后处理
...
var OrgPersonnelComponent = /** @class */ (function () {
    ...
    function () {
        ...
        this.switchPage({ pageIndex: 1 });
        this.treeListData = cloneDeep(this.treeListData);
        this.originalTreeData = cloneDeep(this.originalTreeData);
    };
    /**
     * @return {?}
     */
        ...
        if (helpExtend) {
            ...
            function (data) {
                ...
                if (_this.userInShownOrg.length) {
                    /** @type {?} */
                    var originalPersonnelsData = cloneDeep(res);
...
var FilterOrgTool = /** @class */ (function () {
    function FilterOrgTool() {
        this.selectOrgSubject = new Subject();
    }
    ...
    function PersonnelSelectorComponent(apiService, injector, favoritesTool, eventManager, groupTool, cd) {
        ...
        function () {
            if (!_this.confirmToken) {
                _this.selections = cloneDeep(_this.cloneSelections);
                _this.componentMap.forEach((/**
                 * @param {?} component
                 * @return {?}
                 */
                function (component) {
                    component.cloneSelections = cloneDeep(_this.selections);
    ...
    */
    ...
    function (obj) {
        ...
        if (obj.selections && obj.selections instanceof Array) {
            this.selections = cloneDeep(obj.selections);
            this.selections.forEach((/**
             * @param {?} item
             * @return {?}
             */
        ...
        if (obj.token && obj.token === 'quick') {
            ...
            if (this.recentContactsList.length === 0) {
                this.recentContactsList = cloneDeep(obj.recentContactsList);
            }
            this.returnResult(1);
        }
    };
    ...
    function (plainSource, userPath) {
        var _this = this;
        /** @type {?} */
        var listData = cloneDeep(plainSource);
        if (this.withPermission) {
    ...
    function (numberType) {
        ...
        var finalText;
        if (numberType) {
            this.cloneSelections = cloneDeep(this.selections);
    ...
    function (data) {
         ...
         */
        function (component) {
            component.selections = cloneDeep(_this.selections);
    ...
    function (e) {
        ...
        if (e.nextId === this.organizationTabId) {
            this.unSelectDatagrid.selections = cloneDeep(this.selections);
            this.unSelectDatagrid.filterId = this.filterId;
            ...
            this.sysUserGroupUnselect.selections = cloneDeep(this.selections);
            this.sysUserGroupUnselect.filterId = this.filterId;
            ...
            this.candidateDatagrid.selections = cloneDeep(this.selections);
            // if(!!this.shownOrgId && this.shownOrgId != '*' && !this.candidateDatagrid.userInShownOrg.length) {
            //     const requestParam: any = {
            //         withAllOrg: this._onlyCurrentOrg ? 0 : 1,
            //         notGetStopUser: !this.includeStopUser,
            ...
            this.recentContactsComponent.selections = cloneDeep(this.selections);
            if (!!this.shownOrgId && this.shownOrgId != '*' && !this.recentContactsComponent.userInShownOrg.length) {
                /** @type {?} */
                var requestParam = {
                    withAllOrg: this._onlyCurrentOrg ? 0 : 1,
            ...
            this.favoritesComponent.selections = cloneDeep(this.selections);
            ...
            this.groupComponent.selections = cloneDeep(this.selections);
            if (!!this.shownOrgId && this.shownOrgId != '*' && !this.groupComponent.userInShownOrg.length) {
                /** @type {?} */
                var requestParam = {
                    withAllOrg: this._onlyCurrentOrg ? 0 : 1,
    ...
    function (ids, canShowDialog) {
        ...
        if (!ids) {
            ...
            function (result) {
                ...
                _this.cloneSelections = cloneDeep(_this.selections);
...
var unSelectDatagridOrgComponent = /** @class */ (function () {
    ...
    /** @nocollapse */
    unSelectDatagridOrgComponent.ctorParameters = function () { return [
        { type: ApiLocalService }
    ]; };
    unSelectDatagridOrgComponent.propDecorators = {
        unSelectDatagridOrg: [{ type: ViewChild, args: ['unSelectDatagridOrg',] }],
        columnsOrg: [{ type: Input }],
        itemsOrg: [{ type: Input }],
        pageIndexOrg: [{ type: Input }],
        pageSizeOrg: [{ type: Input }],
        pageTotalAllOrg: [{ type: Input }],
        pathOrg: [{ type: Input }],
        orgIdOrg: [{ type: Input }],
        isContainOrg: [{ type: Input }],
        pageTotalOrg: [{ type: Input }],
        isSingleCheck: [{ type: Input }],
        selections: [{ type: Input }],
        noSelectToRight: [{ type: Input }],
        searchText: [{ type: Input }],
        isLoadOutData: [{ type: Input }],
        unSelectedOrgLists: [{ type: Input }],
        unSelectedListOrg: [{ type: Input }],
        organizationList: [{ type: Input }],
        type: [{ type: Input }],
        listIdField: [{ type: Input }],
        searchPage: [{ type: Input }],
...
export { DatagridPersonnelSelectorComponent, PersonnelSelectorDataGridEditorProvider, PersonnelSelectorComponent, PersonnelSelectorModule, SelectionService, CandidateComponent, FavoritesComponent, GroupComponent, UnSelectDatagridComponent, UserGroupUnSelectComponent, RecentContactsComponent, ApiLocalService, GROUP_SERVICE, FavoritesTool, GroupTool, FilterPosition, FilterOrg, DataLoadingService, FilterOrgTool, SearchKeywordPipe as ɵg, QuickSelectComponent as ɵf, quickInputDatagridComponent as ɵa, SearchResultComponent as ɵe, OrgPersonnelComponent as ɵd, unSelectDatagridRoleComponent as ɵb, unSelectDatagridOrgComponent as ɵc };

//# sourceMappingURL=farris-ui-personnel-selector.js.map
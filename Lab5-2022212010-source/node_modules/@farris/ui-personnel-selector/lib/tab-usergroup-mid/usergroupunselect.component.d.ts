import { EventEmitter, OnInit, AfterViewInit, TemplateRef, SimpleChanges, OnChanges, ChangeDetectorRef, OnDestroy } from '@angular/core';
import { ApiLocalService } from '../../utils/api-service';
import { DatagridComponent } from '@farris/ui-datagrid';
import { FavoritesTool } from '../../utils/favorites.tool';
import { DataLoadingService } from '../../utils/loading-service';
import { FilterOrg, SecurityLevel } from '../../utils/user.type';
export declare class UserGroupUnSelectComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
    private apiService;
    private favoritesTool;
    unSelectDatagrid: DatagridComponent;
    ...
    showOrgAllPathByDesc: boolean;
    enableSecurityControl: boolean;
    securityLevel: SecurityLevel;
    selectionsChange: EventEmitter<any>;
    searchResultChange: EventEmitter<boolean>;
    columns: any;
    selections: any[];
    cloneUserIds: string;
    cloneSelections: any[];
    ...
    filterPersonWithOrgUrl: string;
    filterOrgArr: Array<FilterOrg>;
    filterOrgId: string;
    isEmptyFilterOrg: boolean;
    private filterOrgTool;
    private filterOrgSub;
    currentFilterInfo: string;
    constructor(apiService: ApiLocalService, favoritesTool: FavoritesTool);
    ngOnInit(): void;
    ...
    assembleDataBySearch(): void;
    assembleDataByUserGroupId(): void;
    assembleDataByUserGroupIdAndGetFilterOrg(size: any): void;
    /**
     * datagrid用于数据展示
     */
    unSelectedListLoad(initLoad?: boolean): void;
    toggleAll(): void;
    ...
    */
    ...
    changePageSizeHandler($event: any, num: any): void;
    private changeDisplayOrgAllPath;
}

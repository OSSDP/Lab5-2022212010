...
import { PanelMode, SecurityLevel, UserInfo } from '../utils/user.type';
...
export declare class PersonnelSelectorComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy, ControlValueAccessor {
    private apiService;
    private injector;
    ...
    _includeCurrentUser: boolean;
    _disableCurrentUser: boolean;
    ...
    hasSetGlobalConfigParam: boolean;
    ...
    personnelParamUrl: string;
    positionUserManageUrl: string;
    private userMangeInfo;
    private userManageResult;
    userManagePathResult: {
        orgPathList: any[];
        userGroupPathList: any[];
    };
    ...
    */
    ...
    listenPageSizeChange(e: any): void;
    ...
    private searchUserInCandidateItems;
     ...
     * @param id 该条数据
     */
    onRemoveSelectItem(item: string): void;
    mouseoverBut(): void;
    mouseoutBut(): void;
    onClosedFarrisDialog(e: any): void;
    showQuickSelectPanel(): void;
    ...
    private getPositionAssignResult;
    private changeToUserManageAssignResult;
    private getUserManagePathResult;
}

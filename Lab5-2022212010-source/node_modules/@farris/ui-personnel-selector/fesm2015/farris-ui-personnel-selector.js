...
import { Component, ElementRef, EventEmitter, Injector, Renderer2, ViewChild, Injectable, InjectionToken, Input, Output, ChangeDetectorRef, Optional, Inject, forwardRef, HostBinding, NgZone, ViewContainerRef, ApplicationRef, Pipe, defineInjectable, NgModule } from '@angular/core';
...
class DatagridPersonnelSelectorComponent extends DatagridBaseEditorDirective {
    /**
     * @param {?} render
     * @param {?} el
     * @param {?} rts
...
/** @type {?} */
const PersonnelSelectorDataGridEditorProvider = { provide: GRID_EDITORS, useValue: { name: 'PersonnelSelector', value: DatagridPersonnelSelectorComponent }, multi: true };
    ...
    getPersonnelsByGroup(item, groupType = this.publicToken) {
        ...
        if (helpExtend) {
            ...
            data => {
                ...
                if (this.userInShownOrg.length) {
                    /** @type {?} */
                    const originalPersonnelsData = cloneDeep(res);
                    this.items = originalPersonnelsData.filter((/**
                     * @param {?} data
                     * @return {?}
                     */
                    data => this.userInShownOrg.find((/**
                     * @param {?} user
                     * @return {?}
                     */
 ...
 */
// todo 好多功能待优化，暂时先完成
class PersonnelSelectorComponent {
    /**
     * @param {?} apiService
     * @param {?} injector
     * @param {?} favoritesTool
    ...
    dataToTree(plainSource, userPath) {
        /** @type {?} */
        let listData = cloneDeep(plainSource);
        if (this.withPermission) {

...
export declare class NavigationMiddlewareService {
    ...
    private repository;
    private appContext;
    constructor(navigationService: NavigationService, frameContext: FrameContext, msgService: FormMessageService, languageService: LanguageService, cardDataService: CardDataService);
    /**
     * 关闭前处理
     */
    onClosing(): void;
     ...
     */
    getTabId(params: string, targetId: string): any;
    /**
     * 是否有未保存的变更
     */

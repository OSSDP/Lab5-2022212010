...
import { __spread, __assign, __values, __extends, __read } from 'tslib';
...
var FormWizardService = /** @class */ (function () {
    ...
    /** @nocollapse */
    FormWizardService.ctorParameters = function () { return [
        { type: WizardService }
    ]; };
...
var INSIDE_DIALOG_TOKEN = new InjectionToken('@farris/command-service-inside-dialog');
var MODAL_REF = new InjectionToken('@farris/command-service-modal-ref');
...
var NavigationEventService = /** @class */ (function () {
    ...
    NavigationEventService.prototype.fireTabSwitchEvent = function (e) {
        ...
        this.onTabSwitchListeners.forEach(function (handle, key, map$$1) {
    ...
    NavigationEventService.prototype.fireTabClosedEvent = function (e) {
        ...
        this.onClosedListeners.forEach(function (handle, key, map$$1) {
            if (typeof handle === 'function') {
                handle(e);
            }
        });
...
var FARRIS_FORM_COMPONENTS = new InjectionToken('表单弹出窗口或隐藏组件列表');
/**
 * 表单服务
 * @scope FormModule
 */
var FarrisFormService = /** @class */ (function () {
    ...
    /** @nocollapse */
    FarrisFormService.ctorParameters = function () { return [
...
var ValidationService = /** @class */ (function () {
    ...
    ValidationService.prototype.validateCurrentRow = function () {
        ...
        var result$ = zip.apply(void 0, __spread(observableList)).pipe(tap(function (resultList) {
            frameContexts.forEach(function (formContext) {
    ...
    ValidationService.prototype.collectValidationErrors = function (rootViewModel, errors, namespace, filter$$1) {
        var _this = this;
        if (filter$$1 === void 0) { filter$$1 = true; }
        if (filter$$1) {
...
var CardDataService = /** @class */ (function () {
     ...
     */
    CardDataService.prototype.loadPaged = function (filter$$1, sort) {
        var _this = this;
        // 获取id
        var id = this.bindingData.list.currentId;
        if (!id) {
...
var ApplicationParamService = /** @class */ (function () {
    ...
    ApplicationParamService.prototype.mapStaticParamsToObject = function (staticParams, queryParams, viewModel) {
        ...
        var uiState = viewModel && viewModel.uiState && viewModel.uiState.innerData || {};
        var result = {};
        staticParams.forEach(function (value, key, map$$1) {
            if (!inDialog) {
                // 静态参数不能覆盖查询参数
...
var EntityManipulationService = /** @class */ (function () {
    ...
    /** @nocollapse */
    EntityManipulationService.ctorParameters = function () { return [
        { type: FrameContext }
    ]; };
...
var EntityListService = /** @class */ (function () {
    ...
    /** @nocollapse */
    EntityListService.ctorParameters = function () { return [
        { type: BindingData }
    ]; };
...
var ListDataService = /** @class */ (function () {
     ...
     * 加载
     */
    ListDataService.prototype.load = function (filter$$1, sort) {
        var _this = this;
        // 参数处理
        ...
        var query$ = this.repository.getEntities(JSON.parse(filter$$1), JSON.parse(sort), null, null);
        return query$.pipe(tap(function () {
            // 触发远端合计事件
            _this.fireQueryEvent(filter$$1);
            _this.loadingService.hideDelayLoading(loadingTimerId);
        }, function (error) {
            _this.loadingService.hideDelayLoading(loadingTimerId);
            _this.formErrorService.exception(_this.languageService.loadFailed, error);
     ...
     * @param sort 排序条件
     */
    ListDataService.prototype.filter = function (filter$$1, sort) {
        var _this = this;
        // 参数处理
        filter$$1 = !filter$$1 ? '[]' : filter$$1;
        sort = !sort ? '[]' : sort;
        ...
        sort = this.mergeSortConditions(sort);
        var loadingTimerId = this.loadingService.showLoadingWithDelay(200);
        var query$ = this.repository.filter(JSON.parse(filter$$1), JSON.parse(sort));
        return query$.pipe(tap(function () {
            // 触发远端合计事件
            _this.fireQueryEvent(filter$$1);
            _this.loadingService.hideDelayLoading(loadingTimerId);
     ...
     * 查询
     */
    ListDataService.prototype.query = function (filter$$1, sort, pageSize, pageIndex) {
        var _this = this;
        // 参数处理
        filter$$1 = (filter$$1 === '') ? '[]' : filter$$1;
        sort = (sort === '') ? '[]' : sort;
        ...
        var query$ = this.repository.getEntities(JSON.parse(filter$$1), JSON.parse(sort), pageSize, pageIndex);
        return query$.pipe(tap(function () {
            // 触发远端合计事件
            _this.fireQueryEvent(filter$$1);
            _this.loadingService.hideDelayLoading(loadingTimerId);
    ...
    ListDataService.prototype.queryChild = function (filter$$1, sort) {
        var _this = this;
        ...
        var BindingList$$1 = bindingData.getValue(parentPaths);
        if (!BindingList$$1) {
            return;
        }
     ...
     * @param filter 表单过滤条件
     */
    ListDataService.prototype.mergeFilterConditions = function (filter$$1) {
...
var ParentTreeRepository = /** @class */ (function () {
    ...
    ParentTreeRepository.prototype.buildEntityFilter = function (filter$$1, sort, pageSize, pageIndex) {
...
var PathTreeRepository = /** @class */ (function () {
    ...
    */
    ...
    PathTreeRepository.prototype.buildEntityFilter = function (filter$$1, sort, pageSize, pageIndex) {
        // @todo：临时兼容老代码，降低改动带来的风险
        if (!filter$$1 && !sort && !pageSize && !pageIndex) {
            return null;
        }
...
var DialogService = /** @class */ (function () {
    ...
    DialogService.prototype.createModalComponentRef = function (config, component, uiStateObject) {
        ...
        if (frameContext && componentFactoryResolver) {
            ...
            var modalContentInjector = ReflectiveInjector.resolveAndCreate(__spread(this._providers), injector);
            componentRef = contentCmptFactory.create(modalContentInjector);
            if (componentRef && componentRef.instance && componentRef.instance.viewModel && componentRef.instance.viewModel.uiState) {
                if (typeof uiStateObject === 'object' && Object.keys(uiStateObject).length) {
                    Object.keys(uiStateObject).forEach(function (item) {
...
var FilterService = /** @class */ (function () {
    ...
    FilterService.prototype.stripFiltersWithSpecialValue = function (filters, specialValues) {
        ...
        var strippedFilterArray = filterArray.filter(function (filter$$1) {
            var filterValue = _this.getFilterValue(filter$$1);
     ...
     */
    FilterService.prototype.getFilterValue = function (filter$$1) {
...
var FARRIS_FORM_COMPONENTS$1 = new InjectionToken('表单弹出窗口或隐藏组件列表');
/**
 * 表单服务
 * @scope FormModule
 */
...
var ListFilterConditionsService = /** @class */ (function () {
    ...
    /** @nocollapse */
    ListFilterConditionsService.ctorParameters = function () { return [
        { type: FrameContext }
    ]; };
...
var LocalizationService = /** @class */ (function () {
    ...
    LocalizationService.prototype.transformNumber = function (value) {
        ...
        var format$$1 = this.buildNumberFormat();
     ...
     * @param format format
     */
    LocalizationService.prototype.parseDateFormat = function (format$$1) {
     ...
     * @param format format
     */
    LocalizationService.prototype.parseTimeFormat = function (format$$1) {
...
var FeatureRepository = /** @class */ (function () {
     ...
     * @returns
     */
    FeatureRepository.prototype.getHelpInfo = function (helpid, filter$$1, params) {
...
var FeatureDataService = /** @class */ (function () {
     ...
     * @returns
     */
    FeatureDataService.prototype.getHelpInfo = function (helpid, filter$$1, params) {
        var url = BasePathService.convertPath('/api/scm/scmfnd/v1.0/scmcommoncmpservice/service/gethelpdata');
        var httpParams = {};
        if (params) {
            if (params.pageIndex) {
...
var ExpressionService = /** @class */ (function () {
    ...
    ExpressionService.prototype.execute = function (expression, customContext) {
        ...
        var context = __assign((_a = {}, _a[this.entityOriginalNodeCode] = entityContext, _a), stateContext, { BigNumber: BigNumber, frameContext: this.frameContext, bindingData: this.frameContext.bindingData, repository: this.frameContext.repository }, customContext);
...
var CommandServicesModule = /** @class */ (function () {
    ...
    /** @nocollapse */
    CommandServicesModule.ctorParameters = function () { return [
        { type: WorkFlowMessage }
    ]; };

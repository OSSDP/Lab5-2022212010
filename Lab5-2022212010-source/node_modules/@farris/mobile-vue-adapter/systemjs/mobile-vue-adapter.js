System.register(['@farris/mobile-devkit', 'vue', '@farris/mobile-command-services', '@farris/mobile-bef', 'rxjs', 'rxjs/operators'], function (exports) {
    'use strict';
    var DateUtil, App, EnumUtil, NumberUtil, StringUtil, BoolUtil, HttpMethods, reactive, createApp, HistoryBackService, RouterService, JsBridgeService, BefLookupDataService, Subject, forkJoin, map, mergeMap;
    return {
        setters: [function (module) {
            DateUtil = module.DateUtil;
            App = module.App;
            EnumUtil = module.EnumUtil;
            NumberUtil = module.NumberUtil;
            StringUtil = module.StringUtil;
            BoolUtil = module.BoolUtil;
            HttpMethods = module.HttpMethods;
        }, function (module) {
            reactive = module.reactive;
            createApp = module.createApp;
        }, function (module) {
            HistoryBackService = module.HistoryBackService;
            RouterService = module.RouterService;
            JsBridgeService = module.JsBridgeService;
        }, function (module) {
            BefLookupDataService = module.BefLookupDataService;
        }, function (module) {
        ...
        execute: function () {
            ...
            exports({
                mapBindingStates: mapBindingStates,
                mapCommandMethods: mapCommandMethods,
                mapCurrentEntityData: mapCurrentEntityData,
                mapEntityListData: mapEntityListData,
                mapForm: mapForm,
            ...
            ***************************************************************************** */
             ...
             * 绑定状态
             */
            BindingStates = exports('BindingStates', /** @class */ (function () {
                /**
                 * 构造函数
            ...
            /** @type {?} */
            var DevkitPlugin = exports('DevkitPlugin', {
                install: (ɵ0$2)
            });
             ...
             * 帮助映射服务
             */
            LookupMappingService = exports('LookupMappingService', /** @class */ (function () {
            ...
            /** @type {?} */
            var bindListviewExtenderDir = exports('bindListviewExtenderDir', {
                mounted: (ɵ0$3),
                unmounted: (ɵ1$1)
            });
            ...
            /** @type {?} */
            var bindLookupExtenderDir = exports('bindLookupExtenderDir', {
                mounted: (ɵ0$4),
                unmounted: (ɵ1$2)
            });
            ...
            /** @type {?} */
            var bindFilterExtenderDir = exports('bindFilterExtenderDir', {
                mounted: (ɵ0$5),
                unmounted: (ɵ1$3)
            });
            ...
            /** @type {?} */
            var bindTabExtenderDir = exports('bindTabExtenderDir', {
                mounted: (ɵ0$6),
                unmounted: (ɵ1$4)
            });
            ...
            /** @type {?} */
            var bindSearchExtenderDir = exports('bindSearchExtenderDir', {
                mounted: (ɵ0$7),
                unmounted: (ɵ1$5)
            });
            ...
            /** @type {?} */
            var bindRefleshExtenderDir = exports('bindRefleshExtenderDir', {
                mounted: (ɵ0$8),
                unmounted: (ɵ1$6)
            });
            ...
            /** @type {?} */
            var bindCheckboxExtenderDir = exports('bindCheckboxExtenderDir', {
                mounted: (ɵ0$9),
                unmounted: (ɵ1$7)
            });
            ...
            /** @type {?} */
            var bindAttachmentExtenderDir = exports('bindAttachmentExtenderDir', {
                mounted: (ɵ0$a),
                unmounted: (ɵ1$8)
            });
            ...
            /** @type {?} */
            var bindMapExtenderDir = exports('bindMapExtenderDir', {
                mounted: (ɵ0$b),
             ...
             * 日期转换器
             */
            DateConverter = exports('DateConverter', /** @class */ (function () {
                /**
                 * 构造函数
                 * @param format 日期格式
                 */
             ...
             * 字符串数组转换器
             */
            StringArrayConverter = exports('StringArrayConverter', /** @class */ (function () {
             ...
             */
            /** @type {?} */
            var filterMapData = exports('filterMapData', (/**
             ...
             * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
             */
            var AppCreator = exports('AppCreator', /** @class */ (function () {
                function AppCreator() {
                }
                /**
                 * 创建Vue应用

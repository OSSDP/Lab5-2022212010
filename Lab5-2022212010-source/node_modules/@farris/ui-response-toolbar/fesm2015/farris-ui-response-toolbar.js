...
class ResponseToolbarItem extends ResponseToolbarBasic {
    // 点击事件
    /**
     * @param {?} item
     */
...
class ResponseToolbarDropDown extends ResponseToolbarBasic {
    /**
     * @param {?} item
     */
    constructor(item) {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ResponseToolbarComponent {
    /**
     * @param {?} el
     * @param {?} render
     * @param {?} cd

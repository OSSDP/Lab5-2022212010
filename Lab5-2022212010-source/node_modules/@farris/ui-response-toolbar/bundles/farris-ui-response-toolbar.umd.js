(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('resize-observer-polyfill'), require('@farris/ui-locale'), require('@angular/core'), require('@angular/common'), require('@farris/ui-dropdown'), require('@farris/ui-tooltip')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-response-toolbar', ['exports', 'rxjs', 'rxjs/operators', 'resize-observer-polyfill', '@farris/ui-locale', '@angular/core', '@angular/common', '@farris/ui-dropdown', '@farris/ui-tooltip'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-response-toolbar'] = {}),global.rxjs,global.rxjs.operators,global.ResizeObserver,global.uiLocale,global.ng.core,global.ng.common,global.uiDropdown,global.uiTooltip));
}(this, (function (exports,rxjs,operators,ResizeObserver,uiLocale,core,common,uiDropdown,uiTooltip) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FResizedDirective = /** @class */ (function () {
        function FResizedDirective(element) {
            this.element = element;
            this.resizedEvent = new core.EventEmitter();
        ...
        /** @nocollapse */
        FResizedDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        FResizedDirective.propDecorators = {
            resizedEvent: [{ type: core.Output }],
    ...
    var ResponseToolbarComponent = /** @class */ (function () {
        function ResponseToolbarComponent(el, render, cd, localeService) {
            ...
            this.prCls = true;
            // 传递点击事件
            this.rtClickEvent = new core.EventEmitter();
            // 辅助计算宽度数据
            this.auxiliaryDatas = [];
            // 控制父元素滚动的样式
            ...
            this._stateDatas = new rxjs.Subject();
            this._btnVisibleDatas = new rxjs.Subject();
         ...
         */
            function () {
                ...
                if (!this.ngZone) {
                    ...
                    this.ngZone = moduleInjector.get(core.NgZone, null);
                }
                this.ngZone.runOutsideAngular(( /**
                 * @return {?}
                 */function () {
        ...
        /** @nocollapse */
        ResponseToolbarComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Renderer2 },
        ...
        ResponseToolbarComponent.propDecorators = {
            frtCls: [{ type: core.HostBinding, args: ["class.f-response-toolbar",] }],
            prCls: [{ type: core.HostBinding, args: ["class.position-relative",] }],
            resizedContainerEl: [{ type: core.ViewChild, args: ["resizedContainer",] }],
            auxiliaryContainerEl: [{ type: core.ViewChild, args: ["auxiliaryContainer",] }],
            resizedContentEl: [{ type: core.ViewChild, args: ["resizedContent",] }],
            resizedContainerDirective: [{ type: core.ViewChild, args: ["resizedContainer", { read: FResizedDirective },] }],
            rtClickEvent: [{ type: core.Output }],
            groups: [{ type: core.Input }],
            datas: [{ type: core.Input }],
            btnState: [{ type: core.Input }],
            btnVisible: [{ type: core.Input }],
            clickThrottleTime: [{ type: core.Input }],
            buttonSize: [{ type: core.Input }],
            popDirection: [{ type: core.Input }],
            btnAlign: [{ type: core.Input }]
        };
    ...
    exports.FResizedDirective = FResizedDirective;
    exports.ResponseToolbarComponent = ResponseToolbarComponent;
    exports.FResponseToolbarModule = FResponseToolbarModule;
    exports.ResponseToolbarBasic = ResponseToolbarBasic;
    exports.ResponseToolbarItem = ResponseToolbarItem;
    exports.ResponseToolbarDropDown = ResponseToolbarDropDown;
    exports.ResponseToolbarGroup = ResponseToolbarGroup;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-response-toolbar.umd.js.map
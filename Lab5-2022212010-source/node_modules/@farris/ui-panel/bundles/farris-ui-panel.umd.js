(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-panel', ['exports', '@angular/common', '@angular/core', '@angular/animations'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-panel'] = {}),global.ng.common,global.ng.core,global.ng.animations));
}(this, (function (exports,common,core,animations) { 'use strict';
    ...
    var FarrisPanelComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FarrisPanelComponent.ctorParameters = function () {
            return [
                { type: core.Renderer2 }
            ];
        };
        FarrisPanelComponent.propDecorators = {
            farrisPanel: [{ type: core.ViewChild, args: ['farrisPanel',] }],
            width: [{ type: core.Input }],
            height: [{ type: core.Input }],
            className: [{ type: core.Input }],
            foldable: [{ type: core.Input }],
            defaultExpand: [{ type: core.Input }],
    ...
    var FarrisPanelItemComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FarrisPanelItemComponent.ctorParameters = function () {
            return [
                { type: FarrisPanelComponent, decorators: [{ type: core.Optional }] },
        ...
        FarrisPanelItemComponent.propDecorators = {
            ...
            tabTitle: [{ type: core.Input, args: ['title',] }],
            disable: [{ type: core.Input }, { type: core.HostBinding, args: ['class.f-state-disable',] }],
            headRef: [{ type: core.ContentChild, args: ['headTempl',] }],
            toolTempl: [{ type: core.ContentChild, args: ['toolTempl',] }],
            contentRef: [{ type: core.ContentChild, args: ['contentTempl',] }],
            isPanelItem: [{ type: core.HostBinding, args: ['class.farris-panel-item',] }],
            isCard: [{ type: core.HostBinding, args: ['class.card',] }]
        };
    ...
    exports.dropAnimation = dropAnimation;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-panel.umd.js.map
...
export declare class ConvertorService {
    ...
    */
    ...
    private getDropDownValueFieldCondition;
    private getRadioValueFieldCondition;
    private getCheckboxGroupValueFieldCondition;
    private getSmartHelpValueFieldCondition;
    private getFlexibleNumberValueFieldCondition;
    private getFlexibleDateValueFieldCondition;
    private getNumberValueFieldCondition;

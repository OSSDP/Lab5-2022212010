(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@farris/ui-filter', ['exports', 'lodash-es', '@farris/ui-common/date', 'rxjs/operators', 'resize-observer-polyfill', '@angular/common', '@angular/forms', '@farris/ui-sidebar', '@farris/ui-tooltip', '@farris/ui-input-group', '@farris/ui-datepicker', '@farris/ui-datalist', '@farris/ui-combo-list', '@farris/ui-lookup', '@farris/ui-forms', '@farris/ui-number-spinner', '@farris/ui-perfect-scrollbar', '@farris/ui-common', '@farris/ui-filter-panel', '@farris/ui-filter-condition', 'rxjs', '@angular/core', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-filter'] = {}),global.lodashEs,global.date,global.rxjs.operators,global.ResizeObserver,global.ng.common,global.ng.forms,global.uiSidebar,global.uiTooltip,global.uiInputGroup,global.uiDatepicker,global.uiDatalist,global.uiComboList,global.uiLookup,global.uiForms,global.uiNumberSpinner,global.uiPerfectScrollbar,global.uiCommon,global.uiFilterPanel,global.uiFilterCondition,global.rxjs,global.ng.core,global.uiLocale));
}(this, (function (exports,lodashEs,date,operators,ResizeObserver,common,forms,uiSidebar,uiTooltip,uiInputGroup,uiDatepicker,uiDatalist,uiComboList,uiLookup,uiForms,uiNumberSpinner,uiPerfectScrollbar,uiCommon,uiFilterPanel,uiFilterCondition,rxjs,i0,uiLocale) { 'use strict';
         ...
         */
            function () {
                if (this.valueField) {
                     ...
                     * @param {?} helpItem
                     * @return {?}
                     */function (helpItem) { return HelpValue.getPropValue(helpItem, lodashEs.cloneDeep(args_1)); }));
    ...
    var DateValue = /** @class */ (function () {
         ...
         */
            function (ctrl) {
                if (ctrl && ctrl.format) {
                    return new date.DateTimeHelperService().formatTo(this.value, ctrl.format);
                }
                return this.value;
            };
        return DateValue;
         ...
         */
            function (ctrl) {
                ...
                if (this.startTime && this.startTime.length && this.endTime && this.endTime.length) {
                    if (ctrl && ctrl.format) {
                        /** @type {?} */
                        var dateHlp = new date.DateTimeHelperService();
         ...
         */
            function () {
                ...
                if (this.textField) {
                     ...
                     * @param {?} item
                     * @return {?}
                     */function (item) { return _this.getPropValue(item, lodashEs.cloneDeep(args_1)); }));
                    return textArr && textArr.length ? textArr.join(',') : '';
                }
                else {
                    return '';
    ...
    var FlexibleNumberValue = /** @class */ (function () {
        function FlexibleNumberValue(value, single) {
            if (value === void 0) {
                value = { startValue: null, endValue: null, value: null };
            }
            if (single === void 0) {
                single = true;
            }
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var FILTER_HANDLER_TOKEN = new i0.InjectionToken('gsp-cmp/FILTER_HANDLER');
    ...
    var FilterComponent = /** @class */ (function () {
        function FilterComponent(filterPanelService, filterService, convertorService, handler, cd, render, ngzone, localeService, injector) {
            ...
            this.resetChange = new i0.EventEmitter();
            this.clearFilter = new i0.EventEmitter();
            this.expandFilter = new i0.EventEmitter();
            this.packupFilter = new i0.EventEmitter();
            this.filterResize = new i0.EventEmitter();
            // 条件变更时候触发
            ...
            if (this.injector) {
                ...
                this.filterHandler = this.injector.get(FILTER_HANDLER_TOKEN, null, i0.InjectFlags.Optional);
         ...
         */
            function () {
                ...
                rxjs.fromEvent(window, 'resize').pipe(operators.auditTime(50)).subscribe(( /**
                 * @return {?}
                 */function () {
        ...
        FilterComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        providers: [
                            uiFilterPanel.FilterPanelService
                        ]
                    }] }
        ];
        /** @nocollapse */
        FilterComponent.ctorParameters = function () {
            return [
                { type: uiFilterPanel.FilterPanelService },
                { type: FilterService },
        ...
        FilterComponent.propDecorators = {
            ...
            showReminder: [{ type: i0.Input }],
            floatFilter: [{ type: i0.Input }],
            clearSelectedText: [{ type: i0.Input }],
            enableAutoWidth: [{ type: i0.Input }],
            localStorageKey: [{ type: i0.Input }],
            defaultEmptyValueSearch: [{ type: i0.Input }],
            defaultValue: [{ type: i0.Input }],
            cla: [{ type: i0.HostBinding, args: ['class.f-filter',] }],
            query: [{ type: i0.Output }],
            searchChange: [{ type: i0.Output }],
            resetChange: [{ type: i0.Output }],
            clearFilter: [{ type: i0.Output }],
            expandFilter: [{ type: i0.Output }],
            packupFilter: [{ type: i0.Output }],
            filterResize: [{ type: i0.Output }],
            conditionsChange: [{ type: i0.Output }],
            filterMain: [{ type: i0.ViewChild, args: ['filterMain',] }],
            filterTool: [{ type: i0.ViewChild, args: ['filterTool',] }],
            filterWrapper: [{ type: i0.ViewChild, args: ['filterWrapper',] }],
            farrissidebar: [{ type: i0.ViewChild, args: ['farrissidebar',] }],
            listWrapper: [{ type: i0.ViewChild, args: ['listWrapper',] }],
            filterListWrapper: [{ type: i0.ViewChild, args: ['filterListWrapper',] }],
    ...
    var DateRangeComponent = /** @class */ (function () {
         ...
         */
            function (dateString) {
                ...
                /** @type {?} */
                var date$$1 = new Date(dateString);
                return date$$1;
            };
        /**
         * @param {?} event
    ...
    var SimpleInputGroupComponent = /** @class */ (function () {
        ...
        */
        ...
        /** @nocollapse */
        SimpleInputGroupComponent.ctorParameters = function () {
            return [
                { type: SolutionService }
            ];
        };
    ...
    var FlexibleNumberComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FlexibleNumberComponent.ctorParameters = function () {
            return [
                { type: SolutionService },
                { type: i0.ElementRef },
                { type: uiLocale.LocaleService }
    ...
    var FlexibleDateComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FlexibleDateComponent.ctorParameters = function () {
            return [
                { type: uiLocale.LocaleService },
                { type: SolutionService }
            ];
        ...
        SimpleFilterModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [
                            common.CommonModule,
                            forms.FormsModule,
                            uiFilterPanel.FilterPanelModule,
                            uiSidebar.FarrisSidebarModule,
    ...
    exports.SimpleFilterModule = SimpleFilterModule;
    ...
    exports.SimpleInputGroupComponent = SimpleInputGroupComponent;
    exports.SingleNumberComponent = SingleNumberComponent;
    exports.FlexibleNumberComponent = FlexibleNumberComponent;
    exports.FlexibleDateComponent = FlexibleDateComponent;
    ...
    exports.FlexibleNumberValue = FlexibleNumberValue;
    exports.FlexibleDateValue = FlexibleDateValue;
    ...
    exports.FlexibleDateControl = FlexibleDateControl;
    ...
    exports.FlexibleNumberControl = FlexibleNumberControl;
    ...
    exports.FILTER_HANDLER_TOKEN = FILTER_HANDLER_TOKEN;
...
//# sourceMappingURL=farris-ui-filter.umd.js.map
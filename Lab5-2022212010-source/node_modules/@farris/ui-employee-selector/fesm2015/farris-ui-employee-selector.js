...
class ApiLocalService {
    ...
    getOrganizations(param) {
        ...
        /** @type {?} */
        let url = this.getOrgsUrl + `/getorgs?withDisabledOrg=${param.withDisabledOrg}&gettingCurrentOrg=${param.gettingCurrentOrg}&onlyDisplayOrg=${param.onlyDisplayOrg}`;
     ...
     * @return {?} observable
     */
    getOrganizationsWithLayer(param) {
        /** @type {?} */
        const options = {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
        ...
        /** @type {?} */
        let url = this.getOrgsUrl + `/getOrgsWithLayer?withDisabledOrg=${param.withDisabledOrg}`;
     ...
     * @return {?} observable
     */
    getOrganizationWithFilter(queryFilter) {
        /** @type {?} */
        const options = {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
     ...
     * @return {?} observable
     */
    getUsersWithFilter(queryFilter) {
        /** @type {?} */
        const options = {
            headers: new HttpHeaders({
                'Content-Type': 'application/json',
 ...
 */
/** @type {?} */
const GROUP_SERVICE = new InjectionToken('groupService');
...
class CandidateComponent {
    ...
    unSelectedListLoad() {
        ...
        /** @type {?} */
        const tempSelections = cloneDeep(this.selections);
        this.toggleChecked();
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class UnSelectDatagridComponent {
    /**
     * @param {?} apiService
     * @param {?} favoritesTool
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class UserGroupUnSelectComponent {
    /**
     * @param {?} apiService
     * @param {?} favoritesTool
     */
 ...
 */
/** @type {?} */
const PERSONNEL_SELECTOR_LOCALE = {
    "zh-CHS": {
        personnelSelector: {
            selection: {
...
class EmployeeSelectorComponent {
    ...
    constructor(apiService, injector, favoritesTool, eventManager, groupTool, cd) {
        ...
        () => {
            if (!this.confirmToken) {
                 ...
                 */
                component => {
                    component.cloneSelections = cloneDeep(this.selections);
    ...
    moveToLeft(data) {
         ...
         */
        component => {
            component.selections = cloneDeep(this.selections);
 ...
 */
// 兼容保留，该组件无用
class quickInputDatagridComponent {
    /**
     * @param {?} ApiLocalService
     */
    constructor(ApiLocalService$$1) {
 ...
 */
// 兼容保留，该组件无用
class unSelectDatagridOrgComponent {
    /**
     * @param {?} ApiLocalService
     */
    constructor(ApiLocalService$$1) {
...
/** @nocollapse */
unSelectDatagridOrgComponent.ctorParameters = () => [
    { type: ApiLocalService }
];
 ...
 */
// 兼容保留，该组件无用
class unSelectDatagridRoleComponent {
    /**
     * @param {?} ApiLocalService
     */
    constructor(ApiLocalService$$1) {

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash-es'), require('rxjs'), require('@farris/ui-loading'), require('@farris/ui-messager'), require('@farris/ui-common'), require('@farris/ui-modal'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-treetable'), require('@farris/ui-perfect-scrollbar'), require('@farris/ide-devkit'), require('@farris/ui-datagrid'), require('@farris/ui-locale'), require('@farris/ui-language-textbox')) :
    typeof define === 'function' && define.amd ? define('@farris/ide-publish-menu', ['exports', 'lodash-es', 'rxjs', '@farris/ui-loading', '@farris/ui-messager', '@farris/ui-common', '@farris/ui-modal', '@angular/core', '@angular/common', '@angular/forms', '@farris/ui-treetable', '@farris/ui-perfect-scrollbar', '@farris/ide-devkit', '@farris/ui-datagrid', '@farris/ui-locale', '@farris/ui-language-textbox'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ide-publish-menu'] = {}),global.lodashEs,global.rxjs,global.uiLoading,global.uiMessager,global.uiCommon,global.uiModal,global.ng.core,global.ng.common,global.ng.forms,global.uiTreetable,global.uiPerfectScrollbar,global.ideDevkit,global.uiDatagrid,global.uiLocale,global.uiLanguageTextbox));
}(this, (function (exports,lodashEs,rxjs,uiLoading,uiMessager,uiCommon,uiModal,i0,common,forms,uiTreetable,uiPerfectScrollbar,ideDevkit,uiDatagrid,uiLocale,uiLanguageTextbox) { 'use strict';
    ...
    var PublishMenuService = /** @class */ (function () {
        ...
        /** @nocollapse */ PublishMenuService.ngInjectableDef = i0.defineInjectable({ factory: function PublishMenuService_Factory() { return new PublishMenuService(); }, token: PublishMenuService, providedIn: "root" });
    ...
    var GspAppManagerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        GspAppManagerComponent.ctorParameters = function () {
            return [
                { type: ideDevkit.HttpService },
                { type: i0.Injector },
                { type: i0.NgZone },
    ...
    var BizobjectOperatorsComponent = /** @class */ (function () {
            ...
            function () {
                 ...
                 */function (data) {
                    if (data) {
                        ...
                        _this.allOperators = lodashEs.cloneDeep(_this.items);
                    }
                }));
            };
        /**
        ...
        /** @nocollapse */
        BizobjectOperatorsComponent.ctorParameters = function () {
            return [
                { type: ideDevkit.HttpService },
                { type: i0.Injector },
                { type: i0.NgZone }
    ...
    var SelectAppComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        SelectAppComponent.ctorParameters = function () {
            return [
                { type: ideDevkit.HttpService },
                { type: i0.Injector },
                { type: i0.NgZone }
    ...
    var PublishMenuComponent = /** @class */ (function () {
        function PublishMenuComponent(http, injector, modalService, uuid, messagerSer, loadingSer, cd) {
            ...
            this.commonUtil = this.injector.get(uiCommon.CommonUtils);
            this.localeId = this.injector.get(i0.LOCALE_ID, 'zh-CHS');
            if (this.localeId === 'zh') {
                this.localeId = 'zh-CHS';
            }
            if (!this.localeSer) {
                this.localeSer = this.injector.get(uiLocale.LocaleService, null);
                if (!this.localeSer) {
                    this.localeSer = new uiLocale.LocaleService(this.localeId, this.commonUtil, PUBLISH_MENU_LOCALE);
                }
                else {
         ...
         */
            function () {
                ...
                if (this.validate()) {
                    ...
                    /** @type {?} */
                    var _funcModel = lodashEs.cloneDeep(this.funcModel);
        ...
        /** @nocollapse */
        PublishMenuComponent.ctorParameters = function () {
            return [
                { type: ideDevkit.HttpService },
                { type: i0.Injector },
        ...
        PublishMenuComponent.propDecorators = {
            serverIp: [{ type: i0.Input }],
            dlgContent: [{ type: i0.ViewChild, args: ['dlgContent',] }],
            publishPath: [{ type: i0.Input }]
        };
        ...
        PublishMenuModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [
                            common.CommonModule,
                            forms.FormsModule,
                            uiLocale.LocaleModule.forRoot(PUBLISH_MENU_LOCALE),
                            ...
                            ideDevkit.CacheModule.forRoot(),
                            uiLoading.LoadingModule.forRoot(),
                            ideDevkit.GSPHttpModule,
    ...
    exports.PublishMenuService = PublishMenuService;
    exports.PublishMenuComponent = PublishMenuComponent;
    exports.PublishMenuModule = PublishMenuModule;
    exports.ɵb = BizobjectOperatorsComponent;
    exports.ɵa = GspAppManagerComponent;
    exports.ɵd = PUBLISH_MENU_LOCALE;
    exports.ɵc = SelectAppComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ide-publish-menu.umd.js.map
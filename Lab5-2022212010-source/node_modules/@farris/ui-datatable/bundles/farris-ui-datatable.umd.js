(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@farris/ui-datatable', ['exports', 'lodash-es', 'rxjs', '@farris/ui-locale', '@angular/common', '@angular/forms', '@farris/ui-perfect-scrollbar', '@farris/ui-pagination', '@farris/ui-common', '@farris/ui-common/column', '@farris/ui-input-group', '@farris/ui-forms', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-datatable'] = {}),global.lodashEs,global.rxjs,global.uiLocale,global.ng.common,global.ng.forms,global.uiPerfectScrollbar,global.uiPagination,global.uiCommon,global.column,global.uiInputGroup,global.uiForms,global.ng.core));
}(this, (function (exports,lodashEs,rxjs,uiLocale,common,forms,uiPerfectScrollbar,uiPagination,uiCommon,column,uiInputGroup,uiForms,core) { 'use strict';
    ...
    var DataTableService = /** @class */ (function () {
        function DataTableService() {
             ...
             * 选中行事件
             */
            this.selectedRow = new rxjs.Subject();
            this.unSelectedRow = new rxjs.Subject();
            this.selectedAll = new rxjs.Subject();
            this.dblClickRow = new rxjs.Subject();
            this.updateCheckAllStatus = new rxjs.Subject();
        }
    ...
    ***************************************************************************** */
    ...
    var ColumnDirective = /** @class */ (function () {
        ...
        ColumnDirective.propDecorators = {
            ...
            media: [{ type: core.Input }],
            sortable: [{ type: core.Input }],
            multipleFilter: [{ type: core.Input }],
            filter: [{ type: core.Input }],
            fixedClass: [{ type: core.HostBinding, args: ['class.fixed',] }]
        };
    ...
    var DataTableComponent = /** @class */ (function () {
        function DataTableComponent(dataService, idService, el, cd, ngZone) {
            ...
            this.columnSorted = new core.EventEmitter();
            this.rowDblClick = new core.EventEmitter();
            this.selectedRow = new core.EventEmitter();
            // 兼容
            this.selectRows = new core.EventEmitter();
            this.unSelectRow = new core.EventEmitter();
            this.cellClick = new core.EventEmitter();
            this.clearSearchValue = new core.EventEmitter();
            this.checkAll = new core.EventEmitter();
        ...
        DataTableComponent.prototype.stopDrag =
            ...
            function (e, column$$1) {
                if (this.autoFitColumns) {
                    this.resizeColumn2(e, column$$1);
                    if (this.ps) {
                        this.ps.update();
                    }
                    return;
                }
                this.resizeColumn(e, column$$1);
            };
        /**
         * @param {?} e
         * @param {?} column
         ...
         */
            function (e, column$$1) {
                if (this.isCheckBox(column$$1, 'dt-checkbox-cell')) {
                ...
                // 最小宽度
                /** @type {?} */
                var minWidth = column$$1.style.minWidth || 30;
                // 新宽度大于或等于最小宽度时
                ...
                // 父节点宽度
                /** @type {?} */
                var parentWidth = column$$1.parentElement.offsetWidth;
                // 判断是不是有checkbox
                /** @type {?} */
                var firstElement = column$$1.parentElement.firstElementChild;
                /** @type {?} */
         ...
         */
            function (e, column$$1) {
                ...
                /** @type {?} */
                var field = column$$1.getAttribute('field');
                if (field) {
                    /** @type {?} */
        ...
        DataTableComponent.propDecorators = {
            keydownEnterEdit: [{ type: core.Input }],
            id: [{ type: core.Input }],
            size: [{ type: core.Input }],
            allColumnsTitle: [{ type: core.Input }],
            width: [{ type: core.Input }],
            height: [{ type: core.Input }],
            searchAnyField: [{ type: core.Input }],
            fill: [{ type: core.Input }],
            pagination: [{ type: core.Input }],
            pagerOnServer: [{ type: core.Input }],
            pageSize: [{ type: core.Input }],
            pageIndex: [{ type: core.Input }],
            showPageInfo: [{ type: core.Input }],
            showPageNumber: [{ type: core.Input }],
            showPageList: [{ type: core.Input }],
            pagerViewMode: [{ type: core.Input }],
            pagerExtendTemplate: [{ type: core.Input }],
            ...
            rowStyler: [{ type: core.Input }],
            cellStyler: [{ type: core.Input }],
            selections: [{ type: core.Input }],
            scorllableBody: [{ type: core.ViewChild, args: ['scorllableBody',] }],
            tableHeader: [{ type: core.ViewChild, args: ['tableHeader',] }],
            tablePager: [{ type: core.ViewChild, args: ['tablePager',] }],
            dtHeader: [{ type: core.ViewChild, args: ['dtHeader',] }],
            dtBody: [{ type: core.ViewChild, args: ['dtBody',] }],
            dtLeftBody: [{ type: core.ViewChild, args: ['dtLeftBody',] }],
            dtRightBody: [{ type: core.ViewChild, args: ['dtRightBody',] }],
            dtLeftFixed: [{ type: core.ViewChild, args: ['dtLeftFixed',] }],
            dtRightFixed: [{ type: core.ViewChild, args: ['dtRightFixed',] }],
            pager: [{ type: core.ViewChild, args: ['pager',] }],
            inputGroup: [{ type: core.ViewChild, args: ['inputgroup',] }],
            pgScrollbar: [{ type: core.ViewChild, args: ['pgScrollbar',] }],
            pageChanged: [{ type: core.Output }],
            pageSizeChanged: [{ type: core.Output }],
            search: [{ type: core.Output }],
            columnSorted: [{ type: core.Output }],
            rowDblClick: [{ type: core.Output }],
            selectedRow: [{ type: core.Output }],
            selectRows: [{ type: core.Output }],
            unSelectRow: [{ type: core.Output }],
            cellClick: [{ type: core.Output }],
            clearSearchValue: [{ type: core.Output }],
            checkAll: [{ type: core.Output }],
            searchValueChange: [{ type: core.Output }],
            sortChange: [{ type: core.Output }],
            columnsRef: [{ type: core.ContentChildren, args: [ColumnDirective,] }],
            footer: [{ type: core.ContentChild, args: ['footer',] }],
            dragLine: [{ type: core.ViewChild, args: ['dragLine',] }],
            resizableColumns: [{ type: core.Input }],
            keepSelect: [{ type: core.Input }],
            perfectScrollbar: [{ type: core.ViewChild, args: ['perfectScrollbar',] }]
        };
    ...
    var DataTableHeaderComponent = /** @class */ (function () {
        function DataTableHeaderComponent(el, dataService, render, utils, dt) {
            ...
            this.columns = [];
            this.singleSelect = true;
            this.checkedAll = new core.EventEmitter();
            this.rowsChange = new core.EventEmitter();
            this.loadData = new core.EventEmitter();
            this.sortType = {};
            this.filterFields = {};
        ...
        DataTableHeaderComponent.propDecorators = {
            ...
            loadData: [{ type: core.Output }],
            checkallEl: [{ type: core.ViewChild, args: ['checkall',] }]
        };
    ...
    var DTDblClickRowDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DTDblClickRowDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: DataTableComponent, decorators: [{ type: core.Optional }] }
            ];
        };
        DTDblClickRowDirective.propDecorators = {
            row: [{ type: core.Input, args: ['dblclick',] }],
    ...
    var DataTableBodyComponent = /** @class */ (function () {
        function DataTableBodyComponent(el, dataService, render, dt, colFormatSer, utils, injector) {
            ...
            this.cellEdit = new core.EventEmitter();
            this.cellClick = new core.EventEmitter();
            this.lastRowIndex = 0;
        ...
        DataTableBodyComponent.propDecorators = {
            ...
            cellEdit: [{ type: core.Output }],
            cellClick: [{ type: core.Output }],
            emptyTbodyElRef: [{ type: core.ViewChild, args: ['emptyTbody',] }]
        };
    ...
    var DatatableFooterComponent = /** @class */ (function () {
        ...
        DatatableFooterComponent.propDecorators = {
            hover: [{ type: core.Input }],
            columns: [{ type: core.Input }],
            tableFooter: [{ type: core.Input }, { type: core.ContentChild, args: [core.TemplateRef,] }]
        };
    ...
    var DragColumnDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DragColumnDirective.ctorParameters = function () {
            return [
                { type: DataTableComponent },
                { type: core.NgZone },
                { type: core.ElementRef },
    ...
    var CellStylerDirective = /** @class */ (function () {
        ...
        CellStylerDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[cell-styler]' },] }
        ];
        /** @nocollapse */
        CellStylerDirective.ctorParameters = function () {
            return [
        ...
        CellStylerDirective.propDecorators = {
            options: [{ type: core.Input, args: ['cell-styler',] }]
        };
        ...
        DataTableModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: [
                            ...
                            uiCommon.FarrisCommonModule, DatatableFooterComponent,
                            DragColumnDirective
                        ],
                        declarations: [
                            DataTableComponent, DataTableHeaderComponent,
    ...
    exports.DTDblClickRowDirective = DTDblClickRowDirective;
    ...
    exports.CellStylerDirective = CellStylerDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-datatable.umd.js.map
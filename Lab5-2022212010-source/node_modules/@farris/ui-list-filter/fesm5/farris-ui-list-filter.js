...
import { EventEmitter, Injectable, Directive, Input, Optional, Self, Injector, NgModule, Component, ViewEncapsulation, Pipe, InjectionToken, HostBinding, Output, ChangeDetectorRef, ElementRef, ViewChild, LOCALE_ID, InjectFlags, ChangeDetectionStrategy, Renderer2, defineInjectable } from '@angular/core';
 ...
 */
/** @type {?} */
var LISTFILTER_HANDLER_TOKEN = new InjectionToken('gsp-cmp/LISTFILTER_HANDLER');

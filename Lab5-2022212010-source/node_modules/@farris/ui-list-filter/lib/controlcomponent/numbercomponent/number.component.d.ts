import { OnInit, EventEmitter, AfterViewInit, ElementRef, SimpleChanges, OnChanges } from '@angular/core';
...
export declare class NumberComponent implements OnInit, AfterViewInit, OnChanges {

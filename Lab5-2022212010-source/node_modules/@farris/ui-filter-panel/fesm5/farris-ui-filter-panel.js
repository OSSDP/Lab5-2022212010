...
import { Component, Input, Output, EventEmitter, Renderer2, ElementRef, ViewChild, ViewEncapsulation, HostListener, Injectable, ComponentFactoryResolver, Injector, ApplicationRef, NgModule, Pipe, Optional, defineInjectable, inject, INJECTOR } from '@angular/core';
...
var FilterPanelComponent = /** @class */ (function () {
    ...
    function () {
        ...
        this.currentItem = cloneDeep({ value: __assign({}, this.option.item.value), type: this.option.item.control.controltype, id: this.option.item.id });
    };
    /**
     * @return {?}
     */
     ...
     */
    function ($event) {
        this.currentItem = cloneDeep({ value: __assign({}, $event.value), type: $event.control.controltype, id: $event.id });

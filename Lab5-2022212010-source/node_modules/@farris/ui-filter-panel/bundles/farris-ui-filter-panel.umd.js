(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-common'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-input-group'), require('@farris/ui-datepicker'), require('@farris/ui-datalist'), require('@farris/ui-combo-list'), require('@farris/ui-lookup'), require('@farris/ui-forms'), require('@farris/ui-number-spinner'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-filter-condition'), require('rxjs'), require('lodash-es'), require('@angular/platform-browser'), require('@farris/ui-switch'), require('@angular/core'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-filter-panel', ['exports', '@farris/ui-common', '@angular/common', '@angular/forms', '@farris/ui-input-group', '@farris/ui-datepicker', '@farris/ui-datalist', '@farris/ui-combo-list', '@farris/ui-lookup', '@farris/ui-forms', '@farris/ui-number-spinner', '@farris/ui-perfect-scrollbar', '@farris/ui-filter-condition', 'rxjs', 'lodash-es', '@angular/platform-browser', '@farris/ui-switch', '@angular/core', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-filter-panel'] = {}),global.uiCommon,global.ng.common,global.ng.forms,global.uiInputGroup,global.uiDatepicker,global.uiDatalist,global.uiComboList,global.uiLookup,global.uiForms,global.uiNumberSpinner,global.uiPerfectScrollbar,global.uiFilterCondition,global.rxjs,global.lodashEs,global.ng.platformBrowser,global.uiSwitch,global.ng.core,global.uiLocale));
}(this, (function (exports,uiCommon,common,forms,uiInputGroup,uiDatepicker,uiDatalist,uiComboList,uiLookup,uiForms,uiNumberSpinner,uiPerfectScrollbar,uiFilterCondition,rxjs,lodashEs,platformBrowser,uiSwitch,i0,uiLocale) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FilterPanelComponent = /** @class */ (function () {
        function FilterPanelComponent(renderer, elementRef, filterConditionSer) {
            ...
            this.filterSubmit = new i0.EventEmitter();
         ...
         */
            function () {
                ...
                this.currentItem = lodashEs.cloneDeep({ value: __assign({}, this.option.item.value), type: this.option.item.control.controltype, id: this.option.item.id });
            };
        /**
         * @return {?}
         */
         ...
         */
            function ($event) {
                this.currentItem = lodashEs.cloneDeep({ value: __assign({}, $event.value), type: $event.control.controltype, id: $event.id });
        ...
        /** @nocollapse */
        FilterPanelComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
                { type: i0.ElementRef },
                { type: uiFilterCondition.QuerySolutionService }
            ];
        };
        FilterPanelComponent.propDecorators = {
            ...
            filterSubmit: [{ type: i0.Output }],
            clearFilter: [{ type: i0.Output }],
            dataChange: [{ type: i0.Output }],
            filterPanel: [{ type: i0.ViewChild, args: ['filterPanel',] }],
    ...
    var FilterPanelService = /** @class */ (function () {
        ...
        /** @nocollapse */
        FilterPanelService.ctorParameters = function () {
            return [
    ...
    var PanelControlTypeXPipe = /** @class */ (function () {
        ...
        PanelControlTypeXPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'panelControlType' },] }
        ];
    ...
    var PanelfilterCheckboxComponent = /** @class */ (function () {
        function PanelfilterCheckboxComponent(localeService) {
            ...
            this.submitChange = new i0.EventEmitter();
        ...
        /** @nocollapse */
        PanelfilterCheckboxComponent.ctorParameters = function () {
            return [
                { type: uiLocale.LocaleService, decorators: [{ type: i0.Optional }] }
            ];
        };
        PanelfilterCheckboxComponent.propDecorators = {
            enableSearch: [{ type: i0.Input }],
            boolcheck: [{ type: i0.Input }],
            item: [{ type: i0.Input }],
            searchInput: [{ type: i0.ViewChild, args: ['searchInput',] }],
            searchHandle: [{ type: i0.Output, args: ['searchHandle',] }],
            submitChange: [{ type: i0.Output, args: ['submitChange',] }]
        };
     ...
     * @return {?}
     */
    function getToday(dayTags, showtime) {
        if (dayTags === void 0) {
            dayTags = 'today';
        }
        /** @type {?} */
    ...
    var PanelDateRangeComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PanelDateRangeComponent.ctorParameters = function () {
            return [
        ...
        PanelDateRangeComponent.propDecorators = {
            ...
            searchHandle: [{ type: i0.Output, args: ['searchHandle',] }],
            submitChange: [{ type: i0.Output, args: ['submitChange',] }],
            datepickerEle: [{ type: i0.ViewChild, args: ['datepicker',] }]
        };
    ...
    var PanelHelpComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PanelHelpComponent.ctorParameters = function () {
            return [
                { type: i0.Injector }
            ];
        };
    ...
    var PanelNumberComponent = /** @class */ (function () {
        ...
        PanelNumberComponent.propDecorators = {
            ...
            submitChange: [{ type: i0.Output }],
            item: [{ type: i0.Input }],
            numberRangeText: [{ type: i0.ViewChild, args: ['numberRangeText',] }]
        };
    ...
    var PanelInputComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PanelInputComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
                { type: i0.Injector }
            ];
    ...
    var PanelSearchComponent = /** @class */ (function () {
        ...
        PanelSearchComponent.propDecorators = {
            ...
            searchHandle: [{ type: i0.Output }],
            submitChange: [{ type: i0.Output }],
            searchText: [{ type: i0.ViewChild, args: ['searchText',] }]
        };
    ...
    var FilterSafePipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        FilterSafePipe.ctorParameters = function () {
            return [
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var FilterHighlightSearchPipe = /** @class */ (function () {
        function FilterHighlightSearchPipe() {
        }
        /**
         * @param {?} value
         * @param {?=} args
         * @return {?}
         */
        FilterHighlightSearchPipe.prototype.transform = /**
         * @param {?} value
         * @param {?=} args
         * @return {?}
         */
         ...
         * @return {?}
         */
        FilterHighlightSearchPipe.prototype.getEndMatchedValue = /**
         * @param {?} value
         * @param {?} searchValue
         * @param {?} oriValue
         * @return {?}
         */
            function (value, searchValue, oriValue) {
                if (searchValue) {
                    /** @type {?} */
                    var endValue = oriValue;
                    /** @type {?} */
                    var upperValue = value.toUpperCase();
                    /** @type {?} */
                    var upperSearch = searchValue.toUpperCase();
                    /** @type {?} */
                    var matchIndex = upperValue.indexOf(upperSearch);
                    if (matchIndex !== -1) {
                        // 将匹配到的内容进行高亮标注
        ...
        return FilterHighlightSearchPipe;
    }());
    ...
    var PanelSingleNumberComponent = /** @class */ (function () {
        ...
        PanelSingleNumberComponent.propDecorators = {
            ...
            submitChange: [{ type: i0.Output }],
            item: [{ type: i0.Input }],
            numberText: [{ type: i0.ViewChild, args: ['numberText',] }]
        };
    ...
    var PanelFlexibleNumberComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PanelFlexibleNumberComponent.ctorParameters = function () {
            return [
                { type: uiLocale.LocaleService }
            ];
        };
        PanelFlexibleNumberComponent.propDecorators = {
            ...
            submitChange: [{ type: i0.Output, args: ['submitChange',] }],
            item: [{ type: i0.Input }],
            beginNumberText: [{ type: i0.ViewChild, args: ['beginNumberText',] }],
            numberText: [{ type: i0.ViewChild, args: ['numberText',] }]
        };
    ...
    var PanelFlexibleDateComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PanelFlexibleDateComponent.ctorParameters = function () {
            return [
                { type: uiLocale.LocaleService }
            ];
        };
        ...
        FilterPanelModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            uiSwitch.SwitchModule.forRoot(),
                            uiFilterCondition.FilterConditionModule
                        ],
                        providers: [
                            // FilterPanelService,
                            uiFilterCondition.QuerySolutionService
    ...
    exports.PanelfilterCheckboxComponent = PanelfilterCheckboxComponent;
    exports.PanelDateComponent = PanelDateComponent;
    exports.PanelDateRangeComponent = PanelDateRangeComponent;
    exports.PanelDropDownComponent = PanelDropDownComponent;
    exports.PanelHelpComponent = PanelHelpComponent;
    exports.PanelInputComponent = PanelInputComponent;
    exports.PanelNumberComponent = PanelNumberComponent;
    exports.PanelSearchComponent = PanelSearchComponent;
    exports.PanelInputGroupComponent = PanelInputGroupComponent;
    exports.PanelSingleNumberComponent = PanelSingleNumberComponent;
    exports.PanelFlexibleNumberComponent = PanelFlexibleNumberComponent;
    exports.PanelFlexibleDateComponent = PanelFlexibleDateComponent;
    exports.PanelRadioComponent = PanelRadioComponent;
    exports.ControlType = ControlType;
    exports.PanelControlTypeXPipe = PanelControlTypeXPipe;
    exports.FilterHighlightSearchPipe = FilterHighlightSearchPipe;
    exports.FilterSafePipe = FilterSafePipe;
...
//# sourceMappingURL=farris-ui-filter-panel.umd.js.map
System.register(['@farris/mobile-devkit', 'rxjs', 'rxjs/operators'], function (exports) {
    'use strict';
    var InjectionToken, EntityCollection, HttpMethods, makePropDecorator, DataChangeType, AppContext, MetadataUtil, InjectFlags, HttpClient, Repository, HttpUtil, BindingPathConverter, PropertyUtil, BindingPropertyType, FieldMetadataUtil, ModifyType, EntityManager, Subject, of, EMPTY, zip, BehaviorSubject, switchMap, tap, map, catchError;
    return {
        setters: [function (module) {
            InjectionToken = module.InjectionToken;
            EntityCollection = module.EntityCollection;
            HttpMethods = module.HttpMethods;
            makePropDecorator = module.makePropDecorator;
            DataChangeType = module.DataChangeType;
            AppContext = module.AppContext;
            MetadataUtil = module.MetadataUtil;
            InjectFlags = module.InjectFlags;
            HttpClient = module.HttpClient;
            Repository = module.Repository;
            HttpUtil = module.HttpUtil;
            BindingPathConverter = module.BindingPathConverter;
            PropertyUtil = module.PropertyUtil;
            BindingPropertyType = module.BindingPropertyType;
            FieldMetadataUtil = module.FieldMetadataUtil;
            ModifyType = module.ModifyType;
        ...
        execute: function () {
            ...
            ***************************************************************************** */
             ...
             * 变更类型
             */
            var ChangeDetailType = exports('ChangeDetailType', /** @class */ (function () {
             ...
             */
            /** @type {?} */
            var BE_SERVER_URI_TOKEN = exports('BE_SERVER_URI_TOKEN', new InjectionToken('@farris/be BE_SERVER_URL'));
            /**
             * 1、因为bef里，很多类都没有注入，BefSessionHandlingStragegy无法直接注入；
             * 2、通过一个字符串Token来间接做策略选择。
             * @type {?}
             */
            var BE_SESSION_HANDLING_STRATEGY_TOKEN = exports('BE_SESSION_HANDLING_STRATEGY_TOKEN', new InjectionToken('@farris/be BE_SESSION_HANDLING_STRATEGY_TOKEN'));
            /**
             * 注入异常处理service
             * @type {?}
             */
            var BE_ERROR_HANDLER__TOKEN = exports('BE_ERROR_HANDLER__TOKEN', new InjectionToken('@farris/be BE_ERROR_HANDLER__TOKEN'));
             ...
             * BefHttp工具类
             */
            BefHttpUtil = exports('BefHttpUtil', /** @class */ (function () {
             ...
             * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
             */
            var RequestInfoUtil = exports('RequestInfoUtil', /** @class */ (function () {
             ...
             * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
             */
            var ResponseInfoUtil = exports('ResponseInfoUtil', /** @class */ (function () {
             ...
             * 变更集工具类
             */
            BefChangeUtil = exports('BefChangeUtil', /** @class */ (function () {
             ...
             * Bef数据中各种Path的转换
             */
            BefDataPathUtil = exports('BefDataPathUtil', /** @class */ (function () {
             ...
             * 2、暂时无法归类的代码封装；
             */
            BefProxyUtil = exports('BefProxyUtil', /** @class */ (function () {
             ...
             * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
             */
            var BefRepositoryUtil = exports('BefRepositoryUtil', /** @class */ (function () {
             ...
             * Bef环境监测工具类
             */
            BefEnvUtil = exports('BefEnvUtil', /** @class */ (function () {
                function BefEnvUtil() {
                }
                /**
                 * 是否在框架内运行
             ...
             * BEF变更集构造器
             */
            BefChangeBuilder = exports('BefChangeBuilder', /** @class */ (function () {
                /**
                 * 构造函数
                 * @param entityType 实体类型
                 */
             ...
             * 处理服务器端变更
             */
            BefChangeHandler = exports('BefChangeHandler', /** @class */ (function () {
                /**
                 * 构造函数
                 */
             ...
             * @abstract
             */
            BefSessionHandlingStrategy = exports('BefSessionHandlingStrategy', /** @class */ (function () {
                /**
                 * 构造函数
                 */
             ...
             * 隔离的BeSession处理策略
             */
            BefSeparatedSessionHandlingStrategy = exports('BefSeparatedSessionHandlingStrategy', /** @class */ (function (_super) {
             ...
             * 3、基于2缓存之后，如何closeSession，成为问题，除非appAcontext是一颗树，只有根AppContext初始化的时候，才去closeSession。
             */
            BefUnifiedSessionHandlingStrategy = exports('BefUnifiedSessionHandlingStrategy', /** @class */ (function (_super) {
             ...
             *  }
             */
            SessionStorageBeSessionStorageStrategy = exports('SessionStorageBeSessionStorageStrategy', /** @class */ (function () {
             ...
             * BeSession处理策略工厂
             */
            BefSessionHandlingStrategyFactory = exports('BefSessionHandlingStrategyFactory', /** @class */ (function () {
             ...
             * BefSessionService
             */
            BefSessionService = exports('BefSessionService', /** @class */ (function () {
                /**
                 * 构造函数
                 */
             ...
             * @abstract
             */
            BefProxy = exports('BefProxy', /** @class */ (function () {
                /**
                 * 构造函数
                 */
             ...
             * @type {?}
             */
            var VARIABLE_PROP_META = exports('VARIABLE_PROP_META', '@farris/bef VARIABLE_PROP_META');
            var ɵ0 = /**
             * @param {?} obj
             * @return {?}
             */
             ...
             * @type {?}
             */
            var VariablePropMeta = exports('VariablePropMeta', makePropDecorator(VARIABLE_PROP_META, (ɵ0)));
             ...
             * 框架Session服务
             */
            FrameworkSessionService = exports('FrameworkSessionService', /** @class */ (function () {
             ...
             * @template T
             */
            BefRepository = exports('BefRepository', /** @class */ (function (_super) {
             ...
             * Bef帮助取数服务
             */
            BefLookupDataService = exports('BefLookupDataService', /** @class */ (function () {
                /**
                 * 构造函数
                 */

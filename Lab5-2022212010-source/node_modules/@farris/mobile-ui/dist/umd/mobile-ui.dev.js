(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vue'), require('dayjs'), require('@vue/compiler-core'), require('vant'), require('quill')) :
    typeof define === 'function' && define.amd ? define(['exports', 'vue', 'dayjs', '@vue/compiler-core', 'vant', 'quill'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.FarrisMobile = {}, global.Vue, global.dayjs, global.compilerCore, global.vant, global.Quill));
}(this, (function (exports, Vue, dayjs, compilerCore, vant, Quill) { 'use strict';
    ...
    var getPosition = function getPosition(target, wrapper) {
      ...
      var _target = Vue.unref(target);

      var _wrapper = Vue.unref(wrapper);
    ...
    var format = function format(date, _format) {
      return dayjs__default['default'](date).format(initFormatForDayjs(_format));
    };
    var parse = function parse(date, format) {
      return isDate(date) ? date : dayjs__default['default'](date, format).toDate();
    };
    ...
    function isEqualDate(prevDate, nextDate) {
      ...
      return dayjs__default['default'](prevDate).isSame(nextDate, 'date');
    }
    function isSameDay(prevDate, nextDate) {
      return dayjs__default['default'](prevDate).isSame(nextDate, 'day');
    }
    function isBefore(prevDate, nextDate, unit) {
      ...
      nextDate = nextDate ? nextDate : new Date();
      return dayjs__default['default'](prevDate).isBefore(nextDate, unit);
    }
    function isAfter(prevDate, nextDate, unit) {
      ...
      nextDate = nextDate ? nextDate : new Date();
      return dayjs__default['default'](prevDate).isAfter(nextDate, unit);
    }
    ...
    function createCodegenContext() {
      var context = {
        ...
        helper: function helper(key) {
          return "_" + compilerCore.helperNameMap[key];
        },
    ...
    function genModulePreamble(ast, context) {
      ...
      if (ast.helpers.length) {
        push("const { " + ast.helpers.map(function (s) {
          return compilerCore.helperNameMap[s] + ": _" + compilerCore.helperNameMap[s];
        }).join(', ') + " } = Vue\n");
      }
    ...
    function genAssets(assets, type, _ref) {
      ...
      var resolver = helper(type === 'component' ? compilerCore.RESOLVE_COMPONENT : compilerCore.RESOLVE_DIRECTIVE);
    ...
    function genNode(node, context) {
      ...
      switch (node.type) {
        ...
        case 9:
        case 11:
          compilerCore.assert(node.codegenNode != null, "Codegen node is missing for element/if/for node. " + "Apply appropriate transforms first.");
        ...
        default:
          {
            compilerCore.assert(false, "unhandled codegen node type: " + node.type);
    ...
    function genInterpolation(node, context) {
      ...
      push(helper(compilerCore.TO_DISPLAY_STRING) + "(");
    ...
    function genExpressionAsPropertyKey(node, context) {
      ...
      if (node.type === 8) {
        ...
        var text = compilerCore.isSimpleIdentifier(node.content) ? node.content : JSON.stringify(node.content);
        push(text, node);
      } else {
    ...
    function genComment(node, context) {
      {
        ...
        push(helper(compilerCore.CREATE_COMMENT) + "(" + JSON.stringify(node.content) + ")", node);
      }
    }
    ...
    function genVNodeCall(node, context) {
      ...
      if (directives) {
        push(helper(compilerCore.WITH_DIRECTIVES) + "(");
      }

      if (isBlock) {
        push("(" + helper(compilerCore.OPEN_BLOCK) + "(" + (disableTracking ? "true" : "") + "), ");
      }
      ...
      push(helper(isBlock ? compilerCore.CREATE_BLOCK : compilerCore.CREATE_VNODE) + "(", node);
    ...
    function genFunctionExpression(node, context) {
      ...
      if (isSlot) {
        push("_" + compilerCore.helperNameMap[compilerCore.WITH_CTX] + "(");
      }
    ...
    function genConditionalExpression(node, context) {
      ...
      if (test.type === 4) {
        var needsParens = !compilerCore.isSimpleIdentifier(test.content);
        needsParens && push("(");
    ...
    function genCacheExpression(node, context) {
      ...
      if (node.isVNode) {
        indent();
        push(helper(compilerCore.SET_BLOCK_TRACKING) + "(-1),");
        newline();
      }
    ...
    })(exports.DragStatus || (exports.DragStatus = {}));
    ...
    function useTouchMove(target, listener, wait) {
      ...
      var offset = Vue.reactive(defaultTouchOffset());
      var dragStatus = Vue.ref(exports.DragStatus.NotStarted);
      ...
      var touchStart = function touchStart(event) {
        ...
        dragStatus.value = exports.DragStatus.Started;
      };
      ...
      var touchMove = function touchMove(event) {
        ...
        dragStatus.value = exports.DragStatus.Dragging;
      };
      ...
      var touchEnd = function touchEnd(event) {
        ...
        dragStatus.value = exports.DragStatus.End;
      };
      ...
      var resetTouchStatus = function resetTouchStatus() {
        ...
        dragStatus.value = exports.DragStatus.NotStarted;
      };
    ...
    var dynamicTemplate = Vue.defineComponent({
    ...
    function useDynamicTemplate(template) {
      var ast = compilerCore.baseParse(template, {
        isNativeTag: isHTMLTag
      });
      var prefixIdentifiers = true;

      var _getBaseTransformPres = compilerCore.getBaseTransformPreset(prefixIdentifiers),
      ...
      dynamicTemplate.render = createFunction(dynamicRender.code)(Vue__namespace);
    ...
    var createState = function createState(initState) {
      return Vue.reactive(initState);
    };
    var useState = function useState(key) {
      return Vue.inject(key ? key : stateSymbol);
    };
    var provideState = function provideState(key, initState) {
      ...
      return Vue.provide(key ? key : stateSymbol, createState(initState));
    };
    ...
    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, [$props.icon ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
        key: 0,
        name: $props.icon
      }, null, 8
      /* PROPS */
      , ["name"])) : Vue.createCommentVNode("v-if", true), $props.loading ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_1, [_hoisted_2])) : Vue.createCommentVNode("v-if", true), Vue.renderSlot(_ctx.$slots, "default", {}, function () {
        return [$props.loading && $props.loadingText ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_3, Vue.toDisplayString($props.loadingText), 1
        /* TEXT */
        )) : Vue.createCommentVNode("v-if", true), $props.type === 'add' ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
          key: 1,
          name: "s-plus"
    ...
    var script$2 = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var wrapperCls = Vue.computed(function () {
          var _ref2;
    ...
    function render$2(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_popup = Vue.resolveComponent("fm-popup");
      ...
      /* CLASS */
      ), Vue.createVNode(_component_fm_popup, {
        show: _ctx.show,
        ...
        "default": Vue.withCtx(function () {
          return [Vue.createVNode("div", _hoisted_2$1, [_ctx.hasArrow ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_3$1)) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", _hoisted_4, [Vue.createVNode("div", {
            "class": "fm-popover-inner-wrapper",
            onClick: _cache[2] || (_cache[2] = function () {
              return _ctx.onContentClick && _ctx.onContentClick.apply(_ctx, arguments);
            })
          }, [Vue.renderSlot(_ctx.$slots, "content")])])], 512
          /* NEED_PATCH */
          )];
        }),
        _: 3
    ...
    const _hoisted_6 = /*#__PURE__*/Vue.createVNode("span", { class: "btn-item-text" }, " 更多 ", -1 /* HOISTED */);
    ...
    function render$3(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_fm_icon = Vue.resolveComponent("fm-icon");
      const _component_fm_popover = Vue.resolveComponent("fm-popover");

      return (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$2, [
        Vue.renderSlot(_ctx.$slots, "default", {}, () => [
          Vue.createVNode("ul", _hoisted_2$2, [
            (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($options.showBtns, (btn, index) => {
              return (Vue.openBlock(), Vue.createBlock("li", {
                ...
                Vue.renderSlot(_ctx.$slots, "btn", {
                  ...
                  Vue.createVNode("span", _hoisted_3$2, [
                    Vue.createVNode(_component_fm_icon, {
                      name: btn.icon
                    }, null, 8 /* PROPS */, ["name"])
                  ]),
                  Vue.createVNode("span", _hoisted_4$1, Vue.toDisplayString(btn.text), 1 /* TEXT */)
                ])
              ], 14 /* CLASS, STYLE, PROPS */, ["onClick"]))
            }), 128 /* KEYED_FRAGMENT */)),
            ($options.extendBtns.length)
              ? (Vue.openBlock(), Vue.createBlock(_component_fm_popover, {
                  key: 0,
                  ref: "popover",
                  placement: "topRight",
                  offset: $data.offset,
                  ...
                  content: Vue.withCtx(() => [
                    Vue.createVNode("div", _hoisted_7, [
                      (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($options.extendBtns, (extendBtn, index) => {
                        return (Vue.openBlock(), Vue.createBlock("div", {
                          class: "fm-popover-item",
                          onClick: $event => ($options.$_itemHandler(extendBtn)),
                          key: index
                        }, [
                          Vue.renderSlot(_ctx.$slots, "extendBtn", {
                            btn: extendBtn,
                            index: index,
                            btns: $props.btns,
                            ...
                            extendBtn.disabled ? 'fm-popover-item-container-disabled' : ''
                              ...
                              Vue.createVNode("div", _hoisted_9, Vue.toDisplayString(extendBtn.text), 1 /* TEXT */)
                            ], 2 /* CLASS */)
                          ])
                        ], 8 /* PROPS */, ["onClick"]))
                      }), 128 /* KEYED_FRAGMENT */))
                  ...
                  default: Vue.withCtx(() => [
                    Vue.renderSlot(_ctx.$slots, "more", { btns: $props.btns }, () => [
                      Vue.createVNode("span", _hoisted_5, [
                        Vue.createVNode(_component_fm_icon, { name: "s-more-o" })
                      ]),
                      _hoisted_6
                    ])
                  ]),
    ...
    function getDateObj(dateRef) {
      var dateValue = Vue.unref(dateRef);
    ...
    var script$4 = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var calendar = Vue.inject('calendar', undefined);
        ...
        var markOption = Vue.computed(mark);
        ...
        var hasEvent = Vue.computed(event);
        ...
        var showLunar = Vue.computed(function () {
    ...
    function render$4(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, [Vue.createVNode("div", _hoisted_1$3, [Vue.createVNode("div", _hoisted_2$3, [Vue.createVNode("span", null, Vue.toDisplayString(_ctx.isCurrentDay(_ctx.day.date) ? '今' : _ctx.day.text), 1
      /* TEXT */
      )]), _ctx.showLunar ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_3$3, [Vue.createVNode("span", null, Vue.toDisplayString(_ctx.day.lunarDay === 1 ? _ctx.day.lunarMonthText : _ctx.day.lunarDayText), 1
      /* TEXT */
      ...
      /* CLASS, STYLE, PROPS */
      , ["innerHTML"]), _ctx.hasEvent ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_4$2)) : Vue.createCommentVNode("v-if", true)], 2
      /* CLASS */
      );
    }
    ...
    function render$5(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_calendar_day = Vue.resolveComponent("fm-calendar-day");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$4, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.week.days, function (day, index) {
        return Vue.openBlock(), Vue.createBlock(_component_fm_calendar_day, {
          key: index,
          day: day,
    ...
    var script$6 = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var firstWeek = Vue.computed(function () {
          return props.weeks[0];
        });
        var othersWeeks = Vue.computed(function () {
    ...
    function render$6(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_calendar_week = Vue.resolveComponent("fm-calendar-week");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$5, [Vue.createVNode(_component_fm_calendar_week, {
        "class": "fm-calendar-week-first",
        week: _ctx.firstWeek,
        onDayClick: _ctx.onDayClick
      }, null, 8
      /* PROPS */
      , ["week", "onDayClick"]), !_ctx.collapsed ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$4, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.othersWeeks, function (week) {
        return Vue.openBlock(), Vue.createBlock(_component_fm_calendar_week, {
          week: week,
          key: week.num,
          onDayClick: _ctx.onDayClick
        }, null, 8
    ...
    function render$7(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$6, [_ctx.title ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$5, Vue.toDisplayString(_ctx.title), 1
      /* TEXT */
      )) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", _hoisted_3$4, [Vue.createVNode("div", _hoisted_4$3, [_ctx.theme === 'form' ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 0,
        "class": "fm-calendar-header-button",
        onClick: _cache[1] || (_cache[1] = function ($event) {
          return _ctx.$emit('db-prev-click');
        })
      }, [Vue.renderSlot(_ctx.$slots, "db-prev", {}, function () {
        return [Vue.createVNode(_component_fm_icon, {
          name: "s-rewind"
        })];
      })])) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", {
        "class": "fm-calendar-header-button",
      ...
      }, [_ctx.prevText ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_5$1, Vue.toDisplayString(_ctx.prevText), 1
      /* TEXT */
      ...
      })])]), Vue.createVNode("div", _hoisted_6$1, [Vue.renderSlot(_ctx.$slots, "title", {
        currentDate: _ctx.currentDate
      }, function () {
        return [Vue.createVNode("span", null, Vue.toDisplayString(_ctx.currentDate.year + "\u5E74" + (_ctx.currentDate.month + 1) + "\u6708"), 1
        /* TEXT */
        )];
      })]), Vue.createVNode("div", _hoisted_7$1, [Vue.createVNode("div", {
        "class": "fm-calendar-header-button",
        onClick: _cache[3] || (_cache[3] = function ($event) {
          return _ctx.$emit('next-click');
        })
      }, [_ctx.nextText ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_8$1, Vue.toDisplayString(_ctx.nextText), 1
      /* TEXT */
      ...
      })]), _ctx.theme === 'form' ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 0,
        "class": "fm-calendar-header-button",
        onClick: _cache[4] || (_cache[4] = function ($event) {
          return _ctx.$emit('db-next-click');
        })
      }, [Vue.renderSlot(_ctx.$slots, "db-next", {}, function () {
        return [Vue.createVNode(_component_fm_icon, {
          name: "s-forword"
        })];
      })])) : Vue.createCommentVNode("v-if", true)])]), Vue.createVNode("div", _hoisted_9$1, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.dayLabels, function (dayLabel) {
        return Vue.openBlock(), Vue.createBlock("span", {
          "class": "fm-calendar-weekday",
          key: dayLabel
        }, Vue.toDisplayString(dayLabel), 1
        /* TEXT */
        );
      }), 128
      /* KEYED_FRAGMENT */
    ...
    var script$8 = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var selecteds = [];
        var selectedRange = Vue.reactive({});
        useExpose({
          selecteds: selecteds,
          selectedRange: selectedRange
        });
        var dayLabels = Vue.computed(function () {
          return genDayLabels(props.firstDay);
        });
        var innerValue = Vue.ref(props.modelValue);
        var current = Vue.ref(new Date());
        ...
        var currentDate = Vue.computed(function () {
        ...
        var gotoByClick = function gotoByClick(gotoType, clickType) {
          ...
          var _unref = Vue.unref(currentDate),
              year = _unref.year,
              month = _unref.month,
              date = _unref.date;
        ...
        var next = function next(type) {
          ...
          emit('next-click', Vue.unref(currentDate));
        };

        var prev = function prev(type) {
          gotoByClick('prev', type);
          emit('prev-click', Vue.unref(currentDate));
        };
    ...
    function render$8(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_calendar_header = Vue.resolveComponent("fm-calendar-header");

      var _component_fm_calendar_month = Vue.resolveComponent("fm-calendar-month");

      var _component_fm_calendar_week = Vue.resolveComponent("fm-calendar-week");

      return Vue.openBlock(), Vue.createBlock("div", {
        "class": ["fm-calendar", 'fm-calendar-theme-' + _ctx.theme]
      }, [Vue.createVNode(_component_fm_calendar_header, {
        theme: _ctx.theme,
        currentDate: _ctx.currentDate,
        title: _ctx.title,
        view: _ctx.view,
      ...
      /* PROPS */
      , ["theme", "currentDate", "title", "view", "prevText", "nextText", "dayLabels", "onPrevClick", "onNextClick"]), Vue.createVNode("div", _hoisted_1$7, [_ctx.offset.offsetX > 50 ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$6, "上一页")) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", {
        "class": "fm-calendar-body-slide-wrapper",
        style: _ctx.bodyStyle
      }, [_ctx.view === 'month' ? (Vue.openBlock(), Vue.createBlock(_component_fm_calendar_month, {
        key: 0,
        weeks: _ctx.weeks,
      ...
      /* PROPS */
      , ["weeks", "collapsed", "onDayClick", "onRender"])) : Vue.createCommentVNode("v-if", true), _ctx.view === 'week' ? (Vue.openBlock(), Vue.createBlock(_component_fm_calendar_week, {
        key: 1,
        week: _ctx.weeks[0],
        onDayClick: _ctx.onDayClick,
        onRender: _ctx.onRender
      ...
      /* PROPS */
      , ["week", "onDayClick", "onRender"])) : Vue.createCommentVNode("v-if", true)], 4
      /* STYLE */
      ), _ctx.offset.offsetX < -50 ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_3$5, "下一页")) : Vue.createCommentVNode("v-if", true), _ctx.theme === 'form' ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_4$4, Vue.toDisplayString(_ctx.currentDate.month + 1), 1
      /* TEXT */
      )) : Vue.createCommentVNode("v-if", true), _ctx.view === 'month' && _ctx.useCollapse ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_5$2, [_ctx.collapsed ? (Vue.openBlock(), Vue.createBlock("span", {
        key: 0,
        onClick: _cache[3] || (_cache[3] = function () {
          return _ctx.toggle && _ctx.toggle.apply(_ctx, arguments);
        })
      }, "展开")) : Vue.createCommentVNode("v-if", true), !_ctx.collapsed ? (Vue.openBlock(), Vue.createBlock("span", {
        key: 1,
        onClick: _cache[4] || (_cache[4] = function () {
          return _ctx.toggle && _ctx.toggle.apply(_ctx, arguments);
        })
      }, "收起")) : Vue.createCommentVNode("v-if", true)])) : Vue.createCommentVNode("v-if", true)], 512
      /* NEED_PATCH */
      ), _hoisted_6$2], 2
      /* CLASS */
      );
    ...
    var Input = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var updateOn = Vue.computed(function () {
        ...
        var updatable = Vue.computed(function () {
        ...
        var innerValue = Vue.ref(initInnerValue(props.modelValue));
        Vue.watch(function () {
          return props.modelValue;
        }, function (value) {
        ...
        var inputType = Vue.ref('text');
        var inputMode = Vue.ref('text');
        ...
        var inputStyle = Vue.reactive({});

        var adjustSize = function adjustSize() {
          var input = Vue.unref(inputEl);
        ...
        var renderClearIcon = function renderClearIcon() {
          return showClear.value ? Vue.createVNode("span", {
        ...
        var renderWordLimit = function renderWordLimit() {
          return props.showWordLimit && props.maxlength ? Vue.createVNode("div", {
            "class": "fm-input-word-limit"
          }, [Vue.createVNode("span", {
            "class": "word-num"
          }, [String(innerValue.value).length]), Vue.createTextVNode("/"), props.maxlength]) : '';
        };
        ...
        var renderErrorMesagge = function renderErrorMesagge() {
          ...
          return props.errorMessage ? Vue.createVNode("div", {
            "class": className
          }, [props.errorMessage]) : '';
        };

        var renderInput = function renderInput() {
          return props.type === 'textarea' ? Vue.withDirectives(Vue.createVNode("textarea", {
            "ref": inputEl,
            "style": inputStyle,
          ...
          }, null), [[Vue.vModelText, innerValue.value]]) : Vue.withDirectives(Vue.createVNode("input", {
            "ref": inputEl,
          ...
          }, null), [[Vue.vModelDynamic, innerValue.value]]);
        };

        var renderInputBody = function renderInputBody() {
          return Vue.createVNode("div", {
            "class": "fm-input-body"
          }, [slots.input ? Vue.createVNode("div", {
            "class": ['fm-input-control', props.inputAlign ? 'fm-input-control-' + props.inputAlign : '', props.readonly ? 'fm-input-control-readonly' : '']
        ...
        var renderBlock = function renderBlock() {
          return function () {
            return Vue.createVNode(Vue.Fragment, null, [slots["default"] ? slots["default"]() : renderInputBody(), renderWordLimit(), renderErrorMesagge()]);
          };
        };
        ...
        return function () {
          ...
          return Vue.createVNode(Vue.resolveComponent("fm-cell"), {
            "class": className,
            "title": props.label,
    ...
    var _hoisted_2$7 = /*#__PURE__*/Vue.createTextVNode(" 确定 ");
    var __default__ = {
      name: 'fm-calendar-input'
    };
    var script$9 = Vue.defineComponent(_extends({}, __default__, {
      expose: [],
      ...
      setup: function setup(__props) {
        ...
        var _useContext = Vue.useContext(),
        ...
        var innerValue = Vue.ref(getInnerValue(props.modelValue, props.format));
        var innerText = Vue.ref(getTextValue(innerValue.value, props.format));
        Vue.watch(function () {
          return props.modelValue;
        }, function (newValue) {
        ...
        return function (_ctx, _cache) {
          var _component_fm_calendar = Vue.resolveComponent("fm-calendar");

          var _component_fm_button = Vue.resolveComponent("fm-button");

          var _component_fm_popup = Vue.resolveComponent("fm-popup");

          return Vue.openBlock(), Vue.createBlock(Vue.Fragment, null, [Vue.createVNode(Vue.unref(Input), {
          ...
          /* PROPS */
          , ["modelValue", "label", "placeholder", "required", "readonly", "disabled", "clickable", "inputAlign", "errorMessage", "errorMessageAlign", "rightIcon"]), Vue.createVNode(_component_fm_popup, {
            show: show.value,
            "onUpdate:show": _cache[3] || (_cache[3] = function ($event) {
            ...
            "default": Vue.withCtx(function () {
              return [Vue.createVNode(_component_fm_calendar, {
              ...
              /* PROPS */
              , ["modelValue", "theme", "type", "title", "useLunar", "firstDay", "view", "mark", "event", "events"]), _ctx.type !== 'single' ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$8, [Vue.createVNode(_component_fm_button, {
                "class": "confirm",
                type: "primary",
                size: "large",
                round: "",
    ...
    var script$a = {
      ...
      setup: function setup(props, _ref) {
        ...
        var showLabel = Vue.computed(function () {
    ...
    function render$9(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, [$props.leftIcon || _ctx.$slots['left-icon'] ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 0,
        "class": "fm-cell-left-icon",
        onClick: _cache[1] || (_cache[1] = Vue.withModifiers(function ($event) {
          return _ctx.$emit('leftIconClick');
        }, ["stop"]))
      }, [Vue.renderSlot(_ctx.$slots, "left-icon", {}, function () {
        return [Vue.createVNode(_component_fm_icon, {
          name: $props.leftIcon
        }, null, 8
        /* PROPS */
        , ["name"])];
      })])) : Vue.createCommentVNode("v-if", true), $setup.showTitle ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 1,
        "class": ["fm-cell-title", [$props.titleClass]]
      }, [Vue.renderSlot(_ctx.$slots, "title", {}, function () {
        return [Vue.createVNode("span", _hoisted_1$9, Vue.toDisplayString($props.title), 1
        /* TEXT */
        )];
      }), $setup.showLabel ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$8, [Vue.renderSlot(_ctx.$slots, "label", {}, function () {
        return [Vue.createVNode("span", null, Vue.toDisplayString($props.label), 1
        /* TEXT */
        )];
      })])) : Vue.createCommentVNode("v-if", true)], 2
      /* CLASS */
      )) : Vue.createCommentVNode("v-if", true), $setup.showValue ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 2,
        "class": ["fm-cell-value", [$props.valueClass, !$setup.showTitle ? 'fm-cell-value-alone' : '']]
      }, [Vue.renderSlot(_ctx.$slots, "default", {}, function () {
        return [Vue.createVNode("span", null, Vue.toDisplayString($props.value), 1
        /* TEXT */
        )];
      })], 2
      /* CLASS */
      )) : Vue.createCommentVNode("v-if", true), $props.rightIcon || _ctx.$slots['right-icon'] || $props.isLink ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 3,
        "class": "fm-cell-right-icon",
        onClick: _cache[2] || (_cache[2] = function ($event) {
          return _ctx.$emit('rightIconClick');
        })
      }, [Vue.renderSlot(_ctx.$slots, "right-icon", {}, function () {
        return [Vue.createCommentVNode(" <span class=\"fm-icon fm-icon-s-arrow\"></span> "), Vue.createVNode(_component_fm_icon, {
          name: $props.rightIcon ? $props.rightIcon : 's-arrow'
        }, null, 8
        /* PROPS */
        , ["name"])];
      })])) : Vue.createCommentVNode("v-if", true), $props.extra || _ctx.$slots.extra ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 4,
        "class": "fm-cell-extra",
        onClick: _cache[3] || (_cache[3] = function ($event) {
        ...
        return [$props.extra ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_3$6, Vue.toDisplayString($props.extra), 1
        /* TEXT */
        )) : Vue.createCommentVNode("v-if", true)];
      })])) : Vue.createCommentVNode("v-if", true)], 2
      /* CLASS */
    ...
    var script$b = {
      ...
      setup: function setup(props, _ref) {
        ...
        var checkClass = Vue.computed(function () {
          var _ref2;
    ...
    function render$a(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", {
        ...
        return [$props.type === 'check' ? (Vue.openBlock(), Vue.createBlock("div", {
          key: 0,
          "class": ["fm-check-icon", {
        ...
        }, [Vue.createVNode("span", null, Vue.toDisplayString($props.label), 1
        /* TEXT */
        )], 2
        /* CLASS */
        )];
    ...
    function render$b(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_checker = Vue.resolveComponent("fm-checker");

      var _component_fm_cell = Vue.resolveComponent("fm-cell");

      return Vue.openBlock(), Vue.createBlock("div", {
        "class": "fm-checkbox-group",
        role: $props.role
      }, [$props.direction === 'vertical' ? (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, {
        key: 0
      }, Vue.renderList($props.items, function (item) {
        return Vue.openBlock(), Vue.createBlock(_component_fm_cell, {
          key: item[$props.valueField],
          "class": "fm-checkbox-vertical"
        }, {
          "default": Vue.withCtx(function () {
            return [Vue.createVNode(_component_fm_checker, {
      ...
      /* KEYED_FRAGMENT */
      )) : Vue.createCommentVNode("v-if", true), $props.direction === 'horizontal' ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 1,
        ...
        return Vue.openBlock(), Vue.createBlock(_component_fm_checker, {
          "class": "fm-checkbox",
          key: item[$props.valueField],
          label: item[$props.textField],
          disabled: $props.disabled,
    ...
    ***************************************************************************** */
    ...
    var Collapse = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        var attrs = _ref.attrs,
            slots = _ref.slots;
        var activeItem = Vue.ref(props.collapse ? [] : [1]);
        Vue.watch(function () {
        ...
        return function () {
          ...
          return Vue.createVNode(Vue.resolveComponent("van-collapse"), {
          ...
          }, _isSlot(_slot = Vue.createVNode(Vue.resolveComponent("van-collapse-item"), Vue.mergeProps(itemProps, {
    ...
    var Overlay = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var renderOverlay = lazyRender(function () {
          ...
          }, [(_a = slots["default"]) === null || _a === void 0 ? void 0 : _a.call(slots)]), [[Vue.vShow, props.show]]);
        });
        return function () {
          var _slot;
    ...
    var Popup = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var clickAwayActive = Vue.ref(false);
        ...
        var renderTransition = function renderTransition() {
          ...
          }, _isSlot$2(_slot = Vue.withDirectives(Vue.createVNode("div", Vue.mergeProps({
            "ref": popupRef,
            "style": style,
            "class": className,
          ...
          }, attrs), [(_a = slots["default"]) === null || _a === void 0 ? void 0 : _a.call(slots)]), [[Vue.vShow, props.show]])) ? _slot : {
            "default": function _default() {
              return [_slot];
            }
          });
        ...
        var renderOverlay = function renderOverlay() {
          ...
          if (props.overlay) {
            return Vue.createVNode(Vue.resolveComponent("fm-overlay"), {
    ...
    var DatePicker = Vue.defineComponent({
      ...
      inheritAttrs: false,
      components: (_components$9 = {}, _components$9[Input.name] = Input, _components$9[Popup.name] = Popup, _components$9[vant.DatetimePicker.name] = vant.DatetimePicker, _components$9),
      props: {
        format: {
          type: String,
      ...
      setup: function setup(props, _ref) {
        var attrs = _ref.attrs,
            emit = _ref.emit,
            slots = _ref.slots;
        var enableShow = Vue.ref(false);
        var enableShowDate = Vue.ref(false);
        Vue.watch(enableShow, function (value) {
          if (!value) {
            setTimeout(function () {
        ...
        var innerValue = Vue.ref(formatDate(props.modelValue));
        Vue.watch(function () {
          return props.modelValue;
        }, function (value) {
        ...
        var isEditable = Vue.computed(function () {
          return !(props.readonly || props.disabled);
        });
        ...
        return function () {
          ...
          var renderInput = function renderInput() {
            return Vue.createVNode("div", {
              ...
              modelValue: innerValue.value
            })) : Vue.createVNode(Vue.resolveComponent("fm-input"), Vue.mergeProps({
              "modelValue": innerValue.value
          ...
          return Vue.createVNode("div", {
            ...
            "default": function _default() {
              return [enableShowDate.value ? Vue.createVNode(Vue.resolveComponent("van-datetime-picker"), Vue.mergeProps({
    ...
    var FMDialog = Vue.defineComponent({
      name: 'fm-dialog',
      ...
      setup: function setup(props, _ref) {
        ...
        var renderHeader = function renderHeader() {
          return props.title ? Vue.createVNode("div", {
        ...
        var renderFooter = function renderFooter() {
          ...
          return Vue.createVNode("div", {
            ...
            return Vue.createVNode(Vue.resolveComponent("fm-button"), {
    ...
    var initInstance = function initInstance() {
      ...
      var _mountComponent = mountComponent({
        setup: function setup() {
          ...
          return function () {
            return Vue.createVNode(FMDialog, Object.assign(Object.assign({}, state), {
    ...
    function render$c(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_switch = Vue.resolveComponent("fm-switch");

      return Vue.openBlock(), Vue.createBlock(Vue.Fragment, null, [Vue.createCommentVNode(" <fm-input\r\n    :name=\"code\"\r\n    :placeholder=\"placeholder\"\r\n    input-align=\"left\"\r\n    class=\"pl-0 pr-0\"\r\n  >\r\n    <template #input>\r\n    </template>\r\n  </fm-input> "), Vue.createVNode(_component_fm_switch, {
    ...
    function render$d(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_datetime_picker = Vue.resolveComponent("fm-datetime-picker");

      return Vue.openBlock(), Vue.createBlock(_component_fm_datetime_picker, {
        "class": "fm-picker-row",
        modelValue: $options.innerValue,
        "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
          return $options.innerValue = $event;
    ...
    var _hoisted_2$9 = /*#__PURE__*/Vue.createVNode("span", {
    ...
    function render$e(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_field_date = Vue.resolveComponent("field-date");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$a, [Vue.createVNode(_component_field_date, {
        fieldProps: {
          placeholder: $data.placeholder,
          format: $data.format,
          type: $data.type,
      ...
      /* PROPS */
      , ["fieldProps", "code", "modelValue", "onUpdate:modelValue"]), _hoisted_2$9, Vue.createVNode(_component_field_date, {
        fieldProps: {
          placeholder: $data.placeholder,
          format: $data.format,
          type: $data.type,
    ...
    var script$g = {
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var innerData = Vue.computed(function () {
        ...
        var isSelected = function isSelected(value) {
          return Vue.unref(selected).includes(value);
        };
        ...
        var onModelChange = function onModelChange(value) {
          ...
          if (isSelected(value)) {
            if (props.multiSelect) {
              tmpValue = Vue.unref(selected).filter(function (el) {
                return el !== value;
              }).join(',');
            }
          } else {
            if (props.multiSelect) {
              tmpValue = [].concat(Vue.unref(selected), [value]).join(',');
            } else {
              tmpValue = value;
            }
          }
    ...
    function render$f(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.innerData, function (lineData, index) {
        return Vue.openBlock(), Vue.createBlock("div", {
          "class": $setup.bem('list-line'),
          key: index
        }, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(lineData, function (item) {
          return Vue.openBlock(), Vue.createBlock("div", {
          ...
          }, [Vue.createVNode("span", null, Vue.toDisplayString(item[$props.textField]), 1
          /* TEXT */
          )], 10
          /* CLASS, PROPS */
          , ["onClick"]);
    ...
    var script$h = {
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var multiSelect = Vue.computed(function () {
        ...
        var enumData = Vue.computed(function () {
    ...
    function render$g(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_panel_list = Vue.resolveComponent("panel-list");

      return Vue.openBlock(), Vue.createBlock(_component_panel_list, {
    ...
    var script$i = {
      ...
      setup: function setup(props, _ref) {
        ...
        var innerValue = Vue.ref(props.selecteds);
        Vue.watch(function () {
    ...
    var useLookupMapping = function useLookupMapping(idField) {
      ...
      Vue.provide('LookupMappingFn', LookupMapping);
      return {
        idValue: idValue,
    ...
    function render$i(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_lookup_input = Vue.resolveComponent("fm-lookup-input");

      return Vue.openBlock(), Vue.createBlock(_component_fm_lookup_input, {
        name: _ctx.code,
        ...
        template: Vue.withCtx(function (slotProps) {
    ...
    function render$j(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_input = Vue.resolveComponent("fm-input");

      return Vue.openBlock(), Vue.createBlock("div", null, [Vue.createVNode(_component_fm_input, {
    ...
    var _hoisted_2$a = /*#__PURE__*/Vue.createVNode("span", {
      "class": "fm-filter-panel-field-split"
    }, null, -1
    /* HOISTED */
    );
    ...
    function render$k(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_field_number = Vue.resolveComponent("field-number");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$b, [Vue.createVNode(_component_field_number, {
        modelValue: $data.firstValue,
        "onUpdate:modelValue": [_cache[1] || (_cache[1] = function ($event) {
          return $data.firstValue = $event;
        }), $options.onConfirmFirst],
      ...
      /* PROPS */
      , ["modelValue", "fieldProps", "code", "onUpdate:modelValue"]), _hoisted_2$a, Vue.createVNode(_component_field_number, {
        fieldProps: $props.fieldProps,
        code: $props.code,
        modelValue: $data.secondValue,
        "onUpdate:modelValue": [_cache[2] || (_cache[2] = function ($event) {
    ...
    var script$m = {
      ...
      setup: function setup(props, _ref) {
        ...
        var required = Vue.computed(function () {
    ...
    function render$l(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock(_component_fm_input, {
        "class": "fm-filter-panel-field-input",
        name: $props.code,
    ...
    var script$n = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var subTitleDatas = Vue.reactive({}); // 帮助已选中值组

        var selecteds = Vue.reactive({}); // 重置对象属性值为空函数
    ...
    function render$m(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_field_lookup_input = Vue.resolveComponent("field-lookup-input");

      var _component_field_check = Vue.resolveComponent("field-check");

      var _component_fm_icon = Vue.resolveComponent("fm-icon");

      return Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.filterList, function (filter) {
        return Vue.openBlock(), Vue.createBlock("div", {
        ...
        }, Vue.toDisplayString(filter.name), 3
        /* TEXT, CLASS */
        ), Vue.createVNode("div", {
          "class": _ctx.bem('field-title-sub')
        }, [Vue.createVNode("span", {
          "class": _ctx.bem('field-title-sub-text')
        }, Vue.toDisplayString(_ctx.subTitleDatas[filter.code]), 3
        /* TEXT, CLASS */
        ), Vue.createVNode("div", {
          "class": _ctx.bem('field-title-sub-button')
        }, [filter.type === 'help' ? (Vue.openBlock(), Vue.createBlock(_component_field_lookup_input, {
          key: 0,
          code: filter.code,
          name: filter.name,
          ...
          cell: Vue.withCtx(function (slotProps) {
            return [Vue.renderSlot(_ctx.$slots, "lookup-cell", {
              listData: slotProps.listData,
              item: slotProps.item,
              idField: slotProps.idField,
              textField: slotProps.textField
        ...
        /* PROPS, DYNAMIC_SLOTS */
        , ["code", "name", "fieldProps", "modelValue", "onUpdate:modelValue", "selecteds", "onChangeText", "onChangeValue"])) : Vue.createCommentVNode("v-if", true), filter.type === 'bool-check' ? (Vue.openBlock(), Vue.createBlock(_component_field_check, {
          key: 1,
          modelValue: _ctx.filterData[filter.code],
        ...
        /* PROPS */
        , ["modelValue", "onUpdate:modelValue", "fieldProps", "id", "code", "name"])) : Vue.createCommentVNode("v-if", true), _ctx.showSubTitle(filter.type) ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
          key: 2,
        ...
        /* PROPS */
        , ["name", "class", "onClick"])) : Vue.createCommentVNode("v-if", true)], 2
        /* CLASS */
        )], 2
        /* CLASS */
        )], 2
        /* CLASS */
        ), _ctx.showContent[filter.code] && filter.type !== 'bool-check' ? (Vue.openBlock(), Vue.createBlock("div", {
          key: 0,
          "class": _ctx.bem('field-content')
        }, [(Vue.openBlock(), Vue.createBlock(Vue.resolveDynamicComponent(filter.component), {
          type: filter.type,
          fieldProps: filter.fieldProps,
          id: filter.id,
          code: filter.code,
    ...
    var script$o = {
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var filterData = Vue.reactive({});
        var filterList = Vue.computed(function () {
    ...
    var _hoisted_5$3 = /*#__PURE__*/Vue.createTextVNode("重置");

    var _hoisted_6$3 = /*#__PURE__*/Vue.createTextVNode("确定");

    function render$n(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_component_panel = Vue.resolveComponent("component-panel");

      var _component_fm_button = Vue.resolveComponent("fm-button");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$c, [Vue.createVNode("div", _hoisted_2$b, [Vue.createVNode(_component_component_panel, {
        filterList: $setup.filterList,
        filterData: $setup.filterData,
        hasClear: $setup.hasClear,
        onChange: $setup.onChange
      }, {
        "lookup-cell": Vue.withCtx(function (slotProps) {
          return [Vue.renderSlot(_ctx.$slots, "lookup-cell", {
            listData: slotProps.listData,
            item: slotProps.item,
            idField: slotProps.idField,
      ...
      /* PROPS */
      , ["filterList", "filterData", "hasClear", "onChange"])]), Vue.createVNode("div", _hoisted_3$7, [Vue.createCommentVNode(" <div class=\"button\" @click=\"onReset\">重置</div>\r\n      <div class=\"button bgc-blue\" @click=\"onConfirm\">确定</div> "), Vue.createVNode("div", _hoisted_4$5, [Vue.createVNode(_component_fm_button, {
        "class": "button",
        plain: "",
        round: "",
      ...
      /* PROPS */
      , ["onClick"]), Vue.createVNode(_component_fm_button, {
        "class": "button",
        round: "",
    ...
    var script$p = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var listData = Vue.computed(function () {
    ...
    function render$o(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$d, [Vue.createVNode("div", _hoisted_2$c, [_ctx.menuData.length > 1 ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_3$8, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.menuData, function (menuItem, index) {
        return Vue.openBlock(), Vue.createBlock("div", {
          "class": ["menu-item", _ctx.getMenuClass(menuItem, index)],
          onClick: function onClick($event) {
            return _ctx.onMenuItemClick(menuItem);
          }
        }, [Vue.createVNode(_component_fm_cell, {
      ...
      /* UNKEYED_FRAGMENT */
      ))])) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", _hoisted_4$6, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.listData, function (item) {
        return Vue.openBlock(), Vue.createBlock("div", {
          "class": "list-item",
          onClick: function onClick($event) {
    ...
    const _hoisted_3$9 = /*#__PURE__*/Vue.createVNode("span", { class: "fm-icon fm-icon-s-search-o" }, null, -1 /* HOISTED */);
    const _hoisted_4$7 = {
      key: 0,
    ...
    function render$p(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_fm_input = Vue.resolveComponent("fm-input");
      ...
      return (Vue.openBlock(), Vue.createBlock("div", {
        ...
        Vue.createVNode("div", {
          ...
          (_ctx.$slots.label || $props.label)
            ...
            : Vue.createCommentVNode("v-if", true),
          Vue.createVNode(_component_fm_input, {
            ...
            "left-icon": Vue.withCtx(() => [
              Vue.createVNode("div", _hoisted_2$d, [
        ...
        ($props.showAction)
          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_4$7, [
              Vue.renderSlot(_ctx.$slots, "action", {}, () => [
                ($props.actionText)
                  ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_5$4, Vue.toDisplayString($props.actionText), 1 /* TEXT */))
    ...
    var script$r = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var searchBoxValue = Vue.ref(props.searchBoxValue);
        Vue.watch(function () {
    ...
    function render$q(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      var _component_fm_search = Vue.resolveComponent("fm-search");
      ...
      }, [Vue.renderSlot(_ctx.$slots, "left", {}, function () {
        return [Vue.createVNode(_component_fm_icon, {
          name: _ctx.icon
        }, null, 8
        /* PROPS */
      ...
      /* CLASS */
      ), _ctx.useSearch ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$f, [Vue.renderSlot(_ctx.$slots, "right", {}, function () {
        return [Vue.createVNode(_component_fm_search, {
    ...
    var script$s = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var silderPosition = Vue.computed(function () {
          return props.type === 'simple' ? 'top' : props.position;
        });
        var popClass = Vue.computed(function () {
          return props.type === 'simple' ? 'fm-filter-popup-drop' : 'fm-filter-popup';
        });
        var popStyle = Vue.ref({});
        var searchRef = Vue.ref();
        return {
          searchBoxValue: searchBoxValue,
    ...
    function render$r(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_fm_filter_search = Vue.resolveComponent("fm-filter-search");

      var _component_fm_filter_panel = Vue.resolveComponent("fm-filter-panel");

      var _component_fm_filter_simple_panel = Vue.resolveComponent("fm-filter-simple-panel");

      var _component_fm_popup = Vue.resolveComponent("fm-popup");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$g, [Vue.renderSlot(_ctx.$slots, "default", {
        click: _ctx.onToggle
      }, function () {
        return [Vue.createVNode(_component_fm_filter_search, {
        ...
        "default": Vue.withCtx(function () {
          return [_ctx.type === 'normal' ? (Vue.openBlock(), Vue.createBlock(_component_fm_filter_panel, {
            key: 0,
            modelValue: _ctx.modelValue,
          ...
          /* PROPS */
          , ["modelValue", "fieldConfigs", "query", "extraConditions", "onConfirm", "onChange"])) : (Vue.openBlock(), Vue.createBlock(_component_fm_filter_simple_panel, {
            key: 1,
            fieldConfigs: _ctx.fieldConfigs,
            onChange: _ctx.onChange,
            onConfirm: _ctx.onConfirm
    ...
    function render$s(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (Vue.openBlock(), Vue.createBlock("div", {
        ...
        Vue.withDirectives(Vue.createVNode("img", {
          ...
          [Vue.vShow, $data.isLoaded]
        ]),
        (!$data.isLoaded)
          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$h, [
          ...
          : ($options.error && $props.showError)
            ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$e, [
    ...
    const _hoisted_8$2 = /*#__PURE__*/Vue.createVNode("span", { class: "fm-icon fm-icon-singlechoice" }, null, -1 /* HOISTED */);
    ...
    const _hoisted_14 = /*#__PURE__*/Vue.createVNode("div", { class: "fm-cell-right-icon" }, [
      /*#__PURE__*/Vue.createVNode("span", null, ">")
    ], -1 /* HOISTED */);
    const _hoisted_15 = {
      key: 3,
      class: "fm-listview-empty"
    };
    const _hoisted_16 = /*#__PURE__*/Vue.createVNode("span", { class: "fm-listview-empty-text" }, "暂无数据", -1 /* HOISTED */);
    ...
    function render$t(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_fm_button = Vue.resolveComponent("fm-button");
      ...
      return (Vue.openBlock(), Vue.createBlock(_component_van_pull_refresh, {
        ...
        default: Vue.withCtx(() => [
          Vue.createVNode("div", {
            ...
            (!$props.fill)
              ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$i, null, 512 /* NEED_PATCH */))
              : Vue.createCommentVNode("v-if", true),
            (!$props.fill && $props.direction === 'up')
              ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$f, null, 512 /* NEED_PATCH */))
              : Vue.createCommentVNode("v-if", true),
            (_ctx.$slots['listViewHeader'])
              ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_3$a, [
                  Vue.renderSlot(_ctx.$slots, "listViewHeader")
                ]))
              : Vue.createCommentVNode("v-if", true),
            Vue.createVNode("div", _hoisted_4$8, [
              ($props.fill)
                ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_5$5, null, 512 /* NEED_PATCH */))
                : Vue.createCommentVNode("v-if", true),
              ($props.fill && $props.direction === 'up')
                ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_6$4, null, 512 /* NEED_PATCH */))
                : Vue.createCommentVNode("v-if", true),
              ($data.inListData && $data.inListData.length)
                ? (Vue.openBlock(), Vue.createBlock("div", {
                    ...
                    (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($data.inListData, (listItem, index) => {
                      return (Vue.openBlock(), Vue.createBlock("div", {
                  ...
                  'fm-listview-item-padding-none': $props.multiple && $data.listMultiple && $data.initMultiList
                        ...
                        ($props.multiple && $data.listMultiple)
                          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_7$2, [
                              Vue.createVNode("div", {
                          ...
                          : Vue.createCommentVNode("v-if", true),
                        Vue.createVNode("div", _hoisted_9$2, [
                          Vue.renderSlot(_ctx.$slots, "default", {
                            item: listItem,
                            ...
                            Vue.createVNode("div", _hoisted_10, [
                              Vue.createVNode("div", _hoisted_11, [
                                Vue.createVNode("span", _hoisted_12, Vue.toDisplayString(listItem.title), 1 /* TEXT */),
                                Vue.createVNode("div", _hoisted_13, Vue.toDisplayString(listItem.label), 1 /* TEXT */)
                              ]),
                              _hoisted_14,
                              Vue.renderSlot(_ctx.$slots, "cell-extra")
                            ])
                          ])
                        ])
                ...
                : (Vue.openBlock(), Vue.createBlock("div", _hoisted_15, [
                    Vue.renderSlot(_ctx.$slots, "listviewEmpty", {}, () => [
                      _hoisted_16
                    ])
                  ])),
              ($props.error)
                ? (Vue.openBlock(), Vue.createBlock("div", {
                    ...
                    Vue.renderSlot(_ctx.$slots, "error", {}, () => [
                      Vue.createVNode("span", _hoisted_17, Vue.toDisplayString($props.errorText), 1 /* TEXT */)
                    ])
                  ]))
                : Vue.createCommentVNode("v-if", true),
              (!$props.error)
                ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_18, [
                    (!$props.listRefreshing && $data.innerLoading && !$props.finished)
                      ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_19, [
                          Vue.createVNode("div", _hoisted_20, [
                            Vue.renderSlot(_ctx.$slots, "loading", {}, () => [
                              Vue.createVNode("span", _hoisted_21, Vue.toDisplayString($props.loadingText), 1 /* TEXT */)
                            ])
                          ])
                        ]))
                      : Vue.createCommentVNode("v-if", true),
                    ($props.finished && $props.showFinishedText && $data.inListData && $data.inListData.length)
                      ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_22, [
                          Vue.createVNode("div", _hoisted_23, [
                            Vue.renderSlot(_ctx.$slots, "finished", {}, () => [
                              Vue.createVNode("span", _hoisted_24, Vue.toDisplayString($props.finishedText), 1 /* TEXT */)
                            ])
                          ])
                        ]))
                      : Vue.createCommentVNode("v-if", true)
              ...
              ($props.fill && $props.direction === 'down')
                ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_25, null, 512 /* NEED_PATCH */))
                : Vue.createCommentVNode("v-if", true)
            ], 512 /* NEED_PATCH */),
            ($props.showSubmitBtn && $props.multiple && $data.listMultiple)
              ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_26, [
                  ($props.btns && $props.btns.length)
                    ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_27, [
                        (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($props.btns, (btn, index) => {
                          return (Vue.openBlock(), Vue.createBlock(_component_fm_button, {
                            type: btn.type?btn.type:'primary',
                            plain: !!btn.plain?btn.plain:false,
                            block: "",
                            disabled: !!btn.disabled,
                            onClick: $event => ($options.$_onClick(btn)),
                            onTouchmove: _cache[4] || (_cache[4] = Vue.withModifiers(() => {}, ["prevent"])),
                            class: "fm-listview-btns-item"
                          }, {
                            default: Vue.withCtx(() => [
                              Vue.createTextVNode(Vue.toDisplayString(btn.text), 1 /* TEXT */)
                            ]),
                            _: 2 /* DYNAMIC */
            ...
            (_ctx.$slots['listViewFooter'])
              ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_28, [
                  Vue.renderSlot(_ctx.$slots, "listViewFooter")
                ]))
              : Vue.createCommentVNode("v-if", true),
            (!$props.fill && $props.direction === 'down')
              ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_29, null, 512 /* NEED_PATCH */))
              : Vue.createCommentVNode("v-if", true)
          ], 2 /* CLASS */)
        ]),
        _: 1 /* STABLE */
    ...
    var _hoisted_2$g = /*#__PURE__*/Vue.createVNode("circle", {
      cx: "50",
      cy: "50",
      r: "20",
      fill: "none"
    ...
    function render$u(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock(Vue.Fragment, null, [_ctx.show ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$j)) : Vue.createCommentVNode("v-if", true), _ctx.show ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 1,
        "class": ["fm-loading", {
      ...
      }, Vue.toDisplayString(_ctx.message), 5
      /* TEXT, STYLE */
      )) : Vue.createCommentVNode("v-if", true)], 2
      /* CLASS */
    ...
    var initInstance$1 = function initInstance() {
      ...
      var _mountComponent = mountComponent({
        setup: function setup() {
          ...
          return function () {
            return Vue.createVNode(script$v, Object.assign(Object.assign({}, state), {
              'onUpdate:show': toggle
            }), null);
          };
        }
    ...
    var useHttpService = function useHttpService(url) {
      ...
      var LookupHttpService = Vue.inject('LookupHttpService', {});
    ...
    var usePresonal = function usePresonal(props) {
      ...
      if (props) {
        ...
        memoizedRecentData[currentIndex] = Vue.ref([]);
        memoizedFavoriteData[currentIndex] = Vue.ref([]);
        index++;
      } else {
    ...
    function render$v(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.withDirectives((Vue.openBlock(), Vue.createBlock("div", {
        ...
        style: _ctx.style
      }, Vue.toDisplayString(_ctx.message), 7
      /* TEXT, CLASS, STYLE */
      )), [[Vue.vShow, _ctx.show]]);
    }
    ...
    var initInstance$2 = function initInstance() {
      ...
      var _mountComponent = mountComponent({
        setup: function setup() {
          ...
          return function () {
            return Vue.createVNode(script$w, Object.assign(Object.assign({}, state), {
              'onUpdate:show': toggle
            }), null);
          };
        }
    ...
    var useSelect = function useSelect(props) {
      ...
      if (props) {
        memoizedSelecteds[currentIndex] = Vue.ref(emptySelected);
      ...
      var LookupMappingFn = Vue.inject('LookupMappingFn', {});
      ...
      var getSelectedValues = function getSelectedValues(ignorMapValue) {
        ...
        var _selected = Vue.unref(selected);
    ...
    var useLoadData = function useLoadData(props) {
      ...
      var innerDataList = [];
      var innerParentData = [];
      var dataList = Vue.ref([]);
      var serverTemplate = Vue.ref('');
    ...
    var script$x = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var innerSearchValue = Vue.ref(props.searchValue);
        Vue.watch(function () {
        ...
        var selectedLength = Vue.computed(function () {
        ...
        var showRoot = Vue.computed(function () {
    ...
    function render$w(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      var _component_fm_image = Vue.resolveComponent("fm-image");

      var _component_fm_input = Vue.resolveComponent("fm-input");

      var _component_fm_cell = Vue.resolveComponent("fm-cell");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$k, [Vue.createVNode("div", _hoisted_2$h, [Vue.createVNode("div", {
        "class": "nav-left",
        onClick: _cache[1] || (_cache[1] = function () {
      ...
      }, [Vue.createVNode("div", _hoisted_3$b, Vue.toDisplayString(_ctx.rootProps.title), 1
      /* TEXT */
      ), Vue.createVNode("div", _hoisted_4$9, Vue.toDisplayString(_ctx.subTitle), 1
      /* TEXT */
      )], 4
      /* STYLE */
      )]), Vue.createCommentVNode(" <fm-search\r\n      v-if=\"showSearch\"\r\n      :modelValue=\"searchValue\"\r\n      placeholder=\"请输入搜索关键词\"\r\n      @search=\"onSearch\"\r\n      @update:modelValue=\"onSearch($event, 'input')\"\r\n      @clear=\"onSearch('', 'clear')\"\r\n    >\r\n      <template #left-icon>\r\n        \r\n      </template>\r\n    </fm-search> "), Vue.createVNode("div", _hoisted_5$6, [_ctx.selectedLength > 0 ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_6$5, [!_ctx.showAvatar ? (Vue.openBlock(), Vue.createBlock(Vue.Fragment, {
        key: 0
      }, [_ctx.selectedLength > _ctx.rootProps.collapseLimit ? (Vue.openBlock(), Vue.createBlock("div", {
        key: 0,
        "class": "search-selected-item",
        onClick: _cache[2] || (_cache[2] = function ($event) {
          return _ctx.$emit('seclected-click');
        })
      }, [Vue.createVNode("span", _hoisted_7$3, Vue.toDisplayString("" + _ctx.selected.texts[0]), 1
      /* TEXT */
      ), Vue.createVNode("span", null, Vue.toDisplayString("\u7B49" + _ctx.selectedLength + "\u4E2A"), 1
      /* TEXT */
      )])) : (Vue.openBlock(), Vue.createBlock("div", _hoisted_8$3, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.selected.items, function (item, index) {
        return Vue.openBlock(), Vue.createBlock("div", {
          "class": "search-selected-item",
          onClick: function onClick($event) {
            return _ctx.toggleSelecte(item);
          }
        }, [Vue.createVNode("span", _hoisted_9$3, Vue.toDisplayString(_ctx.selected.texts[index]), 1
        /* TEXT */
        )], 8
        /* PROPS */
        , ["onClick"]);
      ...
      /* STABLE_FRAGMENT */
        ...
        key: 1
      }, [Vue.createVNode("div", _hoisted_10$1, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.selected.items, function (item, index) {
        return Vue.openBlock(), Vue.createBlock("div", {
          "class": "avatar",
          onClick: function onClick($event) {
            return _ctx.toggleSelecte(item);
          }
        }, [_ctx.getValue(_ctx.rootProps.avatarField, item) ? (Vue.openBlock(), Vue.createBlock(_component_fm_image, {
          key: 0,
          "class": "avatar-image",
          src: _ctx.rootProps.avatarPrefix + _ctx.getValue(_ctx.rootProps.avatarField, item) + _ctx.rootProps.avatarSuffix,
          round: ""
        }, {
          error: Vue.withCtx(function () {
            return [Vue.createVNode("span", null, Vue.toDisplayString(_ctx.getAvatarText(_ctx.selected.texts[index])), 1
            /* TEXT */
            )];
          }),
          _: 2
        ...
        /* PROPS, DYNAMIC_SLOTS */
        , ["src"])) : (Vue.openBlock(), Vue.createBlock("span", _hoisted_11$1, Vue.toDisplayString(_ctx.getAvatarText(_ctx.selected.texts[index])), 1
        /* TEXT */
        ))], 8
        /* PROPS */
        , ["onClick"]);
      ...
      }, [Vue.createVNode("span", null, Vue.toDisplayString("\u5171" + _ctx.selectedLength + "\u4E2A"), 1
      /* TEXT */
      )])], 64
      /* STABLE_FRAGMENT */
      ))])) : Vue.createCommentVNode("v-if", true), _ctx.rootProps.useSearch ? (Vue.openBlock(), Vue.createBlock(_component_fm_input, {
        key: 1,
        ref: "inputRef",
        "class": "search-input",
        placeholder: "搜索",
      ...
      /* PROPS */
      , ["modelValue", "left-icon", "onKeypress", "onBlur", "onFocus"])) : Vue.createCommentVNode("v-if", true)]), _ctx.showRoot ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_12$1, [Vue.createVNode(_component_fm_icon, {
        "class": "header-portal-icon",
        name: "s-processflow"
      }), Vue.createVNode(_component_fm_cell, {
        title: _ctx.rootProps.navTitle,
        isLink: "",
        onClick: Vue.withModifiers(_ctx.onPortalClick, ["stop"])
      }, null, 8
      /* PROPS */
      , ["title", "onClick"])])) : Vue.createCommentVNode("v-if", true)]);
    }
    ...
    var script$y = Vue.defineComponent({
      name: 'lookup-list',
      components: (_components$q = {}, _components$q[vant.List.name] = vant.List, _components$q),
      props: {
        dataList: {
          type: Array,
          "default": function _default() {
      ...
      setup: function setup(props, _ref) {
        ...
        var upperCaseType = Vue.computed(function () {
    ...
    var _hoisted_6$6 = /*#__PURE__*/Vue.createVNode("span", {
    ...
    function render$x(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      var _component_van_list = Vue.resolveComponent("van-list");

      return _ctx.allDataList && _ctx.allDataList.length > 0 ? (Vue.openBlock(), Vue.createBlock(_component_van_list, {
        key: 0,
        "class": "list",
        ...
        "default": Vue.withCtx(function () {
          return [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.allDataList, function (item, index) {
            return Vue.openBlock(), Vue.createBlock("div", {
            ...
            }, [Vue.createVNode("div", _hoisted_1$l, [_ctx.showChecker(item) ? (Vue.openBlock(), Vue.createBlock(_component_fm_checker, {
              key: 0,
            ...
            /* PROPS */
            , ["disabled", "class", "checked"])) : Vue.createCommentVNode("v-if", true)]), _ctx.showAvatar(item) ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$i, [Vue.createVNode("div", _hoisted_3$c, [_ctx.getValue(item, _ctx.rootProps.avatarField) ? (Vue.openBlock(), Vue.createBlock(_component_fm_image, {
              key: 0,
              "class": "avatar-image",
              ...
              error: Vue.withCtx(function () {
                return [Vue.createVNode("span", null, Vue.toDisplayString(_ctx.getAvatarText(item)), 1
                /* TEXT */
                )];
              }),
              _: 2
            ...
            /* PROPS, DYNAMIC_SLOTS */
            , ["src"])) : (Vue.openBlock(), Vue.createBlock("span", _hoisted_4$a, Vue.toDisplayString(_ctx.getAvatarText(item)), 1
            /* TEXT */
            ))])])) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", {
              ...
              return [Vue.createVNode(_component_fm_cell, {
                ...
                name: "right-icon",
                fn: Vue.withCtx(function () {
                  return [_ctx.showStar(item) ? (Vue.openBlock(), Vue.createBlock("div", {
                    key: 0,
                  ...
                  , ["name"])], 8
                  /* PROPS */
                  , ["onClick"])) : Vue.createCommentVNode("v-if", true), _ctx.showArrow(item) ? (Vue.openBlock(), Vue.createBlock("div", {
                    key: 1,
      ...
      /* PROPS */
      , ["loading", "finished", "onUpdate:loading"])) : (Vue.openBlock(), Vue.createBlock("div", _hoisted_5$7, [Vue.createCommentVNode(" <slot name=\"listviewEmpty\">\r\n    </slot> "), _hoisted_6$6]));
    }
    ...
    var script$z = Vue.defineComponent({
      ...
      setup: function setup() {
        ...
        var selectedTexts = Vue.computed(function () {
    ...
    function render$y(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$m, [Vue.createVNode("div", null, [Vue.renderSlot(_ctx.$slots, "left", {}, function () {
        return [_ctx.leftText ? (Vue.openBlock(), Vue.createBlock("span", {
          key: 0,
          style: {
            "font-size": "16px",
            "color": "#3A90FF"
        ...
        }, Vue.toDisplayString(_ctx.leftText), 1
        /* TEXT */
        )) : Vue.createCommentVNode("v-if", true)];
      })]), Vue.createVNode(_component_fm_button, {
        round: "",
        size: "small",
        onClick: _cache[2] || (_cache[2] = function ($event) {
        ...
        "default": Vue.withCtx(function () {
          return [Vue.createTextVNode(Vue.toDisplayString(_ctx.rightText), 1
          /* TEXT */
          )];
        }),
        _: 1
      ...
      return (Vue.openBlock(), Vue.createBlock("div", {
        ...
        ($props.leftArrow || $props.leftText)
          ? (Vue.openBlock(), Vue.createBlock("div", {
              ...
              Vue.renderSlot(_ctx.$slots, "left", {}, () => [
                ($props.leftArrow)
                  ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_1$n))
                  : Vue.createCommentVNode("v-if", true),
                ($props.leftText)
                  ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_2$j, Vue.toDisplayString($props.leftText), 1 /* TEXT */))
                  : Vue.createCommentVNode("v-if", true)
              ])
            ], 2 /* CLASS */))
          : Vue.createCommentVNode("v-if", true),
        Vue.createVNode("div", _hoisted_3$d, [
        ...
        Vue.createVNode("div", {
          ...
          Vue.renderSlot(_ctx.$slots, "right", {}, () => [
            Vue.createVNode("span", _hoisted_4$b, Vue.toDisplayString($props.rightText), 1 /* TEXT */)
          ])
        ])
      ], 2 /* CLASS */))
    }
    ...
    function render$A(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      var _component_lookup_list = Vue.resolveComponent("lookup-list");

      var _component_fm_popup = Vue.resolveComponent("fm-popup");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$o, [Vue.createVNode(_component_fm_popup, {
        "class": "popup-wrapper",
        show: _ctx.show,
        position: "right",
        zIndex: 100,
    ...
    var script$C = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var innerLoading = Vue.ref(props.loading);
        Vue.watch(function () {
    ...
    function render$B(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$p, [_ctx.showTitle ? (Vue.openBlock(), Vue.createBlock(_component_fm_cell, {
        key: 0,
        title: _ctx.rootProps.title
      }, null, 8
      /* PROPS */
      , ["title"])) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", {
        "class": "list-wrapper",
        style: {
          top: _ctx.showTitle ? '44px' : 0
        }
      }, [Vue.createVNode(_component_lookup_list, {
    ...
    function render$C(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", {
        ...
        /* TEXT, CLASS */
        ), !_ctx.isLast(item.value) ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
          key: 0,
          name: "s-arrow",
          "class": _ctx.bem('breadcrumb-item-icon')
        }, null, 8
        /* PROPS */
        , ["class"])) : Vue.createCommentVNode("v-if", true)], 10
        /* CLASS, PROPS */
        , ["onClick"]);
      }), 128
      /* KEYED_FRAGMENT */
    ...
    var script$E = Vue.defineComponent({
      ...
      setup: function setup(props) {
        ...
        var dataList = Vue.computed(function () {
    ...
    function render$D(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$q, [Vue.createVNode(_component_lookup_list, {
        dataList: _ctx.dataList,
    ...
    function render$E(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$r, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.items, function (item) {
        return Vue.openBlock(), Vue.createBlock("span", {
          "class": ["tabbar-item", {
        ...
        }, Vue.toDisplayString(item.text), 11
        /* TEXT, CLASS, PROPS */
        , ["onClick"]);
      }), 256
      /* UNKEYED_FRAGMENT */
      )), Vue.createCommentVNode(" <span class=\"nav-title selected\">我的收藏</span> ")]);
    }
    ...
    var script$G = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        ...
        var breadcrumbItems = Vue.computed(function () {
        ...
        var breadcrumbShow = Vue.computed(function () {
        ...
        var tabsData = Vue.computed(function () {
          var tmp = [];
        ...
        var tabbarShow = Vue.computed(function () {
          // return true
        ...
        var searchListShow = Vue.ref(false);
        ...
        var currentPanel = Vue.computed(function () {
        ...
        var footerProps = Vue.computed(function () {
        ...
        var _checkAll = Vue.ref(false);

        var checkAll = Vue.computed({
          get: function get() {
    ...
    function render$F(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      var _component_lookup_header = Vue.resolveComponent("lookup-header");

      var _component_lookup_tabbar = Vue.resolveComponent("lookup-tabbar");

      var _component_lookup_breadcrumb = Vue.resolveComponent("lookup-breadcrumb");

      var _component_dynamic_template = Vue.resolveComponent("dynamic-template");

      var _component_lookup_list = Vue.resolveComponent("lookup-list");

      var _component_lookup_personal_panel = Vue.resolveComponent("lookup-personal-panel");

      var _component_lookup_search_panel = Vue.resolveComponent("lookup-search-panel");

      var _component_fm_checker = Vue.resolveComponent("fm-checker");

      var _component_lookup_footer = Vue.resolveComponent("lookup-footer");

      var _component_lookup_selected_panel = Vue.resolveComponent("lookup-selected-panel");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$s, [Vue.createVNode(_component_lookup_header, {
        ref: "headerRef",
      ...
      /* PROPS */
      , ["searchValue", "searchFocused", "subTitle", "isHome", "onSearch", "onBack", "onPortalClick"]), Vue.createVNode("div", _hoisted_2$l, [Vue.withDirectives(Vue.createVNode("div", _hoisted_3$e, [_ctx.tabbarShow ? (Vue.openBlock(), Vue.createBlock(_component_lookup_tabbar, {
        key: 0,
        items: _ctx.tabsData,
      ...
      /* PROPS */
      , ["items", "currentPage"])) : Vue.createCommentVNode("v-if", true), Vue.withDirectives(Vue.createVNode("div", _hoisted_4$c, [_ctx.breadcrumbShow ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_5$8, [Vue.createVNode(_component_lookup_breadcrumb, {
        items: _ctx.breadcrumbItems,
        onItemClick: _ctx.onBreadcrumbClick
      }, null, 8
      /* PROPS */
      , ["items", "onItemClick"])])) : Vue.createCommentVNode("v-if", true), Vue.createVNode("div", {
        "class": "list-wrapper",
        ...
        "default": Vue.withCtx(function (slotProps) {
          return [Vue.renderSlot(_ctx.$slots, "cell", {
            ...
            return [_ctx.serverTemplate ? (Vue.openBlock(), Vue.createBlock(_component_dynamic_template, {
              key: 0,
              props: {
                item: slotProps.item,
                instance: _this
            ...
            /* PROPS */
            , ["props"])) : Vue.createCommentVNode("v-if", true)];
          })];
        }),
        _: 1
        /* STABLE */
      ...
      /* NEED_PATCH */
      ), [[Vue.vShow, !_ctx.loadState.isShowHome && _ctx.currentPage === 'list']]), Vue.withDirectives(Vue.createVNode("div", _hoisted_6$7, [Vue.createVNode(_component_lookup_personal_panel, {
        currentPage: _ctx.currentPage,
        onCellClick: _ctx.onSelect
      }, null, 8
      /* PROPS */
      ...
      /* NEED_PATCH */
      ), [[Vue.vShow, _ctx.loadState.isShowHome || _ctx.currentPage !== 'list']])], 512
      /* NEED_PATCH */
      ), [[Vue.vShow, !_ctx.searchListShow]]), Vue.withDirectives(Vue.createVNode(_component_lookup_search_panel, {
      ...
      /* PROPS */
      , ["loading", "dataList", "finished", "onCellClick"]), [[Vue.vShow, _ctx.searchListShow]])]), _ctx.multiSelect ? (Vue.openBlock(), Vue.createBlock(_component_lookup_footer, {
        key: 0,
      ...
      /* PROPS, DYNAMIC_SLOTS */
      , ["leftText", "rightText", "onLeftClick", "onRightClick"])) : Vue.createCommentVNode("v-if", true), Vue.createVNode(_component_lookup_selected_panel, {
    ...
    var script$H = Vue.defineComponent({
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var displayText = Vue.ref(props.modelValue);
        Vue.watch(function () {
          return props.modelValue;
        ...
        var selecteds = Vue.ref({});
        var lookupPanelRef = Vue.ref();
        var enableShow = Vue.ref(false);
        Vue.watch(enableShow, function (value) {
    ...
    function render$G(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      var _component_fm_lookup_panel = Vue.resolveComponent("fm-lookup-panel");

      var _component_fm_popup = Vue.resolveComponent("fm-popup");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$t, [Vue.renderSlot(_ctx.$slots, "template", {
        displayText: _ctx.displayText,
        click: _ctx.onToggle
      }, function () {
        return [Vue.createVNode(_component_fm_input, {
          ...
          name: "left-icon",
          fn: Vue.withCtx(function () {
            return [Vue.renderSlot(_ctx.$slots, "left-icon")];
          })
        } : undefined, _ctx.$slots['right-icon'] && !_ctx.readonly ? {
          name: "right-icon",
          fn: Vue.withCtx(function () {
            return [Vue.renderSlot(_ctx.$slots, "right-icon")];
          })
        } : undefined, _ctx.$slots.extra ? {
          name: "extra",
          fn: Vue.withCtx(function () {
            return [Vue.renderSlot(_ctx.$slots, "extra")];
          })
        } : undefined, _ctx.$slots.input ? {
          name: "input",
          fn: Vue.withCtx(function () {
            return [Vue.renderSlot(_ctx.$slots, "input", {
        ...
        "default": Vue.withCtx(function () {
          return [Vue.createVNode(_component_fm_lookup_panel, {
            ref: "lookupPanelRef",
            type: _ctx.type,
            title: _ctx.title,
    ...
    function render$H(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$u, [Vue.renderSlot(_ctx.$slots, "template", {
        displayText: _ctx.displayText,
        click: _ctx.onToggle
      }, function () {
        return [Vue.createVNode(_component_fm_input, {
    ...
    var Picker = Vue.defineComponent({
      name: 'fm-picker',
      inheritAttrs: false,
      props: {
      ...
      setup: function setup(props, _ref) {
        var attrs = _ref.attrs,
            ...
            slots = _ref.slots;
        var enableShow = Vue.ref(false);
        var lookupMappingFn = Vue.inject('LookupMappingFn', null);
        ...
        var innerValue = Vue.ref(getInnerValue(props.modelValue));
        Vue.watch(function () {
          return props.modelValue;
        }, function (value) {
        ...
        var columns = Vue.ref(getColumns(props.data));
        Vue.watch(function () {
          return props.data;
        }, function (data) {
        ...
        return function () {
          ...
          return Vue.createVNode("div", {
            "class": "fm-picker"
          }, [Vue.createVNode(Vue.resolveComponent("fm-popup"), {
            "show": enableShow.value,
            "onUpdate:show": function onUpdateShow($event) {
              return enableShow.value = $event;
            },
            "position": "bottom"
          }, _isSlot$4(_slot = Vue.createVNode(Vue.resolveComponent("van-picker"), Vue.mergeProps(slotProps, {
    ...
    var Collapse$1 = Vue.defineComponent({
      name: 'fm-rate',
      setup: function setup(props, context) {
        return function () {
          return Vue.createVNode(Vue.resolveComponent("van-rate"), null, _extends({}, context.slots));
        };
      }
    });
    ...
    var script$K = {
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var hourList = Vue.reactive([]);
        var currentSelectedEvent = Vue.ref({});
        var currentSelectedAllEvent = Vue.ref({});
        var eventInfoRef = Vue.ref(null);
        var showEventInfo = Vue.ref(false);
        ...
        var allDateEvents = Vue.ref([]);
        var hourEvents = Vue.ref([]);
        Vue.watch(function () {
          return props.events;
        }, function () {
        ...
        var eventList = Vue.computed(function () {
    ...
    var _hoisted_6$8 = /*#__PURE__*/Vue.createVNode("div", {
      "class": "label"
    }, [/*#__PURE__*/Vue.createVNode("span", null, "全天")], -1
    /* HOISTED */
    );
    ...
    var _hoisted_9$4 = /*#__PURE__*/Vue.createVNode("div", {
      "class": "left"
    ...
    var _hoisted_19$1 = /*#__PURE__*/Vue.createVNode("div", {
      "class": "left"
    }, [/*#__PURE__*/Vue.createVNode("i", {
      "class": "fm-icon fm-icon-photograph"
    })], -1
    ...
    function render$J(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$v, [Vue.createVNode("div", _hoisted_2$m, [Vue.createVNode("div", _hoisted_3$f, [Vue.renderSlot(_ctx.$slots, "title", {
        events: $props.events
      }, function () {
        return [Vue.createVNode("span", null, Vue.toDisplayString($props.events ? $props.events.length : 0) + "项日程", 1
        /* TEXT */
        )];
      })])]), Vue.createVNode("div", _hoisted_4$d, [Vue.createVNode("div", _hoisted_5$9, [_hoisted_6$8, Vue.createVNode("div", _hoisted_7$4, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.allDateEvents, function (event, index) {
        return Vue.openBlock(), Vue.createBlock("div", {
          key: event.id,
          "class": {
        ...
        /* STYLE */
        ), Vue.createVNode("div", _hoisted_8$4, [Vue.renderSlot(_ctx.$slots, "event", {
          event: event
        }, function () {
          return [_hoisted_9$4, Vue.createVNode("div", _hoisted_10$2, [Vue.createVNode("div", _hoisted_11$2, [Vue.createVNode("span", null, Vue.toDisplayString(event.title), 1
          /* TEXT */
          )]), Vue.createVNode("div", _hoisted_12$2, [Vue.createVNode("span", null, Vue.toDisplayString(event.content), 1
          /* TEXT */
          )])])];
        })])], 10
        /* CLASS, PROPS */
      ...
      /* KEYED_FRAGMENT */
      ))])]), Vue.createVNode("div", _hoisted_13$1, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.hourList, function (hour) {
        return Vue.openBlock(), Vue.createBlock("div", {
          "class": "hour-cell boder-bottom",
          key: hour
        }, [Vue.createVNode("div", _hoisted_14$1, [Vue.createVNode("div", _hoisted_15$1, [Vue.createVNode("span", null, Vue.toDisplayString(hour > 12 ? hour - 12 : hour), 1
        /* TEXT */
        )]), Vue.createVNode("div", _hoisted_16$1, Vue.toDisplayString($setup.getHourState(hour)), 1
        /* TEXT */
        )])]);
      }), 128
      /* KEYED_FRAGMENT */
      )), Vue.createVNode("div", _hoisted_17$1, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.eventList, function (event, index) {
        return Vue.openBlock(), Vue.createBlock("div", {
          key: event.id,
        ...
        /* STYLE */
        ), Vue.createVNode("div", _hoisted_18$1, [Vue.renderSlot(_ctx.$slots, "event", {
          event: event
        }, function () {
          return [_hoisted_19$1, Vue.createVNode("div", _hoisted_20$1, [Vue.createVNode("div", _hoisted_21$1, [Vue.createVNode("span", null, Vue.toDisplayString(event.title), 1
          /* TEXT */
          )]), Vue.createVNode("div", _hoisted_22$1, [Vue.createVNode("span", null, Vue.toDisplayString(event.content), 1
          /* TEXT */
          )])])];
        })])], 14
        /* CLASS, STYLE, PROPS */
      ...
      methods: {
        $_initScroller: function $_initScroller() {
          ...
          if (this.immediateCheckEndReaching) {
            Vue.nextTick(this.$_checkScrollerEnd);
          }
        },
    ...
    function render$L(_ctx, _cache, $props, $setup, $data, $options) {
      return (Vue.openBlock(), Vue.createBlock("div", {
        ...
        (_ctx.$slots.header)
          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$w, [
        ...
        (_ctx.$slots.footer)
          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$n, [
    ...
    var _hoisted_3$g = /*#__PURE__*/Vue.createVNode("svg", {
      viewBox: "25 25 50 50",
    ...
    function render$M(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      }, [Vue.createVNode("div", _hoisted_1$x, [$props.loading ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_2$o, [_hoisted_3$g])) : Vue.createCommentVNode("v-if", true)])], 6
      /* CLASS, STYLE */
      );
    }
    ...
    function render$N(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock(_component_fm_input, {
        ...
        input: Vue.withCtx(function () {
          return [Vue.createVNode(_component_fm_switch, {
    ...
    function render$O(_ctx, _cache, $props, $setup, $data, $options) {
      return (Vue.openBlock(), Vue.createBlock(Vue.Fragment, null, [
        Vue.createCommentVNode(" <transition :name=\"transitionName\">\r\n</transition> "),
    ...
    function render$P(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_fm_icon = Vue.resolveComponent("fm-icon");
      const _component_fm_scroll_view = Vue.resolveComponent("fm-scroll-view");
     ...
     $props.type === 'nav'?'fm-tab-bar-nav':null
        ...
        Vue.createVNode("div", _hoisted_1$y, [
          ($options.scrollable)
            ? (Vue.openBlock(), Vue.createBlock(Vue.Fragment, { key: 0 }, [
                Vue.withDirectives(Vue.createVNode("div", _hoisted_2$p, null, 512 /* NEED_PATCH */), [
                  [Vue.vShow, $data.maskStartShown]
                ]),
                Vue.withDirectives(Vue.createVNode("div", _hoisted_3$h, null, 512 /* NEED_PATCH */), [
                  [Vue.vShow, $data.maskEndShown]
                ])
              ], 64 /* STABLE_FRAGMENT */))
            : Vue.createCommentVNode("v-if", true),
          Vue.createVNode(_component_fm_scroll_view, {
            ref: "scroller",
            ...
            default: Vue.withCtx(() => [
              Vue.createVNode("div", {
                ...
                (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($props.items, (item, index) => {
                ...
                'is-disabled': !!item.disabled
                    ...
                    Vue.renderSlot(_ctx.$slots, "item", {
                      ...
                      ($props.type === 'line')
                        ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_4$e, [
                            Vue.createVNode("span", {
                        ...
                        : ($props.type === 'tab')
                          ? (Vue.openBlock(), Vue.createBlock("div", {
                              ...
                              Vue.createVNode("div", _hoisted_5$a, [
                                (item.name !== $data.currentName || !item.activeIcon)
                                  ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
                                      key: 0,
                                      name: item.icon,
                                ...
                                (item.activeIcon && item.name === $data.currentName)
                                  ...
                                  : Vue.createCommentVNode("v-if", true),
                                (item.dot)
                                  ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_6$9))
                                  : Vue.createCommentVNode("v-if", true),
                                (item.badge)
                                  ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_7$5, Vue.toDisplayString(item.badge), 1 /* TEXT */))
                                  : Vue.createCommentVNode("v-if", true)
                              ]),
                              Vue.createVNode("div", {
                                class: "text",
                          ...
                          : ($props.type === 'nav')
                            ? (Vue.openBlock(), Vue.createBlock("div", {
                                ...
                                Vue.createVNode("div", _hoisted_8$5, [
                                  (item.name !== $data.currentName || !item.activeIcon)
                                    ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
                                        key: 0,
                                        name: item.icon,
                                  ...
                                  (item.activeIcon && item.name === $data.currentName)
                                    ...
                                    : Vue.createCommentVNode("v-if", true),
                                  (item.dot)
                                    ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_9$5))
                                    : Vue.createCommentVNode("v-if", true),
                                  (item.badge)
                                    ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_10$3, Vue.toDisplayString(item.badge), 1 /* TEXT */))
                                    : Vue.createCommentVNode("v-if", true)
                                ]),
                                Vue.createVNode("div", {
                                  class: "text",
                            ...
                            : (Vue.openBlock(), Vue.createBlock("div", _hoisted_11$3, [
                                Vue.createVNode("span", {
                                  textContent: Vue.toDisplayString(item.title)
                                }, null, 8 /* PROPS */, ["textContent"])
                              ]))
    ...
    function render$Q(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_fm_tab_bar = Vue.resolveComponent("fm-tab-bar");

      return (Vue.openBlock(), Vue.createBlock("div", {
        class: ["fm-tabs", {'fm-tabs-fill': $props.fill || $props.type === 'nav', 'fm-tabs-nav': $props.type === 'nav'}]
      }, [
        ($props.type === 'nav')
          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$z, [
              Vue.renderSlot(_ctx.$slots, "default")
            ]))
          : Vue.createCommentVNode("v-if", true),
        Vue.createVNode(_component_fm_tab_bar, {
          ref: "tabBar",
          items: $options.menus,
        ...
        ($props.type !== 'nav')
          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$q, [
              Vue.renderSlot(_ctx.$slots, "default")
            ]))
          : Vue.createCommentVNode("v-if", true)
      ], 2 /* CLASS */))
    ...
    const _hoisted_4$f = /*#__PURE__*/Vue.createVNode("span", { class: "fm-tag-add-text" }, "添加", -1 /* HOISTED */);
    const _hoisted_5$b = {
      key: 1,
    ...
    function render$S(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      $props.checkable?'fm-tags-checkable':''
        ...
        Vue.createVNode("ul", _hoisted_1$A, [
          (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($options.innerValue, (tag, index) => {
            return (Vue.openBlock(), Vue.createBlock("li", {
              key: index,
              class: ["fm-tag-item", [
            ...
            tag.color? 'fm-tag-item-has-color' : ''
              ...
              Vue.createVNode("span", _hoisted_2$r, Vue.toDisplayString(tag.text), 1 /* TEXT */),
              (tag.closable)
                ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_3$i, [
                    Vue.createVNode(_component_fm_icon, {
                      name: "s-clear",
          ...
          ($props.addable && !$data.addInput)
            ? (Vue.openBlock(), Vue.createBlock("li", {
                ...
                Vue.createVNode(_component_fm_icon, { name: "s-plus" }),
                _hoisted_4$f
              ]))
            : Vue.createCommentVNode("v-if", true),
          ($props.addable && $data.addInput)
            ? (Vue.openBlock(), Vue.createBlock("li", _hoisted_5$b, [
                Vue.withDirectives(Vue.createVNode("input", {
                  ...
                  [Vue.vModelText, $data.addTagValue]
                ])
              ]))
            : Vue.createCommentVNode("v-if", true)
        ])
    ...
    function render$T(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$B, [Vue.createVNode("div", _hoisted_2$s, Vue.toDisplayString($props.label), 1
      /* TEXT */
      ), Vue.createVNode("div", _hoisted_3$j, Vue.toDisplayString($options.innnerValue), 1
      /* TEXT */
      )]);
    }
    ...
    const _hoisted_2$t = /*#__PURE__*/Vue.createVNode("svg", {
      viewBox: "25 25 50 50",
      ...
      return (_ctx.show)
        ? (Vue.openBlock(), Vue.createBlock("div", {
          ...
          'fm-icon-warningmessage': (this.type == 'warning' || this.type == 'info')
              ...
              : Vue.createCommentVNode("v-if", true),
            (this.type == 'loading')
              ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_1$C, [
                  _hoisted_2$t
                ]))
              : Vue.createCommentVNode("v-if", true),
            Vue.createVNode("span", _hoisted_3$k, Vue.toDisplayString(_ctx.message), 1 /* TEXT */)
          ], 2 /* CLASS */))
        : Vue.createCommentVNode("v-if", true)
    }
    ...
    var initInstance$3 = function initInstance() {
      ...
      var _mountComponent = mountComponent({
        setup: function setup() {
          ...
          return function () {
            return Vue.createVNode(script$U, Object.assign(Object.assign({}, state), {
              'onUpdate:show': toggle
            }), null);
          };
        }
    ...
    const _hoisted_10$4 = /*#__PURE__*/Vue.createVNode("span", { class: "line-inner" }, null, -1 /* HOISTED */);
    ...
    function render$V(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      'fm-steps-fill': $props.fill
        ...
        Vue.createVNode("ul", _hoisted_1$D, [
          (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($props.steps, (step, index) => {
            return (Vue.openBlock(), Vue.createBlock(Vue.Fragment, null, [
              Vue.createVNode("li", {
                class: ["fm-steps-item", {
            ...
            'fm-steps-item-current': index == $props.current
                ...
                Vue.createVNode("div", _hoisted_2$u, [
                  (step.icon)
                    ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
                        key: 0,
                        name: step.icon
                    ...
                    : (index < $props.current)
                      ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_3$l))
                      : (Vue.openBlock(), Vue.createBlock("span", _hoisted_4$g, Vue.toDisplayString(index+1), 1 /* TEXT */))
                ]),
                Vue.createVNode("div", _hoisted_5$c, [
                  Vue.renderSlot(_ctx.$slots, "default", {
                    step: step,
                    index: index,
                    currentIndex: $props.current
                  }, () => [
                    Vue.createVNode("div", _hoisted_6$a, Vue.toDisplayString(step.name), 1 /* TEXT */),
                    (step.desc)
                      ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_7$6, Vue.toDisplayString(step.desc), 1 /* TEXT */))
                      : Vue.createCommentVNode("v-if", true),
                    (step.subDesc)
                      ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_8$6, Vue.toDisplayString(step.subDesc), 1 /* TEXT */))
                      : Vue.createCommentVNode("v-if", true)
                  ])
                ]),
                ($props.direction == 'vertical' && index < ($props.steps.length - 1))
                  ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_9$6))
                  : Vue.createCommentVNode("v-if", true)
              ], 2 /* CLASS */),
    ...
    var script$W = {
      ...
      setup: function setup(props, _ref) {
        ...
        var handleBeforeClose = function handleBeforeClose(type) {
          if ((dragStatus == null ? void 0 : dragStatus.value) === exports.DragStatus.NotStarted) {
            return;
          }
        ...
        Vue.watch(closed, function (value) {
        ...
        Vue.watch(offset, function (_ref2) {
    ...
    var script$Y = {
      ...
      setup: function setup(props, _ref) {
        var slots = _ref.slots;
        var contentStyle = Vue.ref({});
        var contentRef = Vue.ref();
        var show = Vue.ref(!props.collapse);
        Vue.watch(function () {
          return props.collapse;
        }, function (value) {
          toggleShow(!value);
    ...
    function render$Y(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$E, [$setup.showHeader ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$v, [Vue.renderSlot(_ctx.$slots, "header", {
        title: $props.title,
        icon: $props.icon,
      ...
      }, [Vue.createVNode("div", _hoisted_3$m, [Vue.renderSlot(_ctx.$slots, "default")], 512
      /* NEED_PATCH */
      )], 4
      /* STYLE */
      ), $setup.showFooter ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_4$h, [Vue.renderSlot(_ctx.$slots, "footer", {}, function () {
        return [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($props.actions, function (action) {
          return Vue.openBlock(), Vue.createBlock(_component_fm_button, {
            type: "action.type",
            block: "",
            plain: "",
            ...
            "default": Vue.withCtx(function () {
              ...
              /* PROPS */
              , ["name"]), Vue.createVNode("span", _hoisted_5$d, Vue.toDisplayString(action.text), 1
              /* TEXT */
              )];
            }),
            _: 2
    ...
    function render$Z(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return $data.isShow ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$F, [Vue.createVNode("div", {
        "class": ["fm-notice-bar-left", [!$options.customLeft && !$props.icon && 'fm-notice-bar-empty']]
      }, [$options.customLeft ? Vue.renderSlot(_ctx.$slots, "left", {
        key: 0
      }) : $props.icon ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
        key: 1,
      ...
      /* PROPS */
      , ["name"])) : Vue.createCommentVNode("v-if", true)], 2
      /* CLASS */
      ), Vue.createVNode("div", {
      ...
      /* CLASS */
      ), Vue.createVNode("div", _hoisted_2$w, [$options.customRight ? Vue.renderSlot(_ctx.$slots, "right", {
        key: 0
      }) : $props.mode || $props.closable ? (Vue.openBlock(), Vue.createBlock(_component_fm_icon, {
        key: 1,
      ...
      /* PROPS */
      , ["name", "onClick"])) : Vue.createCommentVNode("v-if", true)])])) : Vue.createCommentVNode("v-if", true);
    }
    ...
    var script$_ = {
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var currentName = Vue.ref(props.modelValue);
        var currentIndex = Vue.ref(0);
        var items = Vue.reactive([]);
        var itemDoms = Vue.reactive([]);
        var sidebarContent = Vue.ref(null);
        var sidebarList = Vue.ref(null);
        var clickChange = Vue.ref(false);
        var itemRefs = [];
        ...
        Vue.watch(currentIndex, function (value) {
    ...
    function render$_(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$G, [Vue.createVNode("div", {
        "class": "fm-sidebar-list",
        style: {
          'width': $props.sidebarWidth + 'px'
        },
        ref: "sidebarList"
      }, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.menus, function (item, index) {
        return Vue.openBlock(), Vue.createBlock("div", {
        ...
        }, [Vue.createVNode("span", _hoisted_2$x, Vue.toDisplayString(item.title), 1
        /* TEXT */
        )], 10
        /* CLASS, PROPS */
        , ["onClick"]);
      ...
      /* STYLE */
      ), Vue.createVNode("div", _hoisted_3$n, [Vue.renderSlot(_ctx.$slots, "default")], 512
      /* NEED_PATCH */
      )]);
    }
    ...
    var Parchment = Quill__default['default']["import"]('parchment');
    ...
    Quill__default['default'].register('formats/customSize', SizeStyle);
    Quill__default['default'].register('formats/customColor', ColorStyle);
    var toolbarHandlers = {
    ...
    var script$10 = Vue.defineComponent({
      ...
      setup: function setup(props) {
        var quillRef = Vue.inject(quillToken, Vue.ref(null));
        ...
        Vue.watch(quillRef, function (quill) {
          quill == null ? void 0 : quill.on('selection-change', handlerSelectionChange);
        });
        var colorList = Vue.ref(['#000000', '#e60000', '#ff9900', '#008a00', '#0066cc', '#9933ff']);
        var currentColor = Vue.ref('#000000');
        var fontSize = Vue.ref(14);
        var sliderRef = Vue.ref(null); // 创建事件
    ...
    var _hoisted_6$b = /*#__PURE__*/Vue.createVNode("button", {
      style: {
        "width": "35px"
      }
    }, "Aa", -1
    ...
    function render$10(_ctx, _cache, $props, $setup, $data, $options) {
      var _component_van_slider = Vue.resolveComponent("van-slider");

      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$H, [_hoisted_2$y, Vue.createVNode("div", _hoisted_4$i, [_hoisted_5$e, Vue.createVNode("div", {
        ...
        onMousedown: _cache[3] || (_cache[3] = Vue.withModifiers(function () {}, ["stop"])),
        onMouseup: _cache[4] || (_cache[4] = Vue.withModifiers(function () {}, ["stop"]))
      }, [Vue.createVNode(_component_van_slider, {
      ...
      , ["value"]), _hoisted_6$b]), Vue.createVNode("div", _hoisted_7$7, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(_ctx.colorList, function (color, index) {
        return Vue.openBlock(), Vue.createBlock("button", {
    ...
    var script$11 = {
      ...
      setup: function setup(props, _ref) {
        var emit = _ref.emit;
        var rootRef = Vue.ref();
        var editorRef = Vue.ref();
        var toolbarRef = Vue.ref();
        var hasFocus = Vue.ref(false);
        var editorContent = null;
        var compositionStatus = 'end';
        var quill;
        var quillRef = Vue.ref(null);
        Vue.provide(quillToken, quillRef);
        Vue.watch(function () {
          return props.modelValue;
        }, function (html) {
        ...
        var initEditor = function initEditor() {
          ...
          var editorEl = Vue.unref(editorRef);

          if (!editorEl) {
            return;
          }

          quillRef.value = quill = new Quill__default['default'](editorEl, {
            theme: props.theme,
            readOnly: props.readonly,
            debug: props.debug,
            placeholder: props.placeholder,
            modules: {
              toolbar: {
                container: Vue.unref(toolbarRef),
                handlers: toolbarHandlers
              }
            }
          });
          editorContent = (_unref = Vue.unref(editorRef)) == null ? void 0 : _unref.querySelector('.ql-editor');
    ...
    function render$11(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$I, [Vue.createVNode("div", {
    ...
    function render$12(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_fm_icon = Vue.resolveComponent("fm-icon");
      const _component_fm_popup = Vue.resolveComponent("fm-popup");

      return (Vue.openBlock(), Vue.createBlock(_component_fm_popup, {
        show: $props.show,
        ...
        default: Vue.withCtx(() => [
          ($props.title || $props.closeable)
            ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$J, [
                Vue.createVNode("span", _hoisted_2$A, Vue.toDisplayString($props.title), 1 /* TEXT */),
                Vue.createVNode("div", {
                  ...
                  Vue.renderSlot(_ctx.$slots, "cancel", {}, () => [
                    Vue.createVNode(_component_fm_icon, { name: "s-cross" })
                  ])
                ])
              ]))
            : Vue.createCommentVNode("v-if", true),
          ($props.description)
            ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_3$o, [
                Vue.renderSlot(_ctx.$slots, "description", {}, () => [
                  Vue.createVNode("div", _hoisted_4$j, Vue.toDisplayString($props.description), 1 /* TEXT */)
                ])
              ]))
            : Vue.createCommentVNode("v-if", true),
          Vue.createVNode("div", _hoisted_5$f, [
            Vue.renderSlot(_ctx.$slots, "default", {}, () => [
              (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($props.actions, (action, index) => {
                return (Vue.openBlock(), Vue.createBlock("div", {
            ...
            action.className
                  ...
                  }, Vue.toDisplayString(action.name), 5 /* TEXT, STYLE */),
                  (action.subname)
                    ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_6$c, Vue.toDisplayString(action.subname), 1 /* TEXT */))
                    : Vue.createCommentVNode("v-if", true)
                ], 10 /* CLASS, PROPS */, ["onClick"]))
              }), 128 /* KEYED_FRAGMENT */))
            ])
          ...
          ($props.cancelText)
            ? (Vue.openBlock(), Vue.createBlock("div", {
                ...
                Vue.createVNode("div", _hoisted_7$8, Vue.toDisplayString($props.cancelText), 1 /* TEXT */)
              ]))
            : Vue.createCommentVNode("v-if", true)
        ]),
        _: 3 /* FORWARDED */
    ...
    var script$13 = {
      ...
      setup: function setup(props, _ref) {
        ...
        var shareOptions = Vue.computed(function () {
          var result = [];
    ...
    function render$13(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (Vue.openBlock(), Vue.createBlock(_component_fm_popup, {
        ...
        default: Vue.withCtx(() => [
          ($props.title)
            ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$K, [
                Vue.renderSlot(_ctx.$slots, "title", {}, () => [
                  Vue.createVNode("span", _hoisted_2$B, Vue.toDisplayString($props.title), 1 /* TEXT */)
                ]),
                ($props.description)
                  ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_3$p, [
                      Vue.renderSlot(_ctx.$slots, "description", {}, () => [
                        Vue.createTextVNode(Vue.toDisplayString($props.description), 1 /* TEXT */)
                      ])
                    ]))
                  : Vue.createCommentVNode("v-if", true)
              ]))
            : Vue.createCommentVNode("v-if", true),
          (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.shareOptions, (shareItem, i) => {
            return (Vue.openBlock(), Vue.createBlock("div", {
        ...
        i !== 0? 'fm-sharesheet-options-border':null
              ...
              (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList(shareItem, (item, index) => {
                return (Vue.openBlock(), Vue.createBlock("div", {
                  ...
                  Vue.createVNode("span", _hoisted_4$k, Vue.toDisplayString(item.name), 1 /* TEXT */),
                  (item.description)
                    ? (Vue.openBlock(), Vue.createBlock("span", _hoisted_5$g, Vue.toDisplayString(item.description), 1 /* TEXT */))
                    : Vue.createCommentVNode("v-if", true)
                ], 10 /* CLASS, PROPS */, ["onClick"]))
              }), 128 /* KEYED_FRAGMENT */))
            ], 2 /* CLASS */))
          ...
          ($props.cancelText)
            ? (Vue.openBlock(), Vue.createBlock("div", {
                ...
                Vue.createVNode("div", _hoisted_6$d, Vue.toDisplayString($props.cancelText), 1 /* TEXT */)
              ]))
            : Vue.createCommentVNode("v-if", true)
        ]),
        _: 1 /* STABLE */
    ...
    var script$14 = {
      ...
      setup: function setup(props, _ref) {
        ...
        var innerDiscussionListData = Vue.computed(function () {
    ...
    const _hoisted_7$9 = /*#__PURE__*/Vue.createTextVNode(" 回复 ");
    const _hoisted_8$7 = { class: "list-item-reply-name" };
    const _hoisted_9$7 = /*#__PURE__*/Vue.createTextVNode("： ");
    const _hoisted_10$5 = { class: "list-item-buttom" };

    function render$14(_ctx, _cache, $props, $setup, $data, $options) {
      return (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$L, [
        (Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.innerDiscussionListData, (item, index) => {
          return (Vue.openBlock(), Vue.createBlock("div", {
            ...
            Vue.createVNode("div", _hoisted_3$q, [
              Vue.createVNode("div", _hoisted_4$l, Vue.toDisplayString(item.userName), 1 /* TEXT */),
              Vue.createVNode("div", {
                class: "list-item-text",
                innerHTML: item.text
              }, null, 8 /* PROPS */, ["innerHTML"]),
              (item.parentData)
                ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_5$h, [
                    Vue.createVNode("span", _hoisted_6$e, [
                      _hoisted_7$9,
                      Vue.createVNode("span", _hoisted_8$7, Vue.toDisplayString(item.parentData.userName), 1 /* TEXT */),
                      _hoisted_9$7
                    ]),
                    Vue.createVNode("span", {
                ...
                : Vue.createCommentVNode("v-if", true),
              Vue.createVNode("div", _hoisted_10$5, [
    ...
    var script$15 = {
      ...
      setup: function setup(props, _ref) {
        ...
        var editorContent = Vue.ref(null); //评论ref dom

        var lookupValue = Vue.ref(''); //人员帮助数据
    ...
    const _hoisted_3$r = /*#__PURE__*/Vue.createTextVNode(" 回复: ");
    ...
    const _hoisted_7$a = /*#__PURE__*/Vue.createTextVNode("提交");

    function render$15(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_fm_lookup_input = Vue.resolveComponent("fm-lookup-input");
      const _component_fm_button = Vue.resolveComponent("fm-button");

      return (Vue.openBlock(), Vue.createBlock("div", _hoisted_1$M, [
        ($props.replyUser && $props.replyUser.id)
          ? (Vue.openBlock(), Vue.createBlock("div", _hoisted_2$D, [
              _hoisted_3$r,
              Vue.createVNode("span", _hoisted_4$m, Vue.toDisplayString($props.replyUser.userName), 1 /* TEXT */)
            ]))
          : Vue.createCommentVNode("v-if", true),
        Vue.createVNode("div", _hoisted_5$i, [
          Vue.createVNode("div", {
          ...
          Vue.createVNode("div", _hoisted_6$f, [
            Vue.createVNode(_component_fm_lookup_input, {
              ...
              template: Vue.withCtx((slotProps) => [
                Vue.createVNode("div", {
    ...
    function render$16(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock("div", _hoisted_1$N, [Vue.createVNode("div", {
        "class": ["fm-swipe-box", {
      ...
      /* CLASS, STYLE, HYDRATE_EVENTS */
        ...
        return [$setup.count > 1 && $props.showIndicators ? (Vue.openBlock(), Vue.createBlock("div", {
          key: 0,
          "class": ["fm-swipe-indicators", {
            'fm-swipe-indicators-vertical': $props.vertical
          }]
        }, [(Vue.openBlock(true), Vue.createBlock(Vue.Fragment, null, Vue.renderList($setup.count, function (countitem, index) {
          return Vue.openBlock(), Vue.createBlock("div", {
            key: countitem,
    ...
    var script$17 = {
      name: 'fm-swipe-item',
      setup: function setup() {
        var rootSwipe = Vue.inject('rootSwipe');
        var internalInstance = Vue.getCurrentInstance();
        Vue.onBeforeMount(function () {
    ...
    function render$17(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.openBlock(), Vue.createBlock("div", {
        "class": "fm-swipe-item",
        style: $setup.style
      }, [$setup.shouldRender ? Vue.renderSlot(_ctx.$slots, "default", {
        key: 0
    ...
    var _hoisted_5$j = /*#__PURE__*/Vue.createTextVNode("的 ");
    ...
    function render$18(_ctx, _cache, $props, $setup, $data, $options) {
      return Vue.renderSlot(_ctx.$slots, "default", {}, function () {
        return [Vue.createVNode("div", _hoisted_1$O, [Vue.createVNode("div", _hoisted_2$E, [Vue.createVNode("img", {
          src: $props.staffImage,
          alt: "",
          "class": "fm-staff-card-img"
        }, null, 8
        /* PROPS */
        , ["src"])]), Vue.createVNode("div", _hoisted_3$s, [Vue.createVNode("div", _hoisted_4$n, [Vue.createVNode("span", null, Vue.toDisplayString($props.staffName), 1
        /* TEXT */
        ), _hoisted_5$j, Vue.createVNode("span", _hoisted_6$g, "【" + Vue.toDisplayString($props.title) + "】", 1
        /* TEXT */
        )]), Vue.createVNode("div", _hoisted_7$b, Vue.toDisplayString($props.departmentName), 1
        /* TEXT */
        )])])];
      });
    }
    ...
    exports.ActionBar = script$3;
    exports.Button = script$1;
    exports.Calendar = script$8;
    exports.CalendarInput = script$9;
    exports.Cell = script$a;
    exports.Checkbox = script$c;
    exports.Collapse = Collapse;
    exports.DatePicker = DatePicker;
    exports.Dialog = Dialog;
    exports.Filter = script$s;
    exports.FilterPanel = script$o;
    exports.HtmlPanel = script$X;
    exports.Icon = script;
    exports.Image = script$t;
    exports.Listview = script$u;
    exports.Loading = Loading;
    exports.LookupInput = script$H;
    exports.LookupPanel = script$G;
    exports.Navbar = script$A;
    exports.NoticeBar = script$Z;
    exports.Notify = Notify;
    exports.Overlay = Overlay;
    exports.Picker = Picker;
    exports.Popover = script$2;
    exports.Popup = Popup;
    exports.Radio = script$J;
    exports.Rate = Collapse$1;
    exports.Schedule = script$K;
    exports.ScrollView = script$L;
    exports.Search = script$q;
    exports.StaffCard = script$18;
    exports.Steps = script$V;
    exports.Swipe = script$16;
    exports.SwipeItem = script$17;
    exports.Swipecell = script$W;
    exports.Switch = script$M;
    exports.SwitchCell = script$N;
    exports.Tab = script$O;
    exports.TabBar = script$P;
    exports.Tabs = script$Q;
    exports.Tag = script$R;
    exports.Tags = script$S;
    exports.Text = script$T;
    exports.Toast = Toast;
    ...
    exports.useMd5 = useMd5;
    exports.usePopupState = usePopupState;
    exports.useRootProps = useRootProps;

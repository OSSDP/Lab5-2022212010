System.register(['vue', 'dayjs', '@vue/compiler-core', 'vant', 'quill'], function (exports) {
    'use strict';
    var ref, watch, unref, onMounted, nextTick, onActivated, onUnmounted, onDeactivated, getCurrentInstance, reactive, createApp, defineComponent, Vue, inject, provide, openBlock, createBlock, resolveComponent, createCommentVNode, renderSlot, toDisplayString, createVNode, computed, Fragment, withCtx, renderList, withModifiers, withDirectives, vModelText, vModelDynamic, createTextVNode, useContext, mergeProps, isVNode, Transition, vShow, Teleport, resolveDynamicComponent, createSlots, onBeforeUpdate, onBeforeMount, createStaticVNode, onBeforeUnmount, dayjs, helperNameMap, RESOLVE_COMPONENT, RESOLVE_DIRECTIVE, assert, TO_DISPLAY_STRING, CREATE_COMMENT, WITH_DIRECTIVES, OPEN_BLOCK, CREATE_BLOCK, CREATE_VNODE, WITH_CTX, isSimpleIdentifier, SET_BLOCK_TRACKING, baseParse, getBaseTransformPreset, transform, DatetimePicker, List, Quill;
    return {
        setters: [function (module) {
            ...
            helperNameMap = module.helperNameMap;
            RESOLVE_COMPONENT = module.RESOLVE_COMPONENT;
            RESOLVE_DIRECTIVE = module.RESOLVE_DIRECTIVE;
            assert = module.assert;
            TO_DISPLAY_STRING = module.TO_DISPLAY_STRING;
            CREATE_COMMENT = module.CREATE_COMMENT;
            WITH_DIRECTIVES = module.WITH_DIRECTIVES;
            OPEN_BLOCK = module.OPEN_BLOCK;
            CREATE_BLOCK = module.CREATE_BLOCK;
            CREATE_VNODE = module.CREATE_VNODE;
            WITH_CTX = module.WITH_CTX;
            isSimpleIdentifier = module.isSimpleIdentifier;
            SET_BLOCK_TRACKING = module.SET_BLOCK_TRACKING;
            baseParse = module.baseParse;
            getBaseTransformPreset = module.getBaseTransformPreset;
        ...
        execute: function () {
            ...
            exports({
                ...
                useDynamicTemplate: useDynamicTemplate,
            ...
            })(DragStatus || (DragStatus = exports('DragStatus', {})));
            ...
            var useElementRect = exports('useElementRect', function useElementRect(el) {
              var rect = ref();
            ...
            var dynamicTemplate = exports('dynamicTemplate', defineComponent({
            ...
            var stateSymbol = exports('stateSymbol', Symbol('state'));
            var createState = exports('createState', function createState(initState) {
              return reactive(initState);
            });
            var useState = exports('useState', function useState(key) {
              return inject(key ? key : stateSymbol);
            });
            var provideState = exports('provideState', function provideState(key, initState) {
              if (initState === void 0) {
                initState = {};
              }
            ...
            var b64pad = '';
            var chrsz = 8;
            var useMd5 = exports('useMd5', function useMd5() {
              return {
                md5: md5,
                hex_md5: hex_md5,
                b64_md5: b64_md5,
            ...
            var useRootProps = exports('useRootProps', function useRootProps(key, props) {
            ...
            var script$2 = exports('Popover', defineComponent({
              name: 'fm-popover',
              props: {
                value: {
                  type: Boolean,
            ...
            var _components$1;
            var script$3 = exports('ActionBar', {
              name: 'fm-action-bar',
            ...
            function render$4(_ctx, _cache, $props, $setup, $data, $options) {
              ...
              }, [createVNode("div", _hoisted_1$3, [createVNode("div", _hoisted_2$3, [createVNode("span", null, toDisplayString(_ctx.isCurrentDay(_ctx.day.date) ? '今' : _ctx.day.text), 1
              /* TEXT */
            ...
            var _components$5;
            var script$8 = exports('Calendar', defineComponent({
              name: 'fm-calendar',
            ...
            function render$8(_ctx, _cache, $props, $setup, $data, $options) {
              ...
              /* PROPS */
              , ["theme", "currentDate", "title", "view", "prevText", "nextText", "dayLabels", "onPrevClick", "onNextClick"]), createVNode("div", _hoisted_1$7, [_ctx.offset.offsetX > 50 ? (openBlock(), createBlock("div", _hoisted_2$6, "上一页")) : createCommentVNode("v-if", true), createVNode("div", {
              ...
              /* STYLE */
              ), _ctx.offset.offsetX < -50 ? (openBlock(), createBlock("div", _hoisted_3$5, "下一页")) : createCommentVNode("v-if", true), _ctx.theme === 'form' ? (openBlock(), createBlock("div", _hoisted_4$4, toDisplayString(_ctx.currentDate.month + 1), 1
              /* TEXT */
            ...
            var _hoisted_2$7 = /*#__PURE__*/createTextVNode(" 确定 ");
            var __default__ = {
              name: 'fm-calendar-input'
            };
            var script$9 = exports('CalendarInput', defineComponent(_extends({}, __default__, {
              expose: [],
            ...
            ***************************************************************************** */
            ...
            var Collapse = exports('Collapse', defineComponent({
              name: 'fm-collapse',
              props: {
                isInner: Boolean,
                collapse: {
            ...
            var Overlay = exports('Overlay', defineComponent({
              name: 'fm-overlay',
              props: {
                show: Boolean,
            ...
            var Popup = exports('Popup', defineComponent({
              name: 'fm-popup',
            ...
            var _components$9;
            var DatePicker = exports('DatePicker', defineComponent({
            ...
            var _components$j;
            var script$o = exports('FilterPanel', {
            ...
            var _hoisted_5$3 = /*#__PURE__*/createTextVNode("重置");

            var _hoisted_6$3 = /*#__PURE__*/createTextVNode("确定");
            ...
            function render$n(_ctx, _cache, $props, $setup, $data, $options) {
              ...
              /* PROPS */
              , ["filterList", "filterData", "hasClear", "onChange"])]), createVNode("div", _hoisted_3$7, [createCommentVNode(" <div class=\"button\" @click=\"onReset\">重置</div>\r\n      <div class=\"button bgc-blue\" @click=\"onConfirm\">确定</div> "), createVNode("div", _hoisted_4$5, [createVNode(_component_fm_button, {
                "class": "button",
                plain: "",
                round: "",
            ...
            var _components$m;
            var script$s = exports('Filter', defineComponent({
              name: 'fm-filter',
              inheritAttrs: false,
            ...
            var _components$u;
            var script$G = exports('LookupPanel', defineComponent({
            ...
            var _components$v;
            var script$H = exports('LookupInput', defineComponent({
            ...
            var Picker = exports('Picker', defineComponent({
              name: 'fm-picker',
              inheritAttrs: false,
              props: {
            ...
            var Collapse$1 = exports('Rate', defineComponent({
              name: 'fm-rate',
            ...
            var script$L = exports('ScrollView', {
              name: 'fm-scroll-view',
              props: {
                scrollingX: {
                  type: Boolean,
            ...
            var script$N = exports('SwitchCell', {
              name: 'fm-switch-cell',
              props: {
                modelValue: {
                  type: Boolean || String,
            ...
            const _hoisted_4$f = /*#__PURE__*/createVNode("span", { class: "fm-tag-add-text" }, "添加", -1 /* HOISTED */);
            const _hoisted_5$b = {
              key: 1,
            ...
            var script$W = exports('Swipecell', {
              name: 'fm-swipecell',
              props: {
                name: {
                  type: [Number, String],
            ...
            var script$X = exports('HtmlPanel', {
              name: 'fm-html',
              props: {
                html: {
                  type: String,
            ...
            var _components$C;
            var script$Z = exports('NoticeBar', {
              name: 'fm-notice-bar',
            ...
            const _hoisted_7$9 = /*#__PURE__*/createTextVNode(" 回复 ");
            ...
            const _hoisted_3$r = /*#__PURE__*/createTextVNode(" 回复: ");
            ...
            const _hoisted_7$a = /*#__PURE__*/createTextVNode("提交");
            ...
            var script$17 = exports('SwipeItem', {
              name: 'fm-swipe-item',
              setup: function setup() {
            ...
            var script$18 = exports('StaffCard', {
              name: 'fm-staff-card',
              props: {
                staffName: {
                  type: String
            ...
            var _hoisted_5$j = /*#__PURE__*/createTextVNode("的 ");

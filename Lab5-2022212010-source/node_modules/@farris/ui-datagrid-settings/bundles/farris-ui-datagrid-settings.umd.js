(function (global, factory) {
    ...
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['ui-datagrid-settings'] = {}), global.rxjs.operators, global.rxjs, global.ng.core, global.uiModal, global.uiMessager, global.uiLocale, global.ng.forms, global.uiTreetable, global.uiNotify, global.uiDatagrid, global.lodashEs, global.uiCommon, global.uiMultiSelect, global.ng.common, global.uiComboList, global.uiSwitch, global.uiTooltip, global.uiOrganizationSelector, global.smoothDnd, global.uiLanguageTextbox));
}(this, function (exports, operators, rxjs, core, uiModal, uiMessager, uiLocale, forms, uiTreetable, uiNotify, uiDatagrid, lodashEs, uiCommon, uiMultiSelect, common, uiComboList, uiSwitch, uiTooltip, uiOrganizationSelector, smoothDnd, uiLanguageTextbox) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NewHeaderFormComponent = /** @class */ (function () {
        ...
        NewHeaderFormComponent.propDecorators = {
            ...
            input: [{ type: core.ViewChild, args: ['txt',] }]
        };
    ...
    function mergetColumnOptions(viewCols, gridInitOptions) {
        if (viewCols && gridInitOptions) {
            /** @type {?} */
            var dataFields_1 = lodashEs.flatten(gridInitOptions['designerColumns']);
            /** @type {?} */
            var _cols = lodashEs.cloneDeep(viewCols).map((/**
             * @param {?} cols
             * @return {?}
             */
            function (cols) {
    ...
    function multiHeadersHasDataFields(multiHeaderColumns) {
        if (multiHeaderColumns && multiHeaderColumns.length) {
            return lodashEs.flatten(multiHeaderColumns).filter((/**
             * @param {?} n
             * @return {?}
             */
    ...
    function getDataFieldsForMultiHeaders(groupHeaderCols) {
        return lodashEs.flatten(groupHeaderCols).filter((/**
         * @param {?} n
         * @return {?}
         */
    ...
    var ColumnTreeComponent = /** @class */ (function () {
        ...
        function () {
            ...
            /** @type {?} */
            var allDataFields = lodashEs.flatten(groupHeaders).filter((/**
             * @param {?} col
             * @return {?}
             */
        ...
        function () {
            ...
            if (this.options.columns && this.options.columns.length > 1) {
                /** @type {?} */
                var _treeData = columnsToTreeNodes(lodashEs.cloneDeep(this.options.columns));
                /** @type {?} */
                var houXuanLie = this.fields.filter((/**
                 * @param {?} f
                 * @return {?}
                 */
                function (f) { return !lodashEs.flatten(_this.options.columns).find((/**
                 * @param {?} col
                 * @return {?}
                 */
        ...
        ColumnTreeComponent.propDecorators = {
            ...
            inModal: [{ type: core.Input }],
            nodeSelected: [{ type: core.Output }],
            cellTemp: [{ type: core.ViewChild, args: ['nodeTemplate',] }],
    ...
    var ColumnFormatSettingComponent = /** @class */ (function () {
        ...
        ColumnFormatSettingComponent.propDecorators = {
            ...
            groupHeadersRef: [{ type: core.ViewChild, args: ['gh',] }],
            formatChange: [{ type: core.Output }],
            fieldsChange: [{ type: core.Output }],
            multiHeaderOptions: [{ type: core.Input }],
            enableMultipleHeaders: [{ type: core.Input }]
        };
    ...
    var DatagridSettingsComponent = /** @class */ (function () {
        function DatagridSettingsComponent(cd, inject) {
            ...
            this.render2 = this.inject.get(core.Renderer2, null);
            this.notifySer = this.inject.get(uiNotify.NotifyService, null);
            this.searchItems = [
        ...
        DatagridSettingsComponent.propDecorators = {
            ...
            activeTab: [{ type: core.ViewChild, args: ['activeTab',] }],
            colFormatSettings: [{ type: core.ViewChild, args: ['colFormatSettings',] }]
        };
    ...
    var SimpleColumnsComponent = /** @class */ (function () {
        function SimpleColumnsComponent(injector, cd) {
             ...
             * 分组表头确定事件
             */
            this.submitForGroupHeader = new core.EventEmitter();
            this.closed = new core.EventEmitter();
            this.advanced = new core.EventEmitter();
            this.canceld = new core.EventEmitter();
            ...
            this.schemeChanged = new core.EventEmitter();
            this.allCols = [];
            this.columnType = 'all';
            this.isEn = false;
        ...
        function () {
            ...
            if (this.gridInstance.enableScheme) {
                if (!this.prevSchemeItem) {
                    this.prevSchemeItem = lodashEs.cloneDeep(this.currentSchemeItem);
                }
        ...
        SimpleColumnsComponent.propDecorators = {
            ...
            multiHeaderRef: [{ type: core.ViewChild, args: ['gh',] }],
            formatChange: [{ type: core.Output }],
            fieldsChange: [{ type: core.Output }],
            submit: [{ type: core.Output }],
            submitForGroupHeader: [{ type: core.Output }],
            closed: [{ type: core.Output }],
            advanced: [{ type: core.Output }],
            canceld: [{ type: core.Output }],
            addNewScheme: [{ type: core.Output }],
            showSchemeList: [{ type: core.Output }],
            activeItemChange: [{ type: core.Output }],
            schemeChanged: [{ type: core.Output }],
    ...
    var DatagridSchemeService = /** @class */ (function () {
         ...
         */
        function (uri, perfix) {
            return uiCommon.appendPerfixForUri ? uiCommon.appendPerfixForUri(uri, perfix) : uri;
        };
        /**
         * @private
         * @return {?}
        ...
        function () {
            /** @type {?} */
            var idService = new uiCommon.IdService();
        ...
        function (configs) {
            this.currentSchemeSettings = {
                ...
                values: lodashEs.cloneDeep(configs)
            };
        };
        /**
         * @return {?}
    ...
    var SchemeListComponent = /** @class */ (function () {
        ...
        SchemeListComponent.propDecorators = {
            ...
            currentSchemeId: [{ type: core.Input }],
            header: [{ type: core.ViewChild, args: ['header',] }],
    ...
    var DatagridSettingsService = /** @class */ (function () {
        ...
        function (dgId, activeItem) {
            ...
            if (activeItem) {
                this.activeSchemeItem[schemekey] = lodashEs.cloneDeep(activeItem);
            }
            else {
        ...
        function (gridInstance, settings, selectedSchemeItem) {
            ...
            if (this.cfr) {
                ...
                if (gridInstance.enableScheme) {
                    ...
                    if (settings) {
                        ...
                        if (!simpleRef_1.instance['prevSchemeItem'] && this.prevSchemeItem) {
                            simpleRef_1.instance['prevSchemeItem'] = lodashEs.cloneDeep(this.prevSchemeItem);
                        }
                        if (selectedSchemeItem) {
                            ...
                            if (_currentSchemtItem) {
                                ...
                                this.prevSchemeItem = lodashEs.cloneDeep(_currentSchemtItem);
                 ...
                 */
                function () {
                    _this.getSchemeList(gridInstance.id).pipe(operators.switchMap((/**
                     * @param {?} t
                     * @return {?}
                     */
                    function (t) {
                    ...
                    function (t) {
                        ...
                        _this.showSchemeListDialog(gridInstance, lodashEs.cloneDeep(t.list || []), t, simpleRef_1);
                    }));
                }));
                ...
                function (t) {
                    ...
                    _this.setActiveSchemeItem(gridInstance.id, lodashEs.cloneDeep(t));
                }));
        ...
        function (gridInstance, opts, selectedSchemeItem) {
            ...
            function (n) { return n.field && n.field !== gridInstance.ControlPanelFeild; }));
            /** @type {?} */
            var sortFields = getDataFieldsForMultiHeaders(lodashEs.cloneDeep(columns)).filter((/**
             * @param {?} n
             * @return {?}
             */
            function (n) { return n.field.indexOf('farris-datagrid-column_') == -1 && n.sortable; }));
            ...
            function (e) {
                ...
                _this.showSimple(gridInstance, { sortInfo: sortInfo, viewColumns: viewColumns, columnFormat: columnFormat, groupField: groupField, multiHeaders: multiHeaders }, lodashEs.cloneDeep(selectedSchemeItem));
            }));
            /** @type {?} */
        ...
        function (key, isMultiHeader) {
            ...
            if (this.httpRestService) {
                ...
                return rxjs.of(this.getLocalSettings(key, isMultiHeader));
            }
        };
        /**
         * @param {?} key
        ...
        function (gridId, data, isNewScheme, currentSettings) {
            ...
            if (!data.name) {
                // msg 请输入方案名称
                return rxjs.of({ flag: false, msg: 'required.schemeName' });
            }
            else {
                /** @type {?} */
                ...
                if (typeof hasName === 'boolean' && hasName) {
                    // msg '方案名称已存在，请修改。'
                    return rxjs.of({ flag: false, msg: 'has.exist' });
                }
                    ...
                    if (hasName.includes(this.localeSer.localeId)) {
                        ...
                        return rxjs.of({ flag: false, msg: msg });
                    }
                    else {
                        /** @type {?} */
            ...
            if (data.type && data.type === 'org' && (!data.orgids || !data.orgids.length)) {
                // msg '请选择组织'
                return rxjs.of({ flag: false, msg: 'required.org' });
            }
            /** @type {?} */
            var _config = null;
            if (!isNewScheme) {
            ...
            return this.schemeService.saveScheme(scheme, gridId, false, gridInstance.enableSetMultiHeaders).pipe(operators.map((/**
             * @return {?}
             */
            function () {
                return scheme;
    ...
    var ColumnGroupSettingComponent = /** @class */ (function () {
        function ColumnGroupSettingComponent(injector, gridSettingComponentRef, cd) {
            ...
            this.expandGroupRowsChange = new core.EventEmitter();
            // 分组列
            this.groupColumns = [];
            // 所有允许分组列
        ...
        ColumnGroupSettingComponent.propDecorators = {
            ...
            expandGroupRows: [{ type: core.Input }],
            enabelGroupFooter: [{ type: core.Input }],
            groupFieldsChange: [{ type: core.Output }],
            formatColumnsChange: [{ type: core.Output }],
            expandGroupRowsChange: [{ type: core.Output }],
    ...
    var FarrisDblClickDirective = /** @class */ (function () {
        ...
        function () {
            ...
            /** @type {?} */
            var leftClick$ = rxjs.fromEvent(this.el.nativeElement, 'click').pipe(operators.filter((/**
             * @param {?} event
             * @return {?}
             */
            ...
            var bufferGate$ = rxjs.race(debounce$, clickLimit$)
                .pipe(operators.first(), operators.repeat());
            this._click$ = leftClick$.pipe(operators.buffer(bufferGate$), operators.filter((/**
             * @param {?} clicks
             * @return {?}
             */
            function (clicks) {
        ...
        FarrisDblClickDirective.propDecorators = {
            options: [{ type: core.Input, args: ['f-dbl-click',] }],
    ...
    var PreviewMultiHeadersComponent = /** @class */ (function () {
        ...
        PreviewMultiHeadersComponent.propDecorators = {
            previewGroupColumns: [{ type: core.Input }]
        };
    ...
    var ShowPreviewDirective = /** @class */ (function () {
        ...
        ShowPreviewDirective.propDecorators = {
            treeIns: [{ type: core.Input, args: ['preview-headers',] }],
            dlgTitle: [{ type: core.Input }],
            onPreviewBtnClick: [{ type: core.HostListener, args: ['click', ['$event'],] }]
        };
    ...
    exports.ColumnTreeComponent = ColumnTreeComponent;
    ...
    exports.FarrisDblClickDirective = FarrisDblClickDirective;
    exports.GRID_SETTINGS_WEBAPI = GRID_SETTINGS_WEBAPI;
    exports.IS_MULTI_HEADER_STRING = IS_MULTI_HEADER_STRING;
    exports.NewHeaderFormComponent = NewHeaderFormComponent;
    exports.NewSchemeComponent = NewSchemeComponent;
    exports.PreviewMultiHeadersComponent = PreviewMultiHeadersComponent;
    exports.SchemeListComponent = SchemeListComponent;
    exports.SetColumnsComponent = SetColumnsComponent;
    exports.ShowPreviewDirective = ShowPreviewDirective;

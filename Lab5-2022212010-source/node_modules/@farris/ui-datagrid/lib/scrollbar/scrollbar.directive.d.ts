...
import { ScrollbarConfigInterface } from './scrollbar.interfaces';
export declare class ScrollbarDirective implements OnInit, OnDestroy, DoCheck, OnChanges, AfterViewInit {
    private zone;
    private differs;
    elementRef: ElementRef;
    private platformId;
    private defaults;
    instance: PerfectScrollbar | null;
    private ro;
    private timeout;
    private animation;
    private configDiff;
    ...
    disabled: boolean;
    config?: ScrollbarConfigInterface;
    ...
    constructor(zone: NgZone, differs: KeyValueDiffers, elementRef: ElementRef, platformId: any, defaults: ScrollbarConfigInterface);
    ngOnInit(): void;

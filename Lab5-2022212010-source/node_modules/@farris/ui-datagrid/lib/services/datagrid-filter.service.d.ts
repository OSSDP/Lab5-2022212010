...
import { DataColumn, ColumnFilter, FilterCondition as ClientFilterCondition } from '../types/data-column';
export declare class DatagridFilterService {
    ...
    validateRowData(rowData: any, conditions: {
        [field: string]: ClientFilterCondition;
    }): boolean;
    ...
    private checkEnumTypeFilters;
    private convertEnumTypeFilter;

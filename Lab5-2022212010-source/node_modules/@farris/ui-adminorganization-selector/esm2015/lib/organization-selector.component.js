...
export class AdminOrganizationSelectorComponent {
    ...
    assembleFinalText() {
        ...
        (item, index) => {
            ...
            /** @type {?} */
            let finalText = '';
            if (this.orgNameType == 'short') {
                finalText = formatedName ? formatedName : (item['abbreviation'] ? item['abbreviation'] : item[this.displayField]);
            }
            else {
                finalText = formatedName ? formatedName : item[this.displayField];
            }
    ...
    listenSelectionsChange() {
        ...
        data => {
            ...
            this.onlyParentFinalText && this.assembleParentFinal();
     ...
     * @return {?}
     */
    removeItem(data, index, event) {
        if (this.selections.length > 0) {
            if (this.onlyParentFinalText) {
                /** @type {?} */
                let removeIndex = this.selections.findIndex((/**
                 * @param {?} item
                 * @return {?}
                 */
                item => item['id'] == data['id']));
                /** @type {?} */
                let removeData = this.selections.splice(removeIndex, 1);
                if (data.children.length) {
                    /** @type {?} */
                    const afterRemoveChild = this.selections.filter((/**
                     * @param {?} item
                     * @return {?}
                     */
                    item => !item.path.startsWith(removeData[0].path)));
    ...
    assembleParentFinal() {
        ...
        (item, index) => {
            /** @type {?} */
            let highLayerOrg = this.selections.filter((/**
             * @param {?} data
             * @return {?}
             */
            data => item.path.startsWith(data.path) && item.path != data.path));
            /** @type {?} */
            let targetLayer;
            ...
            /** @type {?} */
            let highLayerOrgIndex = this.selections.findIndex((/**
             * @param {?} data
             * @return {?}
             */
            data => item.path.startsWith(data.path) && item.path != data.path && data.layer == targetLayer));
            if (highLayerOrgIndex > -1) {
                /** @type {?} */
                let parentIndex = this.parentFinal.findIndex((/**
                 * @param {?} p
                 * @return {?}
                 */
                p => p.id == this.selections[highLayerOrgIndex].id));
                if (parentIndex > -1) {
                    this.parentFinal[parentIndex]['children'].push(this.finalText[index]);
                }
                else {
                    this.parentFinal.push(Object.assign({}, {
                        id: this.selections[highLayerOrgIndex]['id'],
                        path: this.selections[highLayerOrgIndex]['path'],
                        name: this.finalText[highLayerOrgIndex],
                        children: [this.finalText[index]]
                    }));
                }
            }
            else {
        ...
        item => {
            if (item.children.length > 10) {
                /** @type {?} */
                let firstChilds = item.children.slice(0, 5).concat(['……']);
                /** @type {?} */
                let lastChilds = item.children.slice(-5);
...
/** @nocollapse */
AdminOrganizationSelectorComponent.ctorParameters = () => [
    { type: Renderer2 },
    { type: Injector },
    { type: FavoritesTool },
    { type: ApiService },
...
//# sourceMappingURL=data:application/json;base64,
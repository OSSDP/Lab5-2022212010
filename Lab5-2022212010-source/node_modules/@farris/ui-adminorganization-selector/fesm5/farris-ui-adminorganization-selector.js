    ...
    function () {
        ...
        function (data) {
            if (data.changeType === ChangeType.ValueChanged) {
                _this.selections = cloneDeep(data.value);
            }
    ...
    function AdminOrganizationSelectorComponent(render, injector, favoritesTool, apiService, ngZone, stateMgr) {
        ...
        function () {
            ...
            if (_this.confirmToken) {
                _this.originalSelections = cloneDeep(_this.selections);
            }
            else {
                _this.selections = cloneDeep(_this.originalSelections);
            }
...
var SelectionComponent = /** @class */ (function () {
    ...
    function () {
        ...
        function (data) {
            _this.pageIndex = 0;
            if (data.changeType === ChangeType.ValueChanged) {
                _this.datas = cloneDeep(data.value);
            }
            else if (data.changeType === ChangeType.Remove) {

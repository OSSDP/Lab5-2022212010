...
import { Injectable, Component, Input, ChangeDetectorRef, Injector, ViewChild, HostBinding, NgZone, EventEmitter, Optional, Output, forwardRef, Renderer2, NgModule } from '@angular/core';
...
class CommonUtil {
     ...
     * @return {?} 位置索引
     */
    static findIndex(value, field, array) {
        if (!field || !value) {
 ...
 */
/** @type {?} */
const ORGANIZATION_SELECTOR_LOCALE = {
    "zh-CHS": {
...
class AppendGroupOrgComponent {
    ...
    toggleChecked(e) {
        ...
        this.currentOrgs = cloneDeep(checkeds);
    ...
    toggleSelected(e) {
        ...
        this.currentOrgs = cloneDeep(selected);
        if (this.currentOrgs.length == 0) {
            this.orgTree.clearCheckeds();
            this.orgTree.clearSelections();
            this.orgTree.detectChanges();
    ...
    ngOnInit() {
        ...
        data => {
            if (data.changeType === ChangeType.ValueChanged) {
                this.selections = cloneDeep(data.value);
            }
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class AdminOrganizationSelectorComponent {
    /**
     * @param {?} render
     * @param {?} injector
     * @param {?} favoritesTool
    ...
    constructor(render, injector, favoritesTool, apiService, ngZone, stateMgr) {
        ...
        () => {
            ...
            if (this.confirmToken) {
                this.originalSelections = cloneDeep(this.selections);
            }
            else {
                this.selections = cloneDeep(this.originalSelections);
            }
...
class SelectionComponent {
    ...
    ngOnInit() {
        ...
        data => {
            this.pageIndex = 0;
            if (data.changeType === ChangeType.ValueChanged) {
                this.datas = cloneDeep(data.value);
            }
            else if (data.changeType === ChangeType.Remove) {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class AdminOrganizationSelectorModule {
}
...
/**
 * @fileoverview added by tsickle
 * Generated from: farris-ui-adminorganization-selector.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */

export { ApiService, FavoritesTool, StateMgrTool, AdminOrganizationSelectorComponent, AdminOrganizationSelectorModule, OrganizationComponent, SearchComponent, SelectionComponent, FavoritesComponent, AppendGroupOrgComponent as ɵb, GroupComponent as ɵa };

//# sourceMappingURL=farris-ui-adminorganization-selector.js.map
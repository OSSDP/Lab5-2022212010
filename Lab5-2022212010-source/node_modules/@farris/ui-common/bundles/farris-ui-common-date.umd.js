(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('date-fns'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-common/date', ['exports', 'date-fns', '@angular/common', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-common'] = global.farris['ui-common'] || {}, global.farris['ui-common'].date = {}),global.dateFns,global.ng.common,global.ng.core));
}(this, (function (exports,dateFns,common,i0) { 'use strict';
    ...
    var DateTimeHelperService = /** @class */ (function () {
         ...
         */
            function (dateLeft, dateRight) {
                return dateFns.differenceInMinutes(dateLeft, dateRight);
            };
        /**
         ...
         */
            function (value, fmt) {
                ...
                if (value instanceof Date) {
                    return dateFns.format(value, fmt);
                }
                /** @type {?} */
                var _d = dateFns.parseISO(value);
                if (_d == "Invalid Date") {
                    _d = this.createDate(value) || new Date(value);
                }
                // const d = parseISO(value);
                if (dateFns.isValid(_d)) {
                    /** @type {?} */
                    var d = dateFns.parseISO(dateFns.format(_d, "yyyy-MM-dd HH:mm:ss"));
                    return dateFns.format(d, fmt);
                }
                else {
                     ...
                     */function (n) { return n !== ""; }))
                        ...
                        /** @type {?} */
                        var fullDateTime = dateFns.parseISO("2022-11-25 " + _time);
                        return dateFns.format(fullDateTime, fmt);
                    }
                    return "";
                }
            };
    ...
    var DateTimeFormatPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        DateTimeFormatPipe.ctorParameters = function () {
            return [
    ...
    exports.DateTimeHelperService = DateTimeHelperService;
...
//# sourceMappingURL=farris-ui-common-date.umd.js.map
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bignumber.js'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-common/number', ['exports', 'bignumber.js', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-common'] = global.farris['ui-common'] || {}, global.farris['ui-common'].number = {}),global.bignumber_js,global.ng.core));
}(this, (function (exports,bignumber_js,i0) { 'use strict';
    ...
    var NumberHelperService = /** @class */ (function () {
         ...
         */
            function (n1, n2) {
                ...
                if (Array.isArray(n1)) {
                    return bignumber_js.BigNumber.max.apply(null, n1).toFixed();
                }
                else {
                    if (n1 && n2) {
                        return bignumber_js.BigNumber.maximum(n1, n2).toFixed();
                    }
                    else {
         ...
         */
            function (n1, n2) {
                ...
                if (Array.isArray(n1)) {
                    return bignumber_js.BigNumber.min.apply(null, n1).toFixed();
                }
                else {
                    if (n1 && n2) {
                        return bignumber_js.BigNumber.minimum(n1, n2).toFixed();
                    }
                    else {
                        console.error("\u8BF7\u63D0\u4F9B\u6BD4\u8F83\u7684\u503Cn1\u3001n2.");
                    }
         ...
         */
            function (n1) {
                return bignumber_js.BigNumber.sum.apply(null, n1).toFixed();
            };
        /** 平均数 */
        /**
         * 平均数
         ...
         */
            function (n1, len) {
                return new bignumber_js.BigNumber(n1).div(len).toFixed();
            };
        /**  加法 */
        /**
         * 加法
         ...
         */
            function (n1, n2) {
                return new bignumber_js.BigNumber(n1).plus(n2).toFixed();
            };
        /** 乘法 */
        /**
         * 乘法
         ...
         */
            function (n1, n2) {
                new bignumber_js.BigNumber(n1).times(n2).toFixed();
            };
        /** 减法 */
        /**
         * 减法
         ...
         */
            function (n1, n2) {
                return new bignumber_js.BigNumber(n1).minus(n2).toFixed();
            };
        /** 是否相等 */
        /**
         * 是否相等
         ...
         */
            function (n1, n2) {
                return new bignumber_js.BigNumber(n1).eq(n2);
            };
        /**
         * @param {?} n1
         * @param {?} n2
         ...
         */
            function (n1, n2) {
                return new bignumber_js.BigNumber(n1).lt(n2);
            };
        /**
         * @param {?} n1
         * @param {?} n2
         ...
         */
            function (n1, n2) {
                return new bignumber_js.BigNumber(n1).gt(n2);
            };
        /**
         * @param {?} n1
         * @return {?}
         ...
         */
            function (n1) {
                return new bignumber_js.BigNumber(n1).toNumber();
            };
        /**
         * @param {?} n1
         * @param {?=} precision
         ...
         */
            function (n1, precision) {
                ...
                return new bignumber_js.BigNumber(n1).toFixed(precision);
            };
        /**
         * @param {?} money
         * @return {?}
         ...
         */
            function (value, opts) {
                /** @type {?} */
                var bignum = new bignumber_js.BigNumber(value);
                /** @type {?} */
                var fmt = {
                    prefix: opts.prefix || '',
                    suffix: opts.suffix || '',
    ...
    exports.NumberHelperService = NumberHelperService;
    exports.NumberHelperModule = NumberHelperModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-common-number.umd.js.map
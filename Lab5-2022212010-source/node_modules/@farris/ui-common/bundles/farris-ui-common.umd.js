(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('resize-observer-polyfill'), require('@farris/ui-common/column'), require('@angular/platform-browser'), require('lodash-es'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-common', ['exports', 'resize-observer-polyfill', '@farris/ui-common/column', '@angular/platform-browser', 'lodash-es', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-common'] = {}),global.ResizeObserver,global.farris['ui-common'].column,global.ng.platformBrowser,global.lodashEs,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,ResizeObserver,column,platformBrowser,lodashEs,rxjs,operators,i0) { 'use strict';
    ...
    var FarrisTemplateDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FarrisTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
        FarrisTemplateDirective.propDecorators = {
            type: [{ type: i0.Input }],
            name: [{ type: i0.Input, args: ['farrisTemplate',] }]
        };
    ...
    ***************************************************************************** */
    ...
    var ResizeObserverDirective = /** @class */ (function () {
        ...
        ResizeObserverDirective.propDecorators = {
            target: [{ type: i0.Input, args: ['resizeObserver',] }],
    ...
    var FarrisComponentTemplateDirective = /** @class */ (function () {
        ...
        FarrisComponentTemplateDirective.decorators = [
            { type: i0.Directive, args: [{ selector: '[component-template]' },] }
        ];
        /** @nocollapse */
        FarrisComponentTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.Injector },
                { type: i0.ElementRef },
        ...
        FarrisComponentTemplateDirective.propDecorators = {
            column: [{ type: i0.Input, args: ['component-template',] }],
            cmpRef: [{ type: i0.Input }],
            ctx: [{ type: i0.Input }],
            renderContext: [{ type: i0.Input }],
    ...
    var CommonUtils = /** @class */ (function () {
        function CommonUtils() {
            this.cfs = null;
            if (!this.cfs) {
                this.cfs = new column.ColumnFormatService(null, null);
            }
        }
        /**
         * @param {?} field
         ...
         */
            function (styleSheetId) {
                ...
                try {
                    ...
                    try {
                        if (styleSheets_1_1 && !styleSheets_1_1.done && (_a = styleSheets_1.return))
                            _a.call(styleSheets_1);
                    }
                    finally {
                        if (e_1)
                            throw e_1.error;
         ...
         */
            function (rules, styleSheet) {
                ...
                try {
                    ...
                    try {
                        if (rules_2_1 && !rules_2_1.done && (_a = rules_2.return))
                            _a.call(rules_2);
                    }
                    finally {
                        if (e_3)
         ...
         */
            function (ruleName, styleSheet) {
                ...
                try {
                    ...
                    try {
                        if (cssRules_1_1 && !cssRules_1_1.done && (_a = cssRules_1.return))
                            _a.call(cssRules_1);
                    }
                    finally {
                        if (e_4)
    ...
    var FarrisSafePipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        FarrisSafePipe.ctorParameters = function () {
            return [
    ...
    var FarrisReplaceXPipe = /** @class */ (function () {
        ...
        FarrisReplaceXPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'replaceX' },] }
        ];
    ...
    var RuntimeStateService = /** @class */ (function () {
        function RuntimeStateService(utils) {
            ...
            this.form$ = this.state$.pipe(operators.map(( /**
             * @param {?} state
             * @return {?}
             */function (state) { return state.form; })));
            this.lookupIsPending$ = this.form$.pipe(operators.map(( /**
             * @param {?} f
             * @return {?}
             */function (f) { return f.lookup.pending; })));
            this._state = lodashEs.cloneDeep(DefaultRuntimeState);
         ...
         */
            function (newVal) {
                if (newVal) {
                    this._state = lodashEs.merge(this._state, newVal);
        ...
        /** @nocollapse */
        RuntimeStateService.ctorParameters = function () {
            return [
                { type: CommonUtils }
            ];
        };
        /** @nocollapse */ RuntimeStateService.ngInjectableDef = i0.defineInjectable({ factory: function RuntimeStateService_Factory() { return new RuntimeStateService(i0.inject(CommonUtils)); }, token: RuntimeStateService, providedIn: "root" });
    ...
    var GetValuePipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        GetValuePipe.ctorParameters = function () {
            return [
                { type: CommonUtils }
            ];
        };
     ...
     */ BaseDataFacadeService = /** @class */ (function () {
        function BaseDataFacadeService(_initState) {
            ...
            this.store = new rxjs.BehaviorSubject(this._state);
            this.state$ = this.store.asObservable();
            this.data$ = this.state$.pipe(operators.map(( /**
             * @param {?} state
             * @return {?}
    ...
    var DebugService = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                if (!this.debugSub) {
                    this.debugSub = rxjs.fromEvent(document.body, 'keydown').pipe(operators.takeUntil(this.destroy$)).subscribe(( /**
                     * @param {?} e
                     * @return {?}
                     */function (e) {
     ...
     */
    /** @type {?} */
    var WEBAPI_PREFIX_TOKEN = new i0.InjectionToken('web api prefix string.');
    /**
     * @param {?} uri
     * @param {?=} perfix
     * @return {?}
    ...
    exports.FarrisComponentTemplateDirective = FarrisComponentTemplateDirective;
    exports.CommonUtils = CommonUtils;
    exports.FarrisSafePipe = FarrisSafePipe;
    exports.FarrisCommonModule = FarrisCommonModule;
    exports.IdService = IdService;
    exports.BaseDataFacadeService = BaseDataFacadeService;
    exports.RuntimeStateService = RuntimeStateService;
    exports.FarrisComponentInstanceService = FarrisComponentInstanceService;
    exports.DebugService = DebugService;
    exports.OverLayHiddenService = OverLayHiddenService;
    exports.FarrisReplaceXPipe = FarrisReplaceXPipe;
    exports.cancelRequestAnimationFrame = cancelRequestAnimationFrame;
    exports.reqAnimFrame = reqAnimFrame;
    exports.Convert2HtmlEditorToolbars = Convert2HtmlEditorToolbars;
    exports.RICH_COMMANDS = RICH_COMMANDS;
    exports.GetValuePipe = GetValuePipe;
    exports.appendPerfixForUri = appendPerfixForUri;
    exports.WEBAPI_PREFIX_TOKEN = WEBAPI_PREFIX_TOKEN;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-common.umd.js.map
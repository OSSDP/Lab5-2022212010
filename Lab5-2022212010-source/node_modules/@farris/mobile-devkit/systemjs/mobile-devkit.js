System.register(['rxjs', 'rxjs/operators', 'axios', 'reflect-metadata', 'date-fns', 'dayjs', '@farris/expression-engine'], function (exports) {
    'use strict';
    var of, from, Observable, isObservable$1, forkJoin, BehaviorSubject, EMPTY$1, Subject, switchMap, map, shareReplay, tap, catchError, concatMap, every, take, throwIfEmpty, takeLast, axios, format, parseISO, isDate, isEqual$1, compareAsc, dayjs, Expression$1, ExpressionEngine, ExpressionContext;
    return {
        setters: [function (module) {
            of = module.of;
            from = module.from;
            Observable = module.Observable;
            isObservable$1 = module.isObservable;
            ...
            Expression$1 = module.Expression;
            ExpressionEngine = module.ExpressionEngine;
            ExpressionContext = module.ExpressionContext;
        }],
        execute: function () {

            exports({
                BackEndMessage: void 0,
                ...
                ɵa: getClosureSafeProperty,
                ɵc: createInjectionToken
            });
            ...
            ***************************************************************************** */
             ...
             * 注入器抽象类
             */
            var Injector = function (v) { return exports({ Injector: v, ɵb: v }), v; }(/** @class */ (function () {
                function Injector() {
                }
                return Injector;
            }()));
            ...
            var ɵ0 = exports('ɵ0', getClosureSafeProperty);
            var USE_VALUE = exports('USE_VALUE', getClosureSafeProperty({ provide: String, useValue: ɵ0 }));
             ...
             * 环境工具类
             */
            var EnvUtil = exports('EnvUtil', /** @class */ (function () {
                function EnvUtil() {
                }
                /**
                 * 是否在任务中心中运行
             ...
             * Url工具类
             */
            var UrlUtil = exports('UrlUtil', /** @class */ (function () {
                function UrlUtil() {
                }
                /**
                 * 获取参数对象
            ...
            var ENTITY_META = exports('ENTITY_META', 'EntityMeta');
            /**
             * 实体装饰器
             */
             ...
             * 表单模块路径
             */
            var VALIDATION_RULE_TOKEN = exports('VALIDATION_RULE_TOKEN', new InjectionToken('@Farris validation rule'));
             ...
             * UIState属性元数据名称
             */
            var CONTROLSTATE_PROP_META = exports('CONTROLSTATE_PROP_META', 'ControlStatePropMeta');
            var ɵ0$2 = function (obj) { return obj; };
            /**
             * UIState属性元数据装饰器工厂
             */
            var ControlStatePropMeta = exports('ControlStatePropMeta', makePropDecorator(CONTROLSTATE_PROP_META, ɵ0$2));
             ...
             * UIState属性元数据装饰器工厂
             */
            var UIStatePropMeta = exports('UIStatePropMeta', makePropDecorator(UISTATE_PROP_META, ɵ0$3));
             ...
             * 命令处理器扩展注入Token
             */
            var CONTROL_STATE_INTERCEPTOR_TOKEN = exports('CONTROL_STATE_INTERCEPTOR_TOKEN', createInjectionToken('@farris/devkit CONTROL_STATE_INTERCEPTOR_TOKEN'));
            var InitContext = exports('InitContext', /** @class */ (function () {
                function InitContext() {
                }
                return InitContext;
            }()));
            var InterceptContext = exports('InterceptContext', /** @class */ (function () {
                function InterceptContext() {
                }
                return InterceptContext;
            }()));
            var ProcessContext = exports('ProcessContext', /** @class */ (function () {
             ...
             * 状态拦截器服务
             */
            var ControlStateInterceptorService = exports('ControlStateInterceptorService', /** @class */ (function () {
             ...
             * 页面状态元数据装饰器工厂
             */
            var StatePropMeta = exports('StatePropMeta', makePropDecorator(STATE_PROP_META, ɵ0$4));
             ...
             * 组件状态元数据工厂
             */
            var RenderStatePropMeta = exports('RenderStatePropMeta', makePropDecorator(RENDER_STATE_PROP_META, ɵ0$5));
             ...
             * 迁移动作元数据装饰工厂
             */
            var ActionMethodMeta = exports('ActionMethodMeta', makePropDecorator(ACTION_METHOD_META, ɵ0$6));
             ...
             * FormControl装饰器工厂
             */
            var FormControlPropMeta = exports('FormControlPropMeta', makePropDecorator(FORM_CONTROL_PROP_META, ɵ0$7));

            /**
             * 验证器工厂
             */
            var ValidatorFactory = exports('ValidatorFactory', /** @class */ (function () {
             ...
             * 命令装饰器工厂
             */
            var CommandMethodMeta = exports('CommandMethodMeta', makePropDecorator(COMMAND_METHOD_META, ɵ0$8));

            var RESOLVER_TOKEN = exports('RESOLVER_TOKEN', new InjectionToken('@farris_resolver_token'));
            var ENTITY_TEMPLATE = exports('ENTITY_TEMPLATE', 'ENTITY~');
            var STATE_TEMPLATE = exports('STATE_TEMPLATE', 'STATE~');
            var GROUP_FUNCTIONS = exports('GROUP_FUNCTIONS', ['SumByProp', 'CountByProp', 'AvgByProp', 'MaxByProp', 'MinByProp', 'IsExistRecord', 'ListContains', 'ListGreaterThan', 'ListLessThan', 'ListStartWith', 'ListEndWith']);

            var ResolverRegistry = exports('ResolverRegistry', /** @class */ (function () {
            ...
            var EntityDependencyResolver = exports('EntityDependencyResolver', /** @class */ (function () {
            ...
            var StateDependencyResolver = exports('StateDependencyResolver', /** @class */ (function () {
             ...
             * 用户自定义参数解析器
             */
            var CommentDependencyResolver = exports('CommentDependencyResolver', /** @class */ (function () {
            ...
            var ResolveService = exports('ResolveService', /** @class */ (function () {
            ...
            var ExpressionUtil = exports('ExpressionUtil', /** @class */ (function () {
            ...
            var Core = exports('Core', /** @class */ (function () {
                function Core() {
                }
            ...
            var FORM_PATH_TOKEN = exports('FORM_PATH_TOKEN', new InjectionToken('@farris/devkit form path token'));
            var BACK_END_MESSAGE_HANDLER_TOKEN = exports('BACK_END_MESSAGE_HANDLER_TOKEN', new InjectionToken('@farris/devkit_back_end_message_handler'));
            var MESSAGE_SERVICE_TOKEN = exports('MESSAGE_SERVICE_TOKEN', new InjectionToken('@farris/message_service_token'));
            var NOTIFY_SERVICE_TOKEN = exports('NOTIFY_SERVICE_TOKEN', new InjectionToken('@farris/notify_service_token'));
            var NAMESPACE = exports('NAMESPACE', new InjectionToken('@farris/devkit NAMESPACE'));

            // export type ClassType = new (...args: any[]) => any;
            var BigNumberType = exports('BigNumberType', 'BigNumber');
            /**
             * 后端消息
             */
            ...
            (function (BackEndMessage) {
                ...
                })(BackEndMessage.Level || (BackEndMessage.Level = {}));
                /**
                 * 消息
            ...
            })(BackEndMessage || (BackEndMessage = exports('BackEndMessage', {})));

            var EFFECTOR_TOKEN = exports('EFFECTOR_TOKEN', new InjectionToken('@farris/effector_token'));

            /**
             * 实体副作用器
             * @description 将表达式计算结果赋值给实体属性
             */
            var RepositoryEffector = exports('RepositoryEffector', /** @class */ (function () {
            ...
            var UIStateEffector = exports('UIStateEffector', /** @class */ (function () {
            ...
            var EffectorRegistry = exports('EffectorRegistry', /** @class */ (function () {
            ...
            (function (Expression) {
                ...
                })(Expression.ExpressionBindingType || (Expression.ExpressionBindingType = {}));
            ...
            })(Expression || (Expression = exports('Expression', {})));

            var LISTENER_TOKEN = exports('LISTENER_TOKEN', new InjectionToken('@Farris listener'));

            /**
             * 变更监听器
             */
            var ChangeListener = exports('ɵe', /** @class */ (function () {
             ...
             * 监听UIState变更
             */
            var UIStateChangeListener = exports('UIStateChangeListener', /** @class */ (function (_super) {
            ...
            var RepositoryChangeListener = exports('RepositoryChangeListener', /** @class */ (function (_super) {
            ...
            var ListenerRegistry = exports('ListenerRegistry', /** @class */ (function () {
                /**
                 * 构造函数
                 */
             ...
             */
            var BindingDataChangeListener = exports('BindingDataChangeListener', /** @class */ (function (_super) {
             ...
             */
            var Listeners = exports('Listeners', /** @class */ (function () {
                /**
                 * 构造函数
                 */
             ...
             * 3、数据加载
             */
            var ExpressionEventEmitter = exports('ExpressionEventEmitter', /** @class */ (function () {
            ...
            var FORM_MANIFEST_SERVICE_TOKEN = exports('FORM_MANIFEST_SERVICE_TOKEN', new InjectionToken('@farris/form_manifest_service'));
            var FORM_EXPRESSION_MANIFEST_SERVICE_TOKEN = exports('FORM_EXPRESSION_MANIFEST_SERVICE_TOKEN', new InjectionToken('@farris/form_expression_manifest_service'));

            var ExpressionRegistry = exports('ExpressionRegistry', /** @class */ (function () {
            ...
            var ExpressionExecutor = exports('ExpressionExecutor', /** @class */ (function () {
            ...
            var EventHandler = exports('EventHandler', /** @class */ (function () {
             ...
             * 实体值变化处理器
             */
            var EntityValueChangedEventHandler = exports('EntityValueChangedEventHandler', /** @class */ (function (_super) {
            ...
            var StateValueChangedEventHandler = exports('StateValueChangedEventHandler', /** @class */ (function (_super) {
            ...
            var RepositoryAddEntityEventHandler = exports('RepositoryAddEntityEventHandler', /** @class */ (function (_super) {
            ...
            var RepositoryRemoveEntityEventHandler = exports('RepositoryRemoveEntityEventHandler', /** @class */ (function (_super) {
            ...
            var RepositoryLoadEventHandler = exports('RepositoryLoadEventHandler', /** @class */ (function (_super) {
            ...
            var EntityUpdateEventHandler = exports('EntityUpdateEventHandler', /** @class */ (function (_super) {
            ...
            var BindingDataAppendObjectEventHandler = exports('BindingDataAppendObjectEventHandler', /** @class */ (function (_super) {
            ...
            var BindingDataValueChangeEventHandler = exports('BindingDataValueChangeEventHandler', /** @class */ (function (_super) {
             ...
             */
            var BindingDataRemoveObjectEventHandler = exports('BindingDataRemoveObjectEventHandler', /** @class */ (function (_super) {
            ...
            var BindingDataLoadEventHandler = exports('BindingDataLoadEventHandler', /** @class */ (function (_super) {
            ...
            var BindingDataSelectionChangedEventHandler = exports('BindingDataSelectionChangedEventHandler', /** @class */ (function (_super) {
             ...
             * 表单模块路径
             */
            var ASSIGNER_TOKEN = exports('ASSIGNER_TOKEN', new InjectionToken('@Farris expression assigner'));
            var EVENT_HANDLER_TOKEN = exports('EVENT_HANDLER_TOKEN', new InjectionToken('@Farris_event_handler'));

            var EventHandlerRegistry = exports('EventHandlerRegistry', /** @class */ (function () {
            ...
            var ExpressionEngineImpl = exports('ExpressionEngineImpl', /** @class */ (function () {
             ...
             * 表达式计算结果
             */
            var ExpressionResult = exports('ExpressionResult', /** @class */ (function () {
            ...
            var ExpressionManager = exports('ExpressionManager', /** @class */ (function () {
            ...
            var ExpressionResultFactory = exports('ExpressionResultFactory', /** @class */ (function () {
            ...
            var ReadonlyEffector = exports('ReadonlyEffector', /** @class */ (function () {
            ...
            var ValidateEffector = exports('ValidateEffector', /** @class */ (function () {
            ...
            var RequiredEffector = exports('RequiredEffector', /** @class */ (function () {
            ...
            var VisibleEffector = exports('VisibleEffector', /** @class */ (function () {
            ...
            var DependencyEffector = exports('DependencyEffector', /** @class */ (function () {
            ...
            var EffectorFactory = exports('EffectorFactory', /** @class */ (function () {
            ...
            var VIEW_MODEL_EXPRESSION_PROVIDERS = exports('VIEW_MODEL_EXPRESSION_PROVIDERS', __spread([
            ...
            var ControlsProxy = exports('ControlsProxy', /** @class */ (function () {
            ...
            var ViewModel = exports('ViewModel', /** @class */ (function () {
                ...
                ViewModel.prototype.initExpression = function () {
                    ...
                    this.injector.get(ExpressionResultFactory, null);
                    this.expressionResult = this.injector.get(ExpressionResult, null);
                };
            ...
            var AppEventBus = exports('ɵd', /** @class */ (function () {
                /**
                 * 构造函数
                 */

 ...
 * 请求方法
 */
declare type HttpMethod = 'GET' | 'DELETE' | 'HEAD' | 'OPTIONS' | 'POST' | 'PUT' | 'PATCH' | 'LINK' | 'UNLINK';
/**
 * HttpMethods
 */
declare class HttpMethods {
    ...
    static LINK: HttpMethod;
    static UNLINK: HttpMethod;
}
/**
 * 返回值类型
 */
 ...
 * 返回值处理类型
 */
declare type ObserveType = 'body' | 'response';
/**
 * Http响应信息
 */

 ...
 * EntityPath转换器
 */
declare class EntityPathConverter {
    /**
     * 转换为Entity可识别的路径
     * 根：[]
     * 主表：['id:xxx', 'name'],
     ...
     */
    static toEntityPathArray(bindingPathString: string, bindingData: BindingData): string[];
    /**
     * 创建路径中的主键部分
     */
    static createPrimaryKeyPath(primaryKey: string, primaryKeyValue: string): string;
}

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('axios'), require('reflect-metadata'), require('date-fns'), require('dayjs'), require('dayjs/plugin/IsBetween'), require('dayjs/plugin/relativeTime'), require('dayjs/plugin/calendar'), require('dayjs/locale/zh-cn'), require('@farris/expression-engine')) :
    typeof define === 'function' && define.amd ? define('@farris/mobile-devkit', ['exports', 'rxjs', 'rxjs/operators', 'axios', 'reflect-metadata', 'date-fns', 'dayjs', 'dayjs/plugin/IsBetween', 'dayjs/plugin/relativeTime', 'dayjs/plugin/calendar', 'dayjs/locale/zh-cn', '@farris/expression-engine'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['mobile-devkit'] = {}), global.rxjs, global.rxjs.operators, global.axios, null, global.dateFns, global.dayjs, global.IsBetween, global.relativeTime, global.Calendar, null, global.expressionEngine));
}(this, (function (exports, rxjs, operators, axios, reflectMetadata, dateFns, dayjs, IsBetween, relativeTime, Calendar, zhCn, expressionEngine) { 'use strict';

    axios = axios && axios.hasOwnProperty('default') ? axios['default'] : axios;
    dayjs = dayjs && dayjs.hasOwnProperty('default') ? dayjs['default'] : dayjs;
    IsBetween = IsBetween && IsBetween.hasOwnProperty('default') ? IsBetween['default'] : IsBetween;
    relativeTime = relativeTime && relativeTime.hasOwnProperty('default') ? relativeTime['default'] : relativeTime;
    ...
    ***************************************************************************** */
            ...
            if (value === CIRCULAR) {
                ...
                if (depRecords.length) {
                    ...
                    for (var i = 0; i < depRecords.length; i++) {
                        ...
                        deps.push(tryResolveToken(depRecord.token, childRecord, records, !childRecord && !(options & 4 /* CheckParent */) ? NULL_INJECTOR : parent, options & 1 /* Optional */ ? null : THROW_IF_NOT_FOUND, exports.InjectFlags.Default));
                    }
                }
    ...
    var HttpClient = /** @class */ (function () {
        ...
        HttpClient.prototype.request = function (method, url, requestConfig) {
            var _this = this;
            var request$ = rxjs.of(true).pipe(operators.switchMap(function () {
                var axiosRequestConfig = HttpUtil.buildAxiosRequestConfig(method, url, requestConfig);
                return rxjs.from(_this.axiosInstance.request(axiosRequestConfig));
            }));
            return request$.pipe(operators.map(function (axiosResponse) {
    ...
    var ChangeSet = /** @class */ (function () {
        ...
        ChangeSet.prototype.findNewAddItemsPath = function (path) {
            return this.modifications.find(function (value, index) {
                return isEqual(path, value.path) && (value.type === exports.ModifyType.Add || value.type === exports.ModifyType.Insert || value.type === exports.ModifyType.Clone);
            });
        };
        /**
        ...
        ChangeSet.prototype.findModifyItemsPath = function (path) {
            return this.modifications.find(function (value, index) {
                return isEqual(path, value.path) && value.type === exports.ModifyType.ValueChange;
            });
        };
        /**
         * 删除后代（包括自己）所有的删除变更
    ...
    var EntityUtil = /** @class */ (function () {
        ...
        EntityUtil.setUpEntityPipeline = function (entity, bindingObject) {
            ...
            entity.onValueChanged.subscribe(function (modification) {
                if (modification.type !== exports.ModifyType.ValueChange || modification.path.length === 0) {
                    return;
                }
    ...
    var DataTypeInfo = /** @class */ (function () {
        ...
        DataTypeInfo.prototype.collectPropInfos = function () {
            ...
            Object.keys(ngPlainProperties).forEach(function (propName) {
                ...
                _this.addPropInfo(exports.DataPropGroup.Primitive, propName, ngProperty.dataField, null, ngProperty);
            });
            // 实体属性
        ...
        DataPathCreator.createByShortPathFromRoot = function (shortPathArrayOrString, entityManager, bindingData) {
            ...
            shortPathArray.forEach(function (propName) {
                ...
                switch (propInfo.group) {
                    case exports.DataPropGroup.Primitive:
    ...
    var Entity = /** @class */ (function () {
        ...
        Entity.prototype.setChanges = function (value) {
            ...
            if (value.type !== exports.ModifyType.Load) {
                this.hasChange = true;
            }
    ...
    var EntityCollection = /** @class */ (function () {
        ...
        EntityCollection.prototype.updateEntity = function (entity, entityData) {
            ...
            this.notifyCollectionChanged(new Modification(entity, exports.ModifyType.Update, null, null));
        };
        /**
         * 批量追加实体
        ...
        EntityCollection.prototype.addEntities = function (entities) {
            ...
            this.notifyCollectionChanged(new Modification(entitiesToAdd, exports.ModifyType.Add));
        };
        /**
         * 添加实体（不切换当前行）
         * @param entities 实体
        ...
        EntityCollection.prototype.addData = function (entities) {
            ...
            this.notifyCollectionChanged(new Modification(entitiesToAdd, exports.ModifyType.AddData));
        };
        /**
         * 根据主键值获取实体
         */
    ...
    var ViewModelContext = /** @class */ (function () {
        ...
        ViewModelContext.prototype.regToTree = function () {
            var parentInjector = this.innerViewModel.injector.get(Injector, null, exports.InjectFlags.SkipSelf);
            if (parentInjector) {
    ...
    var ControlStateInterceptorService = /** @class */ (function () {
        function ControlStateInterceptorService(injector) {
            ...
            this.controlInterceptors = this.injector.get(CONTROL_STATE_INTERCEPTOR_TOKEN, null, exports.InjectFlags.Optional);
        }
        ControlStateInterceptorService.prototype.init = function () {
            ...
            try {
                for (var _b = __values(this.controlInterceptors), _c = _b.next(); !_c.done; _c = _b.next()) {
                    ...
                    if (controlInterceptor.init && typeof controlInterceptor.init === 'function') {
                        ...
                        var $result = rxjs.isObservable(initFunc) ? initFunc : rxjs.of(initFunc);
                        inits.push($result);
                    }
                }
            }
            ...
            return this.result = rxjs.forkJoin(inits).pipe(operators.shareReplay(1));
        };
        ...
        ControlStateListener.prototype.registerBindingDataLintener = function () {
            ...
            if (this.subscriptionsMap.has(stateName) === false) {
                var subscription = this.viewModelContext.bindingData.changes.subscribe(function (change) {
                    if (change.type === exports.ChangeType.Load) {
                        return;
                    }
    ...
    var BindingValueAccessorFactory = /** @class */ (function () {
        ...
        BindingValueAccessorFactory.create = function (bindingType, bindingBindingPath, bindingValueConverter, viewModelContext) {
            switch (bindingType) {
                case exports.BindingType.EntityState:
                ...
                case exports.BindingType.UIState:
    ...
    var ValidatorFactory = /** @class */ (function () {
        ...
        ValidatorFactory.initValidRuleFn = function (validRule) {
            ...
            switch (type) {
                ...
                case 'asyncCustomFunction':
                    return function (v, context) {
                        if (typeof constraints[0] === 'function') {
                            var $message = rxjs.from(constraints[0](v, context));
                            return $message.pipe(operators.switchMap(function (message) {
                                if (!message) {
                                    return rxjs.of({ passing: true, message: '' });
                                }
                                else {
                                    return rxjs.of({ passing: false, message: message });
                                }
                            }));
                        }
                        return { passing: true, message: '' };
        ...
        ValidatorFactory.executeValidator = function (validatorFn, value, context, options) {
            var validationResult = rxjs.of({ passing: true, message: '' });
    ...
    var Form = /** @class */ (function () {
        ...
        Form.prototype.validateFields = function () {
            ...
            this.validateformControls.forEach(function (formControl) {
                var result$ = ValidatorFactory.executeValidator(_this[formControl]['validatorFn'], _this[formControl]['value'], _this.viewModelContext).pipe(operators.tap(function (message) {
        ...
        Form.prototype.getFieldError = function (name) {
            ...
            if (index === -1) {
                ...
                var result$ = ValidatorFactory.executeValidator(this[name]['validatorFn'], this[name]['value'], this.viewModelContext).pipe(operators.tap(function (message) {
        ...
        BindingDataChangeListener.prototype.registerEvent = function () {
            ...
            if (this.bindingData && this.bindingData.changes && typeof this.bindingData.changes.subscribe === 'function') {
                this.bindingData.changes.subscribe(function (change) {
                    if (change.type === exports.ChangeType.Append || change.type === exports.ChangeType.ValueChanged || change.type === exports.ChangeType.Remove || change.type === exports.ChangeType.Load || change.type === exports.ChangeType.SelectionChanged) {
                        var eventType = null;
    ...
    var ExpressionRegistry = /** @class */ (function () {
        ...
        ExpressionRegistry.prototype.setExpressions = function (describe) {
            ...
            exprs.forEach(function (expr) {
                expr.expressions.forEach(function (expression) {
                    ...
                    if (expression.type === exports.Expression.ExpressionType.Required) {
                    ...
                    if (expression.type === exports.Expression.ExpressionType.Validate) {
                    ...
                    if ((expression.type === exports.Expression.ExpressionType.Required || expression.type === exports.Expression.ExpressionType.Validate)) {
        ...
        ExpressionRegistry.prototype.getExpressionMessage = function (expressionType, defaultValue) {
            if (!(expressionType === exports.Expression.ExpressionType.Validate || expressionType === exports.Expression.ExpressionType.Required)) {
                return null;
            }
            if (!this.translate) {
                return defaultValue;
    ...
    var ValidateEffector = /** @class */ (function () {
        ...
        ValidateEffector.prototype.effect = function (path, value, options) {
            ...
            if (value === false && options.eventType !== exports.Expression.EventType.Append && options.eventType !== exports.Expression.EventType.Load) {
                ...
                this.bindingData.setValueChangeInvokerFactory(function (paths) {
                    return function (preValue, value, entityChanged, primaryValue) {
                        ...
                        if (!!command) {
                            ...
                            return rxjs.from(commands).pipe(operators.concatMap(function (item) {
    ...
    var CommandHandlerRegistry = /** @class */ (function () {
        ...
        function CommandHandlerRegistry(injector) {
            var _this = this;
            this.injector = injector;
            var handlers = this.injector.get(COMMAND_HANDLERS_TOKEN, null, exports.InjectFlags.Optional);
    ...
    var CommandHandlerExtenderRegistry = /** @class */ (function () {
        ...
        function CommandHandlerExtenderRegistry(injector) {
            var _this = this;
            this.injector = injector;
            var extenders = this.injector.get(COMMAND_HANDLER_EXTENDERS_TOKEN, null, exports.InjectFlags.Optional);
    ...
    exports.ACTION_METHOD_META = ACTION_METHOD_META;
    exports.ANNOTATIONS = ANNOTATIONS;
    exports.APP_VARIABLE_PROVIDERS = APP_VARIABLE_PROVIDERS;
    exports.ASSIGNER_TOKEN = ASSIGNER_TOKEN;
    exports.ActionMethodMeta = ActionMethodMeta;
    exports.App = App;
    exports.AppContext = AppContext;
    exports.AppOptions = AppOptions;
    exports.ArrayStringValueConverter = ArrayStringValueConverter;
    ...
    exports.BindingValueAccessorFactory = BindingValueAccessorFactory;
    exports.BoolUtil = BoolUtil;
    ...
    exports.COMMAND_HANDLER_EXTENDER_META = COMMAND_HANDLER_EXTENDER_META;
    exports.COMMAND_HANDLER_META = COMMAND_HANDLER_META;
    exports.COMMAND_METHOD_META = COMMAND_METHOD_META;
    exports.CONTROLSTATE_PROP_META = CONTROLSTATE_PROP_META;
    exports.CONTROL_STATE_INTERCEPTOR_TOKEN = CONTROL_STATE_INTERCEPTOR_TOKEN;
    exports.ChangeSet = ChangeSet;
    exports.CommandBus = CommandBus;
    exports.CommandContext = CommandContext;
    exports.CommandHandler = CommandHandler;
    exports.CommandHandlerExtender = CommandHandlerExtender;
    exports.CommandHandlerExtenderMeta = CommandHandlerExtenderMeta;
    exports.CommandHandlerExtenderRegistry = CommandHandlerExtenderRegistry;
    exports.CommandHandlerFactory = CommandHandlerFactory;
    exports.CommandHandlerMeta = CommandHandlerMeta;
    exports.CommandHandlerRegistry = CommandHandlerRegistry;
    exports.CommandMethodMeta = CommandMethodMeta;
    exports.CommandVariableParser = CommandVariableParser;
    exports.CommentDependencyResolver = CommentDependencyResolver;
    exports.Context = Context;
    exports.ControlStateInterceptorService = ControlStateInterceptorService;
    exports.ControlStatePropMeta = ControlStatePropMeta;
    exports.ControlsProxy = ControlsProxy;
    exports.Core = Core;
    exports.DYNAMIC_PROP_META = DYNAMIC_PROP_META;
    exports.DataPath = DataPath;
    exports.DataPathCreator = DataPathCreator;
    ...
    exports.DateStringValueConverter = DateStringValueConverter;
    ...
    exports.DynamicPropMeta = DynamicPropMeta;
    exports.EFFECTOR_TOKEN = EFFECTOR_TOKEN;
    exports.ENTITY_META = ENTITY_META;
    ...
    exports.EntityBindingValueAccessor = EntityBindingValueAccessor;
    ...
    exports.FORM_CONTROL_PROP_META = FORM_CONTROL_PROP_META;
    ...
    exports.FormControlPropMeta = FormControlPropMeta;
    ...
    exports.INJECTOR_IMPL__PRE_R3__ = INJECTOR_IMPL__PRE_R3__;
    exports.INJECTOR_SCOPE = INJECTOR_SCOPE;
    exports.InitContext = InitContext;
    exports.InjectionToken = InjectionToken;
    exports.Injector = Injector;
    exports.InterceptContext = InterceptContext;
    exports.LISTENER_TOKEN = LISTENER_TOKEN;
    exports.LIST_PROP_META = LIST_PROP_META;
    exports.ListPropMeta = ListPropMeta;
    ...
    exports.OBJECT_PROP_META = OBJECT_PROP_META;
    exports.ObjectPropMeta = ObjectPropMeta;
    exports.ObjectUtil = ObjectUtil;
    exports.PARAMETERS = PARAMETERS;
    exports.PARENT_CLASS = PARENT_CLASS;
    exports.PARENT_PATH = PARENT_PATH;
    exports.PRIMITIVE_PROP_META = PRIMITIVE_PROP_META;
    exports.PROP_METADATA = PROP_METADATA;
    exports.PrimitivePropMeta = PrimitivePropMeta;
    exports.ProcessContext = ProcessContext;
    exports.PropertyUtil = PropertyUtil;
    exports.RENDER_STATE_PROP_META = RENDER_STATE_PROP_META;
    exports.REPOSITORY_META = REPOSITORY_META;
    exports.RESOLVER_TOKEN = RESOLVER_TOKEN;
    exports.ReadonlyEffector = ReadonlyEffector;
    exports.RenderStatePropMeta = RenderStatePropMeta;
    ...
    exports.RepositoryMeta = RepositoryMeta;
    ...
    exports.STATE_PROP_META = STATE_PROP_META;
    ...
    exports.StatePropMeta = StatePropMeta;
    ...
    exports.Type = Type;
    exports.UISTATE_PROP_META = UISTATE_PROP_META;
    exports.UIState = UIState;
    exports.UIStateBindingValueAccessor = UIStateBindingValueAccessor;
    ...
    exports.UIStatePropMeta = UIStatePropMeta;
    exports.UIStateVariableParser = UIStateVariableParser;
    exports.USE_VALUE = USE_VALUE;
    exports.UrlUtil = UrlUtil;
    exports.VALIDATION_RULE_TOKEN = VALIDATION_RULE_TOKEN;
    exports.VARIABLE_PARSERS = VARIABLE_PARSERS;
    exports.VIEW_MODEL_COMMAND_PROVIDERS = VIEW_MODEL_COMMAND_PROVIDERS;
    exports.VIEW_MODEL_EXPRESSION_PROVIDERS = VIEW_MODEL_EXPRESSION_PROVIDERS;
    exports.ValidateEffector = ValidateEffector;
    exports.ValidatorFactory = ValidatorFactory;
    exports.VariableParseService = VariableParseService;
    exports.ViewModel = ViewModel;
    exports.ViewModelContext = ViewModelContext;
    exports.ViewModelContextManager = ViewModelContextManager;
    exports.ViewModelOptions = ViewModelOptions;
    ...
    exports.ɵ0 = ɵ0;
    exports.ɵa = getClosureSafeProperty;
    exports.ɵb = Injector;
    exports.ɵc = createInjectionToken;
    exports.ɵd = AppEventBus;
    exports.ɵe = ChangeListener;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=farris-mobile-devkit.umd.js.map

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('rxjs/internal/scheduler/animationFrame'), require('@angular/core'), require('@angular/common'), require('@farris/ui-locale'), require('@farris/ui-draggable'), require('@farris/ui-common')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-scrollspy', ['exports', 'rxjs', 'rxjs/operators', 'rxjs/internal/scheduler/animationFrame', '@angular/core', '@angular/common', '@farris/ui-locale', '@farris/ui-draggable', '@farris/ui-common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-scrollspy'] = {}),global.rxjs,global.rxjs.operators,global.rxjs['internal/scheduler/animationFrame'],global.ng.core,global.ng.common,global.uiLocale,global.uiDraggable,global.uiCommon));
}(this, (function (exports,rxjs,operators,animationFrame,i0,common,uiLocale,uiDraggable,uiCommon) { 'use strict';
    ...
    var FarrisScrollSpyService = /** @class */ (function () {
         ...
         */
            ...
            function (scrollSpyId) {
                if (scrollSpyId === void 0) {
                    scrollSpyId = this.defaultId;
                }
                /** @type {?} */
                var groupId = scrollSpyId !== '' ? scrollSpyId : this.defaultId;
                if (!this.scrollChange[groupId]) {
                    this.scrollChange[groupId] = new rxjs.Subject();
                }
         ...
         */
            function (key) {
                 ...
                 * @return {?}
                 */function () {
                    _this.scrollSubscription = rxjs.fromEvent(_this.scrollContents[key], 'scroll')
                        .pipe(operators.debounceTime(100, animationFrame.animationFrame))
                        .subscribe(( /**
                 * @return {?}
                 */function () {
         ...
         */
            function (key) {
                ...
                if (this.scrollFollowSpipes[key] && this.scrollFollowSpipes[key].length) {
                     ...
                     * @return {?}
                     */function (follow) {
                        rxjs.fromEvent(follow.element, 'click')
                            .pipe(operators.throttleTime(100))
                            .subscribe(( /**
                     * @param {?} event
                     * @return {?}
                     */function (event) {
         ...
         */
            function (element, followId, followContentId) {
                if (followContentId === void 0) {
                    followContentId = this.defaultId;
                }
                /** @type {?} */
         ...
         */
            function (element, scrollId, scrollGroupId) {
                var _this = this;
                if (scrollGroupId === void 0) {
                    scrollGroupId = this.defaultId;
                }
        ...
        /** @nocollapse */
        FarrisScrollSpyService.ctorParameters = function () {
            return [
                { type: i0.NgZone }
            ];
        };
    ...
    var ScrollspyItemTemplateDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        ScrollspyItemTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
    ...
    var ScrollspyComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        ScrollspyComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
        ...
        ScrollspyComponent.propDecorators = {
            ctx: [{ type: i0.Input }],
            scrollspyItemComponentType: [{ type: i0.Input }],
            scrollspyTemplate: [{ type: i0.ContentChild, args: [ScrollspyItemTemplateDirective, { read: i0.TemplateRef },] }],
            currentSectionId: [{ type: i0.Input }],
            scrollGroupId: [{ type: i0.Input }],
            fFollowType: [{ type: i0.Input }],
            sidetabWidth: [{ type: i0.Input }],
            scrollyspyListEl: [{ type: i0.ViewChild, args: ["scrollyspyList",] }],
            scrollspyData: [{ type: i0.Input }]
        };
    ...
    var FarrisScrollSpyDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FarrisScrollSpyDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: FarrisScrollSpyService }
            ];
        ...
        FarrisScrollSpyDirective.propDecorators = {
            scrollId: [{ type: i0.Input, args: ['fScrollSpy',] }],
            scrollGroupId: [{ type: i0.Input, args: ['fScrollGroup',] }]
        };
    ...
    var FscrollFollowElementDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FscrollFollowElementDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: FarrisScrollSpyService }
            ];
        ...
        FscrollFollowElementDirective.propDecorators = {
            followId: [{ type: i0.Input, args: ['fScrollFollowElement',] }],
            followGroupId: [{ type: i0.Input, args: ['fScrollElement',] }]
        };
    ...
    var FscrollSpyContainerDirective = /** @class */ (function () {
        function FscrollSpyContainerDirective(elementRef, scrollSpy, changeDetector) {
            ...
            this.scrollSpy = scrollSpy;
            this.changeDetector = changeDetector;
            this.fScrollChange = new i0.EventEmitter;
        ...
        /** @nocollapse */
        FscrollSpyContainerDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: FarrisScrollSpyService },
                { type: i0.ChangeDetectorRef }
        ...
        FscrollSpyContainerDirective.propDecorators = {
            fOffset: [{ type: i0.Input }],
            fScrollGroupId: [{ type: i0.Input, args: ['fScrollSpyContainer',] }],
            fScrollChange: [{ type: i0.Output }],
    ...
    exports.ScrollspyItemTemplateDirective = ScrollspyItemTemplateDirective;
    exports.ScrollspyComponent = ScrollspyComponent;
    exports.FarrisScrollSpyService = FarrisScrollSpyService;
    exports.FarrisScrollSpyDirective = FarrisScrollSpyDirective;
    exports.FscrollFollowElementDirective = FscrollFollowElementDirective;
    exports.FscrollSpyContainerDirective = FscrollSpyContainerDirective;
...
//# sourceMappingURL=farris-ui-scrollspy.umd.js.map
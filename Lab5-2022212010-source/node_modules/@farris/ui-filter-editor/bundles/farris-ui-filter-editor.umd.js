(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('rxjs'), require('lodash-es'), require('@farris/ui-modal'), require('@farris/ui-common/types'), require('@farris/ui-notify'), require('@angular/forms'), require('@angular/common'), require('@farris/ui-lookup'), require('@farris/ui-dialog'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-messager'), require('@farris/ui-common'), require('@farris/ui-input-group'), require('@angular/core'), require('@farris/ui-locale'), require('@farris/ui-combo-lookup'), require('@farris/ui-forms')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-filter-editor', ['exports', '@angular/platform-browser', 'rxjs', 'lodash-es', '@farris/ui-modal', '@farris/ui-common/types', '@farris/ui-notify', '@angular/forms', '@angular/common', '@farris/ui-lookup', '@farris/ui-dialog', '@farris/ui-perfect-scrollbar', '@farris/ui-messager', '@farris/ui-common', '@farris/ui-input-group', '@angular/core', '@farris/ui-locale', '@farris/ui-combo-lookup', '@farris/ui-forms'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-filter-editor'] = {}),global.ng.platformBrowser,global.rxjs,global.lodashEs,global.uiModal,global.types,global.uiNotify,global.ng.forms,global.ng.common,global.uiLookup,global.uiDialog,global.uiPerfectScrollbar,global.uiMessager,global.uiCommon,global.uiInputGroup,global.ng.core,global.uiLocale,global.uiComboLookup,global.uiForms));
}(this, (function (exports,platformBrowser,rxjs,lodashEs,uiModal,types,uiNotify,forms,common,uiLookup,uiDialog,uiPerfectScrollbar,uiMessager,uiCommon,uiInputGroup,core,uiLocale,uiComboLookup,uiForms) { 'use strict';
    ...
    var FilterService = /** @class */ (function () {
        function FilterService(utils) {
            this.conditionsChanged = new rxjs.Subject();
            this.commonUtils = utils || new uiCommon.CommonUtils();
        }
        /**
         * @param {?} c
         * @return {?}
         ...
         */
            function (conditions, localeService) {
                if (conditions && conditions.length) {
                    // 清除最后条件的关系符
                    conditions[conditions.length - 1].relation = types.FilterRelation.Empty;
                    // 检查关系连接符
                    /** @type {?} */
                 ...
                 * @return {?}
                 */function (n, i) {
                        if (n.relation == "" + types.FilterRelation.Empty) {
        ...
        FilterService.ctorParameters = function () {
            return [
                { type: uiCommon.CommonUtils, decorators: [{ type: core.Optional }] }
            ];
        };
    ...
    var FilterEditorComponent = /** @class */ (function () {
        function FilterEditorComponent(sanitizer, filterService, injector) {
            ...
            this.showExpress = new core.EventEmitter();
            ...
            function () {
                if (this.conditions && this.conditions.length) {
                     ...
                     */function (con) {
                        ...
                        if (cp === types.Compare.In || cp === types.Compare.NotIn) {
        ...
        /** @nocollapse */
        FilterEditorComponent.ctorParameters = function () {
            return [
        ...
        FilterEditorComponent.propDecorators = {
            ...
            showCode: [{ type: core.Input }],
            showSql: [{ type: core.Input }],
            enableExpress: [{ type: core.Input }],
            enableFrontExpress: [{ type: core.Input }],
            fieldEditor: [{ type: core.Input }],
            insertType: [{ type: core.Input }],
            useCustomValue: [{ type: core.Input }],
            showExpress: [{ type: core.Output }],
    ...
    ***************************************************************************** */
    ...
    var FilterGridComponent = /** @class */ (function () {
        function FilterGridComponent(el, render, filterService, messagerService) {
            ...
            this.LeftBracketData = types.LeftBracket;
            this.RighttBracketData = types.RighttBracket;
            this.relationData = types.Relation;
            this.operators = types.CompareOperators;
            ...
            this.useCustomValue = false;
            this.insertType = 'below';
            this.defulatRelation = types.FilterRelation.And;
            this.showExpress = new core.EventEmitter();
            ...
            this.newCondition = {
                ...
                lbracket: '',
                rbracket: '',
                relation: types.FilterRelation.Empty,
                compare: types.Compare.Equal,
                expresstype: types.ExpressValueType.Value
            };
            this.localeService = null;
            this.trackByValue = ( /**
             * @param {?} index
         ...
         */
            function (index, $event) {
                ...
                /** @type {?} */
                var _newCondition = Object.assign({}, this.newCondition, { relation: types.FilterRelation.And });
         ...
         */
            function () {
                 ...
                 * @return {?}
                 */function (n) {
                    if (n.relation == types.FilterRelation.Empty || !n.relation) {
                        n.relation = types.FilterRelation.And;
                    }
                }));
        ...
        /** @nocollapse */
        FilterGridComponent.ctorParameters = function () {
            return [
        ...
        FilterGridComponent.propDecorators = {
            ...
            useCustomValue: [{ type: core.Input }],
            insertType: [{ type: core.Input }],
            defulatRelation: [{ type: core.Input }],
            showExpress: [{ type: core.Output }],
    ...
    var FilterFooterComponent = /** @class */ (function () {
        function FilterFooterComponent(grid) {
            ...
            this.addFilter = new core.EventEmitter();
            this.clearFilter = new core.EventEmitter();
            this.moveTop = new core.EventEmitter();
            this.movePrev = new core.EventEmitter();
            this.moveNext = new core.EventEmitter();
            this.moveBottom = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        FilterFooterComponent.ctorParameters = function () {
            return [
        ...
        FilterFooterComponent.propDecorators = {
            cls: [{ type: core.HostBinding, args: ['class',] }],
            addFilter: [{ type: core.Output }],
            clearFilter: [{ type: core.Output }],
            moveTop: [{ type: core.Output }],
            movePrev: [{ type: core.Output }],
            moveNext: [{ type: core.Output }],
            moveBottom: [{ type: core.Output }]
        };
    ...
    var FilterTabsComponent = /** @class */ (function () {
        function FilterTabsComponent() {
            ...
            this.selectTabChange = new core.EventEmitter();
            this.enableExpress = false;
            this.enableFrontExpress = false;
            this.showExpress = new core.EventEmitter();
            this.insertType = 'below';
        ...
        FilterTabsComponent.propDecorators = {
            ...
            showSql: [{ type: core.Input }],
            fieldEditor: [{ type: core.Input }],
            selectTabChange: [{ type: core.Output }],
            enableExpress: [{ type: core.Input }],
            enableFrontExpress: [{ type: core.Input }],
            showExpress: [{ type: core.Output }],
            insertType: [{ type: core.Input }],
    ...
    var FilterComponent = /** @class */ (function (_super) {
        ...
        function FilterComponent(injector, cfr, modalService, el, filterService) {
            ...
            _this.showExpress = new core.EventEmitter();
            ...
            _this.notifySer = _this.injector.get(uiNotify.NotifyService, null);
            _this.localeService = _this.injector.get(uiLocale.LocaleService);
            _this.cd = _this.injector.get(core.ChangeDetectorRef);
            _this.commonUtils =
                _this.injector.get(uiCommon.CommonUtils, null) || new uiCommon.CommonUtils();
            return _this;
        }
        /**
         * @return {?}
    ...
    var FilterSqlCodeComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FilterSqlCodeComponent.ctorParameters = function () {
            return [
                { type: FilterService }
            ];
        };
    ...
    var FilterCodeComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FilterCodeComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    exports.FilterCodeComponent = FilterCodeComponent;
    exports.FilterSqlCodeComponent = FilterSqlCodeComponent;
    exports.FilterService = FilterService;
    exports.FilterEditorComponent = FilterEditorComponent;
    exports.FilterFooterComponent = FilterFooterComponent;
    exports.FilterGridComponent = FilterGridComponent;
    exports.FilterTabsComponent = FilterTabsComponent;
    exports.FILTER_LOOKUPGRID_VALUE_ACCESSOR = FILTER_LOOKUPGRID_VALUE_ACCESSOR;
...
//# sourceMappingURL=farris-ui-filter-editor.umd.js.map
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-modal'), require('@farris/ui-popover'), require('@farris/ui-dialog'), require('@farris/ui-panel'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-notify'), require('@progress/kendo-angular-inputs'), require('@progress/kendo-angular-dropdowns'), require('@progress/kendo-angular-dateinputs')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-property-panel', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@farris/ui-modal', '@farris/ui-popover', '@farris/ui-dialog', '@farris/ui-panel', '@farris/ui-perfect-scrollbar', '@farris/ui-notify', '@progress/kendo-angular-inputs', '@progress/kendo-angular-dropdowns', '@progress/kendo-angular-dateinputs'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-property-panel'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.uiModal,global.uiPopover,global.uiDialog,global.uiPanel,global.uiPerfectScrollbar,global.uiNotify,global.kendoAngularInputs,global.kendoAngularDropdowns,global.kendoAngularDateinputs));
}(this, (function (exports,core,common,forms,uiModal,uiPopover,uiDialog,uiPanel,uiPerfectScrollbar,uiNotify,kendoAngularInputs,kendoAngularDropdowns,kendoAngularDateinputs) { 'use strict';
    ...
    var PropertyItemComponent = /** @class */ (function () {
        function PropertyItemComponent(resolver, modalService, injector, notifyServ, el) {
            ...
            this.triggerRefreshPanel = new core.EventEmitter(); // 向上触发整体面板刷新
            // 模态框类型的属性:属性框的展示值
            this.selectOptions = [];
    ...
    var PropertyPanelComponent = /** @class */ (function () {
        function PropertyPanelComponent() {
            ...
            this.closePropertyPanel = new core.EventEmitter(); // isPersitOpenState=true时，抛出面板的关闭事件
            // 属性类型
            this.propertyData = {}; // 属性值
            // 属性值
            this.propertyChanged = new core.EventEmitter(); // 属性变更事件
            // 属性变更事件
            this.submitModal = new core.EventEmitter(); // 模态框属性变更事件
            // 模态框属性变更事件
...
//# sourceMappingURL=farris-ui-property-panel.umd.js.map
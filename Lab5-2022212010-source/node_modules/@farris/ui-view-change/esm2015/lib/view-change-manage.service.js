...
export class ViewChangeManageService {
    ...
    removeViewItem(itemId, viewContainerId = this.defaultId) {
        if (this.viewContainers && this.viewContainers[viewContainerId]) {
            /** @type {?} */
            const leftItems = this.viewContainers[viewContainerId].items.filter((/**
             * @param {?} el
             * @return {?}
             */
            el => {
     ...
     * @return {?}
     */
    changeCurrentViewIdFromCMP(type, viewContainerId = this.defaultId) {
     ...
     * @return {?}
     */
    createViewContainerChange(viewContainerId = this.defaultId) {
        if (!this.changeCurrentViewId[viewContainerId]) {
...
/** @nocollapse */
ViewChangeManageService.ctorParameters = () => [];
if (false) {
    /**
     * 默认视图切换分组名称
     * @type {?}

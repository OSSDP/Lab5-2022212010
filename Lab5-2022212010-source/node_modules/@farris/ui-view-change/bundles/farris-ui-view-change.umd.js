(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('resize-observer-polyfill'), require('@angular/common'), require('@angular/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-view-change', ['exports', 'resize-observer-polyfill', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-view-change'] = {}),global.ResizeObserver,global.ng.common,global.ng.core,global.rxjs,global.rxjs.operators));
}(this, (function (exports,ResizeObserver,common,i0,rxjs,operators) { 'use strict';
    ...
    var ViewChangeManageService = /** @class */ (function () {
         ...
         */
            function (viewContainerId) {
                ...
                if (!this.changeCurrentViewId[viewContainerId]) {
                    this.changeCurrentViewId[viewContainerId] = new rxjs.BehaviorSubject(null);
                }
            };
        /**
         * @return {?}
    ...
    var ViewChangeService = /** @class */ (function () {
        function ViewChangeService() {
            ...
            this.guidChangeSubject = new rxjs.BehaviorSubject([{
                    guid: '',
                    groupId: '',
                    count: 0
                }]);
    ...
    var ViewChangeComponent = /** @class */ (function () {
        ...
        ViewChangeComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
                { type: ViewChangeService, decorators: [{ type: i0.Optional }] },
        ...
        ViewChangeComponent.propDecorators = {
            ...
            viewchangewrapper: [{ type: i0.ViewChild, args: ['viewchangewrapper',] }]
        };
    ...
    var FarrisViewItemDirective = /** @class */ (function () {
        function FarrisViewItemDirective(elementRef, viewChangeService, render) {
             ...
             * 保证只执行一次
             */
            this.cancelSignal = new rxjs.Subject();
        }
        /**
         * @return {?}
         */
         ...
         */
            function () {
                ...
                // 解决组件与指令创建先后的问题
                this.viewChangeService.getModuleChange().pipe(operators.takeUntil(this.cancelSignal)).subscribe(( /**
    ...
    exports.ViewChangeManageService = ViewChangeManageService;

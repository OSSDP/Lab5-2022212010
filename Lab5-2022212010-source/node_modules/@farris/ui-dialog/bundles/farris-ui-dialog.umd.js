(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@angular/core'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-draggable'), require('@farris/ui-modal')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-dialog', ['exports', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/core', '@farris/ui-perfect-scrollbar', '@farris/ui-draggable', '@farris/ui-modal'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-dialog'] = {}),global.rxjs,global.rxjs.operators,global.ng.common,global.ng.core,global.uiPerfectScrollbar,global.uiDraggable,global.uiModal));
}(this, (function (exports,rxjs,operators,common,core,uiPerfectScrollbar,uiDraggable,uiModal) { 'use strict';
    ...
    var DialogService = /** @class */ (function () {
         ...
         */
            function (tags) {
                 ...
                 * @return {?}
                 */function (n) {
                    return !Array.from(dlgs[0].classList).some(( /**
                     * @param {?} item
                     * @return {?}
    ...
    ***************************************************************************** */
    ...
    var DialogComponent = /** @class */ (function () {
        function DialogComponent(render2, el) {
            ...
            this.maxed = new core.EventEmitter();
         ...
         */
            function ($event) {
                this.moving.emit(__assign({ target: this.dialogEl.nativeElement }, $event));
            };
        ...
        DialogComponent.propDecorators = {
            ...
            showMinButton: [{ type: core.Input }],
            resizable: [{ type: core.Input }],
            draggable: [{ type: core.Input }],
            buttonAlign: [{ type: core.Input }],
            scrollConfig: [{ type: core.Input }],
            beforeOpen: [{ type: core.Input }],
            beforeClose: [{ type: core.Input }],
            modal: [{ type: core.ViewChild, args: [uiModal.ModalDirective,] }],
            ...
            maxed: [{ type: core.Output }],
            widthChange: [{ type: core.Output }],
            heightChange: [{ type: core.Output }],
            moving: [{ type: core.Output }],
            enableScroll: [{ type: core.Input }],
            buttons: [{ type: core.Input }],
            dialogHeaderHeight: [{ type: core.Input }],
            dialogFooterHeight: [{ type: core.Input }],
            parentElement: [{ type: core.Input }],
            showHeader: [{ type: core.Input }],
            dragHandle: [{ type: core.Input }],
            toolTemplate: [{ type: core.ContentChild, args: ['toolTemplate',] }],
            modalContent: [{ type: core.ViewChild, args: ['modalContent',] }],
            modalHeader: [{ type: core.ViewChild, args: ['header',] }],
            dialogEl: [{ type: core.ViewChild, args: ['dialogEl',] }],
            maxPadding: [{ type: core.Input }]
        };
...
//# sourceMappingURL=farris-ui-dialog.umd.js.map
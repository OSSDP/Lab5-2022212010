(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ecp-caf/caf-common'), require('date-fns'), require('@farris/ui-loading'), require('rxjs'), require('rxjs/operators'), require('rxjs/operators/map'), require('@angular/core'), require('@angular/common/http'), require('@farris/devkit')) :
    typeof define === 'function' && define.amd ? define('@farris/bef', ['exports', '@ecp-caf/caf-common', 'date-fns', '@farris/ui-loading', 'rxjs', 'rxjs/operators', 'rxjs/operators/map', '@angular/core', '@angular/common/http', '@farris/devkit'], factory) :
    (factory((global.farris = global.farris || {}, global.farris.bef = {}),global.cafCommon,global.dateFns,global.uiLoading,global.rxjs,global.rxjs.operators,global.rxjs['operators/map'],global.ng.core,global.ng.common.http,global.devkit));
}(this, (function (exports,cafCommon,dateFns,uiLoading,rxjs,operators,map,core,http,devkit) { 'use strict';
     ...
     */
    /** @type {?} */
    var BE_SERVER_URI_TOKEN = new core.InjectionToken('@farris/be BE_SERVER_URL');
    /**
     * 1、因为bef里，很多类都没有注入，BefSessionHandlingStragegy无法直接注入；
     * 2、通过一个字符串Token来间接做策略选择。
     * @type {?}
     */
    var BE_SESSION_HANDLING_STRATEGY_TOKEN = new core.InjectionToken('@farris/be BE_SESSION_HANDLING_STRATEGY_TOKEN');
    ...
    var EntityUtil = /** @class */ (function () {
         ...
         */
            function (entityType, targetPropName) {
                ...
                // NgField
                /** @type {?} */
                var ngFieldProperties = devkit.FieldMetadataUtil.getNgFields(entityType);
                ...
                // NgObject
                /** @type {?} */
                var ngObjectProperties = devkit.FieldMetadataUtil.getNgObjects(entityType);
                ...
                // NgList
                /** @type {?} */
                var ngListProperties = devkit.FieldMetadataUtil.getNgList(entityType);
                ...
                /** @type {?} */
                var ngDynamicProperties = devkit.FieldMetadataUtil.getNgDynamic(entityType);
            ...
            function (modification) {
                ...
                var _loop_1 = function (i) {
                    ...
                    if (propType === 'NgField') {
                        ...
                        if (modification.type !== devkit.ModifyType.ValueChange) {
                        ...
                        if (modification.type === devkit.ModifyType.Add || modification.type === devkit.ModifyType.Insert) ;
                        else if (modification.type === devkit.ModifyType.Remove) ;
                        // 重置
                        parentChangeDetail = null;
                        parentEntityType = null;
                    }
    ...
    var FrameworkSessionService = /** @class */ (function () {
        ...
        /** @nocollapse */
        FrameworkSessionService.ctorParameters = function () {
            return [
                { type: cafCommon.SessionService, decorators: [{ type: core.Optional }] }
            ];
        };
    ...
    ***************************************************************************** */
    ...
    var HttpHeaderUtil = /** @class */ (function () {
         ...
         */
            function (headers) {
                ...
                // 已经是HttpHeaders，直接返回
                /** @type {?} */
                var isHttpHeaders = headers instanceof http.HttpHeaders;
                if (isHttpHeaders === true) {
                    return headers;
                }
                if (Object.keys(headers).length > 0) {
                    /** @type {?} */
                    var httpHeaders_1 = new http.HttpHeaders();
         ...
         */
            function () {
                ...
                if (!!this.frmSessionId) {
                    ...
                    params.headers = new http.HttpHeaders({ SessionId: this.frmSessionId });
                ...
                return this.httpService.request('POST', this.beSessionUri, params).pipe(operators.tap(( /**
                 * @param {?} beSessionId
                 * @return {?}
    ...
    var BefSessionService = /** @class */ (function () {
         ...
         */
            function (sessionId) {
                /** @type {?} */
                var appContext = this.injector.get(devkit.AppContext, null, core.InjectFlags.Optional);
         ...
         */
            function (injector, httpClient, frmSessionService, beBaseUri) {
                ...
                if (!injector) {
                    ...
                    // bef 实例化
                    handlingStrategyName = injector.get(BE_SESSION_HANDLING_STRATEGY_TOKEN, null, core.InjectFlags.Optional);
                }
        ...
        /** @nocollapse */
        BefSessionService.ctorParameters = function () {
            return [
                { type: http.HttpClient },
                { type: String },
     ...
     * @type {?}
     */
    var NgVariable = devkit.makePropDecorator(NG_VARIABLE, ( /**
     * @param {?} obj
     * @return {?}
    ...
    var BefVariableManager = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.injector) {
                    /** @type {?} */
                    var frameContext = this.injector.get(devkit.FrameContext, null);
                    if (frameContext) {
                        /** @type {?} */
        ...
        /** @nocollapse */
        BefVariableManager.ctorParameters = function () {
            return [
     ...
     */ BefDataPathUtil = /** @class */ (function () {
         ...
         */
            function (bindingPath, bindingData) {
                var _this = this;
                /** @type {?} */
                var bindingPathArray = devkit.BindingPathConverter.toBindingPathArray(bindingPath);
                /** @type {?} */
                var pathArray = [];
                /** @type {?} */
                 ...
                 */function (propName) {
                    /** @type {?} */
                    var propInfo = devkit.PropertyUtil.getPropertyByName(currentBindingObject.properties, propName);
                    if (propInfo.type !== devkit.BindingPropertyType.List) {
    ...
    BefDataService = /** @class */ (function () {
        ...
        function BefDataService(injector, repository) {
            ...
            /** @type {?} */
            var httpClient = injector.get(http.HttpClient);
            /** @type {?} */
         ...
         */
            function (filter, sort, pageSize, pageIndex) {
                ...
                return filter$.pipe(operators.map(( /**
                 * @param {?} responseInfo
                 * @return {?}
         ...
         */
            function (id) {
                ...
                /** @type {?} */
                var result$ = retrieve$.pipe(operators.map(( /**
                 * @param {?} responseInfo
                 * @return {?}
                 */function (responseInfo) {
                    /** @type {?} */
         ...
         */
            function (paths, pageIndex, pageSize, filter, sort) {
                ...
                /** @type {?} */
                var viewModel = this.injector.get(devkit.ViewModel, null);
                /** @type {?} */
         ...
         */
            function () {
                ...
                devkit.DataTypeInfoUtil.getChildrenNodeCodes(this.repository.entityTypeInfo, childrenEntityCodes);
                // 实体无子表
         ...
         */
            function () {
                ...
                /** @type {?} */
                var childrenEntityCodes = [];
                devkit.ExpressionUtil.getChildrenEntityPaths(this.repository.entityTypeInfo, childrenEntityCodes);
         ...
         */
            function (defaultValue) {
                ...
                return append$.pipe(operators.map(( /**
                 * @param {?} responseInfo
                 * @return {?}
                 */function (responseInfo) {
                    /** @type {?} */
         ...
         */
            function (position, defaultValue) {
                ...
                return insert$.pipe(operators.map(( /**
                 * @param {?} responseInfo
                 * @return {?}
                 */function (responseInfo) {
                    /** @type {?} */
         ...
         */
            function (id, ifSave) {
                ...
                if (ifSave) {
                    ...
                    return delete$.pipe(operators.switchMap(( /**
                     * @return {?}
                     */function () {
                     ...
                     */function () {
                        _this.repository.entityCollection.removeEntityById(id);
                        _this.repository.dataChangeHistory.addChange({ dataId: id, changeType: devkit.DataChangeType.Delete });
                        return rxjs.of(true);
                    })));
                }
            };
         ...
         */
            function (id) {
                ...
                /** @type {?} */
                var result$ = delete$.pipe(operators.switchMap(( /**
                 * @return {?}
                 */function () {
                    _this.repository.entityCollection.removeEntityById(id);
         ...
         */
            function (ids, ifSave) {
                 ...
                 */function () {
                    if (ifSave) {
                        // 执行保存
                        return _this.applyChangesByIdArray(ids).pipe(operators.tap(( /**
                         * @param {?} result
                         * @return {?}
                         */function (result) {
                            if (result) {
                        ...
                        if (ids && ids.length > 0) {
                             ...
                             * @return {?}
                             */function (id) {
                                changes_1.push({ dataId: id, changeType: devkit.DataChangeType.Delete });
                            }));
         ...
         */
            function (ids) {
                if (ids && ids.length > 0) {
                     ...
                     * @return {?}
                     */function (id) {
                        changes_2.push({ dataId: id, changeType: devkit.DataChangeType.Delete });
                    }));
         ...
         */
            function (fpath, id) {
                ...
                // 从本地实体集合中移除
                return delete$.pipe(operators.map(( /**
                 * @return {?}
                 */function () {
                    _this.repository.entityManager.removeEntityByPath(fpath, id);
                    _this.repository.dataChangeHistory.addChange({ fpath: fpath, dataId: id, changeType: devkit.DataChangeType.Delete });
                    return true;
                })));
            };
        /**
         ...
         */
            function () {
                ...
                // 串联流
                /** @type {?} */
                var result$ = rxjs.zip.apply(void 0, __spread(updateResults)).pipe(operators.map(( /**
                 * @return {?}
                 */function () {
                    return true;
                })));
         ...
         */
            function () {
                ...
                /** @type {?} */
                var result$ = save$.pipe(operators.tap(( /**
                 * @return {?}
                 */function () {
         ...
         */
            function (options) {
                ...
                /** @type {?} */
                var result$ = cancel$.pipe(operators.tap(( /**
                 * @return {?}
                 */function () {
                    _this.repository.entityManager.clearAllEntityChanges();
                    _this.repository.dataChangeHistory.clear();
    ...
    var BackEndMessageUtil = /** @class */ (function () {
         ...
         */
            function (messages, injector, options) {
                /** @type {?} */
                var namespace = injector.get(devkit.NAMESPACE, null);
                /** @type {?} */
                var appContext = injector.get(devkit.AppContext, null);
                /** @type {?} */
                var context = {
                    ns: namespace,
                ...
                /** @type {?} */
                var backEndMessage = new devkit.BackEndMessage.Message(bizMessages, context);
                /** @type {?} */
                var backEndMessageHandler = injector.get(devkit.BACK_END_MESSAGE_HANDLER_TOKEN, null);
    ...
    BefProxyExtend = /** @class */ (function () {
        function BefProxyExtend(context) {
            ...
            if (injector) {
                this.loadingService = injector.get(uiLoading.LoadingService, null);
            }
        }
        /**
         * 请求结果返回
            ...
            function (error, selfHandError, ignoreError) {
                ...
                if (loadingServices && loadingServices instanceof Array && loadingServices.length > 0) {
                    try {
                        ...
                        try {
                            if (loadingServices_1_1 && !loadingServices_1_1.done && (_a = loadingServices_1.return))
                                _a.call(loadingServices_1);
                        }
                        finally {
                            if (e_1)
                                throw e_1.error;
    ...
    var BefRepository = /** @class */ (function (_super) {
        ...
        function BefRepository(injector) {
            ...
            // 初始化变量管理器
            _this.appContext = _this.injector.get(devkit.AppContext);
            /** @type {?} */
            var ngVariables = devkit.MetadataUtil.getPropsMetadatasByName(_this.constructor, NG_VARIABLE);
        ...
        */
        ...
        /** @nocollapse */
        BefRepository.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
    ...
    var UriService = /** @class */ (function () {
        ...
        /** @nocollapse */
        UriService.ctorParameters = function () {
            return [
                { type: String, decorators: [{ type: core.Inject, args: [BE_SERVER_URI_TOKEN,] }] }
            ];
        };
        return UriService;
    }());
    ...
    var BefProxy = /** @class */ (function () {
         ...
         */
            function (entityFilter, requestInfo) {
                ...
                if (entityFilter) {
                    /** @type {?} */
                    var entityFilterJson = JSON.stringify(entityFilter);
                    entityFilterJson = devkit.encodeUrl(entityFilterJson);
                    url = url + "?entityFilter=" + entityFilterJson;
                }
                /** @type {?} */
                var body = requestInfo;
        ...
        BefProxy.prototype.request =
            ...
            function (url, method, params, options, selfHandError, ignoreError, ignoreChanges, runtimeContext) {
                ...
                return this.proxyExtend.extendHeaders(options.headers, runtimeContext).pipe(operators.switchMap(( /**
                 * @param {?} headers
                 * @return {?}
                 */function (headers) {
                 ...
                 * @param {?} response
                 * @return {?}
                 */function (response) { return _this.proxyExtend.parseHeaders(response); })), operators.map(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) { return result.body; })), operators.map(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) {
                    if (hasRequestInfo) {
         ...
         */
            function (url, method, options) {
                ...
                return headers$.pipe(operators.switchMap(( /**
                 * @param {?} headers
                 * @return {?}
                 */function (headers) {
                    options.headers = HttpHeaderUtil.toJson(headers);
                 ...
                 */function (response) { return _this.proxyExtend.parseHeaders(response); })), operators.map(( /**
                     ...
                     * @param {?} result
                     * @return {?}
                     */function (result) { return _this.proxyExtend.onResponse(result, false, options); })), operators.catchError(( /**
                     * @param {?} error
                     * @return {?}
        ...
        /** @nocollapse */
        BefProxy.ctorParameters = function () {
            return [
                { type: http.HttpClient },
                { type: UriService }
            ];
    ...
    var BefRestService = /** @class */ (function () {
         ...
         */
            function (url, method, params, options, selfHandError, ignoreError, ignoreChanges, useCorrectRequestInfoCheckMethod) {
                ...
                return BefSessionManager.getSessionId(formAppContext, this.sessionService).pipe(operators.switchMap(( /**
                 * @param {?} sessionId
                 * @return {?}
                 */function (sessionId) {
                 ...
                 * @param {?} response
                 * @return {?}
                 */function (response) { return response.body; })), operators.map(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) {
                    /** @type {?} */
        ...
        /** @nocollapse */
        BefRestService.ctorParameters = function () {
            return [
                { type: http.HttpClient },
                { type: String },
                { type: FrameworkSessionService },
                { type: BefRepository },
                { type: devkit.EventBus }
            ];
        };
    ...
    var BefLookupRestService = /** @class */ (function () {
        ...
        function BefLookupRestService(repository, frameContext) {
            ...
            this.loadingService = this.frameContext && this.frameContext.injector.get(uiLoading.LoadingService, null);
        }
        /**
         * @private
         * @return {?}
         ...
         */
            function (data) {
                ...
                return this.befRepository.restService.invoke(url, 'POST', null, { body: data }, false).pipe(operators.catchError(( /**
                 * @param {?} error
                 * @return {?}
                 */function (error) {
                    _this.clearLoading();
         ...
         */
            function (key) {
                ...
                return this.befRepository.restService.invoke(url, 'GET', null, null, false).pipe(operators.catchError(( /**
                 * @param {?} error
                 * @return {?}
                 */function (error) {
                    _this.clearLoading();
         ...
         */
            function (labelId, tableName, data) {
                ...
                /** @type {?} */
                var result$ = update$.pipe(operators.switchMap(( /**
                 * @return {?}
                 */function () {
                    _this.extendQueryParam(data);
                    // tslint:disable-next-line: max-line-length
                    return _this.befRepository.restService.invoke(url, 'GET', { nodeCode: tableName, queryParam: JSON.stringify(data) }, null, false).pipe(operators.catchError(( /**
                     * @param {?} error
                     * @return {?}
                     */function (error) {
                        _this.clearLoading();
        ...
        /** @nocollapse */
        BefLookupRestService.ctorParameters = function () {
            return [
    ...
    var BefLookupDefaultService = /** @class */ (function () {
            ...
            function (url) {
                ...
                if (userSessionID) {
                    return this.befRepository.restService.invoke(url, 'POST', null, {
                        headers: new http.HttpHeaders({ 'SessionId': userSessionID }),
                        responseType: 'text'
                    }, false).pipe(operators.switchMap(( /**
                     * @param {?} str
                     * @return {?}
                     */function (str) {
                        return rxjs.of({ status: true, payload: str });
                    })));
                }
                else {
                    return rxjs.of({ status: false, payload: '用户登录信息已过期，请重新登录' });
                }
            };
        /**
         * @param {?} url
         ...
         */
            function (url, params) {
                ...
                return this.createSession(createSessionUrl).pipe(operators.switchMap(( /**
                 * @param {?} usrSess
                 * @return {?}
                 */function (usrSess) {
                    if (usrSess.status) {
        ...
        /** @nocollapse */
        BefLookupDefaultService.ctorParameters = function () {
            return [
                { type: devkit.Repository },
                { type: FrameworkSessionService }
            ];
    ...
    var DefaultComboHttpService = /** @class */ (function () {
        ...
        /** @nocollapse */
        DefaultComboHttpService.ctorParameters = function () {
            return [
                { type: devkit.Repository }
            ];
        };
    ...
    var DefaultDynamiControlGroupHttpService = /** @class */ (function () {
        ...
        /** @nocollapse */
        DefaultDynamiControlGroupHttpService.ctorParameters = function () {
            return [
                { type: devkit.Repository }
            ];
        };
     ...
     */ DynamicBefRepository = /** @class */ (function (_super) {
        ...
        function DynamicBefRepository(injector, name, entityType, serverUri, apiUri) {
            ...
            _this.name = name;
            _this.entityTypeInfo = new devkit.DataTypeInfo(_this.entityType);
            _this.entityCollection = new devkit.EntityCollection(_this.entityType);
            // 初始化实体管理器
            _this.entityManager = new BefEntityManager(_this.entityCollection);
            // 设置proxy属性值
            /** @type {?} */
     ...
     */ PresetBefRepository = /** @class */ (function (_super) {
        ...
        function PresetBefRepository(injector, schema) {
            ...
            _this.schema = schema;
            /** @type {?} */
            var entityTypeFactory = new devkit.EntityTypeFactory();
    ...
    exports.ChangeDetailType = ChangeDetailType;
    exports.BE_SERVER_URI_TOKEN = BE_SERVER_URI_TOKEN;
    exports.BE_SESSION_HANDLING_STRATEGY_TOKEN = BE_SESSION_HANDLING_STRATEGY_TOKEN;
    ...
    exports.BefRestService = BefRestService;
    exports.BefProxy = BefProxy;
    exports.BefLookupRestService = BefLookupRestService;
    exports.BefLookupDefaultService = BefLookupDefaultService;
    exports.BefRepository = BefRepository;
    exports.FrameworkSessionService = FrameworkSessionService;
    exports.NG_VARIABLE = NG_VARIABLE;
    exports.NgVariable = NgVariable;
    exports.BefRepositoryUtil = BefRepositoryUtil;
    exports.BefDataPathUtil = BefDataPathUtil;
    exports.UriService = UriService;
    exports.Uri = Uri;
    exports.DefaultComboHttpService = DefaultComboHttpService;
    exports.DefaultDynamiControlGroupHttpService = DefaultDynamiControlGroupHttpService;
    exports.BefEntityManager = BefEntityManager;
    exports.DynamicBefRepository = DynamicBefRepository;
    exports.PresetBefRepository = PresetBefRepository;
    exports.BefVariableManager = BefVariableManager;
    exports.ɵa = DeprecatedBefRepository;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-bef.umd.js.map
import { ElementRef, EventEmitter, SimpleChanges, AfterViewInit, DoCheck, OnChanges, AfterContentChecked, OnDestroy, Injector } from "@angular/core";
...
export declare class CalendarComponent implements AfterViewInit, DoCheck, OnChanges, AfterContentChecked, OnDestroy {
    element: ElementRef;
    ...
    constructor(element: ElementRef, configService: DefaultConfigService, injector: Injector);

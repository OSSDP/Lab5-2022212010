(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('date-fns'), require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('@farris/ui-common'), require('@farris/ui-modal'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-messager', ['exports', 'rxjs', 'date-fns', '@angular/core', '@angular/forms', '@angular/common', '@farris/ui-common', '@farris/ui-modal', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-messager'] = {}),global.rxjs,global.dateFns,global.ng.core,global.ng.forms,global.ng.common,global.uiCommon,global.uiModal,global.uiLocale));
}(this, (function (exports,rxjs,dateFns,core,forms,common,uiCommon,uiModal,uiLocale) { 'use strict';
    ...
    var FarrisDefaultFocusDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FarrisDefaultFocusDirective.ctorParameters = function () {
            return [
        ...
        FarrisDefaultFocusDirective.propDecorators = {
            button: [{ type: core.Input, args: ['farris-default-focus',] }]
        };
    ...
    /** @type {?} */
    var MESSAGER_DEFAULT_CONFIG = new core.InjectionToken('Messager default options.');
    ...
    var MessagerComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MessagerComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
        MessagerComponent.propDecorators = {
            ...
            showFontSize: [{ type: core.Input }],
            message: [{ type: core.Input }],
            msg: [{ type: core.Input }],
            cls: [{ type: core.HostBinding, args: ['class',] }],
            okText: [{ type: core.Input }],
            cancelText: [{ type: core.Input }],
            showOkButton: [{ type: core.Input }],
            showCancelButton: [{ type: core.Input }],
            readonly: [{ type: core.Input }],
            okHandle: [{ type: core.Input }],
            cancelHandle: [{ type: core.Input }],
            enableWordCount: [{ type: core.Input }],
            countType: [{ type: core.Input }],
            maxLength: [{ type: core.Input }],
            exception: [{ type: core.Input }],
            showLines: [{ type: core.Input }],
            promptText: [{ type: core.ViewChild, args: ['promptText',] }],
            fontSizeEl: [{ type: core.ViewChild, args: ['fontSizeEl',] }],
            wordCountEl: [{ type: core.ViewChild, args: ['wordCount',] }],
            excepMsgEl: [{ type: core.ViewChild, args: ['excepMsg',] }],
            allexcepEl: [{ type: core.ViewChild, args: ['allexcep',] }],
            miniNotifyEl: [{ type: core.ViewChild, args: ['miniNotify',] }],
            btnOkEl: [{ type: core.ViewChild, args: ['btnOkEl',] }],
    ...
    var MessagerService = /** @class */ (function () {
         ...
         */
            function (msgtype, message, opts, submsg) {
                ...
                this.confirmSubject = new rxjs.Subject();
         ...
         */
            function (title, msg, fitContent) {
                ...
                /** @type {?} */
                var promptSubject = new rxjs.Subject();
                /** @type {?} */
         ...
         */
            function (message, msg, fitContent) {
                ...
                /** @type {?} */
                var confirmSubject = new rxjs.Subject();
                /** @type {?} */
         ...
         */
            function (_error, opts) {
                if (opts === void 0) {
                    opts = { width: 440, height: 200, log: false };
                }
                /** @type {?} */
         ...
         */
            function (error, opts) {
                ...
                /** @type {?} */
                var date = error.date || dateFns.format(new Date(), 'yyyy-MM-dd HH:mm:ss');
                /** @type {?} */
                var localDate = date;
                // 发生时间
                /** @type {?} */
        ...
        /** @nocollapse */
        MessagerService.ctorParameters = function () {
            return [
    ...
    exports.FarrisDefaultFocusDirective = FarrisDefaultFocusDirective;
    exports.MessagerDefaultConfig = MessagerDefaultConfig;
    exports.MESSAGER_DEFAULT_CONFIG = MESSAGER_DEFAULT_CONFIG;
...
//# sourceMappingURL=farris-ui-messager.umd.js.map
import { Injectable, EventEmitter, Component, NgZone, ElementRef, Renderer2, Injector, Input, Output, ComponentFactoryResolver, ApplicationRef, ChangeDetectorRef, ViewChild, Directive, ViewContainerRef, ViewEncapsulation, ViewChildren, NgModule } from '@angular/core';
 ...
 */
/** @type {?} */
var FilterRowProvider = { provide: GRID_FILTER_ROW, useValue: FilterRowComponent };

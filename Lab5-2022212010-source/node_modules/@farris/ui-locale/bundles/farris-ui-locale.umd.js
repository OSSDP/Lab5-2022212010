(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-locale', ['exports', '@farris/ui-common', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-locale'] = {}),global.i1,global.ng.core));
     ...
     */
    /** @type {?} */
    var COLLAPSE_DIRECTIVE_LOCALE_ZHCHS = {
        expand: '展开',
        fold: '收起'
    };
     ...
     */
    /** @type {?} */
    var FILTER_EDITOR_LOCALE_ZHCHS = {
        // 取消
        cancelButton: '取消',
        // 确定
        okButton: '确定',
     ...
     */
    /** @type {?} */
    var QUERY_CONDITION_LOCALE_ZHCHS = {
        configDialog: {
     ...
     */
    /** @type {?} */
    var QUERY_SOLUTION_LOCALE_ZHCHS = {
        saveAsDialog: {
            queryPlanName: '方案名称',
            setAsDefault: '设为默认',
            confirm: '确定',
     ...
     */
    /** @type {?} */
    var RESPONSE_TOOLBAR_LOCALE_ZHCHS = {
        more: '更多',
    };
     ...
     */
    /** @type {?} */
    var PROGRESS_STEP_LOCALE_ZHCHS = {
        empty: '步骤条信息为空'
    };
     ...
     */
    /** @type {?} */
    var LANGUAGE_LABEL_LOCALE_ZHCHS = {
        en: '英语',
        "zh-cn": '简体中文',
        "zh-CHS": '简体中文',
        "zh-CHT": '繁体中文',
     ...
     */
    /** @type {?} */
    var BATCH_EDIT_DIALOG_LOCALE_ZHCHS = {
        title: '批量编辑',
        appendText: '添加新编辑列',
     ...
     */
    /** @type {?} */
    var DISCUSSION_GROUP_LOCALE_ZHCHS = {
        submit: '提交',
        cancel: '取消',
        colleague: '同事',
        all: '所有人员可见',
     ...
     */
    /** @type {?} */
    var LOOKUP_CONFIG_LOCALE_ZHCHS = {
        placeholder: '选择表单元数据',
        code: '编号',
        name: '名称',
        select: '选择帮助元数据',
     ...
     */
    /** @type {?} */
    var FILTER_EDITOR_LOCALE_ZHCHT = {
        // 取消
        cancelButton: '取消',
        // 確定
        okButton: '確定',
     ...
     */
    /** @type {?} */
    var RESPONSE_TOOLBAR_LOCALE_ZHCHT = {
        more: '更多',
    };
     ...
     */
    /** @type {?} */
    var QUERY_CONDITION_LOCALE_ZHCHT = {
        configDialog: {
     ...
     */
    /** @type {?} */
    var QUERY_SOLUTION_LOCALE_ZHCHT = {
        saveAsDialog: {
            queryPlanName: '方案名稱',
            setAsDefault: '設為默認',
            confirm: '確定',
     ...
     */
    /** @type {?} */
    var COLLAPSE_DIRECTIVE_LOCALE_ZHCHT = {
        expand: '展開',
        fold: '收起'
    };
     ...
     */
    /** @type {?} */
    var PROGRESS_STEP_LOCALE_ZHCHT = {
        empty: '步驟條信息為空'
    };
     ...
     */
    /** @type {?} */
    var LANGUAGE_LABEL_LOCALE_ZHCHT = {
        en: '英語',
        "zh-cn": '簡體中文',
        "zh-CHS": '簡體中文',
        "zh-CHT": '繁體中文',
     ...
     */
    /** @type {?} */
    var BATCH_EDIT_DIALOG_LOCALE_ZHCHT = {
        title: '批量編輯',
        appendText: '添加新編輯列',
     ...
     */
    /** @type {?} */
    var DISCUSSION_GROUP_LOCALE_ZHCHT = {
        submit: '提交',
        cancel: '取消',
        colleague: '同事',
        all: '所有人員可見',
     ...
     */
    /** @type {?} */
    var LOOKUP_CONFIG_LOCALE_ZHCHT = {
        placeholder: '選擇表單元數據',
        code: '編號',
        name: '名稱',
        select: '選擇幫助元數據',
     ...
     */
    /** @type {?} */
    var FARRIS_LOCAL_CUSTOM_DATA = new i0.InjectionToken('自定义语言数据， 格式：{ "languageCode": { "name": { "key": "value" } } }');
    var LocaleService = /** @class */ (function () {
        ...
        LocaleService.ctorParameters = function () {
            return [
                ...
                { type: i1.CommonUtils },
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [FARRIS_LOCAL_CUSTOM_DATA,] }] }
            ];
        };
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var FarrisLocalePipe = /** @class */ (function () {
        function FarrisLocalePipe(localeService) {
         ...
         * @return {?}
         */
        FarrisLocalePipe.prototype.transform = /**
         * @param {?} name
         * @param {?=} defaultVal
         * @param {?=} customText
         * @return {?}
         */
            function (name, defaultVal, customText) {
                ...
                if (!customText) {
                    /** @type {?} */
                    var r = this.localeService.getValue(name);
                    return r ? r : defaultVal;
                }
                return customText;
            };
        FarrisLocalePipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'locale' },] }
        ];
        /** @nocollapse */
        FarrisLocalePipe.ctorParameters = function () {
            return [
                { type: LocaleService }
            ];
        };
        return FarrisLocalePipe;
    }());
         ...
         */
            function (customData) {
                return {
                    ...
                    providers: [
                        { provide: FARRIS_LOCAL_CUSTOM_DATA, useValue: customData || {} },
                        LocaleService
                    ]
                };
            };
    ...
    exports.EN_US = EN_US;
    exports.ZH_CN = ZH_CN;
    exports.COLLAPSE_DIRECTIVE_LOCALE = COLLAPSE_DIRECTIVE_LOCALE;
    exports.DATAGRID_LOCALE = DATAGRID_LOCALE;
    exports.FILTER_EDITOR_LOCALE = FILTER_EDITOR_LOCALE;
    exports.ENUM_EDITOR_LOCALE = ENUM_EDITOR_LOCALE;
    exports.LOADING_LOCALE = LOADING_LOCALE;
    exports.LOOKUP_LOCALE = LOOKUP_LOCALE;
    exports.MESSAGER_LOCALE = MESSAGER_LOCALE;
    exports.MULTI_SELECT_LOCALE = MULTI_SELECT_LOCALE;
    exports.NOTIFY_LOCALE = NOTIFY_LOCALE;
    exports.PAGINATION_LOCALE = PAGINATION_LOCALE;
    exports.QUERY_CONDITION_LOCALE = QUERY_CONDITION_LOCALE;
    exports.QUERY_SOLUTION_LOCALE = QUERY_SOLUTION_LOCALE;
    exports.RESPONSE_TOOLBAR_LOCALE = RESPONSE_TOOLBAR_LOCALE;
    exports.SECTION_LOCALE = SECTION_LOCALE;
    exports.SIDEBAR_LOCALE = SIDEBAR_LOCALE;
    exports.SORT_EDITOR_LOCALE = SORT_EDITOR_LOCALE;
    exports.TABS_LOCALE = TABS_LOCALE;
    exports.TEXT_LOCALE = TEXT_LOCALE;
    exports.TREETABLE_LOCALE = TREETABLE_LOCALE;
    exports.AVATAR_LOCALE = AVATAR_LOCALE;
    exports.LIST_FILTER_LOCALE = LIST_FILTER_LOCALE;
    exports.PROGRESS_STEP_LOCALE = PROGRESS_STEP_LOCALE;
    exports.LANGUAGE_LABEL_LOCALE = LANGUAGE_LABEL_LOCALE;
    exports.VERIFY_DETAIL_LOCALE = VERIFY_DETAIL_LOCALE;
    exports.COLLAPSE_DIRECTIVE_LOCALE_ZHCHS = COLLAPSE_DIRECTIVE_LOCALE_ZHCHS;
    exports.DATAGRID_LOCALE_ZHCHS = DATAGRID_LOCALE_ZHCHS;
    exports.FILTER_EDITOR_LOCALE_ZHCHS = FILTER_EDITOR_LOCALE_ZHCHS;
    exports.ENUM_EDITOR_LOCALE_ZHCHS = ENUM_EDITOR_LOCALE_ZHCHS;
    exports.LOADING_LOCALE_ZHCHS = LOADING_LOCALE_ZHCHS;
    exports.LOOKUP_LOCALE_ZHCHS = LOOKUP_LOCALE_ZHCHS;
    exports.MESSAGER_LOCALE_ZHCHS = MESSAGER_LOCALE_ZHCHS;
    exports.MULTI_SELECT_LOCALE_ZHCHS = MULTI_SELECT_LOCALE_ZHCHS;
    exports.NOTIFY_LOCALE_ZHCHS = NOTIFY_LOCALE_ZHCHS;
    exports.PAGINATION_LOCALE_ZHCHS = PAGINATION_LOCALE_ZHCHS;
    exports.QUERY_CONDITION_LOCALE_ZHCHS = QUERY_CONDITION_LOCALE_ZHCHS;
    exports.QUERY_SOLUTION_LOCALE_ZHCHS = QUERY_SOLUTION_LOCALE_ZHCHS;
    exports.RESPONSE_TOOLBAR_LOCALE_ZHCHS = RESPONSE_TOOLBAR_LOCALE_ZHCHS;
    exports.SECTION_LOCALE_ZHCHS = SECTION_LOCALE_ZHCHS;
    exports.SIDEBAR_LOCALE_ZHCHS = SIDEBAR_LOCALE_ZHCHS;
    exports.SORT_EDITOR_LOCALE_ZHCHS = SORT_EDITOR_LOCALE_ZHCHS;
    exports.TABS_LOCALE_ZHCHS = TABS_LOCALE_ZHCHS;
    exports.TEXT_LOCALE_ZHCHS = TEXT_LOCALE_ZHCHS;
    exports.TREETABLE_LOCALE_ZHCHS = TREETABLE_LOCALE_ZHCHS;
    exports.AVATAR_LOCALE_ZHCHS = AVATAR_LOCALE_ZHCHS;
    exports.LIST_FILTER_LOCALE_ZHCHS = LIST_FILTER_LOCALE_ZHCHS;
    exports.PROGRESS_STEP_LOCALE_ZHCHS = PROGRESS_STEP_LOCALE_ZHCHS;
    exports.LANGUAGE_LABEL_LOCALE_ZHCHS = LANGUAGE_LABEL_LOCALE_ZHCHS;
    exports.VERIFY_DETAIL_ZHCHS = VERIFY_DETAIL_ZHCHS;
    exports.FARRIS_LOCAL_CUSTOM_DATA = FARRIS_LOCAL_CUSTOM_DATA;
    exports.LocaleService = LocaleService;
    exports.FarrisLocalePipe = FarrisLocalePipe;
    exports.LocaleModule = LocaleModule;
    exports.FARRIS_LOCALES = FARRIS_LOCALES;
    exports.ɵd = BATCH_EDIT_DIALOG_LOCALE;
    exports.ɵa = COMBO_LOCALE;
    exports.ɵg = DISCUSSION_GROUP_LOCALE;
    exports.ɵi = FILTER_PANEL_LOCALE;
    exports.ɵf = FOOTER_LOCALE;
    exports.ɵc = LISTVIEW_LOCALE;
    exports.ɵk = LOOKUP_CONFIG_LOCALE;
    exports.ɵb = NUMERIC_LOCALE;
    exports.ɵe = PAGE_WALKER_LOCALE;
    exports.ɵj = SCROLLSPY_LOCALE;
    exports.ɵh = TAG_LOCALE;
    exports.ɵbt = AVATAR_LOCALE_ZHCHT;
    exports.ɵby = BATCH_EDIT_DIALOG_LOCALE_ZHCHT;
    exports.ɵbs = COLLAPSE_DIRECTIVE_LOCALE_ZHCHT;
    exports.ɵx = COMBO_LOCALE$2;
    exports.ɵy = DATAGRID_LOCALE_ZHCHT;
    exports.ɵcb = DISCUSSION_GROUP_LOCALE_ZHCHT;
    exports.ɵba = ENUM_EDITOR_LOCALE_ZHCHT;
    exports.ɵz = FILTER_EDITOR_LOCALE_ZHCHT;
    exports.ɵcd = FILTER_PANEL_LOCALE_ZHCHT;
    exports.ɵca = FOOTER_LOCALE_ZHCHT;
    exports.ɵw = ZH_CHT;
    exports.ɵbw = LANGUAGE_LABEL_LOCALE_ZHCHT;
    exports.ɵbu = LIST_FILTER_LOCALE_ZHCHT;
    exports.ɵbk = LISTVIEW_LOCALE_ZHCHT;
    exports.ɵbc = LOADING_LOCALE_ZHCHT;
    exports.ɵbb = LOOKUP_LOCALE_ZHCHT;
    exports.ɵcf = LOOKUP_CONFIG_LOCALE_ZHCHT;
    exports.ɵbd = MESSAGER_LOCALE_ZHCHT;
    exports.ɵbi = MULTI_SELECT_LOCALE_ZHCHT;
    exports.ɵbe = NOTIFY_LOCALE_ZHCHT;
    exports.ɵbf = NUMERIC_LOCALE_ZHCHT;
    exports.ɵbz = PAGE_WALKER_ZHCHT;
    exports.ɵbo = PAGINATION_LOCALE_ZHCHT;
    exports.ɵbv = PROGRESS_STEP_LOCALE_ZHCHT;
    exports.ɵbq = QUERY_CONDITION_LOCALE_ZHCHT;
    exports.ɵbr = QUERY_SOLUTION_LOCALE_ZHCHT;
    exports.ɵbp = RESPONSE_TOOLBAR_LOCALE_ZHCHT;
    exports.ɵce = SCROLLSPY_LOCALE_ZHCHT;
    exports.ɵbn = SECTION_LOCALE_ZHCHT;
    exports.ɵbm = SIDEBAR_LOCALE_ZHCHT;
    exports.ɵbg = SORT_EDITOR_LOCALE_ZHCHT;
    exports.ɵbj = TABS_LOCALE_ZHCHT;
    exports.ɵcc = TAG_LOCALE_ZHCHT;
    exports.ɵbl = TEXT_LOCALE_ZHCHT;
    exports.ɵbh = TREETABLE_LOCALE_ZHCHT;
    exports.ɵbx = VERIFY_DETAIL_ZHCHT;
    exports.ɵo = BATCH_EDIT_DIALOG_LOCALE_ZHCHS;
    exports.ɵl = COMBO_LOCALE$1;
    exports.ɵr = DISCUSSION_GROUP_LOCALE_ZHCHS;
    exports.ɵt = FILTER_PANEL_LOCALE_ZHCHS;
    exports.ɵq = FOOTER_LOCALE_ZHCHS;
    exports.ɵn = LISTVIEW_LOCALE_ZHCHS;
    exports.ɵv = LOOKUP_CONFIG_LOCALE_ZHCHS;
    exports.ɵm = NUMERIC_LOCALE_ZHCHS;
    exports.ɵp = PAGE_WALKER_ZHCHS;
    exports.ɵu = SCROLLSPY_LOCALE_ZHCHS;
    exports.ɵs = TAG_LOCALE_ZHCHS;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-locale.umd.js.map
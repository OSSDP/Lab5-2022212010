...
function replaceBootstrap(shouldTransform, getEntryModule, getTypeChecker, enableIvy) {
    const standardTransform = function (sourceFile) {
        ...
        entryModuleIdentifiers.forEach(entryModuleIdentifier => {
            ...
            ops.push(
                new interfaces_1.RemoveNodeOperation(sourceFile, sourceFile.imports[2].parent),
                new interfaces_1.RemoveNodeOperation(sourceFile, sourceFile.imports[3].parent),
                // Replace the entry module import.
                ...insert_import_1.insertStarImport(sourceFile, idNgFactory, modulePath),
                new interfaces_1.ReplaceNodeOperation(sourceFile, entryModuleIdentifier, ts.createPropertyAccess(idNgFactory, ts.createIdentifier(className))),
                // Replace the platformBrowserDynamic import.
                ...insert_import_1.insertStarImport(sourceFile, idPlatformBrowser, '@angular/platform-browser'),
                new interfaces_1.ReplaceNodeOperation(sourceFile, platformBrowserDynamicIdentifier, ts.createPropertyAccess(idPlatformBrowser, 'platformBrowser')),

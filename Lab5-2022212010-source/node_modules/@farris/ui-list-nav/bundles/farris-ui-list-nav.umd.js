(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-draggable'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-list-nav', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@farris/ui-draggable', '@angular/router'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-list-nav'] = {}),global.ng.core,global.ng.common,global.ng.forms,global.uiDraggable,global.ng.router));
}(this, (function (exports,i0,common,forms,uiDraggable,router) { 'use strict';
    ...
    var ListNavComponent = /** @class */ (function () {
        ...
        function ListNavComponent(elementRef, renderer) {
             ...
             */
            this.rzStart = new i0.EventEmitter();
            /**
             * emitted when start resizing
             */
            this.rzResizing = new i0.EventEmitter();
            /**
             * emitted when stop resizing
             */
            this.rzStop = new i0.EventEmitter();
            /**
             * listnav宽度
       ...
       */
        ...
        /** @nocollapse */
        ListNavComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 }
            ];
        ...
        ListNavComponent.propDecorators = {
            ...
            rzStart: [{ type: i0.Output }],
            rzResizing: [{ type: i0.Output }],
            rzStop: [{ type: i0.Output }],
            draggableWrapper: [{ type: i0.ViewChild, args: ['draggableWrapper',] }],
            title: [{ type: i0.Input }],
            ...
            enableDraggable: [{ type: i0.Input }],
            rzMinWidth: [{ type: i0.Input }],
            rzHandles: [{ type: i0.Input }],

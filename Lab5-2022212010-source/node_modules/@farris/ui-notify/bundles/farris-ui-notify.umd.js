(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash-es'), require('rxjs'), require('@angular/common'), require('@angular/core'), require('@farris/ui-common'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-notify', ['exports', 'lodash-es', 'rxjs', '@angular/common', '@angular/core', '@farris/ui-common', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-notify'] = {}),global.lodashEs,global.rxjs,global.ng.common,global.ng.core,global.uiCommon,global.uiLocale));
}(this, (function (exports,lodashEs,rxjs,common,core,uiCommon,uiLocale) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NotifyComponent = /** @class */ (function () {
        ...
        NotifyComponent.propDecorators = {
            ...
            notifyDiv: [{ type: core.ViewChild, args: ['notifyDiv',] }],
            animateCls: [{ type: core.Input }]
        };
    ...
    var NotifyContainerComponent = /** @class */ (function () {
        function NotifyContainerComponent(ngZone) {
            ...
            this.id = '';
            this.empty = new core.EventEmitter();
            this.toasts = [];
        }
         ...
         */
            function (id) {
                ...
                if (id) {
                     ...
                     */function (value, key) {
                        if (value.id === id) {
                            if (value.onRemove && lodashEs.isFunction(value.onRemove)) {
        ...
        /** @nocollapse */
        NotifyContainerComponent.ctorParameters = function () {
            return [
                { type: core.NgZone }
            ];
        };
        NotifyContainerComponent.propDecorators = {
            notifyCmpList: [{ type: core.ViewChildren, args: [NotifyComponent,] }],
            empty: [{ type: core.Output }],
    ...
    exports.NotifyEventType = NotifyEventType;
...
//# sourceMappingURL=farris-ui-notify.umd.js.map
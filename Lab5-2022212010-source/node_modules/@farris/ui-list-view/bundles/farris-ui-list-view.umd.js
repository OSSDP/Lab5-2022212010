(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('resize-observer-polyfill'), require('@farris/ui-common'), require('@farris/ui-locale'), require('@angular/forms'), require('@angular/common'), require('@farris/ui-pagination'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-list-view', ['exports', 'resize-observer-polyfill', '@farris/ui-common', '@farris/ui-locale', '@angular/forms', '@angular/common', '@farris/ui-pagination', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-list-view'] = {}),global.ResizeObserver,global.uiCommon,global.uiLocale,global.ng.forms,global.ng.common,global.uiPagination,global.ng.core));
}(this, (function (exports,ResizeObserver,uiCommon,uiLocale,forms,common,uiPagination,i0) { 'use strict';
    ...
    var ListViewService = /** @class */ (function () {
        ...
        /** @nocollapse */
        ListViewService.ctorParameters = function () { return []; };
        /** @nocollapse */ ListViewService.ngInjectableDef = i0.defineInjectable({ factory: function ListViewService_Factory() { return new ListViewService(); }, token: ListViewService, providedIn: "root" });
    ...
    ***************************************************************************** */
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ListViewHeaderTemplateDirective = /** @class */ (function () {
        function ListViewHeaderTemplateDirective(template) {
        ...
        /** @nocollapse */
        ListViewHeaderTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
        return ListViewHeaderTemplateDirective;
    }());
    var ListViewTemplateDirective = /** @class */ (function () {
        function ListViewTemplateDirective(template) {
            this.template = template;
        }
        ...
        /** @nocollapse */
        ListViewTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
        return ListViewTemplateDirective;
    }());
    var ListViewFooterTemplateDirective = /** @class */ (function () {
        function ListViewFooterTemplateDirective(template) {
            this.template = template;
        }
        ...
        /** @nocollapse */
        ListViewFooterTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
        return ListViewFooterTemplateDirective;
    }());
    var ListViewEmptyTemplateDirective = /** @class */ (function () {
        function ListViewEmptyTemplateDirective(template) {
            this.template = template;
        }
        ...
        /** @nocollapse */
        ListViewEmptyTemplateDirective.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
        return ListViewEmptyTemplateDirective;
    }());
    ...
    var ListViewComponent = /** @class */ (function () {
        function ListViewComponent(el, renderer, cdr, inject) {
            ...
            this.checkItems = [];
            this.checkItemsChange = new i0.EventEmitter();
             ...
             * 点击某一行后
             */
            this.listClick = new i0.EventEmitter();
            /**
             * 多选框 选中状态变化
             */
            this.checkChange = new i0.EventEmitter();
            // 分页事件
         ...
         */
            function (changes) {
                ...
                if (changes.checkItems && !changes.checkItems.isFirstChange()) {
                    this.selectDataListWithOtherPager = __spread(this.checkItems);
                    /** @type {?} */
       ...
       * */
        ...
        */
            ...
            function (active, listItem, emit) {
                ...
                if (this.multipleSelect && this.enableMorePageSelect) {
                    if (active === 'remove' && listItem) {
                        ...
                        if (emit) {
                            this.checkItemsChange.emit({ items: __spread(this.selectDataListWithOtherPager), instance: this });
                        }
                    }
                    else if (active === 'append') {
                        if (!Array.isArray(listItem)) {
                            this.selectDataListWithOtherPager = __spread(this.selectDataListWithOtherPager, [listItem]);
                        }
                        else {
                            this.selectDataListWithOtherPager = __spread(this.selectDataListWithOtherPager, listItem);
                        }
                        ...
                        if (!this.selectDataListWithOtherPager.length) {
                            this.selectDataListWithOtherPager = __spread(this.selectDataList);
                        }
                        else {
                            /** @type {?} */
        ...
        ListViewComponent.propDecorators = {
            headerTemplate: [{ type: i0.ContentChild, args: [ListViewHeaderTemplateDirective, { read: i0.TemplateRef },] }],
            listTemplate: [{ type: i0.ContentChild, args: [ListViewTemplateDirective, { read: i0.TemplateRef },] }],
            footerTemplate: [{ type: i0.ContentChild, args: [ListViewFooterTemplateDirective, { read: i0.TemplateRef },] }],
            emptyDataTemplate: [{ type: i0.ContentChild, args: [ListViewEmptyTemplateDirective, { read: i0.TemplateRef },] }],
            headerComponentType: [{ type: i0.Input }],
            listComponentType: [{ type: i0.Input }],
            emptyComponentType: [{ type: i0.Input }],
            footerComponentType: [{ type: i0.Input }],
            scrollEl: [{ type: i0.ViewChild, args: ['scrollEl',] }],
            listGroup: [{ type: i0.ViewChild, args: ['listGroup',] }],
            pager: [{ type: i0.ViewChild, args: ['pager',] }],
            data: [{ type: i0.Input }],
            id: [{ type: i0.Input }],
            showEmpty: [{ type: i0.Input }],
            emptyTemplate: [{ type: i0.Input }],
            multipleSelect: [{ type: i0.Input }],
            supportPaging: [{ type: i0.Input }],
            pagerOnServer: [{ type: i0.Input }],
            pageSize: [{ type: i0.Input }],
            pageIndex: [{ type: i0.Input }],
            enableMorePageSelect: [{ type: i0.Input }],
            showSelectedList: [{ type: i0.Input }],
            selectedItemFormat: [{ type: i0.Input }],
            keepSelect: [{ type: i0.Input }],
            fill: [{ type: i0.Input }],
            cardLayout: [{ type: i0.Input }],
            activeIndex: [{ type: i0.Input }],
            listClassName: [{ type: i0.Input }],
            checkValues: [{ type: i0.Input }],
            checkValuesChange: [{ type: i0.Output }],
            checkItems: [{ type: i0.Input }],
            checkItemsChange: [{ type: i0.Input }],
            showPageList: [{ type: i0.Input }],
            showPageInfo: [{ type: i0.Input }],
            showPageNumber: [{ type: i0.Input }],
            showGotoInput: [{ type: i0.Input }],
            keepScrollPosition: [{ type: i0.Input }],
            pageList: [{ type: i0.Input }],
            total: [{ type: i0.Input }],
            listidName: [{ type: i0.Input }],
            listviewFill: [{ type: i0.HostBinding, args: ['class.f-listview-fill',] }],
            listClick: [{ type: i0.Output }],
            checkChange: [{ type: i0.Output }],
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ListViewCheckoutComponent = /** @class */ (function () {
        function ListViewCheckoutComponent() {
            this.checkedChange = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ListViewCheckoutComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () { };
        /**
         ...
         * @return {?}
         */
        ListViewCheckoutComponent.prototype.handleClick = /**
         * @param {?} event
         * @return {?}
         */
            function (event) {
        ...
        /** @nocollapse */
        ListViewCheckoutComponent.ctorParameters = function () { return []; };
        ...
        return ListViewCheckoutComponent;
    }());
    ...
    var SelectedListFormatPipe = /** @class */ (function () {
        ...
        SelectedListFormatPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'formatItems' },] }
        ];
        /** @nocollapse */
        SelectedListFormatPipe.ctorParameters = function () {
            return [
    ...
    exports.ListViewHeaderTemplateDirective = ListViewHeaderTemplateDirective;
    exports.ListViewTemplateDirective = ListViewTemplateDirective;
    exports.ListViewFooterTemplateDirective = ListViewFooterTemplateDirective;
    exports.ListViewEmptyTemplateDirective = ListViewEmptyTemplateDirective;
    exports.ListViewCheckoutComponent = ListViewCheckoutComponent;
    exports.SelectedListFormatPipe = SelectedListFormatPipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-list-view.umd.js.map
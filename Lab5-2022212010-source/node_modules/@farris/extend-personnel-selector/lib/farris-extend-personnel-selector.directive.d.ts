...
export declare class PersonnelSelectorDataMappingDirective implements OnInit, AfterViewInit, OnDestroy {
    private vm;
    private targetComponent;
    private injector;
    mapFields: any;
    constructor(vm: ViewModel, targetComponent: PersonnelSelectorComponent, injector: Injector);
    ngOnInit(): void;

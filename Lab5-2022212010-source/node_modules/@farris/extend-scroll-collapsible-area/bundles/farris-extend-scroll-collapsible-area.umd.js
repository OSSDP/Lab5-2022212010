(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@farris/extend-scroll-collapsible-area', ['exports', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['extend-scroll-collapsible-area'] = {}),global.rxjs,global.rxjs.operators,global.ng.core));
    ...
    var FECollapsibleAreaComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FECollapsibleAreaComponent.ctorParameters = function () {
            return [
                { type: i0.NgZone },
                { type: i0.ElementRef }
            ];
        ...
        FECollapsibleAreaComponent.propDecorators = {
            cls: [{ type: i0.HostBinding, args: ['class.fe-cmp-collapsible-area',] }],
            defaultCollapse: [{ type: i0.Input }],
            contentArea: [{ type: i0.ViewChild, args: ['contentArea',] }],
            containerArea: [{ type: i0.ViewChild, args: ['containerArea',] }]
        };
    ...
    var FEScrollAreaDirective = /** @class */ (function () {
        ...
        FEScrollAreaDirective.prototype.bindScrollEvent =
            ...
            function () {
                var _this = this;
                this.scrollSub = rxjs.fromEvent(this.el.nativeElement, 'scroll').pipe(operators.debounceTime(20)).subscribe(( /**
                 * @return {?}
                 */function () {
                    //判断滚动的方向
        ...
        /** @nocollapse */
        FEScrollAreaDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
    ...
    var FEScrollCollapsibleAreaDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FEScrollCollapsibleAreaDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        FEScrollCollapsibleAreaDirective.propDecorators = {
            collapseArea: [{ type: i0.ContentChild, args: [FECollapsibleAreaComponent,] }],
            scrollArea: [{ type: i0.ContentChild, args: [FEScrollAreaDirective,] }]
        };
    ...
    var FEScrollCollapsibleAreaService = /** @class */ (function () {
        ...
        /** @nocollapse */ FEScrollCollapsibleAreaService.ngInjectableDef = i0.defineInjectable({ factory: function FEScrollCollapsibleAreaService_Factory() { return new FEScrollCollapsibleAreaService(); }, token: FEScrollCollapsibleAreaService, providedIn: "root" });
    ...
    exports.FECollapsibleAreaComponent = FECollapsibleAreaComponent;
    exports.FEScrollAreaDirective = FEScrollAreaDirective;
    exports.FEScrollCollapsibleAreaDirective = FEScrollCollapsibleAreaDirective;
    exports.FEScrollCollapsibleAreaService = FEScrollCollapsibleAreaService;
    exports.FEScrollCollapsibleAreaModule = FEScrollCollapsibleAreaModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-extend-scroll-collapsible-area.umd.js.map
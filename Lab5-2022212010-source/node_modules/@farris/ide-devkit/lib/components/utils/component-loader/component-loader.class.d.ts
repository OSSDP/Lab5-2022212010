import { ApplicationRef, ComponentFactoryResolver, ComponentRef, ElementRef, EmbeddedViewRef, EventEmitter, Injector, NgZone, Provider, Renderer2, TemplateRef, Type, ViewContainerRef } from '@angular/core';

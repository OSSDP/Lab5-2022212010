 ...
 */
export declare class NgbNavTabTitle {
 ...
 */
export declare class NgbNavTabContent {
    templateRef: TemplateRef<any>;
    constructor(templateRef: TemplateRef<any>);
}
/**
 ...
 */
export declare class NgbNavTab {
    /**
     ...
     */
    disabled: boolean;
    contentTpl: NgbNavTabContent;
    titleTpl: NgbNavTabTitle;
}
/**
 ...
 */
export declare class NgbNavTabset implements AfterContentChecked {
    justifyClass: string;
    tabs: QueryList<NgbNavTab>;
    /**
     ...
     */
    tabChange: EventEmitter<NgbNavTabChangeEvent>;

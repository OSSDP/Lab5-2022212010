(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/portal'), require('rxjs/observable/fromEvent'), require('rxjs/observable/merge'), require('@angular/cdk/overlay'), require('lodash-es'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-input-group'), require('@farris/ui-datalist'), require('@angular/forms'), require('@progress/kendo-angular-inputs'), require('@progress/kendo-angular-dropdowns'), require('@farris/ui-notify'), require('@farris/ui-combo-list'), require('@farris/ui-modal'), require('@farris/ui-datepicker'), require('@farris/ui-number-spinner'), require('@angular/common'), require('rxjs/Subject'), require('rxjs'), require('@angular/core'), require('@angular/common/http'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@farris/ide-devkit', ['exports', '@angular/cdk/portal', 'rxjs/observable/fromEvent', 'rxjs/observable/merge', '@angular/cdk/overlay', 'lodash-es', '@farris/ui-perfect-scrollbar', '@farris/ui-input-group', '@farris/ui-datalist', '@angular/forms', '@progress/kendo-angular-inputs', '@progress/kendo-angular-dropdowns', '@farris/ui-notify', '@farris/ui-combo-list', '@farris/ui-modal', '@farris/ui-datepicker', '@farris/ui-number-spinner', '@angular/common', 'rxjs/Subject', 'rxjs', '@angular/core', '@angular/common/http', 'rxjs/operators'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ide-devkit'] = {}),global.ng.cdk.portal,global.rxjs['observable/fromEvent'],global.rxjs['observable/merge'],global.ng.cdk.overlay,global.lodashEs,global.uiPerfectScrollbar,global.uiInputGroup,global.uiDatalist,global.ng.forms,global.kendoAngularInputs,global.kendoAngularDropdowns,global.uiNotify,global.uiComboList,global.uiModal,global.uiDatepicker,global.uiNumberSpinner,global.ng.common,global.rxjs.Subject,global.rxjs,global.ng.core,global.ng.common.http,global.rxjs.operators));
}(this, (function (exports,portal,fromEvent,merge,overlay,lodashEs,uiPerfectScrollbar,uiInputGroup,uiDatalist,forms,kendoAngularInputs,kendoAngularDropdowns,uiNotify,uiComboList,uiModal,uiDatepicker,uiNumberSpinner,common,Subject,rxjs,i0,http,operators) { 'use strict';
    ...
    ***************************************************************************** */
        ...
        ComponentLoader.prototype.show =
            ...
            function (opts) {
                ...
                if (!this._componentRef) {
                    ...
                    /** @type {?} */
                    var injector = i0.ReflectiveInjector.resolveAndCreate(this._providers, this._injector);
         ...
         */
            function (content, context, initialState) {
                ...
                if (typeof content === 'function') {
                    ...
                    /** @type {?} */
                    var modalContentInjector = i0.ReflectiveInjector.resolveAndCreate(__spread(this._providers), this._injector);
                    /** @type {?} */
                ...
                if (content instanceof i0.ComponentRef) {
    ...
    var ComponentLoaderFactory = /** @class */ (function () {
        ...
        /** @nocollapse */ ComponentLoaderFactory.ngInjectableDef = i0.defineInjectable({ factory: function ComponentLoaderFactory_Factory() { return new ComponentLoaderFactory(i0.inject(i0.ComponentFactoryResolver), i0.inject(i0.NgZone), i0.inject(i0.INJECTOR), i0.inject(PositioningService), i0.inject(i0.ApplicationRef)); }, token: ComponentLoaderFactory, providedIn: "root" });
    ...
    var TooltipDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.delay) {
                    /** @type {?} */
                    var tipTimer_1 = rxjs.timer(this.delay).subscribe(function () {
                        showTooltip();
        ...
        TooltipDirective.propDecorators = {
            ...
            _animation: [{ type: i0.Input, args: ['tooltipAnimation',] }],
            ...
            _fadeDuration: [{ type: i0.Input, args: ['tooltipFadeDuration',] }],
    ...
    var ModalDirective = /** @class */ (function () {
        ...
        ModalDirective.propDecorators = {
            ...
            onHidden: [{ type: i0.Output }],
            onClick: [{ type: i0.HostListener, args: ['click', ['$event'],] }],
            onEsc: [{ type: i0.HostListener, args: ['keydown.esc', ['$event'],] }]
        };
    ...
    var BsDropdownDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this._subscriptions.push(this._state.isDisabledChange.pipe(operators.filter(function (value) { return value; }))
        ...
        BsDropdownDirective.propDecorators = {
            ...
            isDisabled: [{ type: i0.Input }],
            isOpen: [{ type: i0.Input }],
            level: [{ type: i0.Input, args: ['dropdown',] }],
            isOpenChange: [{ type: i0.Output }],
            onShown: [{ type: i0.Output }],
            onHidden: [{ type: i0.Output }],
            childDropdowns: [{ type: i0.ContentChildren, args: [BsDropdownDirective,] }]
        };
    ...
    var DropdownButtonDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DropdownButtonDirective.ctorParameters = function () {
            return [
                { type: BsDropdownState },
                { type: i0.ElementRef }
            ];
        ...
        DropdownButtonDirective.propDecorators = {
            isDisabled: [{ type: i0.HostBinding, args: ['class.disabled',] }, { type: i0.Input }],
            isOpen: [{ type: i0.HostBinding, args: ['attr.aria-expanded',] }],
            onClick: [{ type: i0.HostListener, args: ['click', ['$event'],] }],
    ...
    var DropdownItemDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DropdownItemDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: NavbarState }
            ];
        ...
        DropdownItemDirective.propDecorators = {
            isDisabled: [{ type: i0.HostBinding, args: ['class.disabled',] }, { type: i0.Input }],
            command: [{ type: i0.Input, args: ['dropdownItem',] }],
            onMouseOver: [{ type: i0.HostListener, args: ['mouseover',] }],
            onItemClick: [{ type: i0.HostListener, args: ['click',] }]
        };
    ...
    var NavbarDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        NavbarDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: BsDropdownConfig },
                { type: NavbarState }
        ...
        NavbarDirective.propDecorators = {
            childDropdowns: [{ type: i0.ContentChildren, args: [BsDropdownDirective,] }],
            childDropdowns2: [{ type: i0.ViewChildren, args: [BsDropdownDirective,] }],
            onDocumentClick: [{ type: i0.HostListener, args: ['document:click', ['$event'],] }],
            onEsc: [{ type: i0.HostListener, args: ['keyup.esc',] }]
        };
    ...
    var TreeNode = /** @class */ (function () {
        function TreeNode(data, parent, treeModel) {
            ...
            // 变更树节点展示字段，由外部触发
            this.changeDisplayField = new i0.EventEmitter();
    ...
    var TreeModel = /** @class */ (function () {
         ...
         */
            function () {
                return lodashEs.first(this.roots);
            };
        /**
         * @return {?}
         */
         ...
         */
            function () {
                return lodashEs.last(this.roots);
            };
        /**
         * @return {?}
         */
    ...
    var TreeComponent = /** @class */ (function () {
        function TreeComponent(treeModel) {
            var _this = this;
            this.treeModel = treeModel;
            treeModel.eventNames.forEach(function (name) { return _this[name] = new i0.EventEmitter(); }); //customEventName -> new EventEmitter()
        }
        ...
        TreeComponent.prototype.onKeydown =
            ...
            function ($event) {
                ...
                if (lodashEs.includes([KEYS.DOWN, KEYS.UP, KEYS.LEFT,
        ...
        TreeComponent.propDecorators = {
            ...
            onActiveChanged: [{ type: i0.Output }],
            ...
            onRightMenuClicked: [{ type: i0.Output }],
    ...
    var TreeNodeContentComponent = /** @class */ (function () {
        function TreeNodeContentComponent(componentFactoryResolver) {
            ...
            this.rightMenuClicked = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        TreeNodeContentComponent.ctorParameters = function () {
            return [
                { type: i0.ComponentFactoryResolver }
            ];
        };
        TreeNodeContentComponent.propDecorators = {
            ...
            originData: [{ type: i0.Input }],
            rightMenuClicked: [{ type: i0.Output }],
            rightMenuContainer: [{ type: i0.ViewChild, args: ['rightMenuContainer', { read: i0.ViewContainerRef },] }]
        };
    ...
    var TreeNodeComponent = /** @class */ (function () {
        ...
        TreeNodeComponent.propDecorators = {
            node: [{ type: i0.Input }],
            nodeIndex: [{ type: i0.Input }],
            treeNodeContentHost: [{ type: i0.ViewChild, args: [TreeNodeContentDirective,] }]
        };
    ...
    /** @type {?} */
    var ANGULAR_MONACO_EDITOR_CONFIG = new i0.InjectionToken('ANGULAR_MONACO_EDITOR_CONFIG');
    ...
    var CodeEditorEventService = /** @class */ (function () {
        ...
        CodeEditorEventService.prototype.addEvent =
             ...
             */
            function (event) {
                lodashEs.assign(this._events, event);
    ...
    var BaseMonacoEditor = /** @class */ (function () {
        function BaseMonacoEditor(codeEditorEventService, config) {
            ...
            codeEditorEventService.eventNames.forEach(function (name) {
                ...
                self[name] = new i0.EventEmitter();
                /** @type {?} */
                var eventPair = lodashEs.pick(self, name);
        ...
        BaseMonacoEditor.propDecorators = {
            _editorComponent: [{ type: i0.ViewChild, args: ['codeEditor',] }],
    ...
    var CODE_EDITOR_INPUT_VALUE_ACCESSOR = {
        ...
        useExisting: i0.forwardRef(function () { return AngularMonacoEditorComponent; }),
        multi: true
    };
    var AngularMonacoEditorComponent = /** @class */ (function (_super) {
        ...
        /** @nocollapse */
        AngularMonacoEditorComponent.ctorParameters = function () {
            return [
                { type: AngularMonacoEditorService },
                { type: i0.NgZone },
                { type: CodeEditorEventService },
                { type: undefined, decorators: [{ type: i0.Inject, args: [ANGULAR_MONACO_EDITOR_CONFIG,] }] }
            ];
        };
        AngularMonacoEditorComponent.propDecorators = {
            model: [{ type: i0.Input, args: ['model',] }]
        };
    ...
    var ShContextMenuItemDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        ShContextMenuItemDirective.ctorParameters = function () {
            return [
    ...
    var ShContextMenuService = /** @class */ (function () {
        function ShContextMenuService(overlay$$1) {
         ...
         */
            function (overlayRef) {
                ...
                this.backDropSub = fromEvent.fromEvent(elm, 'mousedown')
         ...
         */
            function (positionStrategy, scrollStrategy, menu, hasBackdrop) {
                ...
                /*
                    ...
                    */
                /** @type {?} */
                var menuPortal = new portal.TemplatePortal(menu.menuTemplate, menu.menuContainer);
        ...
        /** @nocollapse */
        ShContextMenuService.ctorParameters = function () {
            return [
    ...
    var ShContextMenuComponent = /** @class */ (function () {
        function ShContextMenuComponent(ctxService) {
            ...
            this.contentChildrenItems = new i0.QueryList();
            this.viewChildrenItems = new i0.QueryList();
        }
         ...
         */
            function ($event, item, elm) {
                ...
                this.ctxService.openSubMenu({
                    ...
                    targetElement: new i0.ElementRef(elm),
                    menu: item.subMenu,
                    mouseEvent: $event,
                    parentMenu: this
                });
        ...
        /** @nocollapse */
        ShContextMenuComponent.ctorParameters = function () {
            return [
                { type: ShContextMenuService }
            ];
        };
        ShContextMenuComponent.propDecorators = {
            thisContext: [{ type: i0.Input, args: ['this',] }],
            contentChildrenItems: [{ type: i0.ContentChildren, args: [ShContextMenuItemDirective, { read: ShContextMenuItemDirective },] }],
            viewChildrenItems: [{ type: i0.ViewChildren, args: [ShContextMenuItemDirective, { read: ShContextMenuItemDirective },] }],
            menuTemplate: [{ type: i0.ViewChild, args: ['menuTemplate', { read: i0.TemplateRef },] }],
            menuContainer: [{ type: i0.ViewChild, args: ['menuContainer', { read: i0.ViewContainerRef },] }]
        };
    ...
    var ShAttachMenuDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                var observables = [];
                if (!this.triggers) {
                    observables.push(fromEvent.fromEvent(this.elm.nativeElement, 'contextmenu'));
                }
                else {
                    this.triggers.forEach(function (t) {
                        observables.push(fromEvent.fromEvent(_this.elm.nativeElement, t));
                    });
                }
                this.sub = merge.merge.apply(void 0, __spread(observables)).subscribe(this.openMenu.bind(this));
            };
        /**
         * @param {?} event
         * @return {?}
        ...
        /** @nocollapse */
        ShAttachMenuDirective.ctorParameters = function () {
            return [
                { type: ShContextMenuService },
                { type: i0.ElementRef }
            ];
        ...
        ShAttachMenuDirective.propDecorators = {
            menu: [{ type: i0.Input, args: ['shAttachMenu',] }],
            triggers: [{ type: i0.Input, args: ['shMenuTriggers',] }],
            data: [{ type: i0.Input, args: ['shMenuData',] }]
        };
    ...
    var WizardComponent = /** @class */ (function () {
        function WizardComponent(viewContainerRef, componentFactoryResolver) {
            this.viewContainerRef = viewContainerRef;
            this.componentFactoryResolver = componentFactoryResolver;
            this.clickCancelBtn = new i0.EventEmitter();
            this.clickFinishBtn = new i0.EventEmitter();
            this.title = '';
            this.steps = [];
            this.curStepIndex = 0;
        }
                ...
                if (this.curComponentRef.instance.changeStep) {
                    this.curComponentRef.instance.changeStep.subscribe(function (stepList) {
                        stepList.forEach(function (changeStep) {
                            /** @type {?} */
                            var oldStep = lodashEs.find(_this.steps, function (s) { return s.stepId === changeStep.stepId; });
         ...
         */
            function (nextStep) {
                ...
                /** @type {?} */
                var nextIndex = lodashEs.findIndex(this.steps, function (s) { return s.stepId === nextStep.stepId; });
         ...
         */
            function () {
                /** @type {?} */
                var self = this;
                this.curStepIndex = lodashEs.findIndex(this.steps, function (s) { return s.nextStep === self.curStep.stepId; });
                this.curStep = this.steps[this.curStepIndex];
         ...
         */
            function (data) {
                ...
                this.curStepIndex = lodashEs.findIndex(this.steps, function (s) { return s.stepId === curStep.nextStep; });
        ...
        WizardComponent.propDecorators = {
            clickCancelBtn: [{ type: i0.Output }],
            clickFinishBtn: [{ type: i0.Output }],
            title: [{ type: i0.Input }],
            steps: [{ type: i0.Input }],
            stepContainer: [{ type: i0.ViewChild, args: ['stepContainer', { read: i0.ViewContainerRef },] }]
        };
    ...
    var ComboService = /** @class */ (function () {
        function ComboService() {
            ...
            this.isOpen$ = new rxjs.BehaviorSubject(false);
    ...
    var ComboListComponent = /** @class */ (function () {
        function ComboListComponent(el, cdr, document, render, comboService, injector) {
            ...
            this.comboPanelCreated$ = new rxjs.Subject();
            ...
            this.comboPanelCreated$
                .pipe(operators.takeUntil(this.destroy$), operators.filter(function (v) { return !!v; }))
            ...
            this.comboService.selected$.pipe(operators.takeUntil(this.destroy$)).subscribe(function () {
         ...
         */
            function () {
                ...
                rxjs.fromEvent(window, 'resize')
                    .pipe(operators.debounceTime(100), operators.throttle(function (ev) { return rxjs.interval(100); }), operators.takeUntil(this.destroy$))
                    .subscribe(function () {
        ...
        ComboListComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        providers: [
                            {
                                provide: forms.NG_VALUE_ACCESSOR,
                                useExisting: i0.forwardRef(function () { return ComboListComponent; }),
                                multi: true
                            },
                            ComboService
                        ],
        ...
        /** @nocollapse */
        ComboListComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.ChangeDetectorRef },
        ...
        ComboListComponent.propDecorators = {
            ...
            cmbPanel: [{ type: i0.ViewChild, args: ['comboPanel',] }],
    ...
    var ComboListModule = /** @class */ (function () {
        ...
        ComboListModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, uiInputGroup.InputGroupModule, uiDatalist.DatalistModule],
    ...
    var PropertyItemComponent = /** @class */ (function () {
        function PropertyItemComponent(resolver, modalService, injector, notifyServ, el) {
            ...
            // 向上触发整体面板刷新
            this.triggerRefreshPanel = new i0.EventEmitter();
            // 下拉框的枚举项
            this.selectOptions = [];
            // 控件类型
         ...
         */
            function () {
                ...
                // 监听关闭模态框
                if (compRef.instance.closeModal && compRef.instance.closeModal instanceof i0.EventEmitter) {
                ...
                if (compRef.instance.submitModal && compRef.instance.submitModal instanceof i0.EventEmitter) {
        ...
        PropertyItemComponent.propDecorators = {
            elementConfig: [{ type: i0.Input }],
            elementValue: [{ type: i0.Input }],
            valueChanged: [{ type: i0.Output }],
            submitModal: [{ type: i0.Output }],
            triggerRefreshPanel: [{ type: i0.Output }],
            propItem: [{ type: i0.ViewChild, args: ['propItem', { read: i0.ViewContainerRef },] }],
            stringTmpl: [{ type: i0.ViewChild, args: ['stringTmpl',] }],
            numberTmpl: [{ type: i0.ViewChild, args: ['numberTmpl',] }],
            selectTmpl: [{ type: i0.ViewChild, args: ['selectTmpl',] }],
            boolOrExpTmpl: [{ type: i0.ViewChild, args: ['boolOrExpTmpl',] }],
            multiSelectTmpl: [{ type: i0.ViewChild, args: ['multiSelectTmpl',] }],
            dateTmpl: [{ type: i0.ViewChild, args: ['dateTmpl',] }],
            datetimeTmpl: [{ type: i0.ViewChild, args: ['datetimeTmpl',] }],
            modalTmpl: [{ type: i0.ViewChild, args: ['modalTmpl',] }]
        };
    ...
    var PropertyItemListComponent = /** @class */ (function () {
        ...
        PropertyItemListComponent.propDecorators = {
            ...
            propertyData: [{ type: i0.Input }],
            valueChanged: [{ type: i0.Output }],
            submitModal: [{ type: i0.Output }],
            triggerRefreshPanel: [{ type: i0.Output }],
            items: [{ type: i0.ViewChildren, args: [PropertyItemComponent,] }]
        };
    ...
    var PropertyPanelComponent = /** @class */ (function () {
        function PropertyPanelComponent() {
             ...
             */
            this.closePropertyPanel = new i0.EventEmitter();
            /**
             * 属性值
             */
            this.propertyData = {};
        ...
        PropertyPanelComponent.propDecorators = {
            ...
            isPersitOpenState: [{ type: i0.Input }],
            isShowPanel: [{ type: i0.Input }],
            closePropertyPanel: [{ type: i0.Output }],
            propertyConfig: [{ type: i0.Input }],
            propertyData: [{ type: i0.Input }],
            propertyChanged: [{ type: i0.Output }],
            submitModal: [{ type: i0.Output }],
            showCloseBtn: [{ type: i0.Input }],
            eastDiv: [{ type: i0.ViewChild, args: ['east',] }],
            itemLists: [{ type: i0.ViewChildren, args: [PropertyItemListComponent,] }]
        };
    ...
    var NgbTab = /** @class */ (function () {
        ...
        NgbTab.propDecorators = {
            ...
            title: [{ type: i0.Input }],
            disabled: [{ type: i0.Input }],
            contentTpl: [{ type: i0.ContentChild, args: [NgbTabContent,] }],
            titleTpl: [{ type: i0.ContentChild, args: [NgbTabTitle,] }]
        };
        return NgbTab;
    }());
    /**
    ...
    var NgbTabsetModule = /** @class */ (function () {
        ...
        NgbTabsetModule.decorators = [
            { type: i0.NgModule, args: [{ declarations: NGB_TABSET_DIRECTIVES, exports: NGB_TABSET_DIRECTIVES, imports: [common.CommonModule] },] }
        ];
    ...
    var NgbNavTabTitle = /** @class */ (function () {
        ...
        NgbNavTabTitle.decorators = [
            { type: i0.Directive, args: [{ selector: 'ng-template[ngbNavTabTitle]' },] }
        ];
        /** @nocollapse */
        NgbNavTabTitle.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
    ...
    var NgbNavTabContent = /** @class */ (function () {
        ...
        NgbNavTabContent.decorators = [
            { type: i0.Directive, args: [{ selector: 'ng-template[ngbNavTabContent]' },] }
        ];
        /** @nocollapse */
        NgbNavTabContent.ctorParameters = function () {
            return [
                { type: i0.TemplateRef }
            ];
        };
    ...
    var NgbNavTab = /** @class */ (function () {
        ...
        NgbNavTab.decorators = [
            { type: i0.Directive, args: [{ selector: 'ngb-navtab' },] }
        ];
        NgbNavTab.propDecorators = {
            id: [{ type: i0.Input }],
            title: [{ type: i0.Input }],
            disabled: [{ type: i0.Input }],
            contentTpl: [{ type: i0.ContentChild, args: [NgbNavTabContent,] }],
            titleTpl: [{ type: i0.ContentChild, args: [NgbNavTabTitle,] }]
        };
        return NgbNavTab;
    }());
    /**
    ...
    var NgbNavTabset = /** @class */ (function () {
        ...
        /** @nocollapse */
        NgbNavTabset.ctorParameters = function () {
            return [
                { type: NgbNavTabsetConfig }
            ];
        };
        NgbNavTabset.propDecorators = {
            tabs: [{ type: i0.ContentChildren, args: [NgbNavTab,] }],
            activeId: [{ type: i0.Input }],
            destroyOnHide: [{ type: i0.Input }],
            justify: [{ type: i0.Input }],
            orientation: [{ type: i0.Input }],
    ...
    var NgbNavTabsetModule = /** @class */ (function () {
        ...
        NgbNavTabsetModule.decorators = [
            { type: i0.NgModule, args: [{ declarations: NGB_TABSET_DIRECTIVES$1, exports: NGB_TABSET_DIRECTIVES$1, imports: [common.CommonModule] },] }
        ];
    ...
    var NgbPanel = /** @class */ (function () {
        ...
        NgbPanel.propDecorators = {
            ...
            title: [{ type: i0.Input }],
            type: [{ type: i0.Input }],
            contentTpl: [{ type: i0.ContentChild, args: [NgbPanelContent,] }],
            titleTpl: [{ type: i0.ContentChild, args: [NgbPanelTitle,] }]
        };
        return NgbPanel;
    }());
    /**
    ...
    var NgbAccordionModule = /** @class */ (function () {
        ...
        NgbAccordionModule.decorators = [
            { type: i0.NgModule, args: [{ declarations: NGB_ACCORDION_DIRECTIVES, exports: NGB_ACCORDION_DIRECTIVES, imports: [common.CommonModule] },] }
        ];
    ...
    var SashDirective = /** @class */ (function () {
        function SashDirective(_elementRef, renderer, _viewContainerRef) {
            ...
            this.renderer = renderer;
            this._viewContainerRef = _viewContainerRef;
            this.widthChanged = new i0.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        SashDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 },
                { type: i0.ViewContainerRef }
    ...
    var EventPipe = /** @class */ (function () {
        function EventPipe(name, tokenValue, emitter, parentEventPipeList) {
            ...
            this.eventSubject = new Subject.Subject();
    ...
    var DuplexEventPipe = /** @class */ (function () {
         ...
         */
            function (value) {
                ...
                /** @type {?} */
                var fooObservable = rxjs.timer(0).pipe(operators.mapTo(true));
                /** @type {?} */
                ...
                /** @type {?} */
                var subscription = rxjs.forkJoin(listenerResultArray).subscribe({ next: function (results) {
                        /** @type {?} */
         ...
         */
            function (callback, caller) {
                ...
                this.subject.subscribe(function (_a) {
                    ...
                    if (invokeResult instanceof rxjs.Observable) {
                        listenerResult = invokeResult;
                    }
                    else if (typeof invokeResult === 'boolean') {
                        listenerResult = rxjs.of(invokeResult);
                    }
                    else {
                        listenerResult = rxjs.of(true);
                    }
                    /** @type {?} */
    ...
    var EventBus = /** @class */ (function () {
         ...
         */
            function (emitterType, tokenValue, eventName, eventArgs) {
                ...
                /** @type {?} */
                var emitter;
                if (emitterType instanceof i0.Type) {
            ...
            function () {
                ...
                if (!this.disposed) {
                    try {
                        ...
                        try {
                            if (disposables_1_1 && !disposables_1_1.done && (_a = disposables_1.return))
                                _a.call(disposables_1);
                        }
                        finally {
                            if (e_1)
                                throw e_1.error;
            ...
            function (eventName, handlerToRemove) {
                ...
                if (oldHandlers) {
                    ...
                    try {
                        ...
                        try {
                            if (oldHandlers_1_1 && !oldHandlers_1_1.done && (_a = oldHandlers_1.return))
                                _a.call(oldHandlers_1);
                        }
                        finally {
                            if (e_1)
                                throw e_1.error;
            ...
            function (itemStackIndices) {
                ...
                if (this.items.length > 0) {
                    ...
                    try {
                        ...
                        try {
                            if (itemStackIndices_1_1 && !itemStackIndices_1_1.done && (_a = itemStackIndices_1.return))
                                _a.call(itemStackIndices_1);
                        }
                        finally {
                            if (e_4)
                                throw e_4.error;
    ...
    var CacheService = /** @class */ (function () {
        ...
        CacheService.ctorParameters = function () {
            return [
                { type: CacheStorageAbstract, decorators: [{ type: i0.Optional }] }
            ];
        };
        return CacheService;
    }());
    ...
    CommandRegistry = /** @class */ (function () {
        ...
        CommandRegistry.prototype.add =
            ...
            function (target, commandName, listener, throwOnInvalidSelector) {
                if (throwOnInvalidSelector === void 0) {
                ...
                while (true) {
                    ...
                    for (var commandName in this.selectorBasedListenersByCommandName) {
                        ...
                        try {
                            ...
                            try {
                                if (listeners_1_1 && !listeners_1_1.done && (_b = listeners_1.return))
                                    _b.call(listeners_1);
                            }
                            finally {
                                if (e_1)
    ...
    ViewRegistry = /** @class */ (function () {
         ...
         */
            function (object) {
                var e_1, _a;
                if (object instanceof i0.ComponentRef) {
                    return object;
                }
                /** @type {?} */
                var element;
                if (object && (typeof object.getElement === 'function')) {
                    ...
                    if (element instanceof i0.ComponentRef) {
                        return element;
                    }
                }
                if (object && object.element instanceof i0.ComponentRef) {
    ...
    var Workspace = /** @class */ (function () {
         ...
         */
            function (fileUri, options) {
                ...
                if (options === void 0) {
                    options = { initialColumn: '', initialLine: '', activateItem: '', activatePane: '' };
                }
                var e_3, _a;
            ...
            function (name) {
                ...
                try {
                    for (var callbacks_1 = __values(callbacks), callbacks_1_1 = callbacks_1.next(); !callbacks_1_1.done; callbacks_1_1 = callbacks_1.next()) {
                        ...
                        else if (typeof cbResult.subscribe === 'function' && cbResult.constructor.name === rxjs.Observable.name) {
                ...
                if (observableResult.length) {
                    return rxjs.forkJoin(__spread(observableResult, [rxjs.of(result)])).pipe(operators.map(function (results) {
    ...
    var HttpService = /** @class */ (function () {
        function HttpService(http$$1, cache) {
            this.http = http$$1;
            this.cache = cache;
        }
        /**
    ...
    exports.CODE_EDITOR_INPUT_VALUE_ACCESSOR = CODE_EDITOR_INPUT_VALUE_ACCESSOR;
    exports.AngularMonacoEditorComponent = AngularMonacoEditorComponent;
    exports.ANGULAR_MONACO_EDITOR_CONFIG = ANGULAR_MONACO_EDITOR_CONFIG;
    exports.CODE_EDITOR_EVENTS = CODE_EDITOR_EVENTS;
    exports.CodeEditorEventService = CodeEditorEventService;
    exports.AngularMonacoEditorService = AngularMonacoEditorService;
    ...
    exports.ComboListModule = ComboListModule;
    exports.ComboService = ComboService;
    exports.ComboListComponent = ComboListComponent;
    ...
    exports.BeforeOpenModalResult = BeforeOpenModalResult;
    exports.PropertyChangeObject = PropertyChangeObject;
    ...
    exports.Util = Util;
    exports.DockStyle = DockStyle;
    exports.Dock = Dock;
    exports.GSP = GSP;
    exports.GspEventBus = GspEventBus;
    ...
    exports.ɵf = NgbAccordion;
    exports.ɵe = NgbPanel;
    exports.ɵd = NgbPanelContent;
    exports.ɵc = NgbPanelTitle;
    exports.ɵg = NgbAccordionConfig;
    exports.ɵm = BaseMonacoEditor;
    exports.ɵa = CLASS_NAME;
    exports.ɵb = MenuItemContext;
    exports.ɵk = TreeNodeContentComponent;
    exports.ɵl = TreeNodeDropSlotComponent;
    exports.ɵi = TreeNodeComponent;
    exports.ɵj = TreeNodeContentDirective;
    exports.ɵh = TreeModel;
    exports.ɵp = SashDirective;
    exports.ɵn = PropertyItemListComponent;
    exports.ɵo = PropertyItemComponent;
    exports.ɵq = EventBus;
...
//# sourceMappingURL=farris-ide-devkit.umd.js.map
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('perfect-scrollbar'), require('resize-observer-polyfill'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-perfect-scrollbar', ['exports', 'perfect-scrollbar', 'resize-observer-polyfill', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-perfect-scrollbar'] = {}),global.PerfectScrollbar,global.ResizeObserver,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.common));
}(this, (function (exports,PerfectScrollbar,ResizeObserver,rxjs,operators,core,common) { 'use strict';
                     ...
                     */function () {
                         ...
                         */function (eventName) {
                            ...
                            rxjs.fromEvent(_this.elementRef.nativeElement, eventType)
                                .pipe(
                            // auditTime(20),
                            operators.takeUntil(_this.ngDestroy))
                                .subscribe(( /**
                         * @param {?} event
                         * @return {?}
                         */function (event) {
...
//# sourceMappingURL=farris-ui-perfect-scrollbar.umd.js.map
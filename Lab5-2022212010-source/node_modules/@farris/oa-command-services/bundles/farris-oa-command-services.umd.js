(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-notify'), require('rxjs/operators'), require('@farris/ui-messager'), require('@angular/core'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@farris/oa-command-services', ['exports', '@farris/ui-notify', 'rxjs/operators', '@farris/ui-messager', '@angular/core', 'rxjs'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['oa-command-services'] = {}),global.uiNotify,global.rxjs.operators,global.i1,global.ng.core,global.rxjs));
}(this, (function (exports,uiNotify,operators,i1,i0,rxjs) { 'use strict';
    ...
    var OAListDataService = /** @class */ (function () {
        ...
        /** @nocollapse */
        OAListDataService.ctorParameters = function () {
            return [
    ...
    var SyncTaskSchdule = /** @class */ (function () {
        function SyncTaskSchdule() {
            ...
            // 0 停止中 1 运行中
            this.taskResult = new rxjs.Subject();
            this.taskStack = [];
        }
        /**
         * @param {?} fun
    ...
    var TaskCenterBridgeService = /** @class */ (function () {
        ...
        /** @nocollapse */
        TaskCenterBridgeService.ctorParameters = function () {
            return [
                { type: i1.MessagerService }
            ];
        };
    ...
    exports.OAListDataService = OAListDataService;

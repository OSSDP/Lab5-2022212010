(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('rxjs/operators'), require('rxjs'), require('date-fns'), require('@farris/ui-locale'), require('@farris/ui-common'), require('@angular/common'), require('@angular/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-time-picker', ['exports', '@angular/animations', 'rxjs/operators', 'rxjs', 'date-fns', '@farris/ui-locale', '@farris/ui-common', '@angular/common', '@angular/core', '@angular/forms'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-time-picker'] = {}),global.ng.animations,global.rxjs.operators,global.rxjs,global.dateFns,global.i1,global.uiCommon,global.ng.common,global.ng.core,global.ng.forms));
}(this, (function (exports,animations,operators,rxjs,dateFns,i1,uiCommon,common,i0,forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var UpdateHostClassService = /** @class */ (function () {
        ...
        /** @nocollapse */
        UpdateHostClassService.ctorParameters = function () {
            return [
     ...
     * @return {?}
     */
    function convertToStr(date, format, selected12Hours) {
        if (format === void 0) {
            format = 'hh:mm:ss';
        }
        if (selected12Hours === void 0) {
            selected12Hours = 'AM';
        }
    ...
    var TimeValueAccessorDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        TimeValueAccessorDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        ...
        Object.defineProperty(TimeHolder.prototype, "value", {
             ...
             */ function (value) {
                if (value !== this._value) {
                    this._value = value;
                    if (isNotNil(this._value) && dateFns.isValid(this._value)) {
    ...
    var TimePickerPanelComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        TimePickerPanelComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
        ...
        TimePickerPanelComponent.propDecorators = {
            timeValueAccessorDirective: [{ type: i0.ViewChild, args: [TimeValueAccessorDirective,] }],
            ...
            inDatePicker: [{ type: i0.Input }],
            addOn: [{ type: i0.Input }],
            hideDisabledOptions: [{ type: i0.Input }],
            clearText: [{ type: i0.Input }],
            placeholder: [{ type: i0.Input }],
            selectCurrentTimeWhenNull: [{ type: i0.Input }],
    ...
    var TimePickerLocaleService = /** @class */ (function () {
        ...
        /** @nocollapse */
        TimePickerLocaleService.ctorParameters = function () {
            return [
    ...
    var TimePickerComponent = /** @class */ (function () {
        ...
        TimePickerComponent.propDecorators = {
            timeInput: [{ type: i0.ViewChild, args: ['timeInput',] }],
            hostCls: [{ type: i0.HostBinding, args: ['class.f-component-timepicker',] }],
    ...
    exports.TimePickerPanelComponent = TimePickerPanelComponent;
    exports.TimeValueAccessorDirective = TimeValueAccessorDirective;
    exports.AnimationDuration = AnimationDuration;
    exports.AnimationCurves = AnimationCurves;
    exports.slideMotion = slideMotion;
    exports.UpdateHostClassService = UpdateHostClassService;
    exports.TimePickerLocaleService = TimePickerLocaleService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-time-picker.umd.js.map
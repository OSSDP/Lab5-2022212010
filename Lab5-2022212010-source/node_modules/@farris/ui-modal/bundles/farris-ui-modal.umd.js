(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('rxjs'), require('rxjs/operators'), require('@farris/ui-modal/utils'), require('@farris/ui-common'), require('@angular/core'), require('@angular/common'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-draggable'), require('@farris/ui-modal/positioning'), require('@farris/ui-modal/component-loader'), require('@farris/ui-area-response'), require('@farris/ui-tooltip')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-modal', ['exports', '@angular/platform-browser', 'rxjs', 'rxjs/operators', '@farris/ui-modal/utils', '@farris/ui-common', '@angular/core', '@angular/common', '@farris/ui-perfect-scrollbar', '@farris/ui-draggable', '@farris/ui-modal/positioning', '@farris/ui-modal/component-loader', '@farris/ui-area-response', '@farris/ui-tooltip'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-modal'] = {}),global.ng.platformBrowser,global.rxjs,global.rxjs.operators,global.farris['ui-modal'].utils,global.uiCommon,global.ng.core,global.ng.common,global.uiPerfectScrollbar,global.uiDraggable,global.farris['ui-modal'].positioning,global.farris['ui-modal']['component-loader'],global.uiAreaResponse,global.uiTooltip));
}(this, (function (exports,platformBrowser,rxjs,operators,utils,uiCommon,core,common,uiPerfectScrollbar,uiDraggable,positioning,componentLoader,uiAreaResponse,uiTooltip) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ModalButtonDirective = /** @class */ (function () {
        ...
        ModalButtonDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[modal-button]' },] }
        ];
        /** @nocollapse */
        ModalButtonDirective.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.ElementRef }
            ];
    ...
    var ModalContainerComponent = /** @class */ (function () {
         ...
         */
            function () {
                 ...
                 */function () {
                    _this.isShown = true;
                    _this._renderer.addClass(_this.el.nativeElement, utils.isBs3() ? CLASS_NAME.IN : CLASS_NAME.SHOW);
                    if (_this.isModeless) {
         ...
         */
            function () {
                ...
                this.windowResize$ = rxjs.fromEvent(window, 'resize').pipe(operators.debounceTime(50)).subscribe(( /**
                 * @param {?} e
                 * @return {?}
                 */function (e) {
                    /** @type {?} */
         ...
         */
            function () {
                return this.config.buttons instanceof core.TemplateRef;
            };
        /**
         * @param {?} event
         * @return {?}
         ...
         */
            function (e, isCloseButton) {
                 ...
                 */function (r) {
                    ...
                    _this._renderer.removeClass(_this.el.nativeElement, utils.isBs3() ? CLASS_NAME.IN : CLASS_NAME.SHOW);
                    setTimeout(( /**
                     * @return {?}
                     */function () {
                        _this.isShown = false;
         ...
         */
            function (rememberPrevSize) {
                if (rememberPrevSize === void 0) {
                    rememberPrevSize = true;
                }
                if (rememberPrevSize) {
        ...
        ModalContainerComponent.propDecorators = {
            iframe: [{ type: core.Input }],
            draggbar: [{ type: core.ViewChild, args: [uiDraggable.AngularDraggableDirective,] }],
            modalHeader: [{ type: core.ViewChild, args: ['header',] }],
            closed: [{ type: core.Output }],
            opened: [{ type: core.Output }],
            resized: [{ type: core.Output }],
            modalID: [{ type: core.HostBinding, args: ['id',] }],
            buttons: [{ type: core.ViewChildren, args: [ModalButtonDirective,] }],
    ...
    var BsModalService = /** @class */ (function () {
         ...
         */
            function (e, curModalisModeless) {
                var _this = this;
                if (curModalisModeless === void 0) {
                    curModalisModeless = null;
                }
         ...
         */
            function () {
                /** @type {?} */
                var newSize = utils.Utils.checkDialogSize(this.config.width, this.config.height);
    ...
    var ModalDirective = /** @class */ (function () {
         ...
         */
            function () {
                 ...
                 */function () {
                    if (!_this.isNested) {
                        if (utils.document && utils.document.body && !utils.document.querySelectorAll('.farris-modal.show').length) {
    ...
    exports.ModalButtonDirective = ModalButtonDirective;
...
//# sourceMappingURL=farris-ui-modal.umd.js.map
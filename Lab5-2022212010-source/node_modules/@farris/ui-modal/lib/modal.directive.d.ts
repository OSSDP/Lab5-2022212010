...
import { ComponentRef, ElementRef, EventEmitter, OnDestroy, OnInit, Renderer2, ViewContainerRef, NgZone } from '@angular/core';
...
export declare class ModalDirective implements OnDestroy, OnInit {
    ...
    private isNested;
    private commonUtils;
    constructor(_element: ElementRef, _viewContainerRef: ViewContainerRef, _renderer: Renderer2, clf: ComponentLoaderFactory, ngZone: NgZone, cd: ChangeDetectorRef);

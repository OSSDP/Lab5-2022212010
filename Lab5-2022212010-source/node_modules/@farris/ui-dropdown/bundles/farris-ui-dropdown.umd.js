(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('@farris/ui-common'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-dropdown', ['exports', 'rxjs', 'rxjs/operators', '@farris/ui-common', '@angular/core', '@angular/common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-dropdown'] = {}),global.rxjs,global.rxjs.operators,global.uiCommon,global.ng.core,global.ng.common));
}(this, (function (exports,rxjs,operators,uiCommon,core,common) { 'use strict';
    ...
    var FDropdownDirective = /** @class */ (function () {
        function FDropdownDirective(elementRef, render) {
            ...
            this.dpChangeEvent = new core.EventEmitter();
            this._placement = 'bottom'; // 记录 position
            // 记录 position
            this.isSubDP = false; // 是否是子下拉
            this.isOpenState = new rxjs.Subject();
        ...
        /** @nocollapse */
        FDropdownDirective.ctorParameters = function () {
            return [
        ...
        FDropdownDirective.propDecorators = {
            rectifyReference: [{ type: core.Input }],
            rectifyReferenceV: [{ type: core.Input }],
            autoRectify: [{ type: core.Input }],
            forceState: [{ type: core.Input, args: ['forceState',] }],
            openState: [{ type: core.Input, args: ['open',] }],
            dpChangeEvent: [{ type: core.Output }],
            isSubDP: [{ type: core.Input }],
            placement: [{ type: core.Input, args: ['placement',] }],
            submenuCls: [{ type: core.HostBinding, args: ['class.dropdown-submenu',] }],
            dropdownCls: [{ type: core.HostBinding, args: ['class.dropdown',] }]
        };
    ...
    var FDropdownMenuDirective = /** @class */ (function () {
        function FDropdownMenuDirective(elementRef, dropdown) {
            ...
            this.dropdown.getOpenState().pipe(operators.debounceTime(50)).subscribe(( /**
             * @param {?} state
             * @return {?}
             */function (state) {
                /** @type {?} */
        ...
        /** @nocollapse */
        FDropdownMenuDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef },
        ...
        FDropdownMenuDirective.propDecorators = {
            showDropdownMenu: [{ type: core.HostBinding, args: ["class.dropdown-menu",] }],
            dpIsOpen: [{ type: core.Input }]
        };
    ...
    var FDropdownToggleDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        FDropdownToggleDirective.ctorParameters = function () {
            return [
                { type: FDropdownDirective },
                { type: core.ElementRef }
            ];
        ...
        FDropdownToggleDirective.propDecorators = {
            dpDisabled: [{ type: core.Input }],
            disableCls: [{ type: core.HostBinding, args: ["class.disabled",] }],
    ...
    var FarrisDropdownComponent = /** @class */ (function () {
        function FarrisDropdownComponent(el, renderer) {
            ...
            this.leftClick = new core.EventEmitter();
        ...
        /** @nocollapse */
        FarrisDropdownComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Renderer2 }
            ];
        ...
        FarrisDropdownComponent.propDecorators = {
            ...
            hideOnClick: [{ type: core.Input, args: ['hide-on-click',] }],
            splitButton: [{ type: core.Input, args: ['split-button',] }],
            position: [{ type: core.Input }],
            model: [{ type: core.Input }],
            dropdownTempl: [{ type: core.ContentChild, args: ['dropdownTempl',] }],
            leftClick: [{ type: core.Output, args: ['left-click',] }],
            select: [{ type: core.Output }],
            visibleChange: [{ type: core.Output, args: ['visible-change',] }]
        };
    ...
    exports.FDropdownDirectiveTypeModule = FDropdownDirectiveTypeModule;
    exports.FDropdownMenuDirective = FDropdownMenuDirective;
    exports.FDropdownToggleDirective = FDropdownToggleDirective;
    exports.FDropdownDirective = FDropdownDirective;
    exports.FarrisDropdownComponent = FarrisDropdownComponent;
    exports.FarrisDropdownItemComponent = FarrisDropdownItemComponent;
    exports.FarrisDropdownModule = FarrisDropdownModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-dropdown.umd.js.map
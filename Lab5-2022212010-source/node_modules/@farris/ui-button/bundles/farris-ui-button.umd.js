(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('rxjs'), require('@farris/ui-common')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-button', ['exports', '@angular/common', '@angular/core', 'rxjs', '@farris/ui-common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-button'] = {}),global.ng.common,global.ng.core,global.rxjs,global.uiCommon));
}(this, (function (exports,common,i0,rxjs,uiCommon) { 'use strict';
    ...
    var FarrisButtonService = /** @class */ (function () {
        ...
        /** @nocollapse */ FarrisButtonService.ngInjectableDef = i0.defineInjectable({ factory: function FarrisButtonService_Factory() { return new FarrisButtonService(); }, token: FarrisButtonService, providedIn: "root" });
    ...
    var FarrisButtonComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        FarrisButtonComponent.ctorParameters = function () {
            return [
        ...
        FarrisButtonComponent.propDecorators = {
            ...
            btnEl: [{ type: i0.ViewChild, args: ['btn',] }]
        };
    ...
    var FarrisButtonGroupComponent = /** @class */ (function () {
        function FarrisButtonGroupComponent(changeRef, ngZone) {
            ...
            this.click = new i0.EventEmitter();
            /* 触发下拉按钮面板区域之外的事件 */
            this.clickMenuOut = new i0.EventEmitter();
            /**
            ...
            /* 下拉面板显示 */
            this.show = false;
            this.setPosition$ = new rxjs.Subject();
         ...
         */
            function () {
                /** @type {?} */
                var idSer = new uiCommon.IdService();
        ...
        /** @nocollapse */
        FarrisButtonGroupComponent.ctorParameters = function () {
            return [
        ...
        FarrisButtonGroupComponent.propDecorators = {
            dpBtn: [{ type: i0.ViewChild, args: ["dpBtn",] }],
            dpMenu: [{ type: i0.ViewChild, args: ["dpMenu",] }],
            rectifyReferenceH: [{ type: i0.Input }],
            rectifyReferenceV: [{ type: i0.Input }],
            autoRectify: [{ type: i0.Input }],
            adaptToOuterWidth: [{ type: i0.Input }],
            data: [{ type: i0.Input }],
            count: [{ type: i0.Input }],
            size: [{ type: i0.Input }],
            type: [{ type: i0.Input }],
    ...
    var FarrisButtonModule = /** @class */ (function () {
        ...
        FarrisButtonModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, uiCommon.FarrisCommonModule],
    ...
    exports.FarrisButtonService = FarrisButtonService;
    exports.FarrisButtonComponent = FarrisButtonComponent;
    exports.FarrisButtonModule = FarrisButtonModule;
    exports.FarrisButtonGroupComponent = FarrisButtonGroupComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-button.umd.js.map
...
import { Injectable, Component, Input, EventEmitter, Output, ViewChild, ElementRef, Optional, Injector, NgModule, NgZone, ChangeDetectionStrategy, ChangeDetectorRef, defineInjectable } from '@angular/core';
...
class FarrisButtonGroupComponent {
    /**
     * @param {?} changeRef
     * @param {?} ngZone
     */

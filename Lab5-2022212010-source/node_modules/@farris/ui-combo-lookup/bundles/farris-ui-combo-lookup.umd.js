(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('@farris/ui-lookup'), require('rxjs'), require('@farris/ui-common'), require('@angular/core'), require('@farris/ui-datatable'), require('@farris/ui-treetable'), require('@farris/ui-input-group'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-loading'), require('@farris/ui-combo-list')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-combo-lookup', ['exports', 'rxjs/operators', '@farris/ui-lookup', 'rxjs', '@farris/ui-common', '@angular/core', '@farris/ui-datatable', '@farris/ui-treetable', '@farris/ui-input-group', '@angular/common', '@angular/forms', '@farris/ui-loading', '@farris/ui-combo-list'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-combo-lookup'] = {}),global.rxjs.operators,global.uiLookup,global.rxjs,global.uiCommon,global.ng.core,global.uiDatatable,global.uiTreetable,global.uiInputGroup,global.ng.common,global.ng.forms,global.uiLoading,global.uiComboList));
}(this, (function (exports,operators,uiLookup,rxjs,uiCommon,i0,uiDatatable,uiTreetable,uiInputGroup,common,forms,uiLoading,uiComboList) { 'use strict';
    ...
    var ComboLookupService = /** @class */ (function () {
        ...
        /** @nocollapse */ ComboLookupService.ngInjectableDef = i0.defineInjectable({ factory: function ComboLookupService_Factory() { return new ComboLookupService(); }, token: ComboLookupService, providedIn: "root" });
    ...
    ***************************************************************************** */
    ...
    var ComboLookupComponent = /** @class */ (function (_super) {
        ...
        function ComboLookupComponent(el, cdr, document, render, comboService, injector) {
            ...
            _this.pageChanged = new i0.EventEmitter();
            _this.pageSizeChanged = new i0.EventEmitter();
            /**
             * 使用表单映射，默认 false
             */
            ...
            _this.tt$ = new rxjs.Subject();
            _this.loaded$ = new rxjs.Subject();
            _this._searchKeyWords = '';
            _this.loadDataType = 'all';
            _this.idSer = _this.injector.get(uiCommon.IdService, null);
            if (!_this.idSer) {
                _this.idSer = new uiCommon.IdService();
            }
            return _this;
        }
        ...
        Object.defineProperty(ComboLookupComponent.prototype, "tableCmpRef", {
             ...
             */ function (cmf) {
                ...
                if (cmf && this.pagination) {
                    this.loaded$.pipe(operators.take(1)).subscribe(( /**
                     * @param {?} e
                     * @return {?}
                     */function (e) {
         ...
         */
            function () {
                ...
                this.treeClientSearch.pipe(operators.debounceTime(300)).subscribe(( /**
                 * @param {?} value
                 * @return {?}
                 */function (value) {
            ...
            function (selections) {
                ...
                if (this.displayType === 'LOOKUPLIST') {
                    ...
                    if (this.treeCmpRef) {
                        ...
                        this.tt$.pipe(operators.take(1)).subscribe(( /**
                         * @param {?} cmf
                         * @return {?}
                         */function (cmf) {
         ...
         */
            function () {
                var _this = this;
                this.comboService.data$.pipe(operators.delay(120)).subscribe(( /**
                 * @param {?} data
                 * @return {?}
                 */function (data) {
                    // 帮助数据异步自定义取数；
        ...
        ComboLookupComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        providers: [INPUT_COMBO_VALUE_ACCESSOR, uiComboList.ComboService, uiLookup.LookupUtils]
                    }] }
        ];
        /** @nocollapse */
    ...
    var ComboLookupModule = /** @class */ (function () {
        ...
        ComboLookupModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [
                            common.CommonModule, forms.FormsModule, uiDatatable.DataTableModule,
                            uiTreetable.TreeTableModule, uiInputGroup.InputGroupModule,
                            uiLoading.LoadingModule.forRoot()
                        ],
                        exports: [ComboLookupComponent],
                        providers: [uiComboList.ComboLocaleService]
                    },] }
        ];
    ...
    exports.ComboLookupService = ComboLookupService;
    exports.ComboLookupComponent = ComboLookupComponent;
    exports.ComboLookupModule = ComboLookupModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-combo-lookup.umd.js.map
 ...
 * ```
 */
export var NgField = makePropDecorator(NG_FIELD, makeNgFieldDecorator);
/**
 * --------------------------------------------------------------------------------
 * NgField
 * --------------------------------------------------------------------------------
 ...
 * ```
 */
export var NgList = makePropDecorator(NG_LIST, makeNgListDecorator);
/**
 * --------------------------------------------------------------------------------
 * NgObject
 * --------------------------------------------------------------------------------
 ...
 * ```
 */
export var NgObject = makePropDecorator(NG_OBJECT, makeNgObjectDecorator);
/**
 * --------------------------------------------------------------------------------
 * NgDynamicProperty
 * --------------------------------------------------------------------------------
 */
/** NgObject 实体属性注解器名称 */
export var NG_Dynamic = 'NgDynamic';

 ...
 * 渲染状态，该状态用于和界面UI绑定
 */
export declare type RenderState = boolean;
/**
 * 初始渲染状态
 */
export declare const initialUIState: RenderState;
/**
 * 渲染状态字典，形如：
 * {
 ...
 */
export declare type Render = (context: StateMachineContext) => RenderState;
/**
 * 渲染方法字典
 * {

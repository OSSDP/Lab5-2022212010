...
import { NgCommand, Keybinding } from './decorators';
 ...
 * ```
 */
declare class ViewModel implements IDisposable, OnDestroy {
    name: string;
     ...
     * 界面验证信息
     */
    verifyInformations: any[];
    verifycationChanged: Subject<any[]>;
    /**
     * 表达式服务
     */
    readonly expression: ExpressionManager;
    /**
     * 表达式结果
     */
    readonly expressionResult: ExpressionResult;
    /**
     * 快捷键映射
     */
    ...
    setMetadata(metadata: IContextMetadata): void;
    /**
     * 初始化
     */
    init(context: FrameContext): void;
    /**
     * 绑定命令
     */
    buildCommands(context: FrameContext): void;
    /**
     * 从Form获取监听器
     */
    private initListeners;
    bindToParent(parent: ViewModel): void;
    /**
     * 合并审批及表单表达式并计算结果
     * @param expression 表达式
     * @returns
     */
    transform(expression: string | boolean | Array<any>): any;
}
export { ViewModel };

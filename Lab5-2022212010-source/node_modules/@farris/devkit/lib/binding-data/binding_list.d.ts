...
import { FilterCondition, ObjectFilterCondition } from '../data-filter';
/**
 * BindingList是一个BindingObject集合
 */
declare class BindingList implements IDisposable {
    __type__: string;
    /**
     ...
     * 界面数据源
     */
    defaultView: List<BindingObject>;
    /**
     * 关联实体的属性集合
     */
     ...
     * @param objects 要加载绑定对象数组
     */
    append(objects: BindingObject[], isCloned?: boolean, options?: any): void;
    /**
     * 增加数据
     * @param objects 实体
     * @param options 上下文
     ...
     */
    addData(objects: BindingObject[], options?: any): void;
     ...
     * @param  force 强制切换
     */
    setCurrentId(id: string, emitEvent?: boolean, emitGlobalEvent?: boolean, force?: boolean): void;
    /**
     * 根据主键值为id的绑定对象的索引
     * @param id 主键值
     ...
     */
    filter(conditions: Array<FilterCondition> | ObjectFilterCondition): void;
    /**
     * 获取分页信息
     * @param path 路径

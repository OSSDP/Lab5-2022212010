...
import { __extends, __spread, __assign, __generator, __values, __read } from 'tslib';
 ...
 */
var DEVKIT_RUN_MODE = new InjectionToken('@farris/devkit_run_mode');
/**
 * 组件类型
 */
var ComponentType;
...
var ZonedTime = /** @class */ (function () {
    ...
    // }
    ZonedTime.zonedTimeToSpecialTimeZoneOffsetTimeString = function (date, offset, format$$1) {
        if (offset === void 0) { offset = 0; }
        if (format$$1 === void 0) { format$$1 = 'YYYY-MM-DD HH:mm:ss.SSS'; }
        var utcTime = moment(date).utc();
        var offsetMinutes = offset * 60;
        var result = utcTime.add(offsetMinutes, 'm');
        return result.format(format$$1);
    };
    ZonedTime.timeZoneOffsetTimeToUtcTimeString = function (date, offset, format$$1) {
        if (format$$1 === void 0) { format$$1 = 'YYYY-MM-DD HH:mm:ss.SSS'; }
...
var BindingPathComparer = /** @class */ (function () {
    ...
    BindingPathComparer.isEqual = function (srcPath, dstPath) {
        ...
        var isEqual$$1 = srcPathArray.every(function (srcPathItem, srcPathIndex) {
 ...
 */
var CHANGE_SET_POLICY_TOKEN = new InjectionToken('@farris/changeset_policy_token');
/**
 * 启用服务器端变更检测
 */
var ENABLE_SERVER_SIDE_CHANGE_DETECTION_TOKEN = new InjectionToken('@farris/enable_server_side_change_detection_token');
/**
 * 启用编辑态过滤排序
 */
var ENABLE_EDIT_STATE_FILTER_SORTING = new InjectionToken('@farris/enable_edit_state_filter_sorting_token');
...
var ResolverRegistry = /** @class */ (function () {
    ...
    /** @nocollapse */
    ResolverRegistry.ctorParameters = function () { return [
        { type: Injector },
...
var DefaultRepository = /** @class */ (function (_super) {
     ...
     * 获取实体列表
     */
    DefaultRepository.prototype.getEntities = function (filter$$1, sorts, pageSize, pageIndex) {
        throw new Error('Not Implemented');
    };
    DefaultRepository.prototype.filter = function (filter$$1, sorts, pageSize, pageIndex) {
        throw new Error('Not Implemented');
    };
    /**
     * 获取实体列表
     ...
     * @param sort 排序
     */
    DefaultRepository.prototype.queryChild = function (paths, pageIndex, pageSize, filter$$1, sort) {
        throw new Error('Not Implemented');
    };
    /**
     * 根据id更新实体
...
var Form = /** @class */ (function (_super) {
     ...
     * @param errors 错误消息
     */
    Form.prototype.updateFormErrors = function (errors, forceShow, from$$1) {
        var _this = this;
        if (forceShow === void 0) { forceShow = false; }
        if (from$$1 === void 0) { from$$1 = ''; }
    ...
    * 新增FormControls
    ...
    Form.prototype.compareDate = function (srcDate, dstDate) {
        ...
        var isEqual$$1 = srcDate.getFullYear() === dstDate.getFullYear()
...
var BindingData = /** @class */ (function () {
     ...
     */
    BindingData.prototype.setPagingInfo = function (skip, take$$1, bindingPath) {
...
var BindingList = /** @class */ (function () {
     ...
     * @param take take
     */
    BindingList.prototype.setPaginationInfo = function (skip, take$$1) {
...
var ENTITY_DATA_SERVICE_TOKEN = new InjectionToken('@farris/devkit ENTITY_DATA_SERVICE');
 ...
 */
var isObservable$1 = function (value) {
    if (!value) {
        return false;
    }
...
var TaskNode = /** @class */ (function () {
    ...
    TaskNode.prototype.execute = function (context) {
        ...
        var result$ = isObservable$1(result) ? result : of(result);
        return result$;
    };
    return TaskNode;
}());
 ...
 * @author Witt <jiwt@inspur.com>
 */
var VARIABLE_PARSERS = new InjectionToken('variable parsers');
...
var TaskLink = /** @class */ (function () {
     ...
     * 构造函数
     */
    function TaskLink(from$$1, to, condition) {
        this.from = from$$1;
        this.to = to;
...
var TaskFlow = /** @class */ (function () {
     ...
     * @param func 函数
     */
    TaskFlow.prototype.addLink = function (from$$1, to, condition) {
        var link = this.createLink(from$$1, to, condition);
     ...
     * 创建链接
     */
    TaskFlow.prototype.createLink = function (from$$1, to, condition) {
        var link = new TaskLink(from$$1, to, condition);
        return link;
    };
    // #endregion
    // #region 流程控制
     ...
     * @param context 上下文
     */
    TaskFlow.prototype.getNext = function (from$$1, context) {
        if (!from$$1) {
...
var TranslateToken = new InjectionToken('@farris/devkit TranslateToken');
...
var CommandHandler = /** @class */ (function () {
     ...
     * @param func 任务函数
     */
    CommandHandler.prototype.addLink = function (from$$1, to, condition) {
 ...
 * 变量类型转换
 */
var PARAM_TYPE_TRANSFORM_TOKEN = new InjectionToken('@farris/devkit_param_type_transform');
 ...
 * 表单Id
 */
var FORM_ID = new InjectionToken('@farris/devkit FORM_ID');
...
var FRAME_ID = new InjectionToken('@farris/devkit FRAME_ID');
/**
 * 表单命名空间
 */
 ...
 * 组件初始化时的处理器
 */
var FRAME_COMPONENT_INIT_HANDLER_TOKEN = new InjectionToken('@farris/frame_component_init_handler_token');
...
var Subscription = /** @class */ (function () {
    ...
    Subscription.prototype.paramMap2UiState = function (param, paramMapCollection, currentFrameContext) {
        for (var i = 0; i < paramMapCollection.length; i++) {
            var from$$1 = paramMapCollection[i].from;
 ...
 */
var EXCEPTION_HANDLER = new InjectionToken('@farris/devkit ExceptionHandler');

var UserSettingsToken = new InjectionToken('@farris/devkit UserSettingsToken');
...
var ExpressionExecutor = /** @class */ (function () {
    ...
    ExpressionExecutor.prototype.compile = function (expressionObject, context) {
        ...
        if (!expressionObject.factory) {
            var expression_1 = new Expression(expressionObject.expression, expressionContext);
...
var ExpressionResult = /** @class */ (function () {
    ...
    /** @nocollapse */
    ExpressionResult.ctorParameters = function () { return [
        { type: Injector }
    ]; };
...
var ExpressionManager = /** @class */ (function () {
    ...
    ExpressionManager.prototype.onDataPicking = function (configs) {
        ...
        if (!result) {
            ...
            var messageType = expressionObject.messageType || Expression$1.MessageType.warning;
    ...
    ExpressionManager.prototype.execute = function (expression, customContext) {
        ...
        var context = __assign((_a = {}, _a[this.entityOriginalNodeCode] = entityContext, _a), stateContext, { BigNumber: BigNumber, frameContext: this.frameContext, bindingData: this.frameContext.bindingData, repository: this.frameContext.repository, CurrentLanguage: translate.getCurrentLanguage() || 'zh-CHS' }, data);
        if (!entityContext) {
            return undefined;
        }
...
var EventType = Expression$1.EventType;
...
var ListenerRegistry = /** @class */ (function () {
    ...
    /** @nocollapse */
    ListenerRegistry.ctorParameters = function () { return [
...
var EventType$1 = Expression$1.EventType;
/**
 * 监听bindingList变更
...
var UIStateEffector = /** @class */ (function () {
    ...
    /** @nocollapse */
    UIStateEffector.ctorParameters = function () { return [
        { type: Injector },
        { type: UIState },
        { type: undefined, decorators: [{ type: Inject, args: [NAMESPACE,] }] }
    ]; };
...
var ReadonlyEffector = /** @class */ (function () {
    ...
    /** @nocollapse */
    ReadonlyEffector.ctorParameters = function () { return [
        { type: Injector },
        { type: undefined, decorators: [{ type: Inject, args: [NAMESPACE,] }] },
        { type: FrameContext }
    ]; };
...
var EffectorRegistry = /** @class */ (function () {
    ...
    /** @nocollapse */
    EffectorRegistry.ctorParameters = function () { return [
        { type: Injector },
...
var EventHandler = /** @class */ (function () {
    ...
    EventHandler.prototype.buildContext = function (expressionObject, event, entityContext, currentRows) {
        ...
        var translate = this.injector.get(TranslateToken, null);
        return __assign((_a = {}, _a[entityCode] = entity, _a), stateContext, { BigNumber: BigNumber, frameContext: this.frameContext, bindingData: this.bindingData, repository: this.repository, CurrentLanguage: translate.getCurrentLanguage() || 'zh-CHS' });
    };
    //#endregion
    /**
     * 构造副作用路径
    ...
    EntityUpdateEventHandler.prototype.filter = function (event) {
        ...
        return this.expressionObjects.filter(function (expressionObject) {
            ...
            var index = expressionObject.deps.findIndex(function (dep) {
                ...
                var deps = dep.split(Expression$1.DEPENDENCY_SPLITER).filter(function (p) { return p; }).slice(1);
        ...
        if (this.expressionObjects && this.expressionObjects.length > 0) {
            ...
            var groupExpressions = this.expressionObjects.filter(function (expressionObject) {
                ...
                var index = expressionObject.deps.findIndex(function (dep) {
                    ...
                    var deps = dep.split(Expression$1.DEPENDENCY_SPLITER).filter(function (p) { return p; }).slice(1);
                    var dependPathInfo = _this.getPathInfo(deps.join(Expression$1.DEPENDENCY_SPLITER));
            ...
            var relativeExpressions = this.expressionObjects.filter(function (expressionObject) {
                ...
                // 过滤掉非当前表的表达式
                if (expressionPathInfo.paths.join(Expression$1.DEPENDENCY_SPLITER) !== eventTablePaths_1.join(Expression$1.DEPENDENCY_SPLITER)) {
                    return false;
                }
 ...
 * @Last Modified time: 2019-06-01 17:10:04
 */
var VALIDATION_HANDLER = new InjectionToken('@farris/common-service ValidationHandler');
...
var DeprecatedBindingDataChangeListener = /** @class */ (function (_super) {
    ...
    /** @nocollapse */
    DeprecatedBindingDataChangeListener.ctorParameters = function () { return [
        { type: Injector },
        { type: BindingData },
        { type: undefined, decorators: [{ type: Inject, args: [NAMESPACE,] }] }
    ]; };

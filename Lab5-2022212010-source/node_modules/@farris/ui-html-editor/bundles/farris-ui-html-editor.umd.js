(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/platform-browser'), require('@angular/forms'), require('@farris/ui-common'), require('quill'), require('@angular/core'), require('@farris/ui-notify'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-html-editor', ['exports', '@angular/common', '@angular/platform-browser', '@angular/forms', '@farris/ui-common', 'quill', '@angular/core', '@farris/ui-notify', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-html-editor'] = {}),global.ng.common,global.ng.platformBrowser,global.ng.forms,global.uiCommon,global.Quill,global.ng.core,global.uiNotify,global.uiLocale));
}(this, (function (exports,common,platformBrowser,forms,uiCommon,Quill,core,uiNotify,uiLocale) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var HtmlEditorComponent = /** @class */ (function () {
            ...
            function () {
                ...
                if (this.customToolbar) {
                    if (this.toolbar && this.toolbar.length) {
                        modules.toolbar = uiCommon.Convert2HtmlEditorToolbars('concise', this.toolbar);
                    }
                    else {
                        modules.toolbar = defaultModules.toolbar;
                    }
        ...
        /** @nocollapse */
        HtmlEditorComponent.ctorParameters = function () {
            return [
                ...
                { type: uiNotify.NotifyService, decorators: [{ type: core.Optional }] },
                { type: uiLocale.LocaleService, decorators: [{ type: core.Optional }] },
                { type: core.Injector, decorators: [{ type: core.Optional }] }
            ];
        };
        HtmlEditorComponent.propDecorators = {
            rootClass: [{ type: core.HostBinding, args: ['class',] }],
            readonly: [{ type: core.Input }, { type: core.HostBinding, args: ['class.farris-html-editor-readonly',] }],
            disabled: [{ type: core.Input }, { type: core.HostBinding, args: ['class.farris-html-editor-disabled',] }],
            showBorder: [{ type: core.Input }, { type: core.HostBinding, args: ['class.farris-html-editor-border',] }],
            ...
            preserveWhitespace: [{ type: core.Input }],
            limitImageSize: [{ type: core.Input }],
            maxImgSize: [{ type: core.Input }],
            customToolbar: [{ type: core.Input }],
            toolbar: [{ type: core.Input }],
            fontStyleBar: [{ type: core.Input }],
            BlockBar: [{ type: core.Input }],
            headerBar: [{ type: core.Input }],
            sizeBar: [{ type: core.Input }],
            listBar: [{ type: core.Input }],
            fontBar: [{ type: core.Input }],
            superAndSubscriptBar: [{ type: core.Input }],
            indentBar: [{ type: core.Input }],
            colorBar: [{ type: core.Input }],
            mediaBar: [{ type: core.Input }],
            imageBar: [{ type: core.Input }],
            videoBar: [{ type: core.Input }],
            cleanBar: [{ type: core.Input }],
            alignBar: [{ type: core.Input }],
    ...
    exports.FarrisHtmlEditorModule = FarrisHtmlEditorModule;
    exports.defaultModules = defaultModules;
    exports.toolbarOptions = toolbarOptions;
    exports.ɵb = QUILL_CONFIG_TOKEN;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-html-editor.umd.js.map
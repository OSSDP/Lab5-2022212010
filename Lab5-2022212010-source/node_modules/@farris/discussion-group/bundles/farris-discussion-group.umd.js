(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@farris/discussion-group', ['exports', 'rxjs', 'rxjs/operators', '@angular/common', '@angular/forms', '@angular/platform-browser', '@farris/ui-dialog', '@farris/ui-common', '@farris/ui-common/date', '@farris/ui-tree', '@farris/ui-modal', '@farris/ui-loading', '@farris/ui-locale', '@farris/ui-modal/component-loader', '@farris/ui-modal/positioning', '@farris/ui-perfect-scrollbar', '@farris/ui-pagination', '@farris/ui-notify', '@farris/ui-input-group', '@angular/common/http', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['discussion-group'] = {}),global.rxjs,global.rxjs.operators,global.ng.common,global.ng.forms,global.ng.platformBrowser,global.uiDialog,global.uiCommon,global.date,global.uiTree,global.uiModal,global.uiLoading,global.uiLocale,global.componentLoader,global.positioning,global.uiPerfectScrollbar,global.uiPagination,global.uiNotify,global.uiInputGroup,global.ng.common.http,global.ng.core));
}(this, (function (exports,rxjs,operators,common,forms,platformBrowser,uiDialog,uiCommon,date,uiTree,uiModal,uiLoading,uiLocale,componentLoader,positioning,uiPerfectScrollbar,uiPagination,uiNotify,uiInputGroup,http,i0) { 'use strict';
    ...
    var DiscussionGroupService = /** @class */ (function () {
        ...
        /** @nocollapse */ DiscussionGroupService.ngInjectableDef = i0.defineInjectable({ factory: function DiscussionGroupService_Factory() { return new DiscussionGroupService(); }, token: DiscussionGroupService, providedIn: "root" });
    ...
    var DiscussionListService = /** @class */ (function () {
        function DiscussionListService() {
            this.resultDiscussion = new rxjs.BehaviorSubject(null);
        }
        /**
         * @param {?} data
         * @return {?}
    ...
    var DiscussionListComponent = /** @class */ (function () {
        function DiscussionListComponent(discussionListService) {
            ...
            this.replyMessage = new i0.EventEmitter();
            // 分页事件
             ...
             * 附件预览
             */
            this.filePreview = new i0.EventEmitter();
            /**
             * 附件下载
             */
            this.fileDownload = new i0.EventEmitter();
            this.labels = {
                previousLabel: ' ',
                nextLabel: ' '
            };
    ...
    ***************************************************************************** */
    ...
    var DiscussionEditorComponent = /** @class */ (function () {
        function DiscussionEditorComponent(renderer, elementRef, cd, notifyService, injector, http$$1) {
             ...
             * 附件删除
             */
            this.fileRemove = new i0.EventEmitter();
            this.fileUploadDone = new i0.EventEmitter();
            this.personnelSearch = new i0.EventEmitter();
            this.getOugUsers = new i0.EventEmitter();
        ...
        /** @nocollapse */
        DiscussionEditorComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
                { type: i0.ElementRef },
        ...
        DiscussionEditorComponent.propDecorators = {
            personnelsPrimaryKey: [{ type: i0.Input }],
            personnelsDisplayKey: [{ type: i0.Input }],
            replyPersonnelsDisplayKey: [{ type: i0.Input }],
            cancelVisible: [{ type: i0.Input }],
            editHeight: [{ type: i0.Input }],
            type: [{ type: i0.Input }],
            orgUrl: [{ type: i0.Input }],
            personSearchUrl: [{ type: i0.Input }],
            treeIdField: [{ type: i0.Input }],
            treeDisplayText: [{ type: i0.Input }],
            sectionData: [{ type: i0.Input }],
            personnels: [{ type: i0.Input }],
            replyUser: [{ type: i0.Input }],
            attachFiles: [{ type: i0.Input }],
            selectionsChange: [{ type: i0.Output }],
            lineDataChange: [{ type: i0.Output }],
            valueChange: [{ type: i0.Output }],
            filePreview: [{ type: i0.Output }],
            fileRemove: [{ type: i0.Output }],
            fileUploadDone: [{ type: i0.Output }],
            personnelSearch: [{ type: i0.Output }],
            getOugUsers: [{ type: i0.Output }],
            editor: [{ type: i0.ViewChild, args: ['editor',] }],
            personModal: [{ type: i0.ViewChild, args: ['personModal',] }]
        };
    ...
    var DiscussionPersonnelComponent = /** @class */ (function () {
        function DiscussionPersonnelComponent(renderer, elementRef, ngZone, http$$1, cd, injector) {
            this.renderer = renderer;
            this.elementRef = elementRef;
            this.ngZone = ngZone;
            this.http = http$$1;
            ...
            // 选中的行
            this.lineDataChange = new i0.EventEmitter();
            this.openDialog = new i0.EventEmitter();
            this.ougUsers = new i0.EventEmitter();
            ...
            // 查询变化
            this.searchTextChangeSubject = new rxjs.Subject();
            this.errorText = '';
            this.perfixStr = '';
            this.localeService = this.injector.get(uiLocale.LocaleService);
            this.loadingSer = this.injector.get(uiLoading.LoadingService);
            if (uiCommon.WEBAPI_PREFIX_TOKEN) {
                this.perfixStr = this.injector.get(uiCommon.WEBAPI_PREFIX_TOKEN, '');
            }
        }
        /**
         * @return {?}
         ...
         */
            function (data, parentId, parentName) {
                var _this = this;
                if (parentId === void 0) {
                    parentId = "discussionParent";
                }
                if (parentName === void 0) {
                    parentName = this.allOrg;
                }
                if (data && data.length) {
                    data.forEach(( /**
                     * @param {?} item
         ...
         */
            function (section) {
                ...
                rxjs.forkJoin([this.getOrgByLayerHttp(section), this.getPersonByUrlHttp(section)])
                    .subscribe(( /**
         ...
         */
            function () {
                ...
                this.showOrHideLoading(false);
                this.searchTextChangeSubject = new rxjs.Subject();
                this.searchTextChangeSubject.pipe(operators.debounceTime(200)).subscribe(( /**
                 * @param {?} tsearchText
                 * @return {?}
        ...
        /** @nocollapse */
        DiscussionPersonnelComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
                { type: i0.ElementRef },
                { type: i0.NgZone },
        ...
        DiscussionPersonnelComponent.propDecorators = {
            ...
            listDisplayText: [{ type: i0.Input }],
            sectionData: [{ type: i0.Input }],
            orgUrl: [{ type: i0.Input }],
            personSearchUrl: [{ type: i0.Input }],
            urlGetOrgByLayer: [{ type: i0.Input }],
            personnelDialog: [{ type: i0.ViewChild, args: ['personnelDialog',] }],
            selectionsChange: [{ type: i0.Output }],
            lineDataChange: [{ type: i0.Output }],
            openDialog: [{ type: i0.Output }],
            ougUsers: [{ type: i0.Output }],
            crumbsList: [{ type: i0.ViewChild, args: ['crumbsList',] }],
            discussionContent: [{ type: i0.ViewChild, args: ['discussionContent',] }]
        };
    ...
    var DiscussionListDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DiscussionListDirective.ctorParameters = function () {
            return [
                { type: DiscussionListService }
            ];
        };
        DiscussionListDirective.propDecorators = {
            discussionListData: [{ type: i0.Input }]
        };
    ...
    var AvatarHtmlPipe = /** @class */ (function () {
        ...
        AvatarHtmlPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'avatarHtml' },] }
        ];
    ...
    var GetOrgTextPipe = /** @class */ (function () {
        ...
        GetOrgTextPipe.decorators = [
            { type: i0.Pipe, args: [{ name: 'getOrgText' },] }
        ];
    ...
    exports.DiscussionListComponent = DiscussionListComponent;
    exports.DiscussionEditorComponent = DiscussionEditorComponent;
    exports.MsgInfo = MsgInfo;
    exports.DiscussionPersonnelComponent = DiscussionPersonnelComponent;
    exports.DiscussionListDirective = DiscussionListDirective;
    exports.DiscussionListService = DiscussionListService;
    exports.DiscussionGroupModule = DiscussionGroupModule;
    exports.SafeHtmlPipe = SafeHtmlPipe;
    exports.AvatarHtmlPipe = AvatarHtmlPipe;
    exports.GetOrgTextPipe = GetOrgTextPipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-discussion-group.umd.js.map
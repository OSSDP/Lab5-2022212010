(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash-es'), require('@angular/core'), require('@angular/common'), require('@farris/ui-locale'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-treetable'), require('@farris/ui-common'), require('@angular/forms'), require('@farris/ui-messager')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-multi-select', ['exports', 'lodash-es', '@angular/core', '@angular/common', '@farris/ui-locale', '@farris/ui-perfect-scrollbar', '@farris/ui-treetable', '@farris/ui-common', '@angular/forms', '@farris/ui-messager'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-multi-select'] = {}),global.lodashEs,global.ng.core,global.ng.common,global.uiLocale,global.uiPerfectScrollbar,global.uiTreetable,global.uiCommon,global.ng.forms,global.uiMessager));
}(this, (function (exports,lodashEs,core,common,uiLocale,uiPerfectScrollbar,uiTreetable,uiCommon,forms,uiMessager) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MultiSelectComponent = /** @class */ (function () {
        function MultiSelectComponent(mesagerSer, injector, cd) {
            ...
            this.selectedIdChange = new core.EventEmitter();
            this.beforeMove = new core.EventEmitter();
            this.afterMove = new core.EventEmitter();
            this.sortMove = new core.EventEmitter();
                ...
                if (!this.searchValue) {
                    if (val.length) {
                        if (val[0].toJSON) {
                            ...
                            this.copyDataSource = lodashEs.cloneDeep(val);
                        }
                    }
                    setTimeout(( /**
                     * @return {?}
        ...
        Object.defineProperty(MultiSelectComponent.prototype, "searchValue", {
             ...
             */ function (value) {
                ...
                if (value === undefined || value === null || value === '') {
                    /** @type {?} */
                    var leftCheckitems_1 = __assign({}, this._leftCheckeds);
                    ...
                    if (this.displayType === 'Tree') {
                        ...
                        this._leftCheckeds = __assign({}, leftCheckitems_1);
                    }
                    return;
                }
                if (this.displayType === 'Tree') {
         ...
         */
            function (ids) {
                ...
                if (ids && ids.length) {
                    /** @type {?} */
                    var checkeds = __assign({}, this._leftCheckeds);
            ...
            function (ids) {
                 ...
                 */function () {
                    ...
                    if (_this_1.tt) {
                        ...
                        _this_1.allTreeNodes = lodashEs.cloneDeep(_this_1.tt.state.rowNodes.map(( /**
                         * @param {?} n
                         * @return {?}
                ...
                if ((typeof ids === 'string' && !!ids) || typeof ids === 'number') {
                    ...
                    if (Array.isArray(dataSource)) {
                         ...
                         */function (id) {
                             ...
                             * @param {?} item
                             * @return {?}
                             */function (item) { return item[_this_1.idField] === id; }));
                        })).filter(( /**
                         * @param {?} n
                         * @return {?}
                         */function (n) { return n; }));
                 ...
                 */function (obj) {
                    ...
                    switch (obj.target) {
                        case 'right':
                            ...
                            _this_1._rightData = __spread(_this_1._rightData);
                            if (_this_1.isTree()) {
                                _this_1.tt.clearAll();
                            }
                            direction = 1;
            ...
            function () {
                ...
                if (obj) {
                    ...
                    if (index !== 0) {
                        ...
                        (_a = this._rightData).splice.apply(_a, __spread([index - 1, 0], tempArr));
                    }
                    this.selectionsChange();
                    this.changeSelectIds(0);
                }
         ...
         */
            function (type) {
                ...
                if (this._rightCheckeds && Object.keys(this._rightCheckeds).length) {
                     ...
                     * @return {?}
                     */function (n) {
                        return !_chkItems_1.find(( /**
                         * @param {?} r
                         * @return {?}
                         */function (r) { return r[_this_1.idField] == n[_this_1.idField]; }));
                    }));
                    if (type === 'top') {
                        items.splice.apply(items, __spread([0, 0], _chkItems_1));
                    }
                    else if (type === 'bottom') {
                        items.push.apply(items, __spread(_chkItems_1));
                    }
                    this._rightData = __spread(items);
            ...
            function (type) {
                ...
                if (type === 'up') {
                    ...
                    if (tarIndex < 0) {
                        ...
                        items.splice.apply(items, __spread([tarIndex, 0], _chkItems));
                    }
                }
                else if (type === 'down') {
                    /** @type {?} */
                    ...
                    if (downIdx >= this._rightData.length) {
                        ...
                        items.splice.apply(items, __spread([downIdx, 0], _chkItems));
                    }
                }
                this._rightData = __spread(items);
                this.updateActiveIndex();
            ...
            function ($event, item, index) {
                ...
                if (!isCtrlKey && !isShiftKey) {
                     ...
                     */function (isAdd) {
                        ...
                        /** @type {?} */
                        var selectItems = __spread(_this_1._rightData).splice(start, end - start + 1);
                        if (!isAdd) {
                            _this_1._rightCheckeds = [];
                        }
                        selectItems.forEach(( /**
        ...
        MultiSelectComponent.propDecorators = {
            ...
            enableTargetSort: [{ type: core.Input }],
            idField: [{ type: core.Input }],
            textField: [{ type: core.Input }],
            valueField: [{ type: core.Input }],
            height: [{ type: core.Input }],
            fit: [{ type: core.Input }],
            noDataMoveMessage: [{ type: core.Input }],
            showCascadeControl: [{ type: core.Input }],
            leftTitle: [{ type: core.Input }],
            rightTitle: [{ type: core.Input }],
            ...
            enableMoveMore: [{ type: core.Input }],
            searchValueField: [{ type: core.Input }],
            dataChange: [{ type: core.Output }],
            selected: [{ type: core.Output }],
            unSelected: [{ type: core.Output }],
            selectedIdChange: [{ type: core.Output }],
            beforeMove: [{ type: core.Output }],
            afterMove: [{ type: core.Output }],
            sortMove: [{ type: core.Output }],
            templates: [{ type: core.ContentChildren, args: [uiCommon.FarrisTemplateDirective,] }],
    ...
    var DisplayTextComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DisplayTextComponent.ctorParameters = function () {
            return [
    ...
    exports.DisplayTextComponent = DisplayTextComponent;
...
//# sourceMappingURL=farris-ui-multi-select.umd.js.map
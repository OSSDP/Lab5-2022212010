(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-popover'), require('@farris/ui-notify'), require('@angular/forms'), require('@angular/common'), require('rxjs/operators'), require('@angular/core'), require('rxjs'), require('@farris/ui-input-group'), require('@farris/ui-datalist'), require('@farris/ui-combo-list'), require('@farris/ui-modal'), require('@farris/ui-datepicker'), require('@farris/ui-number-spinner'), require('@farris/property-editor')) :
    typeof define === 'function' && define.amd ? define('@farris/ide-property-panel', ['exports', '@farris/ui-popover', '@farris/ui-notify', '@angular/forms', '@angular/common', 'rxjs/operators', '@angular/core', 'rxjs', '@farris/ui-input-group', '@farris/ui-datalist', '@farris/ui-combo-list', '@farris/ui-modal', '@farris/ui-datepicker', '@farris/ui-number-spinner', '@farris/property-editor'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ide-property-panel'] = {}),global['@farris/ui-popover'],global['@farris/ui-notify'],global.ng.forms,global.ng.common,global.rxjs.operators,global.ng.core,global.rxjs,global['@farris/ui-input-group'],global['@farris/ui-datalist'],global['@farris/ui-combo-list'],global['@farris/ui-modal'],global['@farris/ui-datepicker'],global['@farris/ui-number-spinner'],global['@farris/property-editor']));
}(this, (function (exports,uiPopover,uiNotify,forms,common,operators,core,rxjs,uiInputGroup,uiDatalist,uiComboList,uiModal,uiDatepicker,uiNumberSpinner,propertyEditor) { 'use strict';
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var NumberPropertyComponent = /** @class */ (function () {
        function NumberPropertyComponent() {
            this.valueChanged = new core.EventEmitter();
            /**
             * 数字控件精度
             */
        ...
        Object.defineProperty(NumberPropertyComponent.prototype, "elementConfig", {
            get: /**
             * @return {?}
             */ function () {
                return this._elementConfig;
        ...
        Object.defineProperty(NumberPropertyComponent.prototype, "elementValue", {
            get: /**
             * @return {?}
             */ function () {
                return this._elementValue;
         ...
         * @return {?}
         */
        NumberPropertyComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () { };
        /**
         ...
         * @return {?}
         */
        NumberPropertyComponent.prototype.changeValue = /**
         * @param {?} $event
         * @return {?}
         */
            function ($event) {
    ...
    var DatePropertyComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DatePropertyComponent.ctorParameters = function () {
            return [
    ...
    var ModalPropertyComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                // 监听关闭模态框
                if (compRef.instance.closeModal && compRef.instance.closeModal instanceof core.EventEmitter) {
                ...
                if (compRef.instance.submitModal && compRef.instance.submitModal instanceof core.EventEmitter) {
        ...
        /** @nocollapse */
        ModalPropertyComponent.ctorParameters = function () {
            return [
    ...
    var UniformPropertyComponent = /** @class */ (function () {
        ...
        UniformPropertyComponent.propDecorators = {
            elementConfig: [{ type: core.Input }],
            elementValue: [{ type: core.Input }],
            valueChanged: [{ type: core.Output }]
        };
    ...
    var FPropertyItemComponent = /** @class */ (function () {
        function FPropertyItemComponent(resolver) {
            ...
            this.submitModal = new core.EventEmitter();
            // 向上触发整体面板刷新
            this.triggerRefreshPanel = new core.EventEmitter();
            // 控件类型
        ...
        /** @nocollapse */
        FPropertyItemComponent.ctorParameters = function () {
            return [
                { type: core.ComponentFactoryResolver }
            ];
        };
        FPropertyItemComponent.propDecorators = {
            ...
            valueChanged: [{ type: core.Output }],
            submitModal: [{ type: core.Output }],
            triggerRefreshPanel: [{ type: core.Output }],
            propItem: [{ type: core.ViewChild, args: ['propItem', { read: core.ViewContainerRef },] }]
        };
    ...
    var PropertyItemComponent = /** @class */ (function () {
        ...
        PropertyItemComponent.propDecorators = {
            ...
            triggerRefreshPanel: [{ type: core.Output }],
            propItem: [{ type: core.ViewChild, args: ['propItem', { read: core.ViewContainerRef },] }],
            stringTmpl: [{ type: core.ViewChild, args: ['stringTmpl',] }],
            numberTmpl: [{ type: core.ViewChild, args: ['numberTmpl',] }],
            selectTmpl: [{ type: core.ViewChild, args: ['selectTmpl',] }],
            boolOrExpTmpl: [{ type: core.ViewChild, args: ['boolOrExpTmpl',] }],
            multiSelectTmpl: [{ type: core.ViewChild, args: ['multiSelectTmpl',] }],
            dateTmpl: [{ type: core.ViewChild, args: ['dateTmpl',] }],
            datetimeTmpl: [{ type: core.ViewChild, args: ['datetimeTmpl',] }],
            modalTmpl: [{ type: core.ViewChild, args: ['modalTmpl',] }],
            editableSelectTmpl: [{ type: core.ViewChild, args: ['editableSelectTmpl',] }]
        };
    ...
    var PropertyItemListComponent = /** @class */ (function () {
        ...
        PropertyItemListComponent.propDecorators = {
            ...
            propertyData: [{ type: core.Input }],
            dynamicControl: [{ type: core.Input }],
            valueChanged: [{ type: core.Output }],
            submitModal: [{ type: core.Output }],
            triggerRefreshPanel: [{ type: core.Output }],
            items: [{ type: core.ViewChildren, args: [PropertyItemComponent,] }],
            fitems: [{ type: core.ViewChildren, args: [FPropertyItemComponent,] }]
        };
    ...
    var PropertyPanelComponent = /** @class */ (function () {
        function PropertyPanelComponent() {
             ...
             */
            this.closePropertyPanel = new core.EventEmitter();
            /**
             * 属性值
             */
            this.propertyData = {};
        ...
        PropertyPanelComponent.propDecorators = {
            ...
            isWhiteTheme: [{ type: core.Input }],
            isPersitOpenState: [{ type: core.Input }],
            isShowPanel: [{ type: core.Input }],
            closePropertyPanel: [{ type: core.Output }],
            propertyConfig: [{ type: core.Input }],
            propertyData: [{ type: core.Input }],
            dynamicControl: [{ type: core.Input }],
            propertyChanged: [{ type: core.Output }],
            submitModal: [{ type: core.Output }],
            showCloseBtn: [{ type: core.Input }],
            eastDiv: [{ type: core.ViewChild, args: ['east',] }],
            itemLists: [{ type: core.ViewChildren, args: [PropertyItemListComponent,] }]
        };
    ...
    ***************************************************************************** */
    ...
    var ComboListComponent = /** @class */ (function () {
         ...
         */function (val) {
            ...
            this.comboService.selected$.pipe(operators.takeUntil(this.destroy$)).subscribe(( /**
             * @return {?}
             */function () {
         ...
         */
            function () {
                ...
                rxjs.fromEvent(window, 'resize')
                    .pipe(operators.debounceTime(100), operators.throttle(( /**
             * @param {?} ev
             * @return {?}
             */function (ev) { return rxjs.interval(100); })), operators.takeUntil(this.destroy$))
                    .subscribe(( /**
             * @return {?}
             */function () {
    ...
    exports.TextboxPropertyComponent = TextboxPropertyComponent;
    exports.NumberPropertyComponent = NumberPropertyComponent;
    exports.ModalPropertyComponent = ModalPropertyComponent;
    exports.DatePropertyComponent = DatePropertyComponent;
    exports.CombolistPropertyComponent = CombolistPropertyComponent;
    exports.UniformPropertyComponent = UniformPropertyComponent;
    exports.PropertyPanelComponent = PropertyPanelComponent;
    exports.ɵe = ComboListComponent;
    exports.ɵd = ComboListModule;
    exports.ɵf = ComboService;
    exports.ɵc = FPropertyItemComponent;
    exports.ɵa = PropertyItemListComponent;
    exports.ɵb = PropertyItemComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ide-property-panel.umd.js.map
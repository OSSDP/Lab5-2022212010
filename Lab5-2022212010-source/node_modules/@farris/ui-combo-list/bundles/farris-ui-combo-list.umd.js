(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-lookup'), require('rxjs'), require('rxjs/operators'), require('@farris/ui-locale'), require('@farris/ui-common'), require('@angular/platform-browser'), require('resize-observer-polyfill'), require('@farris/ui-notify'), require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('@angular/forms'), require('@farris/ui-input-group'), require('@farris/ui-datalist'), require('@farris/ui-loading')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-combo-list', ['exports', '@farris/ui-lookup', 'rxjs', 'rxjs/operators', '@farris/ui-locale', '@farris/ui-common', '@angular/platform-browser', 'resize-observer-polyfill', '@farris/ui-notify', '@angular/core', '@angular/common', '@angular/common/http', '@angular/forms', '@farris/ui-input-group', '@farris/ui-datalist', '@farris/ui-loading'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-combo-list'] = {}),global.uiLookup,global.rxjs,global.rxjs.operators,global.uiLocale,global.uiCommon,global.ng.platformBrowser,global.ResizeObserver,global.uiNotify,global.ng.core,global.ng.common,global.ng.common.http,global.ng.forms,global.uiInputGroup,global.uiDatalist,global.uiLoading));
}(this, (function (exports,uiLookup,rxjs,operators,uiLocale,uiCommon,platformBrowser,ResizeObserver,uiNotify,core,common,http,forms,uiInputGroup,uiDatalist,uiLoading) { 'use strict';
     ...
     */
    /** @type {?} */
    var ComboServerSideToken = new core.InjectionToken('Combo Grid HTTP service');
    ...
    var ComboService = /** @class */ (function () {
        function ComboService(http$$1, loadingService, injector) {
            var _this = this;
            this.http = http$$1;
            this.loadingService = loadingService;
            this.injector = injector;
            this.selections$ = new rxjs.Subject();
            this.isOpen$ = new rxjs.BehaviorSubject(false);
            this.data$ = new rxjs.BehaviorSubject('');
            this.serachValue$ = new rxjs.Subject();
            this.loadSuccess$ = new rxjs.Subject();
            this.treeInfo$ = new rxjs.BehaviorSubject(null);
            ...
            this._data = [];
            this.serachValue$.pipe(operators.debounceTime(300)).subscribe(( /**
             * @param {?} value
             * @return {?}
             */function (value) {
         ...
         */
            function () {
                if (this.injector && !this.comboHttp) {
                    this.lookupUtils = this.injector.get(uiLookup.LookupUtils, null);
                    if (this.displayType.indexOf('LOOKUP') > -1) {
                        this.comboHttp = this.injector.get(uiLookup.ServerSideToken, null);
                    }
                    else {
         ...
         */
            function (params, selectedIds, method, isTree) {
                ...
                this.getData(params, method).pipe(operators.switchMap(( /**
                 * @param {?} data
                 * @return {?}
                 */function (data) {
                    if (selectedIds) {
                        return _this.getSelectedItems(selectedIds).pipe(operators.map(( /**
                         * @param {?} d
                         * @return {?}
                         */function (d) {
                            if (d && d.items) {
            ...
            function (params, method, loadChild) {
                ...
                if (this.uri) {
                    ...
                    if (this.comboHttp) {
                        ...
                        return this.comboHttp.getData(this.uri, params, method).pipe(operators.tap(( /**
                         * @return {?}
                         */function () {
                            _this.closeLoading();
                        })));
                        ...
                        return this.http.request(method, this.uri, params).pipe(operators.tap(( /**
                         * @return {?}
                         */function () {
                            _this.closeLoading();
                        })));
                    ...
                    if (this.data) {
                        return rxjs.of(this.data).pipe(operators.delay(10));
                    }
                    else {
                        return rxjs.of([]).pipe(operators.delay(10));
                    }
                }
            };
        /**
        ...
        /** @nocollapse */
        ComboService.ctorParameters = function () {
            return [
    ...
    ***************************************************************************** */
    ...
    var ComboLocaleService = /** @class */ (function () {
        ...
        /** @nocollapse */
        ComboLocaleService.ctorParameters = function () {
            return [
    ...
    var BaseComboComponent = /** @class */ (function () {
        function BaseComboComponent(el, cdr, document, render, comboService, injector) {
            ...
            this.emptyMsg = '暂无数据';
            this.showPanel = new core.EventEmitter();
            this.hidePanel = new core.EventEmitter();
            ...
            this._cmbPanel = null;
            this._comboPanelCreated$ = new rxjs.Subject();
            // private _hasPosited = false;
            // private _container: Element;
            this.willHide$ = new rxjs.Subject();
            this.panelListener = null;
            this.ngZone = null;
            this.mouseWheelEvent = null;
            this.textChangeSubject = new rxjs.Subject();
            this.initdataSubscription = null;
            this.customData = null;
            this.originalText = '';
            this.isTextChange = false;
            this.treeClientSearch = new rxjs.Subject();
            this.ro = null;
            this.onChange = ( /**
             * @return {?}
            ...
            this.willHide$.pipe(operators.takeUntil(this.destroy$), operators.debounceTime(110)).subscribe(( /**
             * @param {?} e
             * @return {?}
             */function (e) {
            ...
            this.eventMgr = this.injector.get(platformBrowser.EventManager);
            this.emitTextChange();
         ...
         */
            function () {
                ...
                rxjs.fromEvent(window, 'resize').pipe(operators.takeUntil(this.destroy$)).pipe(operators.debounceTime(100), operators.throttle(( /**
                 * @param {?} ev
                 * @return {?}
                 */function (ev) { return rxjs.interval(100); }))).subscribe(( /**
                 * @return {?}
                 */function () {
         ...
         */
            function () {
                var _this = this;
                return this.textChangeSubject.pipe(operators.debounceTime(200)).subscribe(( /**
                 * @param {?} r
                 * @return {?}
                 */function (r) {
                    /** @type {?} */
         ...
         */
            function (value, searchParam) {
                ...
                this.initdataSubscription = this.comboService.initData(params, method, selectedIds).pipe(operators.throwIfEmpty(focusInput)).subscribe(( /**
                 * @param {?} n
                 * @return {?}
                 */function (n) {
                    if (!_this.isOpen) {
        ...
        BaseComboComponent.prototype.onBeforeShow =
            ...
            function () {
                ...
                return this.beforeShow(this).pipe(operators.take(1));
            };
        /**
         * @private
         * @return {?}
        ...
        BaseComboComponent.prototype.onBeforeHide =
            ...
            function () {
                ...
                this.beforeHide(this).pipe(operators.take(1)).subscribe(( /**
                 * @param {?} value
                 * @return {?}
                 */function (value) {
        ...
        BaseComboComponent.prototype.initToggleAction =
            ...
            function () {
                var _this = this;
                this.comboService.isOpen$.pipe(operators.debounceTime(20), operators.takeUntil(this.destroy$), operators.skip(1)).subscribe(( /**
                 * @param {?} value
                 * @return {?}
                 */function (value) {
                ...
                this._comboPanelCreated$.pipe(operators.takeUntil(this.destroy$), operators.filter(( /**
                 * @param {?} value
                 * @return {?}
                ...
                this.destroy$.pipe(operators.take(1)).subscribe(( /**
                 * @return {?}
                 */function () {
            ...
            function (action) {
                ...
                if (iframes && iframes.length) {
                    try {
                        ...
                        try {
                            if (iframes_1_1 && !iframes_1_1.done && (_a = iframes_1.return))
                                _a.call(iframes_1);
                        }
                        finally {
                            if (e_1)
         ...
         */
            function () {
                var _this = this;
                this.comboService.selections$.pipe(operators.takeUntil(this.destroy$), operators.debounceTime(100)).subscribe(( /**
                 * @param {?} value
                 * @return {?}
                 */function (value) {
         ...
         */
            function (clearMapFields) {
                if (clearMapFields === void 0) {
                    clearMapFields = false;
                }
        ...
        /** @nocollapse */
        BaseComboComponent.ctorParameters = function () {
            return [
        ...
        BaseComboComponent.propDecorators = {
            ...
            enableCancelSelected: [{ type: core.Input }],
            remoteSearch: [{ type: core.Input }],
            beforeShow: [{ type: core.Input }],
            beforeHide: [{ type: core.Input }],
            hidePanelOnClear: [{ type: core.Input }],
            useValue: [{ type: core.Input }],
            separator: [{ type: core.Input }],
            treeToList: [{ type: core.Input }],
            navTreeToList: [{ type: core.Input }],
            emptyMsg: [{ type: core.Input }],
            showPanel: [{ type: core.Output }],
            hidePanel: [{ type: core.Output }],
            clear: [{ type: core.Output }],
            valueChange: [{ type: core.Output }],
            selectChange: [{ type: core.Output }],
            cmbPanel: [{ type: core.ViewChild, args: ['comboPanel',] }],
            input: [{ type: core.ViewChild, args: ['input',] }],
            input2: [{ type: core.ViewChild, args: ['input2',] }]
        };
    ...
    var ComboListComponent = /** @class */ (function (_super) {
        ...
        ComboListComponent.propDecorators = {
            ...
            showPanelType: [{ type: core.Input }],
            dataListRef: [{ type: core.ViewChild, args: ['dl',] }],
            itemHeight: [{ type: core.Input }],
            cls: [{ type: core.HostBinding, args: ['class.f-combo-list',] }],
            clsTag: [{ type: core.HostBinding, args: ['class.f-combo-list--tag',] }],
            registerKeyboardEvent: [{ type: core.HostListener, args: ['keydown', ['$event'],] }],
            escHandlerEvent: [{ type: core.HostListener, args: ['keydown.esc', ['$event'],] }]
        };
    ...
    exports.INPUT_COMBO_VALUE_ACCESSOR = INPUT_COMBO_VALUE_ACCESSOR;
    exports.ComboListComponent = ComboListComponent;
    exports.ComboListModule = ComboListModule;
    exports.BaseComboComponent = BaseComboComponent;
    exports.ComboServerSideToken = ComboServerSideToken;
    exports.ComboLocaleService = ComboLocaleService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-combo-list.umd.js.map
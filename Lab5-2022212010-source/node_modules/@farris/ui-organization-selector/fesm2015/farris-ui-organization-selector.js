...
import { Injectable, Component, Input, ChangeDetectorRef, Injector, ViewChild, HostBinding, NgZone, EventEmitter, Optional, Output, forwardRef, Renderer2, ElementRef, NgModule } from '@angular/core';
...
import { cloneDeep, trim, omitBy, isUndefined, isNull } from 'lodash-es';
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class OrganizationSelectorComponent {
    /**
     * @param {?} render
     * @param {?} injector
     * @param {?} favoritesTool
...
class SearchComponent {
    ...
    loadSearchResult() {
        ...
        (res) => {
            ...
            /** @type {?} */
            let resData = cloneDeep(res.data);
...
class GridOrganizationSelectorComponent extends DatagridBaseEditorDirective {
    /**
     * @param {?} render
     * @param {?} el
     * @param {?} rts
...
/** @type {?} */
const OrganizationSelectorDataGridEditorProvider = { provide: GRID_EDITORS, useValue: { name: 'OrganizationSelector', value: GridOrganizationSelectorComponent }, multi: true };
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class OrganizationSelectorModule {
}
...
export { ApiService, FavoritesTool, StateMgrTool, OrganizationSelectorComponent, OrganizationSelectorModule, OrganizationComponent, SearchComponent, SelectionComponent, FavoritesComponent, GridOrganizationSelectorComponent, OrganizationSelectorDataGridEditorProvider, AppendGroupOrgComponent as ɵb, GroupComponent as ɵa };

//# sourceMappingURL=farris-ui-organization-selector.js.map
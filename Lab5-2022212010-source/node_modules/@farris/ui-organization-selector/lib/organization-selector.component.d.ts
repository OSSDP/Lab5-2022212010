...
export declare class OrganizationSelectorComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy, ControlValueAccessor {
    private render;
    private injector;
    ...
    clearAll(): void;
    removeItem(data: any, index: number): void;
    clearSeletions(): void;
    onSearch(): void;
    clearSearch(): void;

import { OnInit, ViewContainerRef, EventEmitter, ComponentFactoryResolver, ComponentRef, ChangeDetectorRef, OnDestroy } from '@angular/core';
import { Observable } from 'rxjs';
import { LookupGridOptions } from './lookup-grid-options';
import { LookupGridComponent } from './lookup-grid.component';
import { FilterCondition } from '@farris/ui-common/types';
export declare class LookupLeftComponent implements OnInit, OnDestroy {
    private cfr;
    private cd;
    ...
    isTreeList(): boolean;
    private selectLeftDataTableRow;

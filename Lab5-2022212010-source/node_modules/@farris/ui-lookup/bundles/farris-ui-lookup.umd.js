(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-shortcuts'), require('@farris/ui-common/types'), require('rxjs'), require('@angular/platform-browser'), require('lodash-es'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-layout'), require('@farris/ui-messager'), require('@farris/ui-datatable'), require('@farris/ui-treetable'), require('@farris/ui-loading'), require('@farris/ui-context-menu'), require('@farris/ui-forms'), require('@angular/animations'), require('@farris/ui-locale'), require('@farris/ui-input-group'), require('rxjs/operators'), require('@farris/ui-search-box'), require('@farris/ui-dialog'), require('@angular/core'), require('@farris/ui-common'), require('@farris/ui-notify')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-lookup', ['exports', '@farris/ui-shortcuts', '@farris/ui-common/types', 'rxjs', '@angular/platform-browser', 'lodash-es', '@angular/common', '@angular/forms', '@farris/ui-layout', '@farris/ui-messager', '@farris/ui-datatable', '@farris/ui-treetable', '@farris/ui-loading', '@farris/ui-context-menu', '@farris/ui-forms', '@angular/animations', '@farris/ui-locale', '@farris/ui-input-group', 'rxjs/operators', '@farris/ui-search-box', '@farris/ui-dialog', '@angular/core', '@farris/ui-common', '@farris/ui-notify'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-lookup'] = {}),global.uiShortcuts,global.types,global.rxjs,global.ng.platformBrowser,global.lodashEs,global.ng.common,global.ng.forms,global.uiLayout,global.uiMessager,global.uiDatatable,global.uiTreetable,global.uiLoading,global.uiContextMenu,global.uiForms,global.ng.animations,global.uiLocale,global.uiInputGroup,global.rxjs.operators,global.uiSearchBox,global.uiDialog,global.ng.core,global.uiCommon,global.uiNotify));
}(this, (function (exports,uiShortcuts,types,rxjs,platformBrowser,lodashEs,common,forms,uiLayout,uiMessager,uiDatatable,uiTreetable,uiLoading,uiContextMenu,uiForms,animations,uiLocale,uiInputGroup,operators,uiSearchBox,uiDialog,core,uiCommon,uiNotify) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var LookupComponent = /** @class */ (function () {
        function LookupComponent(injector, el, changeDetector) {
             ...
             * 窗口最大化
             */
            this.dialogMaxed = new core.EventEmitter();
            /**
             * 拖拽改变窗口尺寸进行时
             */
            ...
            this.dialogCreated = new rxjs.Subject();
            this._isShow = false;
            this.displayValue = '';
            this.originalText = '';
            this.onModelChange = ( /**
         ...
         */
            function () {
                if (!this.dictPicking) {
                    this.dictPicking = ( /**
                     * @return {?}
                     */function () { return rxjs.of({ showDialog: true }); });
                }
                if (!this.dictPicked) {
                    this.dictPicked = ( /**
                     * @return {?}
                     */function () { return rxjs.of({ closeDialog: true }); });
                }
                if (!this.beforeOpen) {
                    this.beforeOpen = ( /**
                     * @return {?}
        ...
        /** @nocollapse */
        LookupComponent.ctorParameters = function () {
            return [
                { type: core.Injector },
        ...
        LookupComponent.propDecorators = {
            ...
            buttonAlign: [{ type: core.Input }],
            buttonsRef: [{ type: core.Input }],
            showButtons: [{ type: core.Input }],
            showCloseButton: [{ type: core.Input }],
            showMaxButton: [{ type: core.Input }],
            ...
            dictPicking: [{ type: core.Input }],
            dictPicked: [{ type: core.Input }],
            dialogOpened: [{ type: core.Output }],
            dialogClosed: [{ type: core.Output }],
            dialogMaxed: [{ type: core.Output }],
            resizing: [{ type: core.Output }],
            resized: [{ type: core.Output }],
            content: [{ type: core.ViewChild, args: ['dialog',] }]
        };
     ...
     */
    /** @type {?} */
    var ServerSideToken = new core.InjectionToken('Lookup Grid HTTP service');
    ...
    var LookupDefaultMapping = /** @class */ (function () {
        ...
        /** @nocollapse */
        LookupDefaultMapping.ctorParameters = function () {
            return [
    ...
    var LookupUtils = /** @class */ (function () {
         ...
         */
            function (condition, fields, searchData) {
                ...
                if (!condition) {
                    ...
                    condition = lodashEs.cloneDeep(condition);
                }
                    ...
                    if (field === '*') {
                        if (fields && fields.length) {
                            ...
                            if (searchConditions.length) {
                                ...
                                lastSearchConditions.relation = types.FilterRelation.Empty;
                            }
                            if (condition.filterConditions && condition.filterConditions.length) {
                                condition.filterConditions[condition.filterConditions.length - 1].relation = types.FilterRelation.And;
                        ...
                        searchCondition.relation = types.FilterRelation.Empty;
                        if (condition.filterConditions && condition.filterConditions.length) {
                            condition.filterConditions[condition.filterConditions.length - 1].relation = types.FilterRelation.And;
        ...
        /** @nocollapse */
        LookupUtils.ctorParameters = function () {
            return [
                { type: uiCommon.CommonUtils },
    ...
    var PersonalConfigService = /** @class */ (function () {
        function PersonalConfigService(idService) {
            ...
            this.selectItemObser$ = new rxjs.Subject();
        ...
        /** @nocollapse */
        PersonalConfigService.ctorParameters = function () {
            return [
        ...
        FavoriteHelper.prototype.loadFavoritesData =
            ...
            function (res) {
                ...
                switch (this.instance.displayType) {
                    ...
                    case LookupGridDisplayType.TreeList: {
                        if (this.instance.favoritesComponentRef && this.instance.favoritesComponentRef.instance instanceof uiTreetable.TreeTableComponent) {
                            /** @type {?} */
            ...
            function ($event) {
                ...
                if (this.ins.uri) {
                    if (!this.ins.searching) {
                        ...
                        this.ins.httpMgr.getData(p, 'list').pipe(operators.catchError(( /**
                         * @param {?} err
                         * @return {?}
                         */function (err) {
                            _this.ins.searching = false;
                            return rxjs.of({ "_ERROR_": err });
                        })), operators.tap(( /**
                         * @return {?}
                         */function () {
                            _this.ins.searching = false;
            ...
            if (_this.isTextChange && _this.displayText && (!_this.nosearch || e.originalEvent) && !isPending()) {
                 ...
                 */function (pr) {
                    ...
                    if (o) {
                        ...
                        return rxjs.of({ SHOWDIALOG: o, MESSAGE: pr.message || '' });
                    }
                }))).subscribe(( /**
                 * @param {?} data
                 * @return {?}
    ...
    var TreeTableEventManager = /** @class */ (function () {
         ...
         */
            function (search) {
                ...
                return this.ins.httpMgr.getData({ search: search, sortName: tt.sortName, sortOrder: tt.sortOrder }, 'search').pipe(operators.tap(( /**
                 * @return {?}
                 */function () {
         ...
         */
            function (parentPath, parentLayer, searchData) {
                ...
                if (this.ins.conditions && this.ins.conditions.length) {
                    param.searchConditions = lodashEs.cloneDeep(this.ins.conditions);
                }
            ...
            function () {
                ...
                if (this.ins.treeInfo) {
                    ...
                    if (!this.ins.isTextChange) {
                        this.ins.allData = lodashEs.cloneDeep(this.ins.items);
                    }
                    else {
                        this.ins.allData = [];
                    }
         ...
         */
            function () {
                ...
                if (this.ins.showSelected && !this.ins.singleSelect) {
                    selectedColumns = lodashEs.cloneDeep(this.ins.gridOptions.columns);
                    /** @type {?} */
    ...
    var LookupHttpManager = /** @class */ (function () {
         ...
         */
            function (event, type) {
                ...
                if (this.ins.conditions && this.ins.conditions.length && type !== 'fav') {
                    params.searchConditions = lodashEs.cloneDeep(this.ins.conditions);
                }
                /** @type {?} */
            ...
            function (event, type) {
                ...
                if (uri || this.ins.beUri) {
                    ...
                    if (this.ins._searchResult) {
                        return rxjs.of(this.ins._searchResult);
                    }
                    if (type !== 'allChildren') {
         ...
         */
            function () {
                /** @type {?} */
                var defaultConf = lodashEs.cloneDeep(DefaultUserConfig);
            ...
            function (event, type, isQuickSelect) {
                 ...
                 */function (c) {
                    ...
                    if (!_this.ins.isTabChanged) {
                        _this._originalPersonalConfig = lodashEs.cloneDeep(c);
                    }
                })), operators.switchMap(( /**
                 * @param {?} c
                 * @return {?}
                 */function (c) {
                    ...
                    if (_this.ins.activeTab === 'datalist') {
                        ...
                        if ((!favIds || !favIds.length) && !_this.ins.isTabChanged) {
                            return _this.getData(event, 'all').pipe(operators.map(( /**
                             * @param {?} r
                             * @return {?}
                             */function (r) {
                                if (r && !r.items) {
                        ...
                        event.search = null;
                        return _this.getData(event, 'fav').pipe(operators.switchMap(( /**
                         * @param {?} r
                         * @return {?}
                         */function (r) {
                            /** @type {?} */
        ...
        LookupHttpManager.prototype.submitFavoriteData =
            ...
            function (action) {
                ...
                if (this.ins.favoriteDataFrom !== 'locale') {
                    this._originalPersonalConfig = lodashEs.cloneDeep(this.ins.personalConf);
                    /** @type {?} */
                    var configData = {
    ...
    var LookupLeftComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                var dtFac = null;
                if (!this.isTreeList()) {
                    dtFac = this.cfr.resolveComponentFactory(uiDatatable.DataTableComponent);
                }
                else {
                    this.navOptions['fitColumns'] = false;
                    this.navOptions['autoFitColumns'] = true;
                    dtFac = this.cfr.resolveComponentFactory(uiTreetable.TreeTableComponent);
                }
         ...
         */
            function (dt) {
                 ...
                 */function (searchData) {
                    ...
                    _this.lookupCmp.httpMgr.getData(p, 'navsearch').pipe(operators.filter(( /**
                     * @param {?} n
                     * @return {?}
            ...
            function (tn, tt) {
                ...
                if (!tn.children || !tn.children.length) {
                    ...
                    if (this.navOptions.treeInfo.loadDataType === 'async') {
                        ...
                        this.getChildren(parentPath_1, parentLayer_1, { searchField: field === '*' ? '*' : field, searchValue: value }, tt).pipe(operators.switchMap(( /**
                         * @param {?} data
                         * @return {?}
                         */function (data) {
        ...
        /** @nocollapse */
        LookupLeftComponent.ctorParameters = function () {
            return [
        ...
        LookupLeftComponent.propDecorators = {
            cmpContainer: [{ type: core.ViewChild, args: ['container', { read: core.ViewContainerRef },] }],
            selected: [{ type: core.Output }],
            unselected: [{ type: core.Output }],
        ...
        LookupComponentManager.prototype.useContextMenuForTree =
            ...
            function (cmpRef) {
                ...
                if (enableContextMenu && maxLevel) {
                     ...
                     * @return {?}
                     */function () {
                        return rxjs.of({ show: !cmpRef.instance.state.searched });
                    });
                }
            };
        /**
         ...
         */
            function (ops) {
                ...
                this.ins.leftComponentRef.instance.selected
                    .pipe(operators.debounceTime(100), operators.switchMap(( /**
             * @param {?} d
             * @return {?}
             */function (d) {
                    if (d && d.data) {
         ...
         */
            function () {
                ...
                if (this.ins.okButton) {
                    ...
                    /** @type {?} */
                    var leftClick$ = rxjs.fromEvent(this.ins.okButton.nativeElement, 'click').pipe(operators.filter(( /**
                     * @param {?} event
                     * @return {?}
                     */function (event) { return event.button === 0; })));
                    /** @type {?} */
                    var debounce$ = leftClick$.pipe(operators.debounceTime(doubleClickDuration));
                    /** @type {?} */
                    var clickLimit$ = leftClick$.pipe(operators.bufferCount(2));
                    /** @type {?} */
                    var bufferGate$ = rxjs.race(debounce$, clickLimit$)
                        .pipe(
                    // We are only interested in the first event. After that
                    // we want to restart.
                    operators.first(), operators.repeat());
                    this._okbtnclick$ = leftClick$.pipe(operators.buffer(bufferGate$), 
                 ...
                 */function () {
                    ...
                    if (_this.ins.leftPanel) {
                        if (!_this.ins.leftPanel.resizing.observers.length) {
                            /** @type {?} */
                            var leftPanelResize$ = _this.ins.leftPanel.resizing.pipe(operators.debounceTime(50)).subscribe(( /**
                             * @param {?} s
                             * @return {?}
                             */function (s) {
                                /** @type {?} */
    ...
    var LookupSelectionService = /** @class */ (function () {
        function LookupSelectionService(ins) {
            ...
            this.selected$ = this.state$.pipe(operators.switchMap(( /**
             * @param {?} n
             * @return {?}
             */function (n) { return rxjs.of(n.selecteditems); })));
            this.favoriteItems$ = new rxjs.BehaviorSubject({ items: this.state.favoriteItems, action: null });
            this.quickItems$ = this.state$.pipe(operators.switchMap(( /**
             * @param {?} n
             * @return {?}
             */function (n) { return rxjs.of(n.quickItems); })));
    ...
    var LookupGridComponent = /** @class */ (function (_super) {
        ...
        function LookupGridComponent(injector, cfr, el, utils, defaultMapping, changeDetector, shortcuts, lookupUtils, zone, render2) {
             ...
             * 启用任意输入后，值通过输入时触发
             */
            _this.clearMappings = new core.EventEmitter();
            // 收藏列表
            _this.favoriteItems = [];
            /**
             * 是否启用级联选择控制选项
            ...
            _this.selectedData = new core.EventEmitter();
             ...
             * 启用多字段查询时触发
             */
            _this.query = new core.EventEmitter();
            // 帮助文本框中值变化事件
            _this.valueChanged = new core.EventEmitter();
            _this.loadSuccess = new core.EventEmitter();
            _this.pagerChanged = new core.EventEmitter();
            _this.expandTreeNode = new core.EventEmitter();
            _this.textChanged = new core.EventEmitter();
            _this.checkedChange = new core.EventEmitter();
            _this.tagRemoved = new core.EventEmitter();
            /**
             * 内容中留白边距
             */
            ...
            _this.lookupinitializationSubject = new rxjs.Subject();
            /**
             * 多选时，选中的数据
             */
            _this.currentSelectedItems = rxjs.of([]);
            /**
             * 已选数据列信息
             */
            ...
            _this.includeSubordinates$ = new rxjs.Subject();
            ...
            _this.farrisInstances = _this.injector.get(uiCommon.FarrisComponentInstanceService, null);
            _this.overLayService = new uiCommon.OverLayHiddenService();
            _this.debugSer = _this.injector.get(uiCommon.DebugService, null);
            if (_this.debugSer) {
        ...
        Object.defineProperty(LookupGridComponent.prototype, "displayType", {
             ...
             */ function (val) {
                if (val) {
                    /** @type {?} */
                    var types$$1 = Object.values(LookupGridDisplayType);
                    /** @type {?} */
                    var i = types$$1.findIndex(( /**
                     * @param {?} n
                     * @return {?}
         ...
         */
            function () {
                ...
                this._treeInfo_ = this.treeInfo ? lodashEs.cloneDeep(this.treeInfo) : null;
                if (this.quickSelect) {
         ...
         */
            function () {
                ...
                this.localService = this.injector.get(uiLocale.LocaleService);
         ...
         */
            function () {
                ...
                switch (this.displayType) {
                    ...
                    case LookupGridDisplayType.NavList:
                    case LookupGridDisplayType.NavTreeList:
                        return uiDatatable.DataTableComponent;
                    case LookupGridDisplayType.TreeList:
                    case LookupGridDisplayType.NavListTree:
                        return uiTreetable.TreeTableComponent;
                }
            };
        /**
         * @param {?=} msg
         ...
         */
            function () {
                ...
                this.showLoading();
                this.hasError = false;
                this.httpMgr.lookupRequest(p, t).pipe(operators.map(( /**
                 * @param {?} restData
                 * @return {?}
                 */function (restData) {
                    if (restData) {
         ...
         */
            function (resData, rebindEvent) {
                ...
                if (this.componentRef.instance instanceof uiTreetable.TreeTableComponent) {
                    /** @type {?} */
         ...
         */
            function (e, selectedRow) {
                ...
                if (canSelect) {
                    /** @type {?} */
                    var selectedRows$ = rxjs.of(selectedRow);
        ...
        /** @nocollapse */
        LookupGridComponent.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.ComponentFactoryResolver },
                { type: core.ElementRef },
                ...
                { type: core.ChangeDetectorRef },
                { type: uiShortcuts.ShortcutsService },
                { type: LookupUtils },
                { type: core.NgZone },
                { type: core.Renderer2 }
            ];
        ...
        LookupGridComponent.propDecorators = {
            customDisplayType: [{ type: core.Input }],
            ...
            uri: [{ type: core.Input }],
            beUri: [{ type: core.Input }],
            showFilterBar: [{ type: core.Input }],
            pagination: [{ type: core.Input }],
            pageIndex: [{ type: core.Input }],
            pageSize: [{ type: core.Input }],
            pageList: [{ type: core.Input }],
            total: [{ type: core.Input }],
            columns: [{ type: core.Input }],
            remoteSearch: [{ type: core.Input }],
            searchOnServer: [{ type: core.Input }],
            nosearch: [{ type: core.Input }],
            clearMappings: [{ type: core.Output }],
            maxLength: [{ type: core.Input }],
            mappingFn: [{ type: core.Input }],
            items: [{ type: core.Input }],
            favoriteItems: [{ type: core.Input }],
            customData: [{ type: core.Input }],
            bindingData: [{ type: core.Input }],
            treeInfo: [{ type: core.Input }],
            enableCascade: [{ type: core.Input }],
            cascadeStatus: [{ type: core.Input }],
            cascadeItems: [{ type: core.Input }],
            showCascadeControl: [{ type: core.Input }],
            placeholder: [{ type: core.Input }],
            showSelected: [{ type: core.Input }],
            useFavorite: [{ type: core.Input }],
            favoriteDataFrom: [{ type: core.Input }],
            useTip: [{ type: core.Input }],
            isRecordSize: [{ type: core.Input }],
            userId: [{ type: core.Input }],
            enableToSelect: [{ type: core.Input }],
            enableFindText: [{ type: core.Input }],
            expandLevel: [{ type: core.Input }],
            navTreeTableOptions: [{ type: core.Input }],
            treeTableOptions: [{ type: core.Input }],
            dataTableOptions: [{ type: core.Input }],
            loadTreeDataType: [{ type: core.Input }],
            loadDataWhenOpen: [{ type: core.Input }],
            navSelectedIds: [{ type: core.Input }],
            selectFirstInNav: [{ type: core.Input }],
            enableFullTree: [{ type: core.Input }],
            displayFormatter: [{ type: core.Input }],
            displayFields: [{ type: core.Input }],
            displayTextSeparator: [{ type: core.Input }],
            helpId: [{ type: core.Input }],
            textAlign: [{ type: core.Input }],
            enableTitle: [{ type: core.Input }],
            useExtendInfo: [{ type: core.Input }],
            extInfoFields: [{ type: core.Input }],
            extInfoFormatter: [{ type: core.Input }],
            extendInfo: [{ type: core.Input }],
            customFormatter: [{ type: core.Input }],
            customNavFormatter: [{ type: core.Input }],
            okHandler: [{ type: core.Input }],
            cancelHandler: [{ type: core.Input }],
            tagboxHeight: [{ type: core.Input }],
            maxTagboxHeight: [{ type: core.Input }],
            enableGetAllChildNodes: [{ type: core.Input }],
            shortcutKey: [{ type: core.Input }],
            quickSelect: [{ type: core.Input }],
            treeToList: [{ type: core.Input }],
            navTreeToList: [{ type: core.Input }],
            showNavigation: [{ type: core.Input }],
            beforeSelectData: [{ type: core.Input }],
            beforeLoadData: [{ type: core.Input }],
            useNewLayout: [{ type: core.Input }],
            enableMultiFieldSearch: [{ type: core.Input }],
            searchBarMode: [{ type: core.Input }],
            allowQueryFields: [{ type: core.Input }],
            labels: [{ type: core.Input }],
            searchAnyField: [{ type: core.Input }],
            selectedData: [{ type: core.Output }],
            clear: [{ type: core.Output }],
            search: [{ type: core.Output }],
            query: [{ type: core.Output }],
            valueChanged: [{ type: core.Output }],
            loadSuccess: [{ type: core.Output }],
            pagerChanged: [{ type: core.Output }],
            expandTreeNode: [{ type: core.Output }],
            textChanged: [{ type: core.Output }],
            checkedChange: [{ type: core.Output }],
            tagRemoved: [{ type: core.Output }],
            gridOptions: [{ type: core.Input }],
            contentContainer: [{ type: core.ViewChild, args: ["contentContainer", { read: core.ViewContainerRef },] }],
            favoritesContainer: [{ type: core.ViewChild, args: ["favoritesContainer", { read: core.ViewContainerRef },] }],
            leftContainer: [{ type: core.ViewChild, args: ["leftContainer", { read: core.ViewContainerRef },] }],
            centerContainer: [{ type: core.ViewChild, args: ["centerContainer", { read: core.ViewContainerRef },] }],
            selectedDtRef: [{ type: core.ViewChild, args: ["multiSelectDT",] }],
            inputGroup: [{ type: core.ViewChild, args: ["inputgroup",] }],
            leftPanel: [{ type: core.ViewChild, args: ["leftPanel",] }],
            tagbox: [{ type: core.ViewChild, args: ["tagbox",] }],
            okButton: [{ type: core.ViewChild, args: ["okbtn",] }],
            tagInput: [{ type: core.ViewChild, args: ["tagInput",] }],
            selectedpanel: [{ type: core.ViewChild, args: ['selectedpanel',] }],
            cascadeSelect: [{ type: core.ViewChild, args: ['cascadeSelect',] }],
            layoutRef: [{ type: core.ViewChild, args: ['layout',] }]
        };
    ...
    var LookupTabsComponent = /** @class */ (function () {
        function LookupTabsComponent(injector) {
            ...
            this.el = this.injector.get(core.ElementRef);
            ...
            { type: core.Component, args: [{
                        ...
                        animations: [
                            animations.trigger('flyInOut', [
                                animations.transition(':enter', [animations.style({ opacity: 0 }), animations.animate('.3s', animations.style({ opacity: 1 }))]),
                                animations.transition(':leave', [animations.animate('.3s', animations.style({ opacity: 0 }))])
                            ])
                        ],
        ...
        /** @nocollapse */
        LookupTabsComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
        LookupTabsComponent.propDecorators = {
            enableFav: [{ type: core.Input }],
            activeTab: [{ type: core.Input }],
            visible: [{ type: core.Input }],
            layout: [{ type: core.Input }],
            dialogTitle: [{ type: core.Input }],
            tabChange: [{ type: core.Output }],
            inkBarRef: [{ type: core.ViewChild, args: ['inkBar',] }],
            dataListNavRef: [{ type: core.ViewChild, args: ['dataListNav',] }],
            favoriteNavRef: [{ type: core.ViewChild, args: ['favoriteNav',] }],
            selectedNavRef: [{ type: core.ViewChild, args: ['selectedNav',] }],
            advanceLayoutRef: [{ type: core.ViewChild, args: ['advanceLayout',] }]
        };
    ...
    var LookupTipDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.enableTip) {
                    ...
                    this.inputRef.iconMouseLeave.pipe(operators.delay(200)).subscribe(( /**
                     * @param {?} e
                     * @return {?}
                     */function (e) {
        ...
        /** @nocollapse */
        LookupTipDirective.ctorParameters = function () {
            return [
        ...
        LookupTipDirective.propDecorators = {
            enableTip: [{ type: core.Input, args: ['lookup-tip',] }]
        };
    ...
    var LookupQuickSelectPanelComponent = /** @class */ (function () {
        function LookupQuickSelectPanelComponent(injector, cdr) {
            ...
            this.textField = '';
            this.maxItems = 10;
            this.moreClcik = new core.EventEmitter();
        ...
        /** @nocollapse */
        LookupQuickSelectPanelComponent.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.ChangeDetectorRef }
            ];
    ...
    var LookupQuickSelectDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.options && this.options.enable) {
                    ...
                    this.inputRef.valueChange.pipe(operators.debounceTime(200)).subscribe(( /**
                     * @param {?} val
                     * @return {?}
                     */function (val) {
                    ...
                    this.inputRef.keydownHandle.pipe(operators.filter(( /**
                     * @param {?} event
                     * @return {?}
                     */function (event) {
         ...
         */
            function () {
                ...
                return this.lookupRef.httpMgr.lookupRequest(p, t, true).pipe(operators.map(( /**
                 * @param {?} restData
                 * @return {?}
                 */function (restData) {
                    /** @type {?} */
        ...
        LookupQuickSelectDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[quick-select]' },] }
        ];
        /** @nocollapse */
        LookupQuickSelectDirective.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.NgZone },
                { type: core.Renderer2 },
        ...
        LookupQuickSelectDirective.propDecorators = {
            options: [{ type: core.Input, args: ['quick-select',] }],
    ...
    var LookupAdvancedLayoutComponent = /** @class */ (function () {
        function LookupAdvancedLayoutComponent(elRef, injector, zone, render2) {
            ...
            this.dialogRef = this.injector.get(uiDialog.DialogComponent, null);
        }
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        LookupAdvancedLayoutComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef },
                { type: core.Injector },
                { type: core.NgZone },
        ...
        LookupAdvancedLayoutComponent.propDecorators = {
            ...
            activeTab: [{ type: core.Input }],
            enableFav: [{ type: core.Input }],
            dataTab: [{ type: core.Input }],
            favTab: [{ type: core.Input }],
            tabChanged: [{ type: core.Output }],
            close: [{ type: core.Output }],
            headerRel: [{ type: core.ViewChild, args: ['header',] }],
            activetabRef: [{ type: core.ViewChild, args: ['activetab',] }]
        };
    ...
    var LookupFilterBarComponent = /** @class */ (function () {
        function LookupFilterBarComponent(injector, cd, lookIns) {
            ...
            this.isNav = false;
            this.searchFields = [];
            this.conditionsChange = new core.EventEmitter();
            this.textConditions = [];
            this.fieldConditons = [];
            this.dialogRef = this.injector.get(uiDialog.DialogComponent, null);
            this.el = this.injector.get(core.ElementRef);
                ...
                if (this.columns && this.columns.length) {
                    ...
                    if (this.lookIns && this.lookIns.allowQueryFields) {
                        ...
                        if (queryFields) {
                             ...
                             * @return {?}
                             */function (n) {
                                return _queryFields_1.findIndex(( /**
                                 * @param {?} f
                                 * @return {?}
        ...
        /** @nocollapse */
        LookupFilterBarComponent.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.ChangeDetectorRef },
                { type: LookupGridComponent }
        ...
        LookupFilterBarComponent.propDecorators = {
            ...
            columns: [{ type: core.Input }],
            viewType: [{ type: core.Input }],
            isNav: [{ type: core.Input }],
            searchFields: [{ type: core.Input }],
            conditionsChange: [{ type: core.Output }],
            searchboxRef: [{ type: core.ViewChild, args: ['searchbox',] }],
            searchfieldsRef: [{ type: core.ViewChild, args: ['searchfields',] }]
        };
    ...
    var LookupSelectedDirective = /** @class */ (function () {
        ...
        LookupSelectedDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[lookup-selected]' },] }
        ];
        /** @nocollapse */
        LookupSelectedDirective.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: core.ElementRef },
                { type: core.Renderer2 },
        ...
        LookupSelectedDirective.propDecorators = {
            selectedPanel: [{ type: core.Input }],
            dataTableRef: [{ type: core.Input }],
        ...
        LookupModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            ...
                            uiLoading.LoadingModule.forRoot({ delay: 1000 }),
                        ...
                        providers: [],
                        entryComponents: [
                            uiDatatable.DataTableComponent,
                            uiTreetable.TreeTableComponent,
                            LookupLeftComponent,
                            LookupTabsComponent,
                            LookupQuickSelectPanelComponent,
                            LookupAdvancedLayoutComponent,
    ...
    exports.LookupDefaultMapping = LookupDefaultMapping;
    exports.LookupLeftComponent = LookupLeftComponent;
    exports.LookupAdvancedLayoutComponent = LookupAdvancedLayoutComponent;
    exports.LookupFilterBarComponent = LookupFilterBarComponent;
    exports.LookupSelectedDirective = LookupSelectedDirective;
    exports.LOOKUPGRID_VALUE_ACCESSOR = LOOKUPGRID_VALUE_ACCESSOR;
    exports.LookupGridComponent = LookupGridComponent;
    exports.DisplayInfo = DisplayInfo;
    exports.lookupGridDefaults = lookupGridDefaults;
    exports.displayInfoDefault = displayInfoDefault;
    exports.LOOKUPINPUT_VALUE_ACCESSOR = LOOKUPINPUT_VALUE_ACCESSOR;
    exports.LookupComponent = LookupComponent;
    exports.ServerSideToken = ServerSideToken;
    exports.LookupModule = LookupModule;
    exports.PersonalConfigService = PersonalConfigService;
    exports.LookupTabsComponent = LookupTabsComponent;
    exports.LookupTipDirective = LookupTipDirective;
    exports.LookupQuickSelectDirective = LookupQuickSelectDirective;
    exports.LookupQuickSelectPanelComponent = LookupQuickSelectPanelComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=farris-ui-lookup.umd.js.map
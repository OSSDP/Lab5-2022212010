...
/** @type {?} */
const FFileUploadAPIServiceToken = new InjectionToken('MFFileUploadServerConfig');
class FFileUploadAPIService {
    /**
     * @param {?} exConfig
     */
 ...
 */
/** @type {?} */
const FARRIS_UPLOADFILE_LOCALEDATA = {
    en: {
        uploadAndPreview: {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class FFileUploadDefaultService extends UploadServerService {
    /**
     * 2019年3月2日，先假定一个一个传入
     * @param {?} files
     * @param {?} event
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class FFilePreviewListTypeTemplateDirective {
    /**
     * @param {?} template
     */
...
/** @nocollapse */
FFilePreviewListTypeTemplateDirective.ctorParameters = () => [
    { type: TemplateRef }
];
if (false) {
    /** @type {?} */
...
class FFilePreviewToolbarTemplateDirective {
    /**
     * @param {?} template
     */
    constructor(template) {
...
/** @nocollapse */
FFilePreviewToolbarTemplateDirective.ctorParameters = () => [
    { type: TemplateRef }
];
if (false) {
    /** @type {?} */
...
/** @nocollapse */
FFileUploadDirective.ctorParameters = () => [
    { type: TemplateRef }
];
if (false) {
    /** @type {?} */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class PreviewCheckboxComponent {
    constructor() {
        this.cls1 = true;
        this.cls2 = true;
        this.cls3 = true;
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MultiDownloadInfoComponent {
    constructor() {
        this.cls = true;
        // 记载下载数据
        this._downloadInfos = [];
...
/** @nocollapse */
MultiDownloadInfoComponent.ctorParameters = () => [];
...
class UploadAndPreviewComponent {
    /**
       * 附件上传配置---------------------------------------结束
       */
    /**
...
class UploadFileOrderDragDirective {
    /**
     * @param {?} ngzone
     * @param {?} injector
     * @param {?} render

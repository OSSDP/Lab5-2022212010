(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@farris/ui-locale'), require('@farris/ui-common/column'), require('@farris/ui-common/date'), require('@farris/ui-notify'), require('@angular/animations'), require('@farris/ui-modal'), require('resize-observer-polyfill'), require('@farris/ui-common'), require('@farris/smooth-dnd'), require('@angular/common'), require('@farris/ui-messager'), require('@farris/ui-area-response')) :
    typeof define === 'function' && define.amd ? define('@farris/extend-file-upload', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@farris/ui-locale', '@farris/ui-common/column', '@farris/ui-common/date', '@farris/ui-notify', '@angular/animations', '@farris/ui-modal', 'resize-observer-polyfill', '@farris/ui-common', '@farris/smooth-dnd', '@angular/common', '@farris/ui-messager', '@farris/ui-area-response'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['extend-file-upload'] = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.uiLocale, global.column, global.date, global.uiNotify, global.ng.animations, global.uiModal, global.ResizeObserver, global.uiCommon, global.smoothDnd, global.ng.common, global.uiMessager, global.uiAreaResponse));
}(this, (function (exports, core, rxjs, operators, uiLocale, column, date, uiNotify, animations, uiModal, ResizeObserver, uiCommon, smoothDnd, common, uiMessager, uiAreaResponse) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     * @record
     */
    function FFileUploadServerConfig() { }
    if (false) {
        /** @type {?|undefined} */
    ...
    /** @type {?} */
    var FFileUploadAPIServiceToken = new core.InjectionToken('MFFileUploadServerConfig');
    var FFileUploadAPIService = /** @class */ (function () {
        function FFileUploadAPIService(exConfig) {
            var _this = this;
            this.apiArray = ['upload', 'remove'];
            this.config = { upload: null, remove: null };
            this.commonAPI = { type: 'config', url: '', timeout: 0, headers: null, data: {} };
            if (exConfig) {
                for (var key in this.commonAPI) {
             ...
             */
            function (item) {
                _this.config[item] = Object.assign({}, _this.commonAPI);
                if (exConfig && exConfig.hasOwnProperty(item)) {
                    if (exConfig[item].hasOwnProperty('url')) {
                        _this.config[item] = Object.assign({}, _this.config[item], exConfig[item], { url: _this.combinUrl(exConfig[item].url) });
                    }
                }
            }));
            // if (exConfig) {
         ...
         * @return {?}
         */
        FFileUploadAPIService.prototype.combinUrl = /**
         * @private
         * @param {?} typeUrl
         * @return {?}
         */
         ...
         * @return {?}
         */
        FFileUploadAPIService.prototype.getAPI = /**
         * 获取API定义
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        FFileUploadAPIService.prototype.getAssignAPI = /**
         *
         * @param {?} type
         * @param {?} object
         * @return {?}
        ...
        function (type, object) {
            ...
            // 通过设置对应关系
            /** @type {?} */
            var infoMap = { 'removeAll': 'remove', 'uploadAll': 'upload', 'multipartUpload': 'upload' };
        ...
        /** @nocollapse */
        FFileUploadAPIService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [FFileUploadAPIServiceToken,] }] }
        ]; };
        /** @nocollapse */ FFileUploadAPIService.ngInjectableDef = core.defineInjectable({ factory: function FFileUploadAPIService_Factory() { return new FFileUploadAPIService(core.inject(FFileUploadAPIServiceToken, 8)); }, token: FFileUploadAPIService, providedIn: "root" });
        return FFileUploadAPIService;
    }());
    if (false) {
        /**
         * @type {?}
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/model/f-file-upload.model.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    /**
     * @record
    ...
    if (false) {
        ...
        /** @type {?|undefined} */
        UploaderOptions.prototype.uploadedCount;
    }
    /**
     * @record
     */
    ...
    UploadStatus[UploadStatus.Remove] = 'Remove';
     ...
     * @record
     */
    function FUploadFileExtend() { }
    if (false) {
        /** @type {?} */
        FUploadFileExtend.prototype.id;
        /** @type {?} */
        FUploadFileExtend.prototype.name;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.disabled;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.checked;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.size;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.createTime;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.type;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.extend;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.extendStatus;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.extendHeaders;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.showDownload;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.showComments;
        /** @type {?|undefined} */
        FUploadFileExtend.prototype.modeless;
    }
    /**
     * @record
     */
    ...
    if (false) {
        ...
        /** @type {?|undefined} */
        UploadOutput.prototype.message;
        /** @type {?|undefined} */
        UploadOutput.prototype.files;
    }
    /**
     * @record
     */
    ...
    if (false) {
        /** @type {?|undefined} */
        UploadConfig.prototype.url;
        /** @type {?|undefined} */
        UploadConfig.prototype.method;
        /** @type {?|undefined} */
        UploadConfig.prototype.id;
        /** @type {?|undefined} */
        UploadConfig.prototype.fieldName;
        /** @type {?|undefined} */
        UploadConfig.prototype.fileIndex;
        /** @type {?|undefined} */
        UploadConfig.prototype.file;
        /** @type {?|undefined} */
        UploadConfig.prototype.data;
        /** @type {?|undefined} */
        UploadConfig.prototype.headers;
        /** @type {?|undefined} */
        UploadConfig.prototype.includeWebKitFormBoundary;
        /** @type {?|undefined} */
        UploadConfig.prototype.withCredentials;
        /** @type {?|undefined} */
        UploadConfig.prototype.timeout;
    }
    /**
     * @record
     */
    ...
    if (false) {
         ...
         * @type {?|undefined}
         */
        UploadInput.prototype.chunkSize;
    }
    /**
     * @abstract
     */
     ...
     * @abstract
     */
    UploadServerService = /** @class */ (function () {
        function UploadServerService() {
        }
    ...
    if (false) {
         ...
         * @return {?}
         */
        UploadServerService.prototype.upload = function (files, event, extendService) { };
        /**
         * @abstract
         * @param {?} files
         * @param {?} event
         ...
         * @return {?}
         */
        UploadServerService.prototype.remove = function (files, event, extendService) { };
        /**
         * @abstract
         * @param {?} file
         * @param {?} event
         ...
         * @return {?}
         */
        UploadServerService.prototype.multipartUpload = function (file, event, extendService) { };
    }
    /**
     * @record
     */
    function DocMetaProperty() { }
    if (false) {
        /** @type {?|undefined} */
        DocMetaProperty.prototype.extProperties1;
        /** @type {?|undefined} */
        DocMetaProperty.prototype.extProperties2;
        /** @type {?|undefined} */
        DocMetaProperty.prototype.extProperties3;
        /** @type {?|undefined} */
        DocMetaProperty.prototype.extProperties4;
        /** @type {?|undefined} */
        DocMetaProperty.prototype.extProperties5;
    }

    /**
     * @fileoverview added by tsickle
     * Generated from: lib/model/column.model.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    /**
     * @record
    ...
    if (false) {
        /** @type {?|undefined} */
        ColumnFormatter.prototype.type;
        /** @type {?|undefined} */
        ColumnFormatter.prototype.options;
    }
    /**
     * 附件展示列信息
     * formatter：格式化
    ...
    if (false) {
        /** @type {?} */
        ColumnData.prototype.field;
        /** @type {?} */
        ColumnData.prototype.width;
        /** @type {?} */
        ColumnData.prototype.title;
        /** @type {?|undefined} */
        ColumnData.prototype.checkbox;
        /** @type {?|undefined} */
        ColumnData.prototype.formatter;
        /** @type {?|undefined} */
        ColumnData.prototype.template;
    }
     ...
     */
    /** @type {?} */
    var FARRIS_UPLOADFILE_LOCALEDATA = {
        en: {
            uploadAndPreview: {
    ...
    var FFileUploaderService = /** @class */ (function () {
        function FFileUploaderService(uploadServerSer, inject) {
            ...
            if (this.inject && !this.hasLocalSer) {
                this.hasLocalSer = FFileUtils.getLocalState(this.inject.get(uiLocale.LocaleService));
            }
        ...
        FFileUploaderService.ctorParameters = function () { return [
            { type: UploadServerService, decorators: [{ type: core.Optional }] },
    ...
    var FFileUploadDefaultService = /** @class */ (function (_super) {
        __extends(FFileUploadDefaultService, _super);
        ...
        function (files, event, extendService) {
            ...
            function (observer) {
                /** @type {?} */
                var url = event.url || extendService.url || '';
                /** @type {?} */
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/service/index.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/directive/f-file-preview.directive.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var FFilePreviewListTypeTemplateDirective = /** @class */ (function () {
        function FFilePreviewListTypeTemplateDirective(template) {
            this.template = template;
        }
        FFilePreviewListTypeTemplateDirective.decorators = [
            { type: core.Directive, args: [{
                        selector: '[filePreviewListTypeTemplate]'
                    },] }
        ];
        /** @nocollapse */
        FFilePreviewListTypeTemplateDirective.ctorParameters = function () { return [
            { type: core.TemplateRef }
        ]; };
        return FFilePreviewListTypeTemplateDirective;
    }());
    if (false) {
        /** @type {?} */
        FFilePreviewListTypeTemplateDirective.prototype.template;
    }
    var FFilePreviewToolbarTemplateDirective = /** @class */ (function () {
        function FFilePreviewToolbarTemplateDirective(template) {
            this.template = template;
        }
        FFilePreviewToolbarTemplateDirective.decorators = [
            { type: core.Directive, args: [{
                        selector: '[filePreviewToolbarTemplate]'
                    },] }
        ];
        /** @nocollapse */
        FFilePreviewToolbarTemplateDirective.ctorParameters = function () { return [
            { type: core.TemplateRef }
        ]; };
        return FFilePreviewToolbarTemplateDirective;
    }());
    if (false) {
        /** @type {?} */
        FFilePreviewToolbarTemplateDirective.prototype.template;
    }

    /**
     * @fileoverview added by tsickle
     * Generated from: lib/directive/f-file-upload.directive.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var FFileUploadDirective = /** @class */ (function () {
        function FFileUploadDirective(templateRef) {
            this.templateRef = templateRef;
        }
        FFileUploadDirective.decorators = [
            { type: core.Directive, args: [{
                        selector: '[fFielUpload],[fFileUpload]',
                    },] }
        ];
        /** @nocollapse */
        FFileUploadDirective.ctorParameters = function () { return [
            { type: core.TemplateRef }
        ]; };
        return FFileUploadDirective;
    }());
    if (false) {
        /** @type {?} */
        FFileUploadDirective.prototype.templateRef;
    }

    /**
     * @fileoverview added by tsickle
     * Generated from: lib/directive/index.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    ...
    var FormatCellDataPipe = /** @class */ (function () {
        ...
        FormatCellDataPipe.decorators = [
            { type: core.Pipe, args: [{ name: "formatCellData", pure: false },] }
        ];
        /** @nocollapse */
    ...
    var UPLocalePipe = /** @class */ (function () {
        ...
        UPLocalePipe.decorators = [
            { type: core.Pipe, args: [{ name: 'upLocale' },] }
        ];
        /** @nocollapse */
    ...
    var UPLocaleDefaultPipe = /** @class */ (function () {
        ...
        UPLocaleDefaultPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'upLocaleDefault' },] }
        ];
        /** @nocollapse */
     ...
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var FFileViewImageComponent = /** @class */ (function () {
        function FFileViewImageComponent() {
            this.maxHeight = 200;
            this.maxWidth = 300;
            this.cls = true;
            this.selfHeight = '50px';
        }
        Object.defineProperty(FFileViewImageComponent.prototype, "file", {
            get: /**
             * @return {?}
             */
            function () {
         ...
         * @return {?}
         */
        FFileViewImageComponent.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
        };
         ...
         * @return {?}
         */
        FFileViewImageComponent.prototype.changeImageSize = /**
         * @private
         * @param {?} originWidth
         * @param {?} originHeight
         * @return {?}
         */
        function (originWidth, originHeight) {
            // 图片原始尺寸
            // 图片原始尺寸
            // 目标尺寸
            /** @type {?} */
         ...
         * @return {?}
         */
        FFileViewImageComponent.prototype.createImageByCanvas = 
        // 压缩图片需要的一些元素和对象
        /**
         * @private
         * @return {?}
        ...
        function () {
            ...
            function () {
                /** @type {?} */
                var imgSize = _this.changeImageSize(tImage.width, tImage.height);
                // canvas对图片进行缩放
                canvas.width = imgSize.width;
                canvas.height = imgSize.height;
                // 清除画布
                context.clearRect(0, 0, _this.maxWidth, _this.maxHeight);
                // 图片压缩
        ...
        /** @nocollapse */
        FFileViewImageComponent.ctorParameters = function () { return []; };
        FFileViewImageComponent.propDecorators = {
            maxHeight: [{ type: core.Input }],
            maxWidth: [{ type: core.Input }],
            cls: [{ type: core.HostBinding, args: ['class.f-file-view-image',] }],
            selfHeight: [{ type: core.HostBinding, args: ['style.height',] }],
            canvas: [{ type: core.ViewChild, args: ['canvas',] }],
            file: [{ type: core.Input }]
        };
        return FFileViewImageComponent;
    }());
    if (false) {
        /** @type {?} */
    ...
    var FFileUploadComponent = /** @class */ (function () {
        function FFileUploadComponent(uploadAPISer, fileUploaderSer, notifyService, ngZone) {
            ...
            this.tVisible = true;
            // 需要重置,通过不断的赋值来改变
            this.needReset = new rxjs.Subject();
            // 启用拖拽
            ...
            // 上传和删除对外抛出的事件
            this.fUploadDoneEvent = new core.EventEmitter();
            this.fUploadRemovedEvent = new core.EventEmitter();
            // 允许上传的文件类型
            this.allowedContentTypes = "*";
            // 默认不限制附件上传个数
            this.maxUploads = 0;
            ...
            this.files = [];
            this.uploadSelectInput = new core.EventEmitter();
            this.uploadDragInput = new core.EventEmitter();
            // 重置
        ...
        FFileUploadComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        animations: [
                            animations.trigger("hideUploaded", [
                                animations.state("show", animations.style({ opacity: 1, height: "*" })),
                                animations.state("hide", animations.style({ opacity: 0, height: 0 })),
                                // transition('* => void', [
                                //   style({ opacity: 1}),
                                //   animate(200, style({ opacity: 0}))
                                // ])
                                animations.transition("* => hide", animations.animate("0.5s")),
                            ]),
                        ],
        ...
        FFileUploadComponent.propDecorators = {
            cls: [{ type: core.HostBinding, args: ["class.ffileupload",] }],
            visibleState: [{ type: core.HostBinding, args: ["class.ffileupload-unvisible",] }],
            selfDirectiveDefine: [{ type: core.HostBinding, args: ["class.ffileupload-selfdefine",] }],
            uploading: [{ type: core.HostBinding, args: ["class.ffileupload-uploading",] }],
            fFileUploadAssist: [{ type: core.ViewChild, args: ["uploadAssist",] }],
            fFileUploadDir: [{ type: core.ContentChild, args: [FFileUploadDirective,] }],
            fileUpload: [{ type: core.ViewChild, args: [FFileSelectDirective,] }],
            fileDropUpload: [{ type: core.ViewChild, args: [FFileDropDirective,] }],
            enableImagePreview: [{ type: core.Input }],
            uploadImmediately: [{ type: core.Input }],
            uploadedThenHide: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            enableSliceUpload: [{ type: core.Input }],
            chunkSize: [{ type: core.Input }],
            visible: [{ type: core.Input }],
            needReset: [{ type: core.Input }],
            enableDrop: [{ type: core.Input }],
            dropText: [{ type: core.Input }],
            enableSelect: [{ type: core.Input }],
            selectText: [{ type: core.Input }],
            multiple: [{ type: core.Input }],
            uploadedCount: [{ type: core.Input }],
            extendDatas: [{ type: core.Input }],
            widthThreshold: [{ type: core.Input }],
            fUploadDoneEvent: [{ type: core.Output }],
            fUploadRemovedEvent: [{ type: core.Output }],
            options: [{ type: core.Input }],
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/components/preview/f-file-preview.component.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var FFilePreviewComponent = /** @class */ (function () {
        function FFilePreviewComponent(cd, inject) {
            this.cd = cd;
            this.inject = inject;
            this.cls = true;
            // 只读的状态，控制附件是否可删除
            this.readonly = true;
            this._defaultItemCls = '';
            this.visible = true;
            // 是否启用批量操作
            ...
            this.defaultRename = '';
            // 
            this.enableCardAreaResponse = true;
            // 标记是否显示重命名输入框
            this.showRenameInput = false;
            //@Input() fileInfos:FUploadFileExtend[]=[];
            this._fileInfos = [];
            // 附件预览信息，抛出对象给第三方处理
            this.filePreviewEvent = new core.EventEmitter();
            // 附件下载事件，抛出对象给第三方处理
            this.fileDownloadEvent = new core.EventEmitter();
            this.multiSelectedEvent = new core.EventEmitter();
            // 附件删除事件，抛出对象给第三方处理
            this.fileRemoveEvent = new core.EventEmitter();
            this.multiSelected = [];
            // 全选状态
        ...
        Object.defineProperty(FFilePreviewComponent.prototype, "visibleState", {
            get: /**
             * @return {?}
             */
            function () {
        ...
        Object.defineProperty(FFilePreviewComponent.prototype, "defaultItemCls", {
            get: /**
             * @return {?}
             */
            function () {
        ...
        Object.defineProperty(FFilePreviewComponent.prototype, "fileInfos", {
            get: /**
             * @return {?}
             */
            function () {
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
        };
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
        function (changes) {
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.formatDatas = /**
         * 格式化数据
         * @param {?} val
         * @return {?}
         */
        function (val) {
            ...
            if (this.enableMulti) {
                ...
                function (item) {
                    ...
                    //     }
                    // }
                    item['checked'] = _this.selectAllBtnChecked;
                    return item;
                }));
                // 归集已选数据
                if (this.selectAllBtnChecked) {
                    this.multiSelected = __spread(formatValue);
                }
                else {
                    this.multiSelected = [];
                }
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.filePreviewHandler = /**
         * 预览
         * @param {?} ev
         * @param {?} fileInfo
         * @return {?}
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.fileDownloadHandler = /**
         * 下载
         * @param {?} ev
         * @param {?} fileInfo
         * @return {?}
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.fileMultiDownloadHandler = /**
         * @param {?} ev
         * @return {?}
         */
        function (ev) {
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.multiSelectChange = /**
         * checkbox多选
         * @param {?} ev
         * @return {?}
         */
        function (ev) {
            /** @type {?} */
            var hasInArray = this.multiSelected.findIndex((/**
             * @param {?} item
             * @return {?}
             */
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.fileRemoveHandler = /**
         * 删除数据
         * @param {?} ev
         * @param {?} fileInfo
         * @return {?}
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.getFileTypeClassName = /**
         * 获取文档类型对应的class
         * @param {?} fileName
         * @return {?}
         */
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.hasFileName = /**
         * 是不是有附件名称
         * @param {?} name
         * @return {?}
         */
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.selectOrCancelAllHandler = /**
         * 选择或取消所有
         * @param {?} ev
         * @return {?}
         */
        function (ev) {
            if (ev['checked']) {
                ...
                this.multiSelected = __spread(this.fileInfos);
                this.selectAllBtnChecked = true;
            }
            else {
                // 取消
         ...
         * @return {?}
         */
        FFilePreviewComponent.prototype.toggleRenameInput = /**
         * 显示隐藏输入名称
         * @param {?} ev
         * @return {?}
         */
    ...
    if (false) {
         ...
         * @private
         */
        FFilePreviewComponent.prototype.hasLocalSer;
        /**
         * @type {?}
         * @private
         */
        FFilePreviewComponent.prototype.cd;
        /**
         * @type {?}
         * @private
         */
        FFilePreviewComponent.prototype.inject;
        /* Skipping unhandled member: ;*/
    }
    ...
    var PreviewCheckboxComponent = /** @class */ (function () {
        ...
        PreviewCheckboxComponent.propDecorators = {
            cls1: [{ type: core.HostBinding, args: ["class.align-middle",] }],
            cls2: [{ type: core.HostBinding, args: ["class.d-inline-flex",] }],
            cls3: [{ type: core.HostBinding, args: ["class.preview-checkbox",] }],
            checked: [{ type: core.Input }],
            id: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            showDragBar: [{ type: core.Input }],
    ...
    /**
     * @fileoverview added by tsickle
     * Generated from: lib/components/multi-download-info/multi-download-info.component.ts
     * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var MultiDownloadInfoComponent = /** @class */ (function () {
        function MultiDownloadInfoComponent() {
            this.cls = true;
            // 记载下载数据
            this._downloadInfos = [];
            // 默认名称
        ...
        Object.defineProperty(MultiDownloadInfoComponent.prototype, "downloadInfos", {
            get: /**
             * @return {?}
             */
            function () {
        ...
        Object.defineProperty(MultiDownloadInfoComponent.prototype, "downloadName", {
            get: /**
             * @return {?}
             */
            function () {
         ...
         * @return {?}
         */
        MultiDownloadInfoComponent.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
        };
         ...
         * @return {?}
         */
        MultiDownloadInfoComponent.prototype.ngAfterViewInit = /**
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        MultiDownloadInfoComponent.prototype.getDownloadName = /**
         * 获取下载名称
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        MultiDownloadInfoComponent.prototype.getName = /**
         * @private
         * @param {?} name
         * @return {?}
         */
         ...
         * @return {?}
         */
        MultiDownloadInfoComponent.prototype.getFileTypeClassName = /**
         * @param {?} filename
         * @return {?}
         */
        function (filename) {
        };
        MultiDownloadInfoComponent.decorators = [
            { type: core.Component, args: [{
                        selector: 'ffile-multi-download-info',
                        template: "<ng-container *ngIf=\"downloadInfos.length>0\">\r\n  <div class=\"ffile-download-info\">\r\n    <div class=\"ffile-download-info--header\" style=\"align-items: center;\">\r\n      <span style=\"width: 22px;height: 22px;margin-right: 5px;\" class=\"ffilepreview--filetype-icon\" [ngClass]=\"fileTypeCls\"></span>\r\n      <span class=\"file-name\">\r\n        {{downloadInfos[0]['name']}}\r\n      </span>\r\n      <span>{{'uploadAndPreview.downloadCount' | upLocale: downloadInfos.length}}</span>\r\n    </div>\r\n    <div class=\"ffile-download-info--content\">\r\n      <span class=\"rename-label\">{{'uploadAndPreview.newName' | upLocale }}</span>\r\n      <div class=\"rename-container\"><input type=\"text\"\r\n        class=\"form-control\" placeholder=\"\" #multiRenameInput  [value]=\"downloadName\" /></div>\r\n      <span class=\"rename-suffix\">.zip</span>\r\n    </div>\r\n  </div>\r\n</ng-container>",
                        styles: [".ffile-download-info--header{display:-webkit-box;display:flex;margin:0 0 16px}.ffile-download-info--header .file-name{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;-webkit-box-flex:1;flex:1 1 0;padding-right:8px}.ffile-download-info--content{display:-webkit-box;display:flex;-webkit-box-align:center;align-items:center}.ffile-download-info--content .rename-container{-webkit-box-flex:1;flex:1 1 0}.ffile-download-info{padding:10px 24px;font-size:13px}.rename-label{color:#5a5e66;margin:0 10px 0 0}.rename-suffix{margin:0 0 0 8px}"]
                    }] }
        ];
        /** @nocollapse */
        MultiDownloadInfoComponent.ctorParameters = function () { return []; };
        MultiDownloadInfoComponent.propDecorators = {
            cls: [{ type: core.HostBinding, args: ['class.ffile-multi-download-info',] }],
            multiRenameRef: [{ type: core.ViewChild, args: ['multiRenameInput',] }],
            downloadInfos: [{ type: core.Input }],
            downloadName: [{ type: core.Input }]
        };
        return MultiDownloadInfoComponent;
    }());
    if (false) {
        /** @type {?} */
        MultiDownloadInfoComponent.prototype.cls;
        /** @type {?} */
        MultiDownloadInfoComponent.prototype.multiRenameRef;
        /**
         * @type {?}
         * @private
         */
        MultiDownloadInfoComponent.prototype._downloadInfos;
        /**
         * @type {?}
         * @private
         */
        MultiDownloadInfoComponent.prototype._downloadName;
        /** @type {?} */
        MultiDownloadInfoComponent.prototype.fileTypeCls;
    }
    ...
    var UploadAndPreviewComponent = /** @class */ (function () {
        ...
        function UploadAndPreviewComponent(el, uploadAPISer, fileUploaderSer, notifyService, ngZone, modalSer, cd, inject) {
            ...
            this.fileDownloadEvent = new core.EventEmitter();
            // 附件预览，多选事件
            this.fPreviewMultiSelectedEvent = new core.EventEmitter();
            // 当前行
            this.fSelectedEvent = new core.EventEmitter();
            ...
            // 需要重置,通过不断的赋值来改变
            this.uploadNeedReset = new rxjs.Subject();
            // 启用选择文件按钮
             ...
             * 文件放下事件
             */
            this.afterOrdered = new core.EventEmitter();
            this.uploadAndPreviewTableHeader = null;
            this.uploadAndPreviewTableHeaderCreated$ = new rxjs.Subject();
            // 允许上传的文件类型
            this.allowedContentTypes = "*";
            // 默认不限制附件上传个数
            this.maxUploads = 0;
            ...
            this.dateHlp = new date.DateTimeHelperService();
        }
        ...
        Object.defineProperty(UploadAndPreviewComponent.prototype, "previewColumns", {
            ...
            function (value) {
                if (value) {
                    this._previewColumns = __spread(value);
                }
                else {
                    this._presetPreviewColumns = __spread(this._presetPreviewColumns);
                }
            ...
            function (uploadOpts) {
                if (uploadOpts) {
                    ...
                    if (uploadOpts.hasOwnProperty("notAllowedCharsInFileName")) {
                        ...
                        this.notAllowedCharsInFileName = tNotAllowed && tNotAllowed.length > 0 ? __spread(tNotAllowed) : [];
                    }
                    this.selfUploadOpts = Object.assign(this.selfUploadOpts, uploadOpts);
                }
            },
        ...
        function () {
            if (this._previewColumns.length == 0) {
                this.previewColumns = __spread(this._presetPreviewColumns);
            }
        };
        /**
         * @return {?}
        ...
        function (ev) {
            if (ev["checked"]) {
                ...
                this.previewMultiSelected = __spread(this.fileInfos);
        ...
        function (val) {
            ...
            if (this.previewEnableMulti) {
                ...
                //     this.previewMultiSelected = [];
                // }
                this.previewMultiSelected = __spread(newFormatValue).filter((/**
                 * @param {?} n
                 * @return {?}
                 */
        ...
        function (output) {
            ...
            if (output.type === "addedToQueue" && typeof output.file !== "undefined") {
                ...
                this.fileInfos = __spread(newAddFiles, this.fileInfos);
                // 上传完成后不在当前页面上显示
                this.hideAfterLoaded(output);
            }
            else if (output.type === "cancelled" ||
        ...
        function ($event) {
            ...
            (_a = this.fileInfos).splice.apply(_a, __spread([addedIndex, 0], removedItem));
            this.cd.detectChanges();
            /** @type {?} */
        ...
        UploadAndPreviewComponent.propDecorators = {
            cls: [{ type: core.HostBinding, args: ["class.ffileUploadAndPreview",] }],
            fillState: [{ type: core.HostBinding, args: ["class.ffileUploadAndPreview-content-fill",] }],
            previewFileNameTmpl: [{ type: core.ViewChild, args: ["previewFileNameTmpl",] }],
            fileSizeTmpl: [{ type: core.ViewChild, args: ["fileSizeTmpl",] }],
            uapStateTmpl: [{ type: core.ViewChild, args: ["uapStateTmpl",] }],
            previewActionTmpl: [{ type: core.ViewChild, args: ["previewActionTmpl",] }],
            previewDateTmpl: [{ type: core.ViewChild, args: ["previewDateTmpl",] }],
            uploadFileNameTmpl: [{ type: core.ViewChild, args: ["uploadFileNameTmpl",] }],
            extendServerConfig: [{ type: core.Input }],
            contentFill: [{ type: core.Input }],
            enableOrder: [{ type: core.Input }],
            orderField: [{ type: core.Input }],
            editfile: [{ type: core.Input }],
            docMode: [{ type: core.Input }],
            previewColumns: [{ type: core.Input }],
            extendInfos: [{ type: core.Input }],
            fileInfos: [{ type: core.Input }],
            previewDateFormat: [{ type: core.Input }],
            previewReadonly: [{ type: core.Input }],
            previewVisible: [{ type: core.Input }],
            previewEnableMulti: [{ type: core.Input }],
            previewShowType: [{ type: core.Input }],
            previewEnableRename: [{ type: core.Input }],
            previewDefaultRename: [{ type: core.Input }],
            previewShowComments: [{ type: core.Input }],
            previewModeless: [{ type: core.Input }],
            filePreviewEvent: [{ type: core.Output }],
            fileDownloadEvent: [{ type: core.Output }],
            fPreviewMultiSelectedEvent: [{ type: core.Output }],
            fSelectedEvent: [{ type: core.Output }],
            fileRemoveEvent: [{ type: core.Output }],
            fileUpload: [{ type: core.ViewChild, args: [FFileSelectDirective,] }],
            uploadDisabled: [{ type: core.Input }],
            uploadVisible: [{ type: core.Input }],
            uploadNeedReset: [{ type: core.Input }],
            uploadEnableSelect: [{ type: core.Input }],
            uploadSelectText: [{ type: core.Input }],
            uploadEnableMulti: [{ type: core.Input }],
            uploadedCount: [{ type: core.Input }],
            extendDatas: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            noDownload: [{ type: core.Input }],
            noPreview: [{ type: core.Input }],
            noDelete: [{ type: core.Input }],
            enableSorting: [{ type: core.Input }],
            uploadOptions: [{ type: core.Input }],
            enableSliceUpload: [{ type: core.Input }],
            chunkSize: [{ type: core.Input }],
            customInfo: [{ type: core.Input }],
            fUploadDoneEvent: [{ type: core.Output }],
            fUploadRemovedEvent: [{ type: core.Output }],
            afterOrdered: [{ type: core.Output }],
            uploadAndPreviewTbodyRef: [{ type: core.ViewChild, args: ["uaptb",] }],
            uploadAndPreviewTheadRef: [{ type: core.ViewChild, args: ["uapth",] }]
        };
    ...
    var UploadProgressComponent = /** @class */ (function () {
        ...
        Object.defineProperty(UploadProgressComponent.prototype, "progressStatus", {
            //获得进度条状态
            get: 
            //获得进度条状态
            /**
         ...
         * @return {?}
         */
        UploadProgressComponent.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
        function (changes) {
            var status = changes.status, percent = changes.percent, successPercent = changes.successPercent;
            //状态变化
            if (status) {
         ...
         * @return {?}
         */
        UploadProgressComponent.prototype.ngOnInit = /**
         * @return {?}
         */
        function () {
        };
         ...
         * @return {?}
         */
        UploadProgressComponent.prototype.isNotNil = /**
         * @template T
         * @param {?} value
         * @return {?}
         */
        ...
        UploadProgressComponent.propDecorators = {
            ...
            successPercent: [{ type: core.Input }],
    ...
    var UploadFileOrderDragDirective = /** @class */ (function () {
        function UploadFileOrderDragDirective(ngzone, injector, render, el) {
            var _this = this;
            this.ngzone = ngzone;
            this.injector = injector;
            this.render = render;
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.ngAfterViewInit = /**
         * @return {?}
         */
        function () {
            if (this.enableDrag) {
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.ngOnDestroy = /**
         * @return {?}
         */
        function () {
            this.disposeDnd();
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.disposeDnd = /**
         * @private
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.initDnD = /**
         * @private
         * @return {?}
         */
        function () {
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.getChildPayload = /**
         * @private
         * @param {?} index
         * @return {?}
         */
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.onDropReady = /**
         * @private
         * @param {?} dropResult
         * @return {?}
         */
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.onDragStart = /**
         * @private
         * @param {?} info
         * @return {?}
         */
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.onDragEnd = /**
         * @private
         * @param {?} info
         * @return {?}
         */
         ...
         * @return {?}
         */
        UploadFileOrderDragDirective.prototype.onDragEnter = /**
         * @private
         * @return {?}
         */
        function () {
        ...
        /** @nocollapse */
        UploadFileOrderDragDirective.ctorParameters = function () { return [
            { type: core.NgZone },
            { type: core.Injector },
            { type: core.Renderer2 },
            { type: core.ElementRef }
        ...
        UploadFileOrderDragDirective.propDecorators = {
            enableDrag: [{ type: core.Input, args: ['upfile-order-drag',] }],
            drop: [{ type: core.Output }],
            options: [{ type: core.Input }]
        };
        return UploadFileOrderDragDirective;
    }());
    if (false) {
        /**
         * @type {?}
    ...
    exports.DocModeType = DocModeType;
    exports.FFileDatePipe = FFileDatePipe;
    exports.FFileDropDirective = FFileDropDirective;
    exports.FFilePreviewComponent = FFilePreviewComponent;
    exports.FFilePreviewListTypeTemplateDirective = FFilePreviewListTypeTemplateDirective;
    exports.FFilePreviewToolbarTemplateDirective = FFilePreviewToolbarTemplateDirective;
    exports.FFileSelectDirective = FFileSelectDirective;
    exports.FFileSizePipe = FFileSizePipe;
    exports.FFileUploadAPIService = FFileUploadAPIService;
    exports.FFileUploadAPIServiceToken = FFileUploadAPIServiceToken;
    exports.FFileUploadComponent = FFileUploadComponent;
    exports.FFileUploadDefaultService = FFileUploadDefaultService;
    exports.FFileUploadDirective = FFileUploadDirective;
    exports.FFileUploadModule = FFileUploadModule;
    exports.FFileUploaderService = FFileUploaderService;
    exports.FFileUtils = FFileUtils;
    exports.FFileViewImageComponent = FFileViewImageComponent;
    exports.FormatCellDataPipe = FormatCellDataPipe;
    exports.MultiDownloadInfoComponent = MultiDownloadInfoComponent;
    exports.PreviewCheckboxComponent = PreviewCheckboxComponent;
    exports.UPLocaleDefaultPipe = UPLocaleDefaultPipe;
    exports.UPLocalePipe = UPLocalePipe;
    exports.UploadAndPreviewComponent = UploadAndPreviewComponent;
    exports.UploadFileOrderDragDirective = UploadFileOrderDragDirective;
    exports.UploadProgressComponent = UploadProgressComponent;
    exports.UploadServerService = UploadServerService;
    exports.UploadStatus = UploadStatus;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=farris-extend-file-upload.umd.js.map

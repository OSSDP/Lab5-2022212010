import { InjectionToken, Injectable, Optional, Inject, defineInjectable, inject, EventEmitter, Injector, Directive, ElementRef, Input, Output, TemplateRef, Pipe, Component, HostBinding, ViewChild, NgZone, ContentChild, ViewEncapsulation, ChangeDetectorRef, Renderer2, NgModule } from '@angular/core';
...
/** @type {?} */
var FFileUploadAPIServiceToken = new InjectionToken('MFFileUploadServerConfig');
var FFileUploadAPIService = /** @class */ (function () {
    ...
    /** @nocollapse */ FFileUploadAPIService.ngInjectableDef = defineInjectable({ factory: function FFileUploadAPIService_Factory() { return new FFileUploadAPIService(inject(FFileUploadAPIServiceToken, 8)); }, token: FFileUploadAPIService, providedIn: "root" });
...
var FFilePreviewComponent = /** @class */ (function () {
    function FFilePreviewComponent(cd, inject) {
        ...
        this.multiSelectedEvent = new EventEmitter();
        // 附件删除事件，抛出对象给第三方处理
    ...
    FFilePreviewComponent.propDecorators = {
        cls: [{ type: HostBinding, args: ['class.ffilepreview--wrapper',] }],
        visibleState: [{ type: HostBinding, args: ['class.ffilepreview-unvisible',] }],
        readonly: [{ type: Input }],
        defaultItemCls: [{ type: Input }],
        visible: [{ type: Input }],
        enableMulti: [{ type: Input }],
        type: [{ type: Input }],
        itemCls: [{ type: Input }],
        headerCls: [{ type: Input }],
        canRename: [{ type: Input }],
        defaultRename: [{ type: Input }],
        enableCardAreaResponse: [{ type: Input }],
        multiRenameRef: [{ type: ViewChild, args: ['multiRenameInput',] }],
        fileInfos: [{ type: Input }],
        filePreviewEvent: [{ type: Output }],
        fileDownloadEvent: [{ type: Output }],
        multiSelectedEvent: [{ type: Output }],
        fileRemoveEvent: [{ type: Output }],
        listTypeTemplate: [{ type: ContentChild, args: [FFilePreviewListTypeTemplateDirective, { read: TemplateRef },] }],
        toolbarTemplate: [{ type: ContentChild, args: [FFilePreviewToolbarTemplateDirective, { read: TemplateRef },] }]
    };
...
var MultiDownloadInfoComponent = /** @class */ (function () {
    ...
    MultiDownloadInfoComponent.propDecorators = {
        cls: [{ type: HostBinding, args: ['class.ffile-multi-download-info',] }],
        multiRenameRef: [{ type: ViewChild, args: ['multiRenameInput',] }],
        downloadInfos: [{ type: Input }],
        downloadName: [{ type: Input }]
    };
...
/**
 * @fileoverview added by tsickle
 * Generated from: farris-extend-file-upload.ts
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */

export { DocModeType, FFileDatePipe, FFileDropDirective, FFilePreviewComponent, FFilePreviewListTypeTemplateDirective, FFilePreviewToolbarTemplateDirective, FFileSelectDirective, FFileSizePipe, FFileUploadAPIService, FFileUploadAPIServiceToken, FFileUploadComponent, FFileUploadDefaultService, FFileUploadDirective, FFileUploadModule, FFileUploaderService, FFileUtils, FFileViewImageComponent, FormatCellDataPipe, MultiDownloadInfoComponent, PreviewCheckboxComponent, UPLocaleDefaultPipe, UPLocalePipe, UploadAndPreviewComponent, UploadFileOrderDragDirective, UploadProgressComponent, UploadServerService, UploadStatus };
//# sourceMappingURL=farris-extend-file-upload.js.map

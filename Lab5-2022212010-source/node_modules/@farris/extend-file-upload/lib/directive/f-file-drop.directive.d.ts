...
export declare class FFileDropDirective implements OnInit, OnDestroy {
    ...
    constructor(elementRef: ElementRef, upload: FFileUploaderService);
    ngOnInit(): void;
    ngOnDestroy(): void;
    private bindDragAndDropEvent;
    private unbindDragAndDropEvent;
    onDropEnter: (e: Event) => void;
    onDrop(e: any): void;

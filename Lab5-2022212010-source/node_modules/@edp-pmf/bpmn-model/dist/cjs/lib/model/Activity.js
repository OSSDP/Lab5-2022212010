...
var MultiInstanceLoopCharacteristics_1 = require("./MultiInstanceLoopCharacteristics");
...
var Activity = /** @class */ (function (_super) {
    ...
    Activity.prototype.ConvertToJsonObject = function () {
        ...
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "Default", this.Default);
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "IsForCompensation", this.IsForCompensation);
        var dataInputs = new Array();
        for (var item in this.dataInputDIc) {
        ...
        if (resourceRoles.length > 0) {
            BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "resourceRoles", resourceRoles);
        }
        if (this.LoopCharacteristics != null) {
            BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "loopCharacteristics", this.LoopCharacteristics.ConvertToJsonObject());
        }
        return obj;
    };
    Activity.prototype.LoadFromJsonObject = function (obj) {
        ...
        if (obj.hasOwnProperty("resourceRoles") && Array.isArray(obj.resourceRoles)) {
            for (var _h = 0, _j = obj.resourceRoles; _h < _j.length; _h++) {
                var item = _j[_h];
                var resourceRole = BpmnModelHelper_1.BpmnModelHelper.GetElementType(item.ClrTypeID);
        ...
        if (obj.hasOwnProperty("loopCharacteristics")) {
            this.LoopCharacteristics = new MultiInstanceLoopCharacteristics_1.MultiInstanceLoopCharacteristics(this.Model);

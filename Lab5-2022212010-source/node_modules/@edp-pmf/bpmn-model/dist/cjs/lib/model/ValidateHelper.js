...
var ValidateHelper = /** @class */ (function () {
    ...
    ValidateHelper.ValidateEndEvents = function (process, errors) {
        ...
        for (var item in process.GetFlowElements()) {
            ...
            if (endEvent instanceof EndEvent_1.EndEvent)
    ...
    ValidateHelper.ValidateFlowNode = function (process, errors) {
        for (var item in process.GetFlowElements()) {
            ...
            if ((flowNode instanceof FlowNode_1.FlowNode) == false)
                continue;
            ...
            for (var item2 in process.GetFlowElements()) {
                ...
                if (sequenceFlow instanceof SequenceFlow_1.SequenceFlow == false)
                    continue;
            ...
            if (incomings.length == 0 && (flowNode instanceof StartEvent_1.StartEvent) == false) {
                var error = new ValidationError_1.ValidationError();
            ...
            if (incomings.length > 0 && (flowNode instanceof StartEvent_1.StartEvent) == true) {
                var error = new ValidationError_1.ValidationError();
                error.Element = flowNode;
                error.ErrorLevel = ValidationLevel_1.ValidationLevel.$_Error;
                error.ErrorCode = "";
            ...
            if (outgoings.length == 0 && (flowNode instanceof EndEvent_1.EndEvent) == false) {
                var error = new ValidationError_1.ValidationError();
                error.Element = flowNode;
                error.ErrorLevel = ValidationLevel_1.ValidationLevel.$_Error;
                error.ErrorCode = "";
            ...
            if (outgoings.length > 0 && (flowNode instanceof EndEvent_1.EndEvent) == true) {
                if (outgoings.length > 0 && (flowNode instanceof EndEvent_1.EndEvent) == true) {
                    var error = new ValidationError_1.ValidationError();
                    error.Element = flowNode;
                    error.ErrorLevel = ValidationLevel_1.ValidationLevel.$_Error;
    ...
    ValidateHelper.ValidateIDataInputAssociationContainer = function (process, errors, associationContainer) {
        for (var _i = 0, _a = associationContainer.GetDataInputAssociations(); _i < _a.length; _i++) {
            ...
            var IDataInputContainerInterface = {
                ...
                GetDataOutput: function (dataInputId) { return new DataInput_1.DataInput(null); },
    ...
    ValidateHelper.ValidateIDataOutputAssociationContainer = function (process, errors, associationContainer) {
        for (var _i = 0, _a = associationContainer.GetDataOutputAssociations(); _i < _a.length; _i++) {
            ...
            var IDataOutputContainerInterface = {
                ...
                GetDataOutput: function (dataOutputId) { return new DataOutput_1.DataOutput(null); },
                GetDataOutputs: function () { return new Array(); },
    ...
    ValidateHelper.ValidateStartEvents = function (process, errors) {
        ...
        for (var item in process.GetFlowElements()) {
            ...
            if (startEvent instanceof StartEvent_1.StartEvent)

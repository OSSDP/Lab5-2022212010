...
var CallableElement_1 = require("./CallableElement");
...
var Process = /** @class */ (function (_super) {
    ...
    Process.prototype.GetDataObject = function (dataObjectId) {
        if (dataObjectId == null)
            return null;
        if (this.flowElementsDic.hasOwnProperty(dataObjectId) && this.flowElementsDic[dataObjectId] instanceof DataObject_1.DataObject)
    ...
    Process.prototype.GetDataObjects = function () {
        ...
        for (var item in this.flowElementsDic) {
            ...
            if (this.flowElementsDic[item] instanceof DataObject_1.DataObject) {
    ...
    Process.prototype.ConvertToJsonObject = function () {
        ...
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "Key", this.Key);
        var flowElements = [];
    ...
    Process.prototype.RemoveFlowNode = function (element) {
        ...
        for (var item in this.GetFlowElements()) {
            ...
            if (itemElement == null)
                continue;
            if (itemElement instanceof SequenceFlow_1.SequenceFlow && (itemElement.SourceRef == element.Id || itemElement.TargetRef == element.Id))
    ...
    return Process;
}(CallableElement_1.CallableElement));

...
exports.BPMNDiagram = void 0;
var tslib_1 = require("tslib");
var BpmnModelHelper_1 = require("../BpmnModelHelper");
var Diagram_1 = require("../omgdi/Diagram");
var ValidateHelper_1 = require("../ValidateHelper");
var BPMNLabelStyle_1 = require("./BPMNLabelStyle");
var BPMNPlane_1 = require("./BPMNPlane");
var BPMNDiagram = /** @class */ (function (_super) {
    tslib_1.__extends(BPMNDiagram, _super);
    function BPMNDiagram(model) {
        var _this = _super.call(this, model) || this;
        _this.bpmnLabelStyleDic = {};
        _this.BpmnPlane = new BPMNPlane_1.BPMNPlane(model);
        return _this;
    }
    ...
    BPMNDiagram.prototype.ConvertToJsonObject = function () {
        ...
        if (this.BpmnPlane != null) {
            BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "BpmnPlane", this.BpmnPlane.ConvertToJsonObject());
        }
        var bpmnLabelStyles = new Array();
        for (var item in this.bpmnLabelStyleDic) {
        ...
        if (bpmnLabelStyles.length > 0) {
            BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "bpmnLabelStyles", bpmnLabelStyles);
        }
        return obj;
    };
    BPMNDiagram.prototype.LoadFromJsonObject = function (obj) {
        ...
        if (obj.hasOwnProperty("BpmnPlane")) {
            this.BpmnPlane = new BPMNPlane_1.BPMNPlane(this.Model);
        ...
        if (obj.hasOwnProperty("bpmnLabelStyles") && Array.isArray(obj.bpmnLabelStyles)) {
            for (var _i = 0, _a = obj.bpmnLabelStyles; _i < _a.length; _i++) {
                var item = _a[_i];
                var bpmnLabelStyle = new BPMNLabelStyle_1.BPMNLabelStyle(this.Model);

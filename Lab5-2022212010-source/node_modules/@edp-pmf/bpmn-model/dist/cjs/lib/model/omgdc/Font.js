...
var OmgdcElement_1 = require("./OmgdcElement");
var Font = /** @class */ (function (_super) {
    ...
    Font.prototype.ConvertToJsonObject = function () {
        ...
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "IsBold", this.IsBold);
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "IsItalic", this.IsItalic);
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "IsStrikeThrough", this.IsStrikeThrough);
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "IsUnderline", this.IsUnderline);
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "Name", this.Name);
        BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "Size", this.Size);
        return obj;
    };

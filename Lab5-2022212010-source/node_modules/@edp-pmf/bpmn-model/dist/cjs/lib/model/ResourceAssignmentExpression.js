...
exports.ResourceAssignmentExpression = void 0;
...
var ResourceAssignmentExpression = /** @class */ (function (_super) {
    tslib_1.__extends(ResourceAssignmentExpression, _super);
    ...
    ResourceAssignmentExpression.prototype.ConvertToJsonObject = function () {
        ...
        if (this.Expression != null) {
            BpmnModelHelper_1.BpmnModelHelper.SetAttributeValue(obj, "Expression", this.Expression.ConvertToJsonObject());
        }
        return obj;
    };
    ResourceAssignmentExpression.prototype.LoadFromJsonObject = function (obj) {
        ...
        if (obj.hasOwnProperty("Expression")) {
            this.Expression = new Expression_1.Expression(this.Model);
...
//# sourceMappingURL=ResourceAssignmentExpression.js.map
...
var EdgeCell = /** @class */ (function (_super) {
    tslib_1.__extends(EdgeCell, _super);
    function EdgeCell() {
    ...
    EdgeCell.prototype.unbindBpmnModel = function () {
        ...
        if (srcFlowNode != null) {
            ...
            if (srcFlowNode instanceof bpmn_model_1.ExclusiveGateway && srcFlowNode.Default === seqFlow.Id) {
                srcFlowNode.Default = null;
            }
            if (srcFlowNode instanceof bpmn_model_1.Activity && srcFlowNode.Default === seqFlow.Id) {
                srcFlowNode.Default = null;
            }
        }
        if (tarFlowNode != null) {
    ...
    EdgeCell.prototype.createFlowElement = function (flowElt) {
        ...
        if (flowElt) {
            ...
            var tmpSeqFlow = bpmn_model_1.BpmnModelHelper.GetElementType(this.clrTypeId);
    ...
    EdgeCell.prototype.createDiagramElement = function (diagElt) {
        ...
        var edge = new bpmn_model_1.BPMNEdge(bpmnModel);
        edge.SourceShapeElementId = srcDiagElt && srcDiagElt.Id;
        edge.TargetShapeElementId = tarDiagElt && tarDiagElt.Id;
        edge.LineType = bpmn_model_1.SequenceFlowLineType.RectangularLineType;
        var rectangularLine = new bpmn_model_1.RectangularLine(bpmnModel);
        rectangularLine.LineType = bpmn_model_1.RectangularLineType.H2V;
    ...
    EdgeCell.prototype.setPoints = function (waypoints) {
        ...
        waypoints && waypoints.forEach(function (mxPt) {
            var bpmnPt = new bpmn_model_1.Point(_this.diagramElement.Model);
            bpmnPt.X = mxPt.x;
            bpmnPt.Y = mxPt.y;
            bpmnPts.push(bpmnPt);
        });
    ...
    EdgeCell.prototype.setBpmnLabel = function (mxRect) {
        ...
        var bpmnLabel = new bpmn_model_1.BPMNLabel(bpmnModel);

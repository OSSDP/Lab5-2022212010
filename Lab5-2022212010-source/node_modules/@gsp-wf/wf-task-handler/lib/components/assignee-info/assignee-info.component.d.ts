import { OnInit, EventEmitter, ChangeDetectorRef, Injector } from '@angular/core';
...
export declare class AssigneeInfoComponent implements OnInit {
    private i18nService;
    private notify;
    private cd;
    private taskService;
    ...
    wfContext: WfContext;
    index: any;
    isUseNewSelectUserHelp: boolean;
    ...
    private showFarrisUserHelpFromWindow;

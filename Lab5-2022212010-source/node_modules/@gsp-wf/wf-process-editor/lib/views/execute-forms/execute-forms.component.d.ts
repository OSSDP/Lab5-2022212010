import { OnInit, EventEmitter, TemplateRef, ElementRef, ComponentFactoryResolver, Injector, AfterViewInit, ChangeDetectorRef } from '@angular/core';
...
export declare class ExecuteFormsConverter implements TypeConverter {
    private localePipe;
    params: any;
    constructor(params: any, localePipe: WfLocalePipe);

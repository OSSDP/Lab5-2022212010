import { OnInit, TemplateRef, ViewContainerRef, Injector, ChangeDetectorRef } from '@angular/core';
...
export declare class FormFormatConfigComponent implements OnInit, IFormFormatConfigComponent {
    ...
    showExtendTab: boolean;
    searchFields: {
        label: string;
        value: string;
    }[];
    constructor(http: HttpService, message: MessagerService, notify: NotifyService, injector: Injector, cdr: ChangeDetectorRef, localeId: string, resources: any, localePipe: WfLocalePipe);
    ngOnInit(): void;
    submit(): Observable<any>;
    searchField(data: any): void;
    btnConfigChange(bool: boolean, field: string, id: string): void;
    btnBatchOperate(operation: string): void;
    btnBatchReset(): void;
    fieldConfigChange(bool: boolean, field: string, id: string, search?: boolean): void;
    ...
    private getConfig;
    createExtendComponent(extendImpl: string): void;
    private orgFieldConfigs;
    private setFieldConfig;
    private saveConfig;
    private getFormFormat;
    private getFormFormatType;

...
export declare class ExtendPropertyComponent implements OnInit {
    private uiState;
    private cdr;
    private localeId;
    private resources;
    ...
    procExtendProperty: Array<ProcExtendProperty>;
    booleanlist: {
        key: any;
        value: string;
    }[];
    ...
    constructor(uiState: ProcessDesignerUIState, cdr: ChangeDetectorRef, localeId: string, resources: any, localePipe: WfLocalePipe);
    setProperty(obj: any): void;
    ngOnInit(): void;
    clickOK(): void;
    cancel(): void;
}
export declare class ExtendPropertyConverter implements TypeConverter {
    private localePipe;

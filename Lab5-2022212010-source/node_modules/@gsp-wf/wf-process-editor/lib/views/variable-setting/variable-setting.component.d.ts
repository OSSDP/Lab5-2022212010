...
export declare class VariableSettingComponent implements OnInit {
    ...
    constructor(resolver: ComponentFactoryResolver, injector: Injector, modalService: BsModalService, message: MessagerService, uistate: ProcessDesignerUIState, expr: ExpressionService, cdr: ChangeDetectorRef, localeId: string, resources: any, localePipe: WfLocalePipe);
    ngOnInit(): void;
    add(): void;
    delete(): void;
    clickOK(): void;

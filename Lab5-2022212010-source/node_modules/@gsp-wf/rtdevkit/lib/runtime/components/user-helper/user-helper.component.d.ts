...
export declare class UserHelperComponent implements OnInit {
    ...
    userDialog?: DialogComponent;
    constructor(i18nService: I18nService, userSvc: UserService, notify?: NotifyService);

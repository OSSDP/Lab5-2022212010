import { BpmnModel, ExtensionElement, IClrTypeElement } from "@edp-pmf/bpmn-model";
import { AutomaticApprovalRule } from "../AutomaticApprovalRule";
export declare class ParticipantSetting extends ExtensionElement implements IClrTypeElement {

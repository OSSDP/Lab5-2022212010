import { BpmnModel, ExtensionElement, StartEvent, ValidationError } from "@edp-pmf/bpmn-model";
...
export declare class StartActivity extends StartEvent {
    ...
    */
    ...
    clone(): StartActivity;
    setDefaultForms(forms: Array<any>): void;
}

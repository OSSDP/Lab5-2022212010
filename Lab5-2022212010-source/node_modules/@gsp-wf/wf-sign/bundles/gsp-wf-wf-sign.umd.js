(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('signature_pad/dist/signature_pad.umd'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@gsp-wf/wf-sign', ['exports', 'signature_pad/dist/signature_pad.umd', '@angular/core'], factory) :
    (factory((global['gsp-wf'] = global['gsp-wf'] || {}, global['gsp-wf']['wf-sign'] = {}),global.sp,global.ng.core));
}(this, (function (exports,sp,i0) { 'use strict';

    sp = sp && sp.hasOwnProperty('default') ? sp['default'] : sp;
    ...
    var WfSignService = /** @class */ (function () {
        ...
        /** @nocollapse */ WfSignService.ngInjectableDef = i0.defineInjectable({ factory: function WfSignService_Factory() { return new WfSignService(); }, token: WfSignService, providedIn: "root" });
    ...
    var SignatureComponent = /** @class */ (function () {
        ...
        SignatureComponent.propDecorators = {
            ...
            onBeginEvent: [{ type: i0.Output }],
            onEndEvent: [{ type: i0.Output }]
        };
    ...
    var SignComponent = /** @class */ (function () {
        function SignComponent() {
            // 抛出选中的事件
            this.toDataUrlEvent = new i0.EventEmitter();
            this.isDrawEvent = new i0.EventEmitter();
        ...
        SignComponent.propDecorators = {
            signaturePad: [{ type: i0.ViewChild, args: [SignatureComponent,] }],
            canvasDiv: [{ type: i0.ViewChild, args: ['canvastitle',] }],
            toDataUrlEvent: [{ type: i0.Output }],
            isDrawEvent: [{ type: i0.Output }],
            imageType: [{ type: i0.Input }],
    ...
    exports.WfSignService = WfSignService;
    exports.WfSignComponent = WfSignComponent;
    exports.WfSignModule = WfSignModule;
    exports.SignHereComponent = SignHereComponent;
    exports.ɵb = SignComponent;
...
//# sourceMappingURL=gsp-wf-wf-sign.umd.js.map
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('rxjs/operators'), require('rxjs'), require('@gsp-sys/rtf-common'), require('@ecp-caf/caf-common'), require('@qdp/common'), require('@farris/ui-loading')) :
    typeof define === 'function' && define.amd ? define('@qdp/search-join', ['exports', '@angular/common', '@angular/core', 'rxjs/operators', 'rxjs', '@gsp-sys/rtf-common', '@ecp-caf/caf-common', '@qdp/common', '@farris/ui-loading'], factory) :
    (factory((global.qdp = global.qdp || {}, global.qdp['search-join'] = {}),global.ng.common,global.ng.core,global.rxjs.operators,global.rxjs,global.rtfCommon,global.cafCommon,global.common$1,global.uiLoading));
}(this, (function (exports,common,core,operators,rxjs,rtfCommon,cafCommon,common$1,uiLoading) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SearchListService = /** @class */ (function () {
        ...
        /** @nocollapse */
        SearchListService.ctorParameters = function () {
            return [
                { type: common$1.JointSearchManagerService }
            ];
        };
    ...
    var MenuControllerService = /** @class */ (function () {
         ...
         */
            function ($event, elementRef, qdpView, qdpViewElementRef) {
                ...
                /** @type {?} */
                var joinParam = this.cache.get(common$1.RtfServices.getTabId(this._queryId) + 'joinSearch');
         ...
         */
            function (formId, queryId, queryRelativeUrl) {
                ...
                if (this._searchList && this._searchList.queryId === this._queryId) {
                    return rxjs.of(this._searchList);
                }
                /** @type {?} */
        ...
        /** @nocollapse */
        MenuControllerService.ctorParameters = function () {
            return [
    ...
    var SearchJoinMenuComponent = /** @class */ (function () {
        function SearchJoinMenuComponent(elementRef, renderFactory, menuControllerService, frameWorkService, cacheService, jointSearchExtendService, injector) {
            ...
            if (this.injector) {
                this.appService = this.injector.get(rtfCommon.AppService);
            }
        ...
        /** @nocollapse */
        SearchJoinMenuComponent.ctorParameters = function () {
            return [
                ...
                { type: cafCommon.CacheService },
                { type: common$1.JointSearchExtendService, decorators: [{ type: core.Optional }] },
    ...
    exports.SearchJoinModule = SearchJoinModule;
    exports.MenuControllerService = MenuControllerService;
    exports.SearchListService = SearchListService;
    exports.SearchJoinMenuComponent = SearchJoinMenuComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=qdp-search-join.umd.js.map
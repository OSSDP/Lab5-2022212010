...
var FilterManagerService = /** @class */ (function () {
     ...
     * @return {?}
     */
    function (filter$$1, queryRelativeUrl) {
        var _this = this;
        /** @type {?} */
        var restUri = this.host + this.uri + 'savefilter';
        /** @type {?} */
        var result$ = this.restService.post(restUri, filter$$1, {}, this.createHeaderSessionId());
        return result$.pipe(map((/**
         * @return {?}
         */
        function () {
            filter$$1.filter = JSON.parse(filter$$1.filter);
            if (Object.keys(_this.filterInfoList).indexOf(filter$$1.queryid)) {
                _this.filterInfoList[filter$$1.queryid] = filter$$1;
            }
        })));
    };
    /**

...
export declare class JointSearchService {
    private jointSearchManager;
    private lcpService;
    jointSearchInfo: Subject<any>;
    constructor(jointSearchManager: JointSearchManagerService, lcpService: LcpService);

...
export declare class PrintIntegrationService {
    private printIntegrationManager;
    printIntegrationInfo: Subject<any>;
    constructor(printIntegrationManager: PrintIntegrationManagerService);

...
export declare class ParasMappingService {
    private parasMappingManager;
    paramMappingInfo: Subject<any>;
    constructor(parasMappingManager: ParasMappingManagerService);

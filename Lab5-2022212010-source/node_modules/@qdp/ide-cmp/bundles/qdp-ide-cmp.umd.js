(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/Subject'), require('lodash-es'), require('@farris/command-services'), require('@ecp-caf/caf-common'), require('rxjs'), require('@qdp/common'), require('@qdp/localize'), require('@farris/ui-messager'), require('css-element-queries'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-input-group'), require('@farris/ui-flex-layout'), require('@farris/ui-dropdown'), require('@farris/ui-combo-list'), require('@farris/ui-dialog'), require('@farris/ui-notify'), require('@farris/ui-number-spinner'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-treetable'), require('@farris/ui-datagrid-editors'), require('@farris/ui-datagrid'), require('@farris/ui-tabs'), require('@farris/ui-language-textbox'), require('@farris/ui-section'), require('ngx-color-picker'), require('@gsp-sys/rtf-ui'), require('@gsp-sys/rtf-apphelp'), require('@farris/ui-panel'), require('@gsp-svc/expression')) :
    typeof define === 'function' && define.amd ? define('@qdp/ide-cmp', ['exports', 'rxjs/Subject', 'lodash-es', '@farris/command-services', '@ecp-caf/caf-common', 'rxjs', '@qdp/common', '@qdp/localize', '@farris/ui-messager', 'css-element-queries', '@angular/core', '@angular/common', '@angular/forms', '@farris/ui-input-group', '@farris/ui-flex-layout', '@farris/ui-dropdown', '@farris/ui-combo-list', '@farris/ui-dialog', '@farris/ui-notify', '@farris/ui-number-spinner', '@farris/ui-perfect-scrollbar', '@farris/ui-treetable', '@farris/ui-datagrid-editors', '@farris/ui-datagrid', '@farris/ui-tabs', '@farris/ui-language-textbox', '@farris/ui-section', 'ngx-color-picker', '@gsp-sys/rtf-ui', '@gsp-sys/rtf-apphelp', '@farris/ui-panel', '@gsp-svc/expression'], factory) :
    (factory((global.qdp = global.qdp || {}, global.qdp['ide-cmp'] = {}),global.rxjs.Subject,global.lodashEs,global.commandServices,global.cafCommon,global.rxjs,global.common,global.localize,global.uiMessager,global.cssElementQueries,global.ng.core,global.ng.common,global.ng.forms,global.uiInputGroup,global.uiFlexLayout,global.uiDropdown,global.uiComboList,global.uiDialog,global.uiNotify,global.uiNumberSpinner,global.uiPerfectScrollbar,global.uiTreetable,global.uiDatagridEditors,global.uiDatagrid,global.uiTabs,global.uiLanguageTextbox,global.uiSection,global.ngxColorPicker,global.rtfUi,global.rtfApphelp,global.uiPanel,global.expression));
}(this, (function (exports,Subject,lodashEs,commandServices,cafCommon,rxjs,common,localize,uiMessager,cssElementQueries,core,common$1,forms,uiInputGroup,uiFlexLayout,uiDropdown,uiComboList,uiDialog,uiNotify,uiNumberSpinner,uiPerfectScrollbar,uiTreetable,uiDatagridEditors,uiDatagrid,uiTabs,uiLanguageTextbox,uiSection,ngxColorPicker,rtfUi,rtfApphelp,uiPanel,expression) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var JointSearchService = /** @class */ (function () {
        function JointSearchService(jointSearchManager, lcpService) {
            ...
            this.jointSearchInfo = new rxjs.Subject();
        ...
        /** @nocollapse */
        JointSearchService.ctorParameters = function () {
            return [
                { type: common.JointSearchManagerService },
                { type: common.LcpService }
            ];
        };
    ...
    var JointSearchComponent = /** @class */ (function () {
        function JointSearchComponent(renderer, resolver, jointSearchService, injector) {
            ...
            if (this.injector) {
                ...
                this.expressionService = this.injector.get(expression.ExpressionService);
            ...
            function () {
                ...
                this.SubColumns = [
                    ...
                    // { field: 'jointsearchid', width: 100, title: self.localizeService.getValue('ideCmp.drillDown.columnHeader')[2], editor: { type: EditorTypes.TEXTBOX, options: {} } },
                    {
                        ...
                        editor: { type: uiDatagridEditors.EditorTypes.COMBOLIST, options: {
                    ...
                    { field: 'linkfield', width: 100, title: self.localizeService.getValue('ideCmp.drillDown.columnHeader')[6], visible: false, editor: { type: uiDatagridEditors.EditorTypes.TEXTBOX, options: {} } },
                    {
                        field: 'visibleformula', width: 100, title: self.localizeService.getValue('ideCmp.drillDown.columnHeader')[4],
                        editor: {
                            type: uiDatagridEditors.EditorTypes.INPUTGROUP, options: {
                ...
                this.paraColumns = [
                    { field: 'para', width: 100, title: self.localizeService.getValue('ideCmp.drillDown.paramColumnHeader')[0], editor: { type: uiDatagridEditors.EditorTypes.TEXTBOX, options: {} } },
                    { field: 'paraname', width: 100, title: self.localizeService.getValue('ideCmp.drillDown.paramColumnHeader')[1], editor: { type: uiDatagridEditors.EditorTypes.TEXTBOX, options: {} } },
                    { field: 'paravalue', width: 100, title: self.localizeService.getValue('ideCmp.drillDown.paramColumnHeader')[2], editor: { type: uiDatagridEditors.EditorTypes.TEXTBOX, options: {} } },
                    {
                        field: 'paravaluetype', width: 100, title: self.localizeService.getValue('ideCmp.drillDown.paramColumnHeader')[3], editor: { type: uiDatagridEditors.EditorTypes.CHECKBOX, options: {} },
         ...
         */
            function ($event) {
                ...
                if (this.dg.selectedRow) {
                    /** @type {?} */
                    var index = lodashEs.findIndex(this.functionSubDatas, ( /**
                     * @param {?} n
                     * @return {?}
                     */function (n) {
                    ...
                    self.functionSubDatas = __spread(self.functionSubDatas);
                }
            };
        /**
         * @private
                ...
                if (component) {
                    if (component.type === 'QdpFramework') {
                        if (component && component.params && component.params.length) {
                            try {
                                for (var _c = __values(component.params), _d = _c.next(); !_d.done; _d = _c.next()) {
                                    var field = _d.value;
                    ...
                    for (var i = 0; i < contents.length; i++) {
                        if (contents[i].type === 'QdpFramework') {
                            if (contents[i] && contents[i].params && contents[i].params.length) {
                                try {
                                    for (var _e = __values(contents[i].params), _f = _e.next(); !_f.done; _f = _e.next()) {
                                        var field = _f.value;
                                        this.viewModelFields.push(field.ParamCode);
                                    }
                                }
         ...
         */
            function () {
                ...
                if (self.functionSubDatas.length > 0) {
                    self.jointSearchService.savejointsearch({ Id: common.EventBus.guid(), joinsearch: JSON.stringify(self.functionSubDatas), jointparam: JSON.stringify(self.functionParaDatas), queryid: self.queryId, FormId: self.formId }, this.queryRelativeUrl).subscribe();
                }
                else {
         ...
         */
            function () {
                ...
                if (self.dg.selectedRow) {
                    ...
                    /** @type {?} */
                    var index = lodashEs.findIndex(self.functionSubDatas, ( /**
                     * @param {?} n
                     * @return {?}
                     */function (n) {
                        return n.id === id_1;
                    ...
                    if (self.functionSubDatas.length === 0) {
                        ...
                        (_a = self.functionParaDatas).push.apply(_a, __spread(params));
                    }
                    this.dg.refresh();
                    this.dg1.refresh();
                }
            ...
            function ($event) {
                ...
                if (self.dg.selectedRow) {
                    ...
                    if (staticParam) {
                        ...
                        try {
                            for (var staticParam_1 = __values(staticParam), staticParam_1_1 = staticParam_1.next(); !staticParam_1_1.done; staticParam_1_1 = staticParam_1.next()) {
                            ...
                            try {
                                if (staticParam_1_1 && !staticParam_1_1.done && (_a = staticParam_1.return))
                                    _a.call(staticParam_1);
                            }
                            finally {
                                if (e_3)
                                    throw e_3.error;
            ...
            function ($event) {
                ...
                if (self.dg.selectedRow) {
                    ...
                    if (staticParam) {
                        staticParam = JSON.parse(staticParam);
                        try {
                            for (var staticParam_2 = __values(staticParam), staticParam_2_1 = staticParam_2.next(); !staticParam_2_1.done; staticParam_2_1 = staticParam_2.next()) {
                            ...
                            try {
                                if (staticParam_2_1 && !staticParam_2_1.done && (_a = staticParam_2.return))
                                    _a.call(staticParam_2);
                            }
                            finally {
                                if (e_4)
                                    throw e_4.error;
         ...
         */
            function () {
                ...
                if (self.dg.selectedRow) {
                    ...
                    /** @type {?} */
                    var index_1 = lodashEs.findIndex(self.functionSubDatas, ( /**
                     * @param {?} n
                     * @return {?}
                     */function (n) {
                        return n.id === id_2;
                    ...
                    if (this.viewModelFields) {
                        try {
                            for (var _b = __values(this.viewModelFields), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var code = _c.value;
         ...
         */
            function () {
                ...
                if (self.dg1.selectedRow) {
                    /** @type {?} */
                    var index = lodashEs.findIndex(self.functionParaDatas, ( /**
                     * @param {?} n
                     * @return {?}
                     */function (n) {
                     ...
                     * @return {?}
                     */function (x) { return x.functionid === _this.selectedIndex; }));
                    self.functionParaDatasOfSub = __spread(self.functionParaDatasOfSub);
                }
            };
        ...
        /** @nocollapse */
        JointSearchComponent.ctorParameters = function () {
            return [
                { type: core.Renderer2 },
        ...
        JointSearchComponent.propDecorators = {
            ...
            dg1: [{ type: core.ViewChild, args: ['dg1',] }],
            farrisDialog: [{ type: core.ViewChild, args: ['farrisDialog',] }],
            appHelp: [{ type: core.ViewChild, args: ['appHelp',] }],
            rtfappHelp: [{ type: core.ViewChild, args: ['rtfappHelp',] }],
            functioncodeTemp: [{ type: core.ViewChild, args: ['functioncodeTemp',] }],
            functionNameTemp: [{ type: core.ViewChild, args: ['functionNameTemp',] }]
        };
    ...
    var ParasMappingService = /** @class */ (function () {
        function ParasMappingService(parasMappingManager) {
            ...
            this.paramMappingInfo = new rxjs.Subject();
        ...
        /** @nocollapse */
        ParasMappingService.ctorParameters = function () {
            return [
                { type: common.ParasMappingManagerService }
            ];
        };
    ...
    var ParasMappingComponent = /** @class */ (function () {
                ...
                this.columns = [
                    {
                        ...
                        editor: {
                            type: uiDatagridEditors.EditorTypes.COMBOLIST,
                            options: __assign({}, enumOpts, { idField: 'value' }),
                            validators: [
                    ...
                    },
                    {
                        ...
                        editor: {
                            type: uiDatagridEditors.EditorTypes.COMBOLIST,
                            options: __assign({}, enumOpts1, { idField: 'value' })
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        editor: {
                            type: uiDatagridEditors.EditorTypes.CHECKBOX
                        }
                    }
                ];
            };
         ...
         */
            function () {
                ...
                if (self.QueryInfoDatas && self.QueryInfoDatas.length) {
                    ...
                    self.saveDatas = { Id: common.EventBus.guid(), parasmapping: JSON.stringify({ value: JSON.stringify(self.QueryInfoDatas), queryparaData: JSON.stringify(self.queryparaData), sourceparaData: JSON.stringify(self.sourceparaData) }), queryid: self.queryId, datasourceid: self.qoManagerCode };
         ...
         */
            function ($event) {
                ...
                if (this.dg1.selectedRow) {
                    /** @type {?} */
                    var index = lodashEs.findIndex(this.QueryInfoDatas, ( /**
                     * @param {?} n
                     * @return {?}
        ...
        /** @nocollapse */
        ParasMappingComponent.ctorParameters = function () {
            return [
                { type: core.Renderer2 },
                { type: ParasMappingService },
                { type: uiMessager.MessagerService, decorators: [{ type: core.Optional }] },
                { type: core.Injector, decorators: [{ type: core.Optional }] }
            ];
        };
        ParasMappingComponent.propDecorators = {
            ...
            isMultiForm: [{ type: core.Input }],
            modalFooter: [{ type: core.ViewChild, args: ['enumFooter',] }],
            farrisDialog: [{ type: core.ViewChild, args: ['farrisDialog',] }],
            dg1: [{ type: core.ViewChild, args: ['dg1',] }],
            dg2: [{ type: core.ViewChild, args: ['dg2',] }]
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var PopupAnchorDirective = /** @class */ (function () {
        function PopupAnchorDirective(element) {
        ...
        /** @nocollapse */
        PopupAnchorDirective.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        return PopupAnchorDirective;
    }());
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var ChartsTypeComponent = /** @class */ (function () {
        function ChartsTypeComponent(injector) {
            this.injector = injector;
            this.chartsType = {
                series: {
                    type: null
         ...
         * @return {?}
         */
        ChartsTypeComponent.prototype.ngOnInit = /**
         * @return {?}
         */
            function () {
            };
         ...
         * @return {?}
         */
        ChartsTypeComponent.prototype.ngOnChanges = /**
         * @param {?} changes
         * @return {?}
         */
            function (changes) {
                        ...
                        switch (changeName) {
                            case 'currSchema':
                                if (newValue.schemaValue && newValue.schemaValue.chartsType) {
                                    /** @type {?} */
                                    var str = JSON.stringify(newValue.schemaValue.chartsType);
                                    this.chartsType = JSON.parse(str);
                                    /** @type {?} */
                                    var index = lodashEs.findIndex(this.chartsTypeData, ( /**
                                     * @param {?} c
                                     * @return {?}
         ...
         * @return {?}
         */
        ChartsTypeComponent.prototype.valueChange = /**
         * @param {?} value
         * @return {?}
         */
            function (value) {
         ...
         * @return {?}
         */
        ChartsTypeComponent.prototype.getChartsTypeOption = /**
         * @return {?}
         */
            function () {
        ...
        /** @nocollapse */
        ChartsTypeComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
        ChartsTypeComponent.propDecorators = {
            currSchema: [{ type: core.Input }],
            chartTypeChange: [{ type: core.Output }]
        };
        return ChartsTypeComponent;
    }());
    ...
    var ChartsDataComponent = /** @class */ (function () {
                            ...
                            case 'currSchema':
                                ...
                                if (this.chartsType !== 'effectScatter' && this.chartsType !== 'pie' && this.chartsType !== 'map') {
                                    if (newValue.schemaValue && newValue.schemaValue.chartsData) {
                                        ...
                                        /** @type {?} */
                                        var index = lodashEs.findIndex(this.axisTypeData, ( /**
                                         * @param {?} c
                                         * @return {?}
                                         */function (c) {
                                        ...
                                        index = lodashEs.findIndex(this.axisTypeData, ( /**
                                         * @param {?} c
                                         * @return {?}
                                         */function (c) {
                                        ...
                                        index = lodashEs.findIndex(this.xPositionData, ( /**
                                         * @param {?} c
                                         * @return {?}
                                         */function (c) {
                                        ...
                                        index = lodashEs.findIndex(this.yPositionData, ( /**
                                         * @param {?} c
                                         * @return {?}
                                         */function (c) {
         ...
         */
            function (type) {
                ...
                if (type === 'dimension') {
                    ...
                    index = lodashEs.findIndex(this.dimensionFieldList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.indicatorFieldList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.xAxisBindingFeildList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.yAxisBindingFeildList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.firstBindingFeildList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.secondBindingFeildList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.thirdBindingFeildList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.fourthBindingFeildList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    index = lodashEs.findIndex(this.fifthBindingFeildList, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
        ...
        /** @nocollapse */
        ChartsDataComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
        ChartsDataComponent.propDecorators = {
            currSchema: [{ type: core.Input }],
            chartsType: [{ type: core.Input }],
            colList: [{ type: core.Input }]
        };
    ...
    var ChartsStyleComponent = /** @class */ (function () {
                        ...
                        switch (changeName) {
                            case 'currSchema':
                                ...
                                if (newValue.schemaValue && newValue.schemaValue.chartsStyle) {
                                    ...
                                    /** @type {?} */
                                    var index = lodashEs.findIndex(this.xAxisAlignData, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
                                    ...
                                    index = lodashEs.findIndex(this.yAxisAlignData, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
                                    ...
                                    index = lodashEs.findIndex(this.fontFamilyData, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
                                    ...
                                    index = lodashEs.findIndex(this.legendAlignData, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
                                    ...
                                    index = lodashEs.findIndex(this.orientData, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
                                    ...
                                    index = lodashEs.findIndex(this.visualMapTypeData, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
                                    ...
                                    index = lodashEs.findIndex(this.dataMultiple, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
                                    ...
                                    index = lodashEs.findIndex(this.xAxisAlignData, ( /**
                                     * @param {?} c
                                     * @return {?}
                                     */function (c) {
         ...
         */
            function (type) {
                ...
                if (type === 'c') {
                    ...
                    index = lodashEs.findIndex(this.visualMapCategories, ( /**
                     * @param {?} c
                     * @return {?}
                     */function (c) {
                    ...
                    if (this.vmPiecesMin && !this.vmPiecesMax) {
                        index = lodashEs.findIndex(this.visualMapPieces, ( /**
                         * @param {?} c
                         * @return {?}
                         */function (c) {
        ...
        /** @nocollapse */
        ChartsStyleComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
    ...
    var ChartsSchemaEditorComponent = /** @class */ (function () {
        function ChartsSchemaEditorComponent(injector) {
            ...
            this.tabsSelectChange = new core.EventEmitter();
            this.localizeService = this.injector.get(localize.LocalizeService);
        }
        /**
         * @return {?}
        ...
        /** @nocollapse */
        ChartsSchemaEditorComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
        ChartsSchemaEditorComponent.propDecorators = {
            ...
            tabsSelectChange: [{ type: core.Output }],
            chartsTypeCmp: [{ type: core.ViewChild, args: [ChartsTypeComponent,] }],
            chartsDataCmp: [{ type: core.ViewChild, args: [ChartsDataComponent,] }],
            chartsStyleCmp: [{ type: core.ViewChild, args: [ChartsStyleComponent,] }],
            tabs: [{ type: core.ViewChild, args: [uiTabs.FarrisTabsComponent,] }]
        };
    ...
    var SchemaService = /** @class */ (function () {
        function SchemaService(schemaManager, lcpService) {
            ...
            this.lcpService = lcpService;
            this.schemaInfo = new Subject.Subject();
            this.colList = new Subject.Subject();
            this.pageInfoChange = new Subject.Subject();
            this.operationChange = new Subject.Subject();
    ...
    var TitleEditorComponent = /** @class */ (function () {
        function TitleEditorComponent(injector) {
            ...
            this.localizeService = this.injector.get(localize.LocalizeService);
            this.lcpService = this.injector.get(common.LcpService);
         ...
         */
            function () {
                this.subTitles = __spread(this.subTitles);
        ...
        /** @nocollapse */
        TitleEditorComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
    ...
    var ColumnEditorComponent = /** @class */ (function () {
        function ColumnEditorComponent(injector) {
            ...
            this.cols = [];
            this.colIsGroupId = 'colIsGroupId' + common.EventBus.guid();
            this.colVisibleId = 'colVisibleId' + common.EventBus.guid();
            this.colFixedId = 'colFixedId' + common.EventBus.guid();
            this.colWrapId = 'colWrapId' + common.EventBus.guid();
            this.colAutoFitId = 'colAutoFitId' + common.EventBus.guid();
            this.colIsRedId = 'colIsRedId' + common.EventBus.guid();
            ...
            this.formInline = this.localId.toLowerCase() === localize.DEFAULT_LANGUAGE || this.localId.toLowerCase() === 'zh-cht';
         ...
         */
            function () {
                ...
                /** @type {?} */
                var eventId = common.RtfServices.getTabId(queryId);
                common.EventBus.register('pagingModeChanges', this.handlePagingModeChanged.bind(this), eventId);
            };
        /**
         * @param {?} changes
         * @return {?}
         ...
         */
            function () {
                ...
                node.data.id = common.EventBus.guid();
            ...
            function () {
                ...
                if (this.currTreeNode) {
                    if (this.currTreeNode.parent) {
                        /** @type {?} */
                        var index = lodashEs.findIndex(this.currTreeNode.parent.children, ( /**
                         * @param {?} n
                         * @return {?}
                        ...
                        /** @type {?} */
                        var index = lodashEs.findIndex(this.schemaTreeData, ( /**
                         * @param {?} n
                         * @return {?}
                         */function (n) { return n.data.id === self.currTreeNode.data.id; }));
         ...
         */
            function () {
                ...
                if (this.currTreeNode && this.currTreeNode.parent) {
                    ...
                    if (index >= 0) {
                        /** @type {?} */
                        var childIndex = lodashEs.findIndex(self_1.currTreeNode.parent.children, ( /**
                         * @param {?} n
                         * @return {?}
         ...
         */
            function (children, type) {
                ...
                var self = this;
                /** @type {?} */
                var index = lodashEs.findIndex(children, ( /**
                 * @param {?} n
                 * @return {?}
                 */function (n) { return n.data.id === self.currTreeNodeId; }));
                if (index >= 0) {
         ...
         */
            function (children) {
                ...
                if (this.currTreeNode && this.currTreeNode.parent) {
                    ...
                    if (index >= 0) {
                        /** @type {?} */
                        var childIndex = lodashEs.findIndex(self_3.currTreeNode.parent.children, ( /**
                         * @param {?} n
                         * @return {?}
         ...
         */
            function (id) {
                return lodashEs.find(this.editable, ( /**
                 * @param {?} item
                 * @return {?}
        ...
        /** @nocollapse */
        ColumnEditorComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
        ColumnEditorComponent.propDecorators = {
            ...
            colList: [{ type: core.Input }],
            controlType: [{ type: core.Input }],
            colToolbar: [{ type: core.ViewChild, args: ['colToolbar',] }],
            schemaTree: [{ type: core.ViewChild, args: ['schemaTree',] }],
            nameCell: [{ type: core.ViewChild, args: ['nameCell',] }],
            bindFieldCell: [{ type: core.ViewChild, args: ['bindFieldCell',] }],
            colWidthCell: [{ type: core.ViewChild, args: ['colWidthCell',] }],
            colAlignCell: [{ type: core.ViewChild, args: ['colAlignCell',] }],
            visibleCell: [{ type: core.ViewChild, args: ['visibleCell',] }],
            isFixedCell: [{ type: core.ViewChild, args: ['isFixedCell',] }],
            autoFixCell: [{ type: core.ViewChild, args: ['autoFixCell',] }]
        };
    ...
    var StyleEditorComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        StyleEditorComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
    ...
    var OtherEditorComponent = /** @class */ (function () {
        function OtherEditorComponent(injector) {
            this.injector = injector;
            this.isCache = 'isCache' + common.EventBus.guid();
            this.firstLoadId = 'firstLoadId' + common.EventBus.guid();
            this.size = {};
            this.dataCache = true;
            this.firstLoad = true;
            this.pageTypeData = [
            ...
            this.mergeCell = true;
            this.isRowGroup = 'isRowGroup' + common.EventBus.guid();
            this.isColGroup = 'isColGroup' + common.EventBus.guid();
            this.isRowSum = 'isRowSum' + common.EventBus.guid();
            this.isColSum = 'isColSum' + common.EventBus.guid();
            this.isExpand = 'isExpand' + common.EventBus.guid();
            this.isShowZero = 'isShowZero' + common.EventBus.guid();
            this.filterRowId = 'filterRowId' + common.EventBus.guid();
            this.showHeaderSortId = 'showHeaderSortId' + common.EventBus.guid();
            this.mergeCellId = 'mergeCellId' + common.EventBus.guid();
            this.localizeService = this.injector.get(localize.LocalizeService);
            this.localId = this.injector.get(core.LOCALE_ID) || localize.DEFAULT_LANGUAGE;
         ...
         */
            function ($event) {
                common.EventBus.dispatch('pagingModeChanges', $event);
            };
        ...
        /** @nocollapse */
        OtherEditorComponent.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
    ...
    var SchemaEditorComponent = /** @class */ (function () {
        ...
        SchemaEditorComponent.propDecorators = {
            ...
            controlType: [{ type: core.Input }],
            tabsSelectChange: [{ type: core.Output }],
            titleOption: [{ type: core.ViewChild, args: [TitleEditorComponent,] }],
            columnOption: [{ type: core.ViewChild, args: [ColumnEditorComponent,] }],
            styleOption: [{ type: core.ViewChild, args: [StyleEditorComponent,] }],
            otherOption: [{ type: core.ViewChild, args: [OtherEditorComponent,] }],
            tabs: [{ type: core.ViewChild, args: [uiTabs.FarrisTabsComponent,] }]
        };
    ...
    var SchemaManagerComponent = /** @class */ (function () {
        function SchemaManagerComponent(schemaService, msgService, notifyService, injector) {
            ...
            this.injector = injector;
            this.editorParams = {};
            this.schemaSelected = new core.EventEmitter();
            this.saveSchema = new core.EventEmitter();
            this.saveAsSchema = new core.EventEmitter();
            this.removeSchema = new core.EventEmitter();
            this.saveAndCloseSchema = new core.EventEmitter();
            this.dialogBeforeClose = new core.EventEmitter();
            this.closeModal = new core.EventEmitter();
            // 模态框确定后关闭，并传递参数
            this.submitModal = new core.EventEmitter();
            ...
            this.size = {};
            this.isShow = false;
            this.personSchema = 'personSchema' + common.EventBus.guid();
            this.orgSchema = 'orgSchema' + common.EventBus.guid();
            this.publicSchema = 'publicSchema' + common.EventBus.guid();
            this.defaultSchema = 'defaultSchema' + common.EventBus.guid();
            this.schemaTreeData = [
                {
                    data: {
                        id: 'public_schema',
            ...
            this.personSchema = this.personSchema + common.EventBus.guid();
            this.publicSchema = this.publicSchema + common.EventBus.guid();
            this.defaultSchema = this.defaultSchema + common.EventBus.guid();
            if (this.injector) {
                this.localizeService = this.injector.get(localize.LocalizeService);
         ...
         */
            function () {
                ...
                common.EventBus.register('openAdvanceTemplateDialog', this.initSelectedSchemaId.bind(this), this.tabId);
        ...
        /** @nocollapse */
        SchemaManagerComponent.ctorParameters = function () {
            return [
                { type: SchemaService },
        ...
        SchemaManagerComponent.propDecorators = {
            ...
            schemaInfo: [{ type: core.Input }],
            colList: [{ type: core.Input }],
            controlType: [{ type: core.Input }],
            showPreSchema: [{ type: core.Input }],
            editorParams: [{ type: core.Input }],
            isMultiForm: [{ type: core.Input }],
            schemaTree: [{ type: core.ViewChild, args: ['schemaTree',] }],
            modalFooter: [{ type: core.ViewChild, args: ['enumFooter',] }],
            schemaEditor: [{ type: core.ViewChild, args: [SchemaEditorComponent,] }],
            chartsSchemaEditor: [{ type: core.ViewChild, args: [ChartsSchemaEditorComponent,] }],
            farrisPanelComponent: [{ type: core.ViewChild, args: [uiPanel.FarrisPanelComponent,] }],
            farrisDialog: [{ type: core.ViewChild, args: ['farrisDialog',] }],
            schemaSelected: [{ type: core.Output }],
            saveSchema: [{ type: core.Output }],
            saveAsSchema: [{ type: core.Output }],
            removeSchema: [{ type: core.Output }],
            saveAndCloseSchema: [{ type: core.Output }],
            dialogBeforeClose: [{ type: core.Output }],
            closeModal: [{ type: core.Output }],
            submitModal: [{ type: core.Output }],
            queryRelativeUrl: [{ type: core.Input }]
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var PrintIntegrationService = /** @class */ (function () {
        function PrintIntegrationService(printIntegrationManager) {
            var _this = this;
            this.printIntegrationManager = printIntegrationManager;
            this.printIntegrationInfo = new rxjs.Subject();
            this.printIntegrationManager.printIntegrationInfoChange.subscribe(( /**
             * @param {?} value
             * @return {?}
             */function (value) {
                _this.printIntegrationInfo.next(value);
            }));
        }
        /**
         * @param {?} schemaId
         ...
         * @return {?}
         */
        PrintIntegrationService.prototype.getPrintIntegration = /**
         * @param {?} schemaId
         * @param {?} queryId
         * @param {?} queryRelativeUrl
         * @return {?}
         ...
         * @return {?}
         */
        PrintIntegrationService.prototype.savePrintIntegration = /**
         * @param {?} printIntegrationInfo
         * @param {?} queryRelativeUrl
         * @return {?}
         */
            function (printIntegrationInfo, queryRelativeUrl) {
         ...
         * @return {?}
         */
        PrintIntegrationService.prototype.deletPrintIntegration = /**
         * @param {?} schemaId
         * @param {?} queryID
         * @param {?} queryRelativeUrl
         * @return {?}
        ...
        /** @nocollapse */
        PrintIntegrationService.ctorParameters = function () {
            return [
                { type: common.PrintIntegrationManagerService }
            ];
        };
        return PrintIntegrationService;
    }());
    ...
    var PrintIntegrationComponent = /** @class */ (function () {
        function PrintIntegrationComponent(printIntegrationService, cache, injector) {
            ...
            this.injector = injector;
            // 是否嵌入式表单
            this.printIntegration = new core.EventEmitter();
            this.printPreview = new core.EventEmitter();
            this.dialogBeforeClose = new core.EventEmitter();
             ...
             */function () {
                ...
                if (self.printIntegrationData) {
                    // tslint:disable-next-line:max-line-length
                    self.saveDatas = { Id: common.EventBus.guid(), printintegration: JSON.stringify(self.printIntegrationData), queryid: self.queryId, schemaId: self.schemaId };
        ...
        /** @nocollapse */
        PrintIntegrationComponent.ctorParameters = function () {
            return [
        ...
        PrintIntegrationComponent.propDecorators = {
            ...
            controlType: [{ type: core.Input }],
            isMultiForm: [{ type: core.Input }],
            printIntegration: [{ type: core.Output }],
            printPreview: [{ type: core.Output }],
            queryRelativeUrl: [{ type: core.Input }],
            dialogBeforeClose: [{ type: core.Output }],
            farrisDialog: [{ type: core.ViewChild, args: ['farrisDialog',] }]
        };
    ...
    var ResizedDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                new cssElementQueries.ResizeSensor(this.element.nativeElement, ( /**
                 * @param {?} x
                 * @return {?}
    ...
    exports.JointSearchComponent = JointSearchComponent;
    exports.ParasMappingComponent = ParasMappingComponent;
    exports.PopupAnchorDirective = PopupAnchorDirective;
    exports.ChartsSchemaEditorComponent = ChartsSchemaEditorComponent;
    exports.ChartsTypeComponent = ChartsTypeComponent;
    exports.ChartsDataComponent = ChartsDataComponent;
    exports.ChartsStyleComponent = ChartsStyleComponent;
    exports.SchemaManagerComponent = SchemaManagerComponent;
    exports.SchemaEditorComponent = SchemaEditorComponent;
    exports.ColumnEditorComponent = ColumnEditorComponent;
    exports.TitleEditorComponent = TitleEditorComponent;
    exports.StyleEditorComponent = StyleEditorComponent;
    exports.OtherEditorComponent = OtherEditorComponent;
    exports.PrintIntegrationComponent = PrintIntegrationComponent;
    exports.ParasMappingService = ParasMappingService;
    exports.JointSearchService = JointSearchService;
    exports.SchemaService = SchemaService;
    exports.PrintIntegrationService = PrintIntegrationService;
    exports.ResizedEvent = ResizedEvent;
    exports.ResizedDirective = ResizedDirective;
    exports.IdeCmpModule = IdeCmpModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=qdp-ide-cmp.umd.js.map
...
export declare class BillTrackingSettings extends JsonConvertableImpl {
    billNodeName: string;
    billTrackingNodeShownMode: BillTrackingNodeShownMode;
    billNodeShownStyle: string;
    summaryFieldsInfo: string;
    billTrackingDataShownMode: BillTrackingDataShownMode;
    customFieldContent: string;

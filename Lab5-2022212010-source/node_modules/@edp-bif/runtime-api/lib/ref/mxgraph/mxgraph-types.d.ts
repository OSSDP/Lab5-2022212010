...
export declare namespace MxGraphNS {
    function escape(s: string): string;
    function unescape(s: string): string;
    var Base64: any;
    var mxBasePath: string;
    var mxImageBasePath: string;
    var mxLanguage: string;
    var mxLanguages: string[];
    var mxDefaultLanguage: string;
    var mxLoadResources: boolean;
    var mxLoadStylesheets: boolean;
    var mxForceIncludes: boolean;
    var mxResourceExtension: string;
    var mxClient: {
        /**
         * Class: mxClient
         *
    ...
    var mxUtils: {
         ...
         */
        makeDraggable(element: HTMLElement, graphF: mxGraph, funct: Function, dragElement?: HTMLElement, dx?: number, dy?: number, autoscroll?: boolean, scalePreview?: boolean, highlightDropTargets?: boolean, getDropTarget?: (x: number, y: number) => mxCell): mxDragSource;
        /**
         * Function: setOpacity
         *
    ...
    /**
        ...
        */
    function mxPanningManager(graph: any): void;
    /**

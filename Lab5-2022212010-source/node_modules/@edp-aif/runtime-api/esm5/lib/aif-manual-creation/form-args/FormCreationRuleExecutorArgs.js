...
FormCreationRuleExecutorArgs = /** @class */ (function (_super) {
    tslib_1.__extends(FormCreationRuleExecutorArgs, _super);
 ...
 * 表单手工生单时执行生单规则参数类。
 */
export { FormCreationRuleExecutorArgs };
if (false) {
    /**
     * 生单规则ID
     * @type {?}

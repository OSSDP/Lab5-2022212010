...
import { QuerySolutionVo, QuerySolutionExtendVo, SolutionService, QuerySolutionVoConvertor, ConvertorService, ControlType, QueryConditionModule } from '@farris/component-querycondition';
...
import { Component, Output, EventEmitter, ViewChild, HostBinding, ViewEncapsulation, Input, Injectable, InjectionToken, ComponentFactoryResolver, Injector, InjectFlags, ElementRef, ChangeDetectorRef, NgZone, NgModule } from '@angular/core';
 ...
 */
/** @type {?} */
var QUERYSOLUTION_HANDLER_TOKEN = new InjectionToken('gsp-cmp/I_QUERYSOLUTION_HANDLER');
                    ...
                    if (_this.enableHistory && _this.historyRefer['initCondition']) {
                        ...
                        if (_this.defaultQuerySolution && _this.defaultQuerySolution.id != '') {
                            ...
                            if (publicSolution) {
                                ...
                                _this.selectedSolution = !!orgSolution ? orgSolution : cloneDeep(__spread(_this.querySolutionVos, _this.querySolutionAdvancedVos)[0]);
                            }
                        }
                        if (_this.querySolutionVos.length < 1) {
                            _this.querySolutionVos.push(_this.sysQuerySolutionVo);
    ...
    */
    ...
    function () {
        ...
        function (data) {
            ...
            _this.manageDialog.show(cloneDeep(__spread(_this.querySolutionVos, _this.querySolutionAdvancedVos)));
        }));
    };
    /**
     * 管理界面确定处理

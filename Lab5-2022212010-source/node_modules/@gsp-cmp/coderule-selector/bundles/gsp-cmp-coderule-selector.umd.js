(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('@progress/kendo-angular-treeview'), require('@progress/kendo-angular-grid'), require('@angular/common/http'), require('@angular/core'), require('@progress/kendo-data-query')) :
    typeof define === 'function' && define.amd ? define('@gsp-cmp/coderule-selector', ['exports', '@angular/common', '@angular/forms', '@progress/kendo-angular-treeview', '@progress/kendo-angular-grid', '@angular/common/http', '@angular/core', '@progress/kendo-data-query'], factory) :
    (factory((global['gsp-cmp'] = global['gsp-cmp'] || {}, global['gsp-cmp']['coderule-selector'] = {}),global.ng.common,global.ng.forms,global.kendoAngularTreeview,global.kendoAngularGrid,global.ng.common.http,global.ng.core,global.kendoDataQuery));
}(this, (function (exports,common,forms,kendoAngularTreeview,kendoAngularGrid,http,core,kendoDataQuery) { 'use strict';
    ...
    var CodeRuleSelectService = /** @class */ (function () {
        function CodeRuleSelectService(http$$1) {
            this.http = http$$1;
        ...
        /** @nocollapse */
        CodeRuleSelectService.ctorParameters = function () {
            return [
    ...
    var SelectCodeRuleComponent = /** @class */ (function () {
        function SelectCodeRuleComponent(codeRuleSvc, resolver, injector) {
            ...
            this.codeRuleSelected = new core.EventEmitter();
            this.selectorClosed = new core.EventEmitter();
        }
        ...
        /** @nocollapse */
        SelectCodeRuleComponent.ctorParameters = function () {
            return [
        ...
        SelectCodeRuleComponent.propDecorators = {
            serviceUnit: [{ type: core.Input }],
            sessionId: [{ type: core.Input }],
            selectorClosed: [{ type: core.Output }],
            codeRuleSelected: [{ type: core.Output }]
        };
    ...
    var CodeRuleListComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CodeRuleListComponent.ctorParameters = function () {
            return [
                { type: CodeRuleSelectService }
            ];
        };
    ...
    exports.CodeRuleSelectModule = CodeRuleSelectModule;
    exports.SelectCodeRuleComponent = SelectCodeRuleComponent;
    exports.CodeRuleInvokeInfo = CodeRuleInvokeInfo;
    exports.CodeRuleSelectService = CodeRuleSelectService;
    exports.ɵa = CodeRuleListComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gsp-cmp-coderule-selector.umd.js.map
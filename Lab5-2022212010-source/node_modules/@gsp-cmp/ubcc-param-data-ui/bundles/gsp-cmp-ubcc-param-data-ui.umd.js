(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/forms'), require('@progress/kendo-angular-buttons'), require('@gsp-sys/rtf-common'), require('@farris/ui-input-group'), require('@farris/ui-loading'), require('@farris/ui-dialog'), require('@farris/ui-combo-list'), require('@farris/ui-button'), require('@farris/ui-datepicker'), require('@farris/ui-section'), require('@farris/ui-number-spinner'), require('@farris/ui-messager'), require('@farris/ui-notify'), require('@angular/common/http'), require('@ecp-caf/caf-common'), require('rxjs'), require('@gsp-lcm/metadatart-selector'), require('@farris/ui-lookup'), require('@farris/ui-modal'), require('@angular/core'), require('@gsp-cmp/ubcc-param-vo'), require('@ecp-caf/common-structure'), require('@farris/ui-tooltip'), require('@farris/ui-panel')) :
    typeof define === 'function' && define.amd ? define('@gsp-cmp/ubcc-param-data-ui', ['exports', '@angular/common', '@angular/forms', '@progress/kendo-angular-buttons', '@gsp-sys/rtf-common', '@farris/ui-input-group', '@farris/ui-loading', '@farris/ui-dialog', '@farris/ui-combo-list', '@farris/ui-button', '@farris/ui-datepicker', '@farris/ui-section', '@farris/ui-number-spinner', '@farris/ui-messager', '@farris/ui-notify', '@angular/common/http', '@ecp-caf/caf-common', 'rxjs', '@gsp-lcm/metadatart-selector', '@farris/ui-lookup', '@farris/ui-modal', '@angular/core', '@gsp-cmp/ubcc-param-vo', '@ecp-caf/common-structure', '@farris/ui-tooltip', '@farris/ui-panel'], factory) :
    (factory((global['gsp-cmp'] = global['gsp-cmp'] || {}, global['gsp-cmp']['ubcc-param-data-ui'] = {}),global.ng.common,global.ng.forms,global.kendoAngularButtons,global.rtfCommon,global.uiInputGroup,global.uiLoading,global.uiDialog,global.uiComboList,global.uiButton,global.uiDatepicker,global.uiSection,global.uiNumberSpinner,global.i1,global.i2,global.ng.common.http,global.i2$1,global.rxjs,global.metadatartSelector,global.uiLookup,global.uiModal,global.ng.core,global.ubccParamVo,global.commonStructure,global.uiTooltip,global.uiPanel));
}(this, (function (exports,common,forms,kendoAngularButtons,rtfCommon,uiInputGroup,uiLoading,uiDialog,uiComboList,uiButton,uiDatepicker,uiSection,uiNumberSpinner,i1,i2,i1$1,i2$1,rxjs,metadatartSelector,uiLookup,uiModal,i0,ubccParamVo,commonStructure,uiTooltip,uiPanel) { 'use strict';
    ...
    var UbccParamDataUiComponent = /** @class */ (function () {
         ...
         */
            function () {
                this.template = this.template || new ubccParamVo.UbccParamTemplate();
         ...
         */
            function (param) {
                ...
                if (param.parameterType.getKind() === commonStructure.DataTypeConst.DEFAULT_COLLECTION) {
                    return true;
                }
                else {
                    return false;
    ...
    var UbccParamDataManangerService = /** @class */ (function () {
        function UbccParamDataManangerService(http, cache) {
            this.http = http;
            this.cache = cache;
            this.httpHeaders = new i1$1.HttpHeaders();
        ...
        /** @nocollapse */
        UbccParamDataManangerService.ctorParameters = function () {
            return [
                { type: i1$1.HttpClient },
                { type: i2$1.SessionService }
            ];
        };
        /** @nocollapse */ UbccParamDataManangerService.ngInjectableDef = i0.defineInjectable({ factory: function UbccParamDataManangerService_Factory() { return new UbccParamDataManangerService(i0.inject(i1$1.HttpClient), i0.inject(i2$1.SessionService)); }, token: UbccParamDataManangerService, providedIn: "root" });
    ...
    var UbccParamDataUtils = /** @class */ (function () {
         ...
         */
            function (dataType) {
                ...
                if (kind === ubccParamVo.DataTypeExtensionConst.UBCC_STRUCTURE_TYPE_REF) {
                    /** @type {?} */
                    var refType = ( /** @type {?} */(dataType));
                    if (refType.type === ubccParamVo.StructureTypeRefEnum.HELP) {
                        return true;
                    }
                    else {
                        return false;
        ...
        UbccParamDataUtils.prototype.getCollectionElementType =
            ...
            function (dataType) {
                ...
                var kind = dataType.getKind();
                switch (kind) {
                    case commonStructure.DataTypeConst.DEFAULT_COLLECTION:
                        /** @type {?} */
         ...
         */
            function (dataType) {
                ...
                if (dataType.getKind() === commonStructure.DataTypeConst.DEFAULT_COLLECTION) {
                    return true;
                }
                else {
                    return false;
        ...
        /** @nocollapse */
        UbccParamDataUtils.ctorParameters = function () {
            return [
    ...
    var UbccParamDataUiDialogComponent = /** @class */ (function () {
         ...
         */
            function (templateId) {
                 ...
                 */function (vo) {
                    ...
                    /** @type {?} */
                    var serializer = new ubccParamVo.UbccParamTemplateSerializer();
        ...
        /** @nocollapse */
        UbccParamDataUiDialogComponent.ctorParameters = function () {
            return [
    ...
    var UbccParamDimensionUiRootComponent = /** @class */ (function () {
        ...
        UbccParamDimensionUiRootComponent.propDecorators = {
            template: [{ type: i0.Input }],
            dimensionItemDatas: [{ type: i0.Input }],
            paramDataItems: [{ type: i0.Input }],
            canEdit: [{ type: i0.Input }]
        };
    ...
    var UbccParamDataUiRootComponent = /** @class */ (function () {
        function UbccParamDataUiRootComponent(utils, ebsService, http, resolver) {
            ...
            this.templateSerializer = new ubccParamVo.UbccParamTemplateSerializer();
            this.assignmentSerializer = new ubccParamVo.UbccParamTemplateAssignmentSerializer();
         ...
         */
            function () {
                this._assignment = this._assignment || new ubccParamVo.UbccParamTemplateAssignment();
                this.template = this.template || new ubccParamVo.UbccParamTemplate();
            };
        /**
         * @return {?}
         ...
         */
            function () {
                 ...
                 */function (x) {
                    /** @type {?} */
                    var dimensionValue = new ubccParamVo.DataItem();
         ...
         */
            function () {
                 ...
                 */function (x) {
                    /** @type {?} */
                    var paramValue = new ubccParamVo.DataItem();
         ...
         */
            function (dataType) {
                ...
                var kind = dataType.getKind();
                switch (kind) {
                    case commonStructure.DataTypeConst.DEFAULT_PRIMITIVE:
                        return commonStructure.DataTypeConst.DEFAULT_PRIMITIVE + "." + (( /** @type {?} */(dataType))).primitiveTypeKind;
                    case commonStructure.DataTypeConst.DEFAULT_ENUMERATION:
                        return commonStructure.DataTypeConst.DEFAULT_ENUMERATION;
                    case ubccParamVo.DataTypeExtensionConst.HELP_TYPE:
                        return ubccParamVo.DataTypeExtensionConst.HELP_TYPE + ("##" + (( /** @type {?} */(dataType))).helpId);
                    default:
            ...
            function (dataType) {
                ...
                switch (kind) {
                    case commonStructure.DataTypeConst.DEFAULT_COLLECTION:
                        ...
                        return commonStructure.DataTypeConst.DEFAULT_COLLECTION + "." + this.getParamValueType(elemetType);
                    case commonStructure.DataTypeConst.DEFAULT_PRIMITIVE:
                        return commonStructure.DataTypeConst.DEFAULT_PRIMITIVE + "." + commonStructure.PrimitiveTypeKind[(( /** @type {?} */(dataType))).primitiveTypeKind];
                    case ubccParamVo.DataTypeExtensionConst.UBCC_STRUCTURE_TYPE_REF:
                        /** @type {?} */
                        var refType = ( /** @type {?} */(dataType));
                        return refType.type === ubccParamVo.StructureTypeRefEnum.HELP ? ubccParamVo.DataTypeExtensionConst.HELP_TYPE + ("##" + refType.refId) : commonStructure.DataTypeConst.DEFAULT_ENUMERATION;
                    default:
                        throw new Error("\u4E1A\u52A1\u53C2\u6570\u4E0D\u652F\u6301\u7684\u53C2\u6570\u7C7B\u578B" + kind);
                }
            };
        ...
        /** @nocollapse */
        UbccParamDataUiRootComponent.ctorParameters = function () {
            return [
                { type: UbccParamDataUtils },
        ...
        UbccParamDataUiRootComponent.propDecorators = {
            ...
            canEdit: [{ type: i0.Input }],
            paramDataPanel: [{ type: i0.ViewChild, args: ['paramDataPanel', { read: i0.ViewContainerRef },] }]
        };
    ...
    var LookUpHttpService = /** @class */ (function () {
        function LookUpHttpService(http, cache) {
            this.http = http;
            this.cache = cache;
            this.httpHeaders = new i1$1.HttpHeaders().set("sessionid", this.cache.getUserSessionId());
            this.httpHeaders = new i1$1.HttpHeaders();
            this.httpHeaders.set("sessionid", this.cache.getUserSessionId());
        }
        /**
        ...
        /** @nocollapse */
        LookUpHttpService.ctorParameters = function () {
            return [
                { type: i1$1.HttpClient },
                { type: i2$1.SessionService }
            ];
    ...
    var DimensionLookupControlComponent = /** @class */ (function () {
        ...
        DimensionLookupControlComponent.decorators = [
            { type: i0.Component, args: [{
                        ...
                        providers: [{ provide: uiLookup.ServerSideToken, useClass: LookUpHttpService }, metadatartSelector.GSPMetadataRTService],
                        styles: [""]
                    }] }
        ];
        /** @nocollapse */
        DimensionLookupControlComponent.ctorParameters = function () {
            return [
    ...
    var DimensionDropdownlistControlComponent = /** @class */ (function () {
        function DimensionDropdownlistControlComponent(ebsService) {
            this.ebsService = ebsService;
            this.valueChangeEmit = new i0.EventEmitter();
        ...
        /** @nocollapse */
        DimensionDropdownlistControlComponent.ctorParameters = function () {
            return [
                { type: UbccEventBusService }
            ];
        };
        DimensionDropdownlistControlComponent.propDecorators = {
            dimensionItem: [{ type: i0.Input }],
            valueChangeEmit: [{ type: i0.Output }]
        };
    ...
    var DimensionInputControlComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        DimensionInputControlComponent.ctorParameters = function () {
            return [
                { type: UbccEventBusService }
            ];
        };
    ...
    var CheckboxControlComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CheckboxControlComponent.ctorParameters = function () {
            return [
                { type: UbccParamDataUtils }
            ];
        };
    ...
    var DropdownlistControlComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.param.parameterType.kind === commonStructure.DataTypeConst.DEFAULT_COLLECTION) {
                    /** @type {?} */
                    var elementType = this.getCollectionElementType(this.param.parameterType);
                    this.get(elementType);
                }
                else if (this.param.parameterType.kind === ubccParamVo.DataTypeExtensionConst.UBCC_STRUCTURE_TYPE_REF) {
                    /** @type {?} */
         ...
         */
            function () {
                ...
                if (this.param.parameterType.getKind() === commonStructure.DataTypeConst.DEFAULT_COLLECTION) {
                    return true;
                }
                else {
                    return false;
    ...
    var LookupControlComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        LookupControlComponent.ctorParameters = function () {
            return [
                { type: metadatartSelector.GSPMetadataRTService }
            ];
        };
    ...
    var UbccParamDataUiService = /** @class */ (function () {
        ...
        /** @nocollapse */
        UbccParamDataUiService.ctorParameters = function () {
            return [
                { type: i0.ComponentFactoryResolver },
                { type: i0.Injector },
                { type: UbccParamDataUtils },
    ...
    exports.UbccParamDataUiComponent = UbccParamDataUiComponent;
    exports.UbccParamDataUiRootModule = UbccParamDataUiRootModule;
    exports.UbccParamDataManangerService = UbccParamDataManangerService;
    exports.UbccParamDataUiService = UbccParamDataUiService;
    exports.UbccParamDataUiRootComponent = UbccParamDataUiRootComponent;
    exports.UbccParamDimensionUiRootComponent = UbccParamDimensionUiRootComponent;
    exports.DialogResult = DialogResult;
    exports.ɵl = DimensionDropdownlistControlComponent;
    exports.ɵm = DimensionInputControlComponent;
    exports.ɵk = DimensionLookupControlComponent;
    exports.ɵb = CheckboxControlComponent;
    exports.ɵd = DateControlComponent;
    exports.ɵe = DropdownlistControlComponent;
    exports.ɵa = InputControlComponent;
    exports.ɵf = LookupControlComponent;
    exports.ɵh = NumberControlComponent;
    exports.ɵj = UbccEventBusService;
    exports.ɵg = LookUpHttpService;
    exports.ɵi = UbccParamDataUiDialogComponent;
    exports.ɵn = UbccParamDimensionUiComponent;
    exports.ɵc = UbccParamDataUtils;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gsp-cmp-ubcc-param-data-ui.umd.js.map
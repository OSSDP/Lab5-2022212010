...
export declare class UbccParamDataManangerService {
    private http;
    private cache;
    httpHeaders: HttpHeaders;
    constructor(http: HttpClient, cache: SessionService);
    ...
    getHelpData(helpId: string, dataIds: Array<string>): Observable<Object>;
}

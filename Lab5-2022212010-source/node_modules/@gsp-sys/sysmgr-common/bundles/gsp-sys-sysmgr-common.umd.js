(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ecp-caf/caf-common'), require('@angular/common'), require('@angular/core'), require('@angular/common/http'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@gsp-sys/sysmgr-common', ['exports', '@ecp-caf/caf-common', '@angular/common', '@angular/core', '@angular/common/http', 'rxjs/operators'], factory) :
    (factory((global['gsp-sys'] = global['gsp-sys'] || {}, global['gsp-sys']['sysmgr-common'] = {}),global.cafCommon,global.ng.common,global.ng.core,global.ng.common.http,global.rxjs.operators));
}(this, (function (exports,cafCommon,common,i0,i1,operators) { 'use strict';
    ...
    var SysCommonUtilService = /** @class */ (function () {
        ...
        /** @nocollapse */
        SysCommonUtilService.ctorParameters = function () {
            return [
    ...
    var SysSecurityConfigService = /** @class */ (function () {
         ...
         */
            function () {
                ...
                return this.http.get(url, this.sysUtil.getHeader()).pipe(operators.map(( /**
                 * @param {?} res
                 * @return {?}
        ...
        /** @nocollapse */
        SysSecurityConfigService.ctorParameters = function () {
            return [
                { type: i1.HttpClient },
                { type: SysCommonUtilService }
            ];
        };
        /** @nocollapse */ SysSecurityConfigService.ngInjectableDef = i0.defineInjectable({ factory: function SysSecurityConfigService_Factory() { return new SysSecurityConfigService(i0.inject(i1.HttpClient), i0.inject(SysCommonUtilService)); }, token: SysSecurityConfigService, providedIn: "root" });
    ...
    exports.SysCommonModule = SysCommonModule;
    exports.SysCommonUtilService = SysCommonUtilService;
    exports.ResultPackage = ResultPackage;
    exports.GspSecSetting = GspSecSetting;
    exports.SYS_ADD = SYS_ADD;
    exports.SYS_EDIT = SYS_EDIT;
    exports.SYS_VIEW = SYS_VIEW;
    exports.SYS_SAVE = SYS_SAVE;
    exports.SysDataUtil = SysDataUtil;
    exports.PositionFuncOp = PositionFuncOp;
    exports.RoleFuncOp = RoleFuncOp;
    exports.UserFuncOp = UserFuncOp;
    exports.PositionType = PositionType;
    exports.SysSecurityConfigService = SysSecurityConfigService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gsp-sys-sysmgr-common.umd.js.map
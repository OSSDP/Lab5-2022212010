...
var SysFarrisFuncOperationComponent = /** @class */ (function () {
    ...
    function () {
        ...
        /** @type {?} */
        var filter = content.toLowerCase();
        // 如果只显示分组
        if (this.onlyShowGroup) {
...
export { SysFarrisFuncOperationComponent };
if (false) {
    /**
     * 业务对象,负责传递
     * @type {?}

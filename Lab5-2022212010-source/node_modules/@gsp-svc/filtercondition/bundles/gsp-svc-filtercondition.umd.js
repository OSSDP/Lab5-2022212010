(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@progress/kendo-angular-dropdowns'), require('@farris/ui-treetable'), require('@progress/kendo-angular-buttons'), require('@progress/kendo-angular-inputs'), require('@angular/forms'), require('@progress/kendo-angular-popup'), require('@angular/core'), require('@gsp-bef/gsp-cm-metadata'), require('@angular/common/http'), require('@gsp-svc/expression'), require('@farris/ui-modal'), require('@farris/ui-dropdown'), require('@farris/ui-combo-list'), require('@farris/ui-input-group'), require('@farris/ui-notify')) :
    typeof define === 'function' && define.amd ? define('@gsp-svc/filtercondition', ['exports', '@angular/common', '@progress/kendo-angular-dropdowns', '@farris/ui-treetable', '@progress/kendo-angular-buttons', '@progress/kendo-angular-inputs', '@angular/forms', '@progress/kendo-angular-popup', '@angular/core', '@gsp-bef/gsp-cm-metadata', '@angular/common/http', '@gsp-svc/expression', '@farris/ui-modal', '@farris/ui-dropdown', '@farris/ui-combo-list', '@farris/ui-input-group', '@farris/ui-notify'], factory) :
    (factory((global['gsp-svc'] = global['gsp-svc'] || {}, global['gsp-svc'].filtercondition = {}),global.ng.common,global.kendoAngularDropdowns,global.uiTreetable,global.kendoAngularButtons,global.kendoAngularInputs,global.ng.forms,global.kendoAngularPopup,global.ng.core,global.gspCmMetadata,global.ng.common.http,global.expression,global.uiModal,global.uiDropdown,global.uiComboList,global.uiInputGroup,global.uiNotify));
}(this, (function (exports,common,kendoAngularDropdowns,uiTreetable,kendoAngularButtons,kendoAngularInputs,forms,kendoAngularPopup,core,gspCmMetadata,http,expression,uiModal,uiDropdown,uiComboList,uiInputGroup,uiNotify) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FilterConditionLocalePipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        FilterConditionLocalePipe.ctorParameters = function () {
            return [
        ...
        */
        ...
        FilterConditionComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [expression.ExpressionService],
        ...
        /** @nocollapse */
        FilterConditionComponent.ctorParameters = function () {
            return [
        ...
        FilterConditionComponent.propDecorators = {
            ...
            expressionText: [{ type: core.Input }],
            expressionSchema: [{ type: core.Input }],
            expressionInjectedEntities: [{ type: core.Input }],
            expressionCDT: [{ type: core.Input }],
            propertyList: [{ type: core.Input }],
            filterExpressionString: [{ type: core.Input }],
            schemaMap: [{ type: core.Input }],
            newSchemaMap: [{ type: core.Input }],
            injectedEntity: [{ type: core.Input }],
            exprWinWidth: [{ type: core.Input }]
        };
         ...
         */
            function (gspCO, entityTypes) {
                ...
                if ((gspCO.ContainElements) && gspCO.ContainElements.length != 0) {
                     ...
                     * @return {?}
                     */function (element) {
                        if (!element.IsUdt && element.ObjectType != gspCmMetadata.GSPElementObjectType.Association) {
                            /** @type {?} */
         ...
         */
            function (co, types) {
                ...
                if (co.ContainElements && co.ContainElements.length > 0) {
                     ...
                     * @return {?}
                     */function (ele) {
                        if (!ele.IsUdt && ele.ObjectType != gspCmMetadata.GSPElementObjectType.Association) {
                            /** @type {?} */
    ...
    var FilterService = /** @class */ (function () {
        function FilterService(injector, applicationRef, compFactRes, http$$1) {
         ...
         */
            function (name, schemaName, typeNameInSchema, injectedType) {
                //构造注入实体对象
                /** @type {?} */
                var injectedEntity = new expression.InjectedEntity();
         ...
         */
            function (name, schemaName, injectedType) {
                if (injectedType === void 0) {
                    injectedType = FilterInjectedType.EntityType;
                }
                this.injectedEntity = new FilterInjectedEntity();
        ...
        */
        ...
        FilterExpressionComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [expression.ExpressionService, PropertyAdapter],
                        encapsulation: core.ViewEncapsulation.None,
        ...
        /** @nocollapse */
        FilterExpressionComponent.ctorParameters = function () {
            return [
                { type: expression.ExpressionService },
        ...
        FilterExpressionComponent.propDecorators = {
            ...
            propertyList: [{ type: core.Input }],
            filterExpressionString: [{ type: core.Input }],
            schemaName: [{ type: core.Input }],
            schema: [{ type: core.Input }],
            newSchema: [{ type: core.Input }],
            injectedEntity: [{ type: core.Input }],
            gspCommonObject: [{ type: core.Input }],
        ...
        FilterConditionModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            ...
                            kendoAngularButtons.DropDownButtonModule,
    ...
    exports.FilterEntitySchema = FilterEntitySchema;
    exports.FilterEntityType = FilterEntityType;
    exports.FilterEntitySet = FilterEntitySet;
    exports.FilterInjectedType = FilterInjectedType;
    exports.FilterInjectedEntity = FilterInjectedEntity;
    exports.FilterExpressionBase = FilterExpressionBase;
    ...
    exports.ExpressTypeEnum = ExpressTypeEnum;
    exports.RelationTypeEnum = RelationTypeEnum;
    exports.ɵb = FilterConditionLocalePipe;
    exports.ɵa = PropertyAdapter;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=gsp-svc-filtercondition.umd.js.map
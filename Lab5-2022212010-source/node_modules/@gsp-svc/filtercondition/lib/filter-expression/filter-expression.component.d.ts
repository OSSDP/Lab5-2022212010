...
export declare class FilterExpressionComponent implements OnChanges {
    private expr;
    private propertyAdapter;
    private notifyservice;
    private injector;
    localePipe: FilterConditionLocalePipe;
    constructor(expr: ExpressionService, propertyAdapter: PropertyAdapter, notifyservice: NotifyService, injector: Injector, localeId: string);
    ...
    propertyList: Array<{
        text: string;
        value: string;
        propertyFieldType: PropertyDataType;
    }>;
    filterExpressionString: string;
    schemaName: string;
    schema: FilterEntitySchema;
    newSchema: NewSchema;
    filterNewSchemaMap: Map<string, NewSchema>;
    injectedEntity: FilterInjectedEntity;
    gspCommonObject: GSPCommonObject;
    disabled: boolean;
    propertyListInner: Array<{
        text: string;
    ...
    defaultExpressTypeText: any;
    displayPopup: boolean;
    filterExpressionPre: FilterExpression;
    checkFilterStruc: boolean;
    filterSchemaMap: Map<string, FilterEntitySchema>;
    adapter: Adapter;
    treeData: TreeNode[];
    columnWidth: string[];
    private notifies;
     ...
     */
    addNewSchema(name: string, filterNewSchema: NewSchema): void;
    /**
     * 添加schema入Map
     * @param name schema名
     * @param filterSchema

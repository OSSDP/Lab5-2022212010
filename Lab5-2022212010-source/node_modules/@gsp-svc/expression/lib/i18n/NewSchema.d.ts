 ...
 * @author Wenxing Man
 */
export declare class NewSchema {
    name: string;
    description: string;
 ...
 * @author Wenxing Man
 */
export declare class NewEntitySet {
    code: string;
    name: string;
    entityType: string;
}
 ...
 * @author Wenxing Man
 */
export declare class NewEntityType {
    code: string;
    name: string;
    master: boolean;
 ...
 * @author Wenxing Man
 */
export declare class NewAssociation {
    name: string;
    masterType: string;
    childType: string;
 ...
 * @author Wenxing Man
 */
export declare class NewProperty {
    code: string;
    name: string;
 ...
 * @author Wenxing Man
 */
export declare class NewNavigationProperty {
    code: string;
    name: string;
 ...
 * @description 数据类型的枚举
 */
export declare enum NewDataType {
    String = 0,
    Byte = 1,
    Boolean = 2,
    Date = 3,
...
/**
 * @description 导航属性类型的枚举
 * @enum EntitySet EntitySet
 * @enum EntityType EntityType
 */
export declare enum NewNavigationType {
    EntitySet = "EntitySet",
